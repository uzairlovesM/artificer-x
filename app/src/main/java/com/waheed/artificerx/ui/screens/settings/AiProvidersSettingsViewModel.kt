    ...
    constructor(
        ...
        private fun AiProviderConfig.toRecordShape(): ProviderConfigRecord =
            ProviderConfigRecord(
                ...
                visionModelIdsJson = kotlinx.serialization.json.Json.encodeToString(visionModelIds.toList()),
                reasoningModelIdsJson = kotlinx.serialization.json.Json.encodeToString(reasoningModelIds.toList()),
                toolCallingModelIdsJson = kotlinx.serialization.json.Json.encodeToString(toolCallingModelIds.toList()),
