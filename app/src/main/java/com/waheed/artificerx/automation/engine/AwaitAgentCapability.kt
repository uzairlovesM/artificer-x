...
/** Concrete capability contract for await agent.
...
data class AwaitAgentCapability(val id:String="await_agent", val version:Int=1, val requires:Set<String>=emptySet(), val produces:Set<String>=emptySet(), val reversible:Boolean=true)
