...
class CanvasExpansion : ExpansionCapability {
    override val id: String = "domain.model.canvas"
    override val area: String = "domain.model"
    override val purpose: String = "Canvas coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
