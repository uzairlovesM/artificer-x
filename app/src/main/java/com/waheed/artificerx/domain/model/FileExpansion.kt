...
class FileExpansion : ExpansionCapability {
    override val id: String = "domain.model.file"
    override val area: String = "domain.model"
    override val purpose: String = "File coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
