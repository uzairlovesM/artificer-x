...
class AutomationExpansion : ExpansionCapability {
    override val id: String = "domain.model.automation"
    override val area: String = "domain.model"
    override val purpose: String = "Automation coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
