...
/** Concrete capability contract for verify agent.
...
data class VerifyAgentCapability(val id:String="verify_agent", val version:Int=1, val requires:Set<String>=emptySet(), val produces:Set<String>=emptySet(), val reversible:Boolean=true)
