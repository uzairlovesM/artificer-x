...
class VectorExpansion : ExpansionCapability {
    override val id: String = "domain.model.vector"
    override val area: String = "domain.model"
    override val purpose: String = "Vector coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
