...
class ArtifactExpansion : ExpansionCapability {
    override val id: String = "domain.model.artifact"
    override val area: String = "domain.model"
    override val purpose: String = "Artifact coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
