...
class SearchExpansion : ExpansionCapability {
    override val id: String = "domain.usecase.search"
    override val area: String = "domain.usecase"
    override val purpose: String = "Search coordinates domain.usecase responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
