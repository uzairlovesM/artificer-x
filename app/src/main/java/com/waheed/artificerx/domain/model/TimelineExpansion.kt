...
class TimelineExpansion : ExpansionCapability {
    override val id: String = "domain.model.timeline"
    override val area: String = "domain.model"
    override val purpose: String = "Timeline coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
