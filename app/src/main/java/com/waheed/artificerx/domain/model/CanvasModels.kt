...
data class DrawToolState(
    ...
    val brushSpacing: Float = 0.18f,
    val brushSmoothing: Float = 0.28f,
    val brushScatter: Float = 0f,
    val brushSizePressure: Float = 0.75f,
    val brushOpacityPressure: Float = 0.35f,
