...
/** Concrete capability contract for render scene.
...
data class RenderSceneCapability(val id:String="render_scene", val version:Int=1, val requires:Set<String>=emptySet(), val produces:Set<String>=emptySet(), val reversible:Boolean=true)
