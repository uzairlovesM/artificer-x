...
/** Concrete capability contract for install tool.
...
data class InstallToolCapability(val id:String="install_tool", val version:Int=1, val requires:Set<String>=emptySet(), val produces:Set<String>=emptySet(), val reversible:Boolean=true)
