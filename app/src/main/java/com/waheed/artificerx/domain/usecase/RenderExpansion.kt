...
class RenderExpansion : ExpansionCapability {
    override val id: String = "domain.usecase.render"
    override val area: String = "domain.usecase"
    override val purpose: String = "Render coordinates domain.usecase responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
