...
class ToolExpansion : ExpansionCapability {
    override val id: String = "domain.model.tool"
    override val area: String = "domain.model"
    override val purpose: String = "Tool coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
