...
class LayerExpansion : ExpansionCapability {
    override val id: String = "domain.model.layer"
    override val area: String = "domain.model"
    override val purpose: String = "Layer coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
