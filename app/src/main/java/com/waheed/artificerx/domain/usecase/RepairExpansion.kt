...
class RepairExpansion : ExpansionCapability {
    override val id: String = "domain.usecase.repair"
    override val area: String = "domain.usecase"
    override val purpose: String = "Repair coordinates domain.usecase responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
