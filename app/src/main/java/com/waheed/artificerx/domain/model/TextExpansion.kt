...
class TextExpansion : ExpansionCapability {
    override val id: String = "domain.model.text"
    override val area: String = "domain.model"
    override val purpose: String = "Text coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
