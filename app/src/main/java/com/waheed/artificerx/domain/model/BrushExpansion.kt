...
class BrushExpansion : ExpansionCapability {
    override val id: String = "domain.model.brush"
    override val area: String = "domain.model"
    override val purpose: String = "Brush coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
