...
/** Concrete capability contract for apply brush.
...
data class ApplyBrushCapability(val id:String="apply_brush", val version:Int=1, val requires:Set<String>=emptySet(), val produces:Set<String>=emptySet(), val reversible:Boolean=true)
