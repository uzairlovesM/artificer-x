...
class BackupExpansion : ExpansionCapability {
    override val id: String = "domain.usecase.backup"
    override val area: String = "domain.usecase"
    override val purpose: String = "Backup coordinates domain.usecase responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
