...
class RulerExpansion : ExpansionCapability {
    override val id: String = "domain.model.ruler"
    override val area: String = "domain.model"
    override val purpose: String = "Ruler coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
