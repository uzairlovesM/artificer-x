...
class ScheduleExpansion : ExpansionCapability {
    override val id: String = "domain.usecase.schedule"
    override val area: String = "domain.usecase"
    override val purpose: String = "Schedule coordinates domain.usecase responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
