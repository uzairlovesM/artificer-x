...
/** Concrete capability contract for route agent.
...
data class RouteAgentCapability(val id:String="route_agent", val version:Int=1, val requires:Set<String>=emptySet(), val produces:Set<String>=emptySet(), val reversible:Boolean=true)
