...
class BranchExpansion : ExpansionCapability {
    override val id: String = "domain.model.branch"
    override val area: String = "domain.model"
    override val purpose: String = "Branch coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
