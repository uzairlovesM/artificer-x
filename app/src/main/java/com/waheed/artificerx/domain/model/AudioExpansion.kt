...
class AudioExpansion : ExpansionCapability {
    override val id: String = "domain.model.audio"
    override val area: String = "domain.model"
    override val purpose: String = "Audio coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
