...
/** Concrete capability contract for run agent.
...
data class RunAgentCapability(val id:String="run_agent", val version:Int=1, val requires:Set<String>=emptySet(), val produces:Set<String>=emptySet(), val reversible:Boolean=true)
