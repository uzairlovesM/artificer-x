...
class ProviderExpansion : ExpansionCapability {
    override val id: String = "domain.model.provider"
    override val area: String = "domain.model"
    override val purpose: String = "Provider coordinates domain.model responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
