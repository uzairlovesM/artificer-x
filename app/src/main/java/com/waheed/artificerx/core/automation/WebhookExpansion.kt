...
class WebhookExpansion : ExpansionCapability {
    override val id: String = "core.automation.webhook"
    override val area: String = "core.automation"
    override val purpose: String = "Webhook coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
