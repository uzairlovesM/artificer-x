...
/**
 * Runtime capability implementation for core.settings.research.
 *
...
class XResearchCapability : ExpansionCapability {
    override val id: String = "core.settings.research"
    override val area: String = "core.settings"
    override val purpose: String = "Research capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
