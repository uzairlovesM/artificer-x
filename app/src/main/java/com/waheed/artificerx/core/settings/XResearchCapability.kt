...
class XResearchCapability : ExpansionCapability {
    override val id = "core.settings.research"
    override val area = "core.settings"
    override val purpose = "Research capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
