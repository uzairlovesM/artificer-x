...
class NativeAvifExpansion : ExpansionCapability {
    override val id: String = "core.native.nativeavif"
    override val area: String = "core.native"
    override val purpose: String = "NativeAvif coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
