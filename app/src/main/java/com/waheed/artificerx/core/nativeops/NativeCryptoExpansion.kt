...
class NativeCryptoExpansion : ExpansionCapability {
    override val id: String = "core.nativeops.nativecrypto"
    override val area: String = "core.nativeops"
    override val purpose: String = "NativeCrypto coordinates core.nativeops responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
