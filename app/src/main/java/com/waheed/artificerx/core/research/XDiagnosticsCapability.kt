...
class XDiagnosticsCapability : ExpansionCapability {
    override val id = "core.research.diagnostics"
    override val area = "core.research"
    override val purpose = "Diagnostics capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
