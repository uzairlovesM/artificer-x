...
/**
 * Runtime capability implementation for core.memory.session.
 *
...
class XSessionCapability : ExpansionCapability {
    override val id: String = "core.memory.session"
    override val area: String = "core.memory"
    override val purpose: String = "Session capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
