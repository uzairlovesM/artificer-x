...
class XSessionCapability : ExpansionCapability {
    override val id = "core.memory.session"
    override val area = "core.memory"
    override val purpose = "Session capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
