...
/**
 * Runtime capability implementation for core.export.png.
 *
...
class XPngCapability : ExpansionCapability {
    override val id: String = "core.export.png"
    override val area: String = "core.export"
    override val purpose: String = "Png capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
