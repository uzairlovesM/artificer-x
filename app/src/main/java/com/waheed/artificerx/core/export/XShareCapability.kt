...
/**
 * Runtime capability implementation for core.export.share.
 *
...
class XShareCapability : ExpansionCapability {
    override val id: String = "core.export.share"
    override val area: String = "core.export"
    override val purpose: String = "Share capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
