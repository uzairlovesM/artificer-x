...
/**
 * Runtime capability implementation for core.model.toolcall.
 *
 ...
 */
class XToolCallCapability : ExpansionCapability {
    override val id: String = "core.model.toolcall"
    override val area: String = "core.model"
    override val purpose: String = "ToolCall capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
