...
/** Production expansion contract for ToolCall. */
class XToolCallCapability : ExpansionCapability {
    override val id = "core.model.toolcall"
    override val area = "core.model"
    override val purpose = "ToolCall capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
