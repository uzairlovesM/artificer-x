...
/**
 * Runtime capability implementation for core.settings.plugin.
 *
...
class XPluginCapability : ExpansionCapability {
    override val id: String = "core.settings.plugin"
    override val area: String = "core.settings"
    override val purpose: String = "Plugin capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
