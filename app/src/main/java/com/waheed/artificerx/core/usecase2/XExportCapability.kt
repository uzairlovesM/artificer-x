...
class XExportCapability : ExpansionCapability {
    override val id = "core.usecase2.export"
    override val area = "core.usecase2"
    override val purpose = "Export capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
