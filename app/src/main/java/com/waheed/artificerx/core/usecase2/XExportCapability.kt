...
/**
 * Runtime capability implementation for core.usecase2.export.
 *
...
class XExportCapability : ExpansionCapability {
    override val id: String = "core.usecase2.export"
    override val area: String = "core.usecase2"
    override val purpose: String = "Export capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
