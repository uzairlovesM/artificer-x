...
/** Production expansion contract for Push. */
class XPushCapability : ExpansionCapability {
    override val id = "core.repository.push"
    override val area = "core.repository"
    override val purpose = "Push capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
