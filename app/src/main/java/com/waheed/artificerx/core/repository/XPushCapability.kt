...
/**
 * Runtime capability implementation for core.repository.push.
 *
 ...
 */
class XPushCapability : ExpansionCapability {
    override val id: String = "core.repository.push"
    override val area: String = "core.repository"
    override val purpose: String = "Push capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
