...
/**
 * Runtime capability implementation for core.export.image.
 *
...
class XImageCapability : ExpansionCapability {
    override val id: String = "core.export.image"
    override val area: String = "core.export"
    override val purpose: String = "Image capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
