...
/**
 * Runtime capability implementation for core.export.cancel.
 *
...
class XCancelCapability : ExpansionCapability {
    override val id: String = "core.export.cancel"
    override val area: String = "core.export"
    override val purpose: String = "Cancel capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
