...
/** Production expansion contract for Log. */
class XLogCapability : ExpansionCapability {
    override val id = "core.diagnostics.log"
    override val area = "core.diagnostics"
    override val purpose = "Log capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
