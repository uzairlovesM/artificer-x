...
/**
 * Runtime capability implementation for core.diagnostics.log.
 *
 ...
 */
class XLogCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.log"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Log capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
