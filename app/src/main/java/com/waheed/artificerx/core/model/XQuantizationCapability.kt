...
/** Production expansion contract for Quantization. */
class XQuantizationCapability : ExpansionCapability {
    override val id = "core.model.quantization"
    override val area = "core.model"
    override val purpose = "Quantization capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
