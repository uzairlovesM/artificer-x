...
class NativeYamlExpansion : ExpansionCapability {
    override val id: String = "core.native.nativeyaml"
    override val area: String = "core.native"
    override val purpose: String = "NativeYaml coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
