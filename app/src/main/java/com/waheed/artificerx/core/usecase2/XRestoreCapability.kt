...
class XRestoreCapability : ExpansionCapability {
    override val id = "core.usecase2.restore"
    override val area = "core.usecase2"
    override val purpose = "Restore capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
