...
/**
 * Runtime capability implementation for core.usecase2.restore.
 *
...
class XRestoreCapability : ExpansionCapability {
    override val id: String = "core.usecase2.restore"
    override val area: String = "core.usecase2"
    override val purpose: String = "Restore capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
