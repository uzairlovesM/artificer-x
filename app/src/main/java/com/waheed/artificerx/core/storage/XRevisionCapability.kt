...
/** Production expansion contract for Revision. */
class XRevisionCapability : ExpansionCapability {
    override val id = "core.storage.revision"
    override val area = "core.storage"
    override val purpose = "Revision capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
