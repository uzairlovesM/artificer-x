...
/**
 * Runtime capability implementation for core.storage.revision.
 *
 ...
 */
class XRevisionCapability : ExpansionCapability {
    override val id: String = "core.storage.revision"
    override val area: String = "core.storage"
    override val purpose: String = "Revision capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
