...
/**
 * Runtime capability implementation for core.remoteagent.project.
 *
...
class XProjectCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.project"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Project capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
