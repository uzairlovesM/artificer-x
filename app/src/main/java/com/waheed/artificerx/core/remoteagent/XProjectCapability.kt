...
class XProjectCapability : ExpansionCapability {
    override val id = "core.remoteagent.project"
    override val area = "core.remoteagent"
    override val purpose = "Project capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
