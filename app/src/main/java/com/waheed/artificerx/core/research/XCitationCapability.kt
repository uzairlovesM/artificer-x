...
/**
 * Runtime capability implementation for core.research.citation.
 *
 ...
 */
class XCitationCapability : ExpansionCapability {
    override val id: String = "core.research.citation"
    override val area: String = "core.research"
    override val purpose: String = "Citation capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
