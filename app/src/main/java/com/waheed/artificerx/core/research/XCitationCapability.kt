...
/** Production expansion contract for Citation. */
class XCitationCapability : ExpansionCapability {
    override val id = "core.research.citation"
    override val area = "core.research"
    override val purpose = "Citation capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
