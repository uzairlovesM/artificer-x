...
/**
 * Runtime capability implementation for core.model.buffer.
 *
...
class XBufferCapability : ExpansionCapability {
    override val id: String = "core.model.buffer"
    override val area: String = "core.model"
    override val purpose: String = "Buffer capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
