...
/**
 * Runtime capability implementation for core.model.chat.
 *
...
class XChatCapability : ExpansionCapability {
    override val id: String = "core.model.chat"
    override val area: String = "core.model"
    override val purpose: String = "Chat capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
