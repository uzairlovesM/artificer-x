...
class XManifestCapability : ExpansionCapability {
    override val id = "core.repository.manifest"
    override val area = "core.repository"
    override val purpose = "Manifest capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
