...
/**
 * Runtime capability implementation for core.repository.manifest.
 *
 ...
 */
class XManifestCapability : ExpansionCapability {
    override val id: String = "core.repository.manifest"
    override val area: String = "core.repository"
    override val purpose: String = "Manifest capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
