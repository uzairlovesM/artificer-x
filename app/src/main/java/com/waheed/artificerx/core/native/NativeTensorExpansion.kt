...
class NativeTensorExpansion : ExpansionCapability {
    override val id: String = "core.native.nativetensor"
    override val area: String = "core.native"
    override val purpose: String = "NativeTensor coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
