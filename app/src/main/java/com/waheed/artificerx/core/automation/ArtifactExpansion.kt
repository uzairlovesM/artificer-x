...
class ArtifactExpansion : ExpansionCapability {
    override val id: String = "core.automation.artifact"
    override val area: String = "core.automation"
    override val purpose: String = "Artifact coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
