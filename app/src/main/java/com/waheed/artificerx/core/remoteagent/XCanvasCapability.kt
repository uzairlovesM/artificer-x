...
class XCanvasCapability : ExpansionCapability {
    override val id = "core.remoteagent.canvas"
    override val area = "core.remoteagent"
    override val purpose = "Canvas capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
