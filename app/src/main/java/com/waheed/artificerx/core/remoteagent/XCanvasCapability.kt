...
/**
 * Runtime capability implementation for core.remoteagent.canvas.
 *
...
class XCanvasCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.canvas"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Canvas capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
