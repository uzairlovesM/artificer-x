...
/** Production expansion contract for Explain. */
class XExplainCapability : ExpansionCapability {
    override val id = "core.usecase2.explain"
    override val area = "core.usecase2"
    override val purpose = "Explain capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
