...
/**
 * Runtime capability implementation for core.model.loader.
 *
...
class XLoaderCapability : ExpansionCapability {
    override val id: String = "core.model.loader"
    override val area: String = "core.model"
    override val purpose: String = "Loader capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
