...
class XStoryboardCapability : ExpansionCapability {
    override val id = "core.creative.storyboard"
    override val area = "core.creative"
    override val purpose = "Storyboard capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
