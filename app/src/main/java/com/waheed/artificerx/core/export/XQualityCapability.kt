...
/**
 * Runtime capability implementation for core.export.quality.
 *
...
class XQualityCapability : ExpansionCapability {
    override val id: String = "core.export.quality"
    override val area: String = "core.export"
    override val purpose: String = "Quality capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
