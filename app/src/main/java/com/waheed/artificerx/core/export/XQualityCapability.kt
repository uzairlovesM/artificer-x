...
class XQualityCapability : ExpansionCapability {
    override val id = "core.export.quality"
    override val area = "core.export"
    override val purpose = "Quality capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
