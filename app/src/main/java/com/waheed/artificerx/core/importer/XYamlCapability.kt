...
/**
 * Runtime capability implementation for core.importer.yaml.
 *
 ...
 */
class XYamlCapability : ExpansionCapability {
    override val id: String = "core.importer.yaml"
    override val area: String = "core.importer"
    override val purpose: String = "Yaml capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
