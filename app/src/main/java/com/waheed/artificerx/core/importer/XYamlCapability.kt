...
/** Production expansion contract for Yaml. */
class XYamlCapability : ExpansionCapability {
    override val id = "core.importer.yaml"
    override val area = "core.importer"
    override val purpose = "Yaml capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
