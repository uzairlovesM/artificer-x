...
/**
 * Runtime capability implementation for core.export.frame.
 *
...
class XFrameCapability : ExpansionCapability {
    override val id: String = "core.export.frame"
    override val area: String = "core.export"
    override val purpose: String = "Frame capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
