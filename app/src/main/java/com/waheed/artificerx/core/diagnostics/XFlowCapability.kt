...
/**
 * Runtime capability implementation for core.diagnostics.flow.
 *
 ...
 */
class XFlowCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.flow"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Flow capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
