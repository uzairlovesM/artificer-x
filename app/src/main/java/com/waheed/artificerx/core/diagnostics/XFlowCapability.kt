...
/** Production expansion contract for Flow. */
class XFlowCapability : ExpansionCapability {
    override val id = "core.diagnostics.flow"
    override val area = "core.diagnostics"
    override val purpose = "Flow capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
