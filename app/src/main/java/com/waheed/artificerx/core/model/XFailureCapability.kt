...
/**
 * Runtime capability implementation for core.model.failure.
 *
...
class XFailureCapability : ExpansionCapability {
    override val id: String = "core.model.failure"
    override val area: String = "core.model"
    override val purpose: String = "Failure capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
