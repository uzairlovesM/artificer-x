...
class NativeWebpExpansion : ExpansionCapability {
    override val id: String = "core.nativeops.nativewebp"
    override val area: String = "core.nativeops"
    override val purpose: String = "NativeWebp coordinates core.nativeops responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
