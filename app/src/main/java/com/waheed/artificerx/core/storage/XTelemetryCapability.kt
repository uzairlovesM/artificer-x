...
/** Production expansion contract for Telemetry. */
class XTelemetryCapability : ExpansionCapability {
    override val id = "core.storage.telemetry"
    override val area = "core.storage"
    override val purpose = "Telemetry capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
