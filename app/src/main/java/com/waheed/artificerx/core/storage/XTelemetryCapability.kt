...
/**
 * Runtime capability implementation for core.storage.telemetry.
 *
...
class XTelemetryCapability : ExpansionCapability {
    override val id: String = "core.storage.telemetry"
    override val area: String = "core.storage"
    override val purpose: String = "Telemetry capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
