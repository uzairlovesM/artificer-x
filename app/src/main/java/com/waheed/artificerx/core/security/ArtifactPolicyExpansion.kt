...
class ArtifactPolicyExpansion : ExpansionCapability {
    override val id: String = "core.security.artifactpolicy"
    override val area: String = "core.security"
    override val purpose: String = "ArtifactPolicy coordinates core.security responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
