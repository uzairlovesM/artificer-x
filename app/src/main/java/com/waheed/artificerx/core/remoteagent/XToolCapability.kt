...
class XToolCapability : ExpansionCapability {
    override val id = "core.remoteagent.tool"
    override val area = "core.remoteagent"
    override val purpose = "Tool capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
