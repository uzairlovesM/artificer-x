...
/**
 * Runtime capability implementation for core.importer.color.
 *
 ...
 */
class XColorCapability : ExpansionCapability {
    override val id: String = "core.importer.color"
    override val area: String = "core.importer"
    override val purpose: String = "Color capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
