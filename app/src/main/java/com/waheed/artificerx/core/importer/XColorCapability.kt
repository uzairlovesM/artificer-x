...
/** Production expansion contract for Color. */
class XColorCapability : ExpansionCapability {
    override val id = "core.importer.color"
    override val area = "core.importer"
    override val purpose = "Color capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
