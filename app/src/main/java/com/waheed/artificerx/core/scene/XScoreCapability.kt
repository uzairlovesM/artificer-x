...
/**
 * Runtime capability implementation for core.scene.score.
 *
...
class XScoreCapability : ExpansionCapability {
    override val id: String = "core.scene.score"
    override val area: String = "core.scene"
    override val purpose: String = "Score capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
