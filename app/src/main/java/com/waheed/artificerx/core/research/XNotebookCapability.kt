...
/**
 * Runtime capability implementation for core.research.notebook.
 *
 ...
 */
class XNotebookCapability : ExpansionCapability {
    override val id: String = "core.research.notebook"
    override val area: String = "core.research"
    override val purpose: String = "Notebook capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
