...
/** Production expansion contract for Notebook. */
class XNotebookCapability : ExpansionCapability {
    override val id = "core.research.notebook"
    override val area = "core.research"
    override val purpose = "Notebook capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
