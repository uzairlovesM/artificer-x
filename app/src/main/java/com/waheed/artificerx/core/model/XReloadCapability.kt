...
/**
 * Runtime capability implementation for core.model.reload.
 *
 ...
 */
class XReloadCapability : ExpansionCapability {
    override val id: String = "core.model.reload"
    override val area: String = "core.model"
    override val purpose: String = "Reload capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
