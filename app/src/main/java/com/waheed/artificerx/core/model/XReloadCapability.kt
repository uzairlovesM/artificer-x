...
/** Production expansion contract for Reload. */
class XReloadCapability : ExpansionCapability {
    override val id = "core.model.reload"
    override val area = "core.model"
    override val purpose = "Reload capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
