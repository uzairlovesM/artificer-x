...
/**
 * Runtime capability implementation for core.settings.theme.
 *
...
class XThemeCapability : ExpansionCapability {
    override val id: String = "core.settings.theme"
    override val area: String = "core.settings"
    override val purpose: String = "Theme capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
