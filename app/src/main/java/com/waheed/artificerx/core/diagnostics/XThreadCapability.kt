...
/**
 * Runtime capability implementation for core.diagnostics.thread.
 *
 ...
 */
class XThreadCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.thread"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Thread capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
