...
/** Production expansion contract for Thread. */
class XThreadCapability : ExpansionCapability {
    override val id = "core.diagnostics.thread"
    override val area = "core.diagnostics"
    override val purpose = "Thread capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
