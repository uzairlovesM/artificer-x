...
class NativeArchiveExpansion : ExpansionCapability {
    override val id: String = "core.native.nativearchive"
    override val area: String = "core.native"
    override val purpose: String = "NativeArchive coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
