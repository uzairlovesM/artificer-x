...
/**
 * Runtime capability implementation for core.navigation.gesture.
 *
 ...
 */
class XGestureCapability : ExpansionCapability {
    override val id: String = "core.navigation.gesture"
    override val area: String = "core.navigation"
    override val purpose: String = "Gesture capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
