...
/** Production expansion contract for Gesture. */
class XGestureCapability : ExpansionCapability {
    override val id = "core.navigation.gesture"
    override val area = "core.navigation"
    override val purpose = "Gesture capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
