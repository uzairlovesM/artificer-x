...
/**
 * Runtime capability implementation for core.scene.test.
 *
...
class XTestCapability : ExpansionCapability {
    override val id: String = "core.scene.test"
    override val area: String = "core.scene"
    override val purpose: String = "Test capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
