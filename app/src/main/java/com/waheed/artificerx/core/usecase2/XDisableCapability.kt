...
/** Production expansion contract for Disable. */
class XDisableCapability : ExpansionCapability {
    override val id = "core.usecase2.disable"
    override val area = "core.usecase2"
    override val purpose = "Disable capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
