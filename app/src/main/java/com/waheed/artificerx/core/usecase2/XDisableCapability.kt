...
/**
 * Runtime capability implementation for core.usecase2.disable.
 *
 ...
 */
class XDisableCapability : ExpansionCapability {
    override val id: String = "core.usecase2.disable"
    override val area: String = "core.usecase2"
    override val purpose: String = "Disable capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
