...
/**
 * Runtime capability implementation for core.importer.checksum.
 *
 ...
 */
class XChecksumCapability : ExpansionCapability {
    override val id: String = "core.importer.checksum"
    override val area: String = "core.importer"
    override val purpose: String = "Checksum capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
