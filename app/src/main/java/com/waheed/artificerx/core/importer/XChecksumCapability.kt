...
class XChecksumCapability : ExpansionCapability {
    override val id = "core.importer.checksum"
    override val area = "core.importer"
    override val purpose = "Checksum capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
