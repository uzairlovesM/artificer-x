...
/** Production expansion contract for Cleanup. */
class XCleanupCapability : ExpansionCapability {
    override val id = "core.storage.cleanup"
    override val area = "core.storage"
    override val purpose = "Cleanup capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
