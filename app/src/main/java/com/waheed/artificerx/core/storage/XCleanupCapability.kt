...
/**
 * Runtime capability implementation for core.storage.cleanup.
 *
 ...
 */
class XCleanupCapability : ExpansionCapability {
    override val id: String = "core.storage.cleanup"
    override val area: String = "core.storage"
    override val purpose: String = "Cleanup capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
