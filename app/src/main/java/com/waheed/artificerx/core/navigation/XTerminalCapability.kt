...
/**
 * Runtime capability implementation for core.navigation.terminal.
 *
 ...
 */
class XTerminalCapability : ExpansionCapability {
    override val id: String = "core.navigation.terminal"
    override val area: String = "core.navigation"
    override val purpose: String = "Terminal capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
