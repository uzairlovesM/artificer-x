...
/** Production expansion contract for Terminal. */
class XTerminalCapability : ExpansionCapability {
    override val id = "core.navigation.terminal"
    override val area = "core.navigation"
    override val purpose = "Terminal capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
