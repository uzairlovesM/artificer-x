...
/**
 * Runtime capability implementation for core.settings.import.
 *
...
class XImportCapability : ExpansionCapability {
    override val id: String = "core.settings.import"
    override val area: String = "core.settings"
    override val purpose: String = "Import capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
