...
class XImportCapability : ExpansionCapability {
    override val id = "core.settings.import"
    override val area = "core.settings"
    override val purpose = "Import capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
