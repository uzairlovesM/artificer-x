...
/** Production expansion contract for Remote. */
class XRemoteCapability : ExpansionCapability {
    override val id = "core.diagnostics.remote"
    override val area = "core.diagnostics"
    override val purpose = "Remote capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
