...
/**
 * Runtime capability implementation for core.diagnostics.remote.
 *
 ...
 */
class XRemoteCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.remote"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Remote capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
