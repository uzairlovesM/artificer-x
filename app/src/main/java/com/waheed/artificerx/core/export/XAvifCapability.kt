...
/**
 * Runtime capability implementation for core.export.avif.
 *
...
class XAvifCapability : ExpansionCapability {
    override val id: String = "core.export.avif"
    override val area: String = "core.export"
    override val purpose: String = "Avif capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
