...
/** Production expansion contract for Webp. */
class XWebpCapability : ExpansionCapability {
    override val id = "core.importer.webp"
    override val area = "core.importer"
    override val purpose = "Webp capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
