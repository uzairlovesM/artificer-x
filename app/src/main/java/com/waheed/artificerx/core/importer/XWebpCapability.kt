...
/**
 * Runtime capability implementation for core.importer.webp.
 *
 ...
 */
class XWebpCapability : ExpansionCapability {
    override val id: String = "core.importer.webp"
    override val area: String = "core.importer"
    override val purpose: String = "Webp capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
