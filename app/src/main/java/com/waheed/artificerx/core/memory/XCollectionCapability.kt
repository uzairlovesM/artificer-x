...
/**
 * Runtime capability implementation for core.memory.collection.
 *
...
class XCollectionCapability : ExpansionCapability {
    override val id: String = "core.memory.collection"
    override val area: String = "core.memory"
    override val purpose: String = "Collection capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
