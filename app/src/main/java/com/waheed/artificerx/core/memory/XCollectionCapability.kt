...
class XCollectionCapability : ExpansionCapability {
    override val id = "core.memory.collection"
    override val area = "core.memory"
    override val purpose = "Collection capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
