...
/** Production expansion contract for Updater. */
class XUpdaterCapability : ExpansionCapability {
    override val id = "core.plugin.updater"
    override val area = "core.plugin"
    override val purpose = "Updater capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
