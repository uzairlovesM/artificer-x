...
/**
 * Runtime capability implementation for core.plugin.updater.
 *
 ...
 */
class XUpdaterCapability : ExpansionCapability {
    override val id: String = "core.plugin.updater"
    override val area: String = "core.plugin"
    override val purpose: String = "Updater capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
