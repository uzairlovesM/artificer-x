...
/**
 * Runtime capability implementation for core.creative.typographyplan.
 *
 ...
 */
class XTypographyPlanCapability : ExpansionCapability {
    override val id: String = "core.creative.typographyplan"
    override val area: String = "core.creative"
    override val purpose: String = "TypographyPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
