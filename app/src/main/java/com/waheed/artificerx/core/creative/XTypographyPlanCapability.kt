...
/** Production expansion contract for TypographyPlan. */
class XTypographyPlanCapability : ExpansionCapability {
    override val id = "core.creative.typographyplan"
    override val area = "core.creative"
    override val purpose = "TypographyPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
