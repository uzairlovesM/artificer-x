...
class XCapabilityCapability : ExpansionCapability {
    override val id = "core.remoteagent.capability"
    override val area = "core.remoteagent"
    override val purpose = "Capability capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
