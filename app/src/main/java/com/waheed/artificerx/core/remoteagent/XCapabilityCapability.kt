...
/**
 * Runtime capability implementation for core.remoteagent.capability.
 *
...
class XCapabilityCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.capability"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Capability capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
