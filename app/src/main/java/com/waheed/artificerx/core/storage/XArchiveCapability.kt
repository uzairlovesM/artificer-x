...
/** Production expansion contract for Archive. */
class XArchiveCapability : ExpansionCapability {
    override val id = "core.storage.archive"
    override val area = "core.storage"
    override val purpose = "Archive capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
