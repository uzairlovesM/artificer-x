...
/**
 * Runtime capability implementation for core.storage.archive.
 *
...
class XArchiveCapability : ExpansionCapability {
    override val id: String = "core.storage.archive"
    override val area: String = "core.storage"
    override val purpose: String = "Archive capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
