...
class PlannerExpansion : ExpansionCapability {
    override val id: String = "core.automation.planner"
    override val area: String = "core.automation"
    override val purpose: String = "Planner coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
