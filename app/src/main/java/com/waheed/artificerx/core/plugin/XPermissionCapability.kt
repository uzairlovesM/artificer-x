...
/**
 * Runtime capability implementation for core.plugin.permission.
 *
...
class XPermissionCapability : ExpansionCapability {
    override val id: String = "core.plugin.permission"
    override val area: String = "core.plugin"
    override val purpose: String = "Permission capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
