...
/** Production expansion contract for Permission. */
class XPermissionCapability : ExpansionCapability {
    override val id = "core.plugin.permission"
    override val area = "core.plugin"
    override val purpose = "Permission capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
