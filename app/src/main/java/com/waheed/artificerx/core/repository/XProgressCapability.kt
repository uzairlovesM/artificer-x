...
/**
 * Runtime capability implementation for core.repository.progress.
 *
 ...
 */
class XProgressCapability : ExpansionCapability {
    override val id: String = "core.repository.progress"
    override val area: String = "core.repository"
    override val purpose: String = "Progress capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
