...
/** Production expansion contract for Progress. */
class XProgressCapability : ExpansionCapability {
    override val id = "core.repository.progress"
    override val area = "core.repository"
    override val purpose = "Progress capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
