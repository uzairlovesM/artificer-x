...
/**
 * Runtime capability implementation for core.model.cpu.
 *
...
class XCpuCapability : ExpansionCapability {
    override val id: String = "core.model.cpu"
    override val area: String = "core.model"
    override val purpose: String = "Cpu capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
