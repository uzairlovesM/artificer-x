...
/**
 * Runtime capability implementation for core.importer.archive.
 *
...
class XArchiveCapability : ExpansionCapability {
    override val id: String = "core.importer.archive"
    override val area: String = "core.importer"
    override val purpose: String = "Archive capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
