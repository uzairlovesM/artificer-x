...
class XArchiveCapability : ExpansionCapability {
    override val id = "core.importer.archive"
    override val area = "core.importer"
    override val purpose = "Archive capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
