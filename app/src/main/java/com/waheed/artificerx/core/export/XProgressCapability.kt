...
class XProgressCapability : ExpansionCapability {
    override val id = "core.export.progress"
    override val area = "core.export"
    override val purpose = "Progress capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
