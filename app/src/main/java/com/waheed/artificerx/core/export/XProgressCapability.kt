...
/**
 * Runtime capability implementation for core.export.progress.
 *
...
class XProgressCapability : ExpansionCapability {
    override val id: String = "core.export.progress"
    override val area: String = "core.export"
    override val purpose: String = "Progress capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
