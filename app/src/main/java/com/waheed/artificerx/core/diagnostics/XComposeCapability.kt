...
/**
 * Runtime capability implementation for core.diagnostics.compose.
 *
 ...
 */
class XComposeCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.compose"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Compose capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
