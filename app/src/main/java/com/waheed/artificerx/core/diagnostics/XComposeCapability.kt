...
/** Production expansion contract for Compose. */
class XComposeCapability : ExpansionCapability {
    override val id = "core.diagnostics.compose"
    override val area = "core.diagnostics"
    override val purpose = "Compose capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
