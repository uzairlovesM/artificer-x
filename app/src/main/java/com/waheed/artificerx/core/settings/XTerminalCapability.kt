...
/**
 * Runtime capability implementation for core.settings.terminal.
 *
...
class XTerminalCapability : ExpansionCapability {
    override val id: String = "core.settings.terminal"
    override val area: String = "core.settings"
    override val purpose: String = "Terminal capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
