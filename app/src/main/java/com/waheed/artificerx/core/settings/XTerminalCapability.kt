...
class XTerminalCapability : ExpansionCapability {
    override val id = "core.settings.terminal"
    override val area = "core.settings"
    override val purpose = "Terminal capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
