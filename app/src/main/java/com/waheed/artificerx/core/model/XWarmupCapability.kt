...
/** Production expansion contract for Warmup. */
class XWarmupCapability : ExpansionCapability {
    override val id = "core.model.warmup"
    override val area = "core.model"
    override val purpose = "Warmup capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
