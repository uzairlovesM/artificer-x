...
/**
 * Runtime capability implementation for core.model.warmup.
 *
 ...
 */
class XWarmupCapability : ExpansionCapability {
    override val id: String = "core.model.warmup"
    override val area: String = "core.model"
    override val purpose: String = "Warmup capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
