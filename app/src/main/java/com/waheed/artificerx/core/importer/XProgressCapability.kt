...
/**
 * Runtime capability implementation for core.importer.progress.
 *
...
class XProgressCapability : ExpansionCapability {
    override val id: String = "core.importer.progress"
    override val area: String = "core.importer"
    override val purpose: String = "Progress capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
