...
class XProgressCapability : ExpansionCapability {
    override val id = "core.importer.progress"
    override val area = "core.importer"
    override val purpose = "Progress capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
