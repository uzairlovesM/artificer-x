...
/**
 * Runtime capability implementation for core.diagnostics.database.
 *
 ...
 */
class XDatabaseCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.database"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Database capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
