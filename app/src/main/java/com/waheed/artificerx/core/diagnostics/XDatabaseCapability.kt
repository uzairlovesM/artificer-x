...
/** Production expansion contract for Database. */
class XDatabaseCapability : ExpansionCapability {
    override val id = "core.diagnostics.database"
    override val area = "core.diagnostics"
    override val purpose = "Database capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
