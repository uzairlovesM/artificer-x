...
/**
 * Runtime capability implementation for core.research.timeout.
 *
 ...
 */
class XTimeoutCapability : ExpansionCapability {
    override val id: String = "core.research.timeout"
    override val area: String = "core.research"
    override val purpose: String = "Timeout capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
