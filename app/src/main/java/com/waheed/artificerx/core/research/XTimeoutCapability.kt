...
class XTimeoutCapability : ExpansionCapability {
    override val id = "core.research.timeout"
    override val area = "core.research"
    override val purpose = "Timeout capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
