...
class NativeMathExpansion : ExpansionCapability {
    override val id: String = "core.native.nativemath"
    override val area: String = "core.native"
    override val purpose: String = "NativeMath coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
