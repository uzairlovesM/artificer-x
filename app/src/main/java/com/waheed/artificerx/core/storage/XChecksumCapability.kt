...
/**
 * Runtime capability implementation for core.storage.checksum.
 *
...
class XChecksumCapability : ExpansionCapability {
    override val id: String = "core.storage.checksum"
    override val area: String = "core.storage"
    override val purpose: String = "Checksum capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
