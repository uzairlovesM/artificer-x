...
/** Production expansion contract for Checksum. */
class XChecksumCapability : ExpansionCapability {
    override val id = "core.storage.checksum"
    override val area = "core.storage"
    override val purpose = "Checksum capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
