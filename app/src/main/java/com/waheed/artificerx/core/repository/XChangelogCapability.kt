...
/**
 * Runtime capability implementation for core.repository.changelog.
 *
 ...
 */
class XChangelogCapability : ExpansionCapability {
    override val id: String = "core.repository.changelog"
    override val area: String = "core.repository"
    override val purpose: String = "Changelog capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
