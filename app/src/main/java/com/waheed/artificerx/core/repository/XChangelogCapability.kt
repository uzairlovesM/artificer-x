...
/** Production expansion contract for Changelog. */
class XChangelogCapability : ExpansionCapability {
    override val id = "core.repository.changelog"
    override val area = "core.repository"
    override val purpose = "Changelog capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
