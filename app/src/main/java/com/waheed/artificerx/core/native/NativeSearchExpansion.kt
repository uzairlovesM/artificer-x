...
class NativeSearchExpansion : ExpansionCapability {
    override val id: String = "core.native.nativesearch"
    override val area: String = "core.native"
    override val purpose: String = "NativeSearch coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
