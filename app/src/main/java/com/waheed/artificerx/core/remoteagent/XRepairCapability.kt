...
/**
 * Runtime capability implementation for core.remoteagent.repair.
 *
...
class XRepairCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.repair"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Repair capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
