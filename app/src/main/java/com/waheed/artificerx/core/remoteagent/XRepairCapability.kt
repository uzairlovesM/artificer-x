...
class XRepairCapability : ExpansionCapability {
    override val id = "core.remoteagent.repair"
    override val area = "core.remoteagent"
    override val purpose = "Repair capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
