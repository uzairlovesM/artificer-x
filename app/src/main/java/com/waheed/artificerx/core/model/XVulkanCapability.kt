...
/**
 * Runtime capability implementation for core.model.vulkan.
 *
 ...
 */
class XVulkanCapability : ExpansionCapability {
    override val id: String = "core.model.vulkan"
    override val area: String = "core.model"
    override val purpose: String = "Vulkan capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
