...
/** Production expansion contract for Vulkan. */
class XVulkanCapability : ExpansionCapability {
    override val id = "core.model.vulkan"
    override val area = "core.model"
    override val purpose = "Vulkan capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
