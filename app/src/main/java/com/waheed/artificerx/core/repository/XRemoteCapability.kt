...
class XRemoteCapability : ExpansionCapability {
    override val id = "core.repository.remote"
    override val area = "core.repository"
    override val purpose = "Remote capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
