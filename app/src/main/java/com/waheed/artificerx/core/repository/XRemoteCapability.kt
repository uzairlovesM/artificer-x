...
/**
 * Runtime capability implementation for core.repository.remote.
 *
...
class XRemoteCapability : ExpansionCapability {
    override val id: String = "core.repository.remote"
    override val area: String = "core.repository"
    override val purpose: String = "Remote capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
