...
/** Production expansion contract for Keyframe. */
class XKeyframeCapability : ExpansionCapability {
    override val id = "core.creative.keyframe"
    override val area = "core.creative"
    override val purpose = "Keyframe capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
