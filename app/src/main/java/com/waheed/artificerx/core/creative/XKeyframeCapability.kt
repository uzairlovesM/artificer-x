...
/**
 * Runtime capability implementation for core.creative.keyframe.
 *
 ...
 */
class XKeyframeCapability : ExpansionCapability {
    override val id: String = "core.creative.keyframe"
    override val area: String = "core.creative"
    override val purpose: String = "Keyframe capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
