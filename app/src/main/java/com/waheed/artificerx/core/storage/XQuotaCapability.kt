...
/** Production expansion contract for Quota. */
class XQuotaCapability : ExpansionCapability {
    override val id = "core.storage.quota"
    override val area = "core.storage"
    override val purpose = "Quota capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
