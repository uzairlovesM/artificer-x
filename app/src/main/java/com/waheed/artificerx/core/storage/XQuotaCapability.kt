...
/**
 * Runtime capability implementation for core.storage.quota.
 *
 ...
 */
class XQuotaCapability : ExpansionCapability {
    override val id: String = "core.storage.quota"
    override val area: String = "core.storage"
    override val purpose: String = "Quota capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
