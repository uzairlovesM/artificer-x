...
/**
 * Runtime capability implementation for core.research.observer.
 *
 ...
 */
class XObserverCapability : ExpansionCapability {
    override val id: String = "core.research.observer"
    override val area: String = "core.research"
    override val purpose: String = "Observer capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
