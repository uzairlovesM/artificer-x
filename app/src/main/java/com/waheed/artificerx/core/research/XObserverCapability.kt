...
class XObserverCapability : ExpansionCapability {
    override val id = "core.research.observer"
    override val area = "core.research"
    override val purpose = "Observer capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
