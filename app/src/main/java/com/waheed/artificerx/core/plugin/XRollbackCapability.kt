...
/**
 * Runtime capability implementation for core.plugin.rollback.
 *
 ...
 */
class XRollbackCapability : ExpansionCapability {
    override val id: String = "core.plugin.rollback"
    override val area: String = "core.plugin"
    override val purpose: String = "Rollback capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
