...
/** Production expansion contract for Rollback. */
class XRollbackCapability : ExpansionCapability {
    override val id = "core.plugin.rollback"
    override val area = "core.plugin"
    override val purpose = "Rollback capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
