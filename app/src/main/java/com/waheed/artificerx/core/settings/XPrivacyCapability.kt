...
/**
 * Runtime capability implementation for core.settings.privacy.
 *
 ...
 */
class XPrivacyCapability : ExpansionCapability {
    override val id: String = "core.settings.privacy"
    override val area: String = "core.settings"
    override val purpose: String = "Privacy capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
