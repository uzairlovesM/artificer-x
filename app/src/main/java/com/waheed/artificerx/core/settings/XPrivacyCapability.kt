...
/** Production expansion contract for Privacy. */
class XPrivacyCapability : ExpansionCapability {
    override val id = "core.settings.privacy"
    override val area = "core.settings"
    override val purpose = "Privacy capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
