...
/**
 * Runtime capability implementation for core.memory.goal.
 *
 ...
 */
class XGoalCapability : ExpansionCapability {
    override val id: String = "core.memory.goal"
    override val area: String = "core.memory"
    override val purpose: String = "Goal capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
