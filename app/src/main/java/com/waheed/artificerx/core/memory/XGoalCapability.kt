...
/** Production expansion contract for Goal. */
class XGoalCapability : ExpansionCapability {
    override val id = "core.memory.goal"
    override val area = "core.memory"
    override val purpose = "Goal capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
