...
/** Production expansion contract for Parser. */
class XParserCapability : ExpansionCapability {
    override val id = "core.research.parser"
    override val area = "core.research"
    override val purpose = "Parser capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
