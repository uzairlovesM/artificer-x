...
/**
 * Runtime capability implementation for core.research.parser.
 *
 ...
 */
class XParserCapability : ExpansionCapability {
    override val id: String = "core.research.parser"
    override val area: String = "core.research"
    override val purpose: String = "Parser capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
