...
/**
 * Runtime capability implementation for core.model.backend.
 *
 ...
 */
class XBackendCapability : ExpansionCapability {
    override val id: String = "core.model.backend"
    override val area: String = "core.model"
    override val purpose: String = "Backend capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
