...
/** Production expansion contract for Backend. */
class XBackendCapability : ExpansionCapability {
    override val id = "core.model.backend"
    override val area = "core.model"
    override val purpose = "Backend capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
