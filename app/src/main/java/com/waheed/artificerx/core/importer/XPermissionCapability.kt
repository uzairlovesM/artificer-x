...
class XPermissionCapability : ExpansionCapability {
    override val id = "core.importer.permission"
    override val area = "core.importer"
    override val purpose = "Permission capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
