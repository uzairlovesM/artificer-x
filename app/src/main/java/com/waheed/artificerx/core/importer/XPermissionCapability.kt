...
/**
 * Runtime capability implementation for core.importer.permission.
 *
...
class XPermissionCapability : ExpansionCapability {
    override val id: String = "core.importer.permission"
    override val area: String = "core.importer"
    override val purpose: String = "Permission capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
