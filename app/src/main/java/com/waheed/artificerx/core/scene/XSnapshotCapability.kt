...
class XSnapshotCapability : ExpansionCapability {
    override val id = "core.scene.snapshot"
    override val area = "core.scene"
    override val purpose = "Snapshot capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
