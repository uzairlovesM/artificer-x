...
/**
 * Runtime capability implementation for core.scene.snapshot.
 *
...
class XSnapshotCapability : ExpansionCapability {
    override val id: String = "core.scene.snapshot"
    override val area: String = "core.scene"
    override val purpose: String = "Snapshot capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
