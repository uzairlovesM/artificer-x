...
class XCacheCapability : ExpansionCapability {
    override val id = "core.storage.cache"
    override val area = "core.storage"
    override val purpose = "Cache capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
