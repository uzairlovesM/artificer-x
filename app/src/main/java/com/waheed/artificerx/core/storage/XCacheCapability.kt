...
/**
 * Runtime capability implementation for core.storage.cache.
 *
...
class XCacheCapability : ExpansionCapability {
    override val id: String = "core.storage.cache"
    override val area: String = "core.storage"
    override val purpose: String = "Cache capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
