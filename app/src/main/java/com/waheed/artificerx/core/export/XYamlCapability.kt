...
/**
 * Runtime capability implementation for core.export.yaml.
 *
...
class XYamlCapability : ExpansionCapability {
    override val id: String = "core.export.yaml"
    override val area: String = "core.export"
    override val purpose: String = "Yaml capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
