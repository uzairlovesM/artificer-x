...
/** Production expansion contract for Preset. */
class XPresetCapability : ExpansionCapability {
    override val id = "core.importer.preset"
    override val area = "core.importer"
    override val purpose = "Preset capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
