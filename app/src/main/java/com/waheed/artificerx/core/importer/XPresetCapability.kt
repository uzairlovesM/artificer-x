...
/**
 * Runtime capability implementation for core.importer.preset.
 *
 ...
 */
class XPresetCapability : ExpansionCapability {
    override val id: String = "core.importer.preset"
    override val area: String = "core.importer"
    override val purpose: String = "Preset capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
