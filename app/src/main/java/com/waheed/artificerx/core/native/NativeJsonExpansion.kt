...
class NativeJsonExpansion : ExpansionCapability {
    override val id: String = "core.native.nativejson"
    override val area: String = "core.native"
    override val purpose: String = "NativeJson coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
