...
/** Production expansion contract for Breadcrumb. */
class XBreadcrumbCapability : ExpansionCapability {
    override val id = "core.navigation.breadcrumb"
    override val area = "core.navigation"
    override val purpose = "Breadcrumb capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
