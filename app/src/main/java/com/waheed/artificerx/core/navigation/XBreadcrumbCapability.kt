...
/**
 * Runtime capability implementation for core.navigation.breadcrumb.
 *
 ...
 */
class XBreadcrumbCapability : ExpansionCapability {
    override val id: String = "core.navigation.breadcrumb"
    override val area: String = "core.navigation"
    override val purpose: String = "Breadcrumb capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
