...
class XLayoutCapability : ExpansionCapability {
    override val id = "core.settings.layout"
    override val area = "core.settings"
    override val purpose = "Layout capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
