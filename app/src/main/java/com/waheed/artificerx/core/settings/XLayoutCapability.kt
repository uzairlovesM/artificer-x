...
/**
 * Runtime capability implementation for core.settings.layout.
 *
 ...
 */
class XLayoutCapability : ExpansionCapability {
    override val id: String = "core.settings.layout"
    override val area: String = "core.settings"
    override val purpose: String = "Layout capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
