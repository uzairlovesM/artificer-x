...
/**
 * Runtime capability implementation for core.navigation.menu.
 *
 ...
 */
class XMenuCapability : ExpansionCapability {
    override val id: String = "core.navigation.menu"
    override val area: String = "core.navigation"
    override val purpose: String = "Menu capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
