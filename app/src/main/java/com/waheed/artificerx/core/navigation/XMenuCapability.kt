...
/** Production expansion contract for Menu. */
class XMenuCapability : ExpansionCapability {
    override val id = "core.navigation.menu"
    override val area = "core.navigation"
    override val purpose = "Menu capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
