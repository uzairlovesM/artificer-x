...
/**
 * Runtime capability implementation for core.importer.source.
 *
...
class XSourceCapability : ExpansionCapability {
    override val id: String = "core.importer.source"
    override val area: String = "core.importer"
    override val purpose: String = "Source capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
