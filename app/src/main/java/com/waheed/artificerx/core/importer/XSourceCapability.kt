...
class XSourceCapability : ExpansionCapability {
    override val id = "core.importer.source"
    override val area = "core.importer"
    override val purpose = "Source capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
