...
/**
 * Runtime capability implementation for core.usecase2.move.
 *
 ...
 */
class XMoveCapability : ExpansionCapability {
    override val id: String = "core.usecase2.move"
    override val area: String = "core.usecase2"
    override val purpose: String = "Move capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
