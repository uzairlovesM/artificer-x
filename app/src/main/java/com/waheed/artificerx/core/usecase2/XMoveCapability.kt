...
/** Production expansion contract for Move. */
class XMoveCapability : ExpansionCapability {
    override val id = "core.usecase2.move"
    override val area = "core.usecase2"
    override val purpose = "Move capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
