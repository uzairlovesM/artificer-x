...
/**
 * Runtime capability implementation for core.scene.parser.
 *
...
class XParserCapability : ExpansionCapability {
    override val id: String = "core.scene.parser"
    override val area: String = "core.scene"
    override val purpose: String = "Parser capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
