...
/**
 * Runtime capability implementation for core.usecase2.favorite.
 *
...
class XFavoriteCapability : ExpansionCapability {
    override val id: String = "core.usecase2.favorite"
    override val area: String = "core.usecase2"
    override val purpose: String = "Favorite capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
