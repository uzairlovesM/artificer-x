...
class XFavoriteCapability : ExpansionCapability {
    override val id = "core.usecase2.favorite"
    override val area = "core.usecase2"
    override val purpose = "Favorite capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
