...
/**
 * Runtime capability implementation for core.creative.layout.
 *
...
class XLayoutCapability : ExpansionCapability {
    override val id: String = "core.creative.layout"
    override val area: String = "core.creative"
    override val purpose: String = "Layout capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
