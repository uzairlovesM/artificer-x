...
/** Production expansion contract for Layout. */
class XLayoutCapability : ExpansionCapability {
    override val id = "core.creative.layout"
    override val area = "core.creative"
    override val purpose = "Layout capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
