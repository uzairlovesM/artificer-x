...
class XRepositoryCapability : ExpansionCapability {
    override val id = "core.settings.repository"
    override val area = "core.settings"
    override val purpose = "Repository capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
