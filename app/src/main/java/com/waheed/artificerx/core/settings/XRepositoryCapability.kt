...
/**
 * Runtime capability implementation for core.settings.repository.
 *
...
class XRepositoryCapability : ExpansionCapability {
    override val id: String = "core.settings.repository"
    override val area: String = "core.settings"
    override val purpose: String = "Repository capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
