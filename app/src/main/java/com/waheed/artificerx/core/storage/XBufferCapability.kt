...
/** Production expansion contract for Buffer. */
class XBufferCapability : ExpansionCapability {
    override val id = "core.storage.buffer"
    override val area = "core.storage"
    override val purpose = "Buffer capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
