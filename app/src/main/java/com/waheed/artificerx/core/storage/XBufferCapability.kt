...
/**
 * Runtime capability implementation for core.storage.buffer.
 *
 ...
 */
class XBufferCapability : ExpansionCapability {
    override val id: String = "core.storage.buffer"
    override val area: String = "core.storage"
    override val purpose: String = "Buffer capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
