...
class XProjectCapability : ExpansionCapability {
    override val id = "core.repository.project"
    override val area = "core.repository"
    override val purpose = "Project capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
