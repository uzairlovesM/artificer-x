...
/**
 * Runtime capability implementation for core.repository.project.
 *
 ...
 */
class XProjectCapability : ExpansionCapability {
    override val id: String = "core.repository.project"
    override val area: String = "core.repository"
    override val purpose: String = "Project capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
