...
/**
 * Runtime capability implementation for core.navigation.tab.
 *
 ...
 */
class XTabCapability : ExpansionCapability {
    override val id: String = "core.navigation.tab"
    override val area: String = "core.navigation"
    override val purpose: String = "Tab capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
