...
/** Production expansion contract for Tab. */
class XTabCapability : ExpansionCapability {
    override val id = "core.navigation.tab"
    override val area = "core.navigation"
    override val purpose = "Tab capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
