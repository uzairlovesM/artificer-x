...
/**
 * Runtime capability implementation for core.repository.folder.
 *
 ...
 */
class XFolderCapability : ExpansionCapability {
    override val id: String = "core.repository.folder"
    override val area: String = "core.repository"
    override val purpose: String = "Folder capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
