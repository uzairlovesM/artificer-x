...
/** Production expansion contract for Folder. */
class XFolderCapability : ExpansionCapability {
    override val id = "core.repository.folder"
    override val area = "core.repository"
    override val purpose = "Folder capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
