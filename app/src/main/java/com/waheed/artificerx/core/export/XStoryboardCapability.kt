...
class XStoryboardCapability : ExpansionCapability {
    override val id = "core.export.storyboard"
    override val area = "core.export"
    override val purpose = "Storyboard capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
