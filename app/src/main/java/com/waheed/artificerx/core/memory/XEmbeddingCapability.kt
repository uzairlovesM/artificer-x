...
/**
 * Runtime capability implementation for core.memory.embedding.
 *
...
class XEmbeddingCapability : ExpansionCapability {
    override val id: String = "core.memory.embedding"
    override val area: String = "core.memory"
    override val purpose: String = "Embedding capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
