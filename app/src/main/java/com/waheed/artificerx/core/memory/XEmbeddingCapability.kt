...
class XEmbeddingCapability : ExpansionCapability {
    override val id = "core.memory.embedding"
    override val area = "core.memory"
    override val purpose = "Embedding capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
