...
class XRemoteCapability : ExpansionCapability {
    override val id = "core.settings.remote"
    override val area = "core.settings"
    override val purpose = "Remote capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
