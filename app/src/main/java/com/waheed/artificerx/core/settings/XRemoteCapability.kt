...
/**
 * Runtime capability implementation for core.settings.remote.
 *
...
class XRemoteCapability : ExpansionCapability {
    override val id: String = "core.settings.remote"
    override val area: String = "core.settings"
    override val purpose: String = "Remote capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
