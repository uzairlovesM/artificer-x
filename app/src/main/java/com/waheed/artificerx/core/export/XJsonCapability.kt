...
/**
 * Runtime capability implementation for core.export.json.
 *
...
class XJsonCapability : ExpansionCapability {
    override val id: String = "core.export.json"
    override val area: String = "core.export"
    override val purpose: String = "Json capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
