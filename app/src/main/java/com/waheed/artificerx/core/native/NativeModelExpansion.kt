...
class NativeModelExpansion : ExpansionCapability {
    override val id: String = "core.native.nativemodel"
    override val area: String = "core.native"
    override val purpose: String = "NativeModel coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
