...
/** Production expansion contract for Toml. */
class XTomlCapability : ExpansionCapability {
    override val id = "core.importer.toml"
    override val area = "core.importer"
    override val purpose = "Toml capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
