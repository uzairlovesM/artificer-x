...
/**
 * Runtime capability implementation for core.importer.toml.
 *
 ...
 */
class XTomlCapability : ExpansionCapability {
    override val id: String = "core.importer.toml"
    override val area: String = "core.importer"
    override val purpose: String = "Toml capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
