...
/** Production expansion contract for ThumbnailPass. */
class XThumbnailPassCapability : ExpansionCapability {
    override val id = "core.scene.thumbnailpass"
    override val area = "core.scene"
    override val purpose = "ThumbnailPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
