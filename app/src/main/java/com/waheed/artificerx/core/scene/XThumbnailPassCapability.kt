...
/**
 * Runtime capability implementation for core.scene.thumbnailpass.
 *
 ...
 */
class XThumbnailPassCapability : ExpansionCapability {
    override val id: String = "core.scene.thumbnailpass"
    override val area: String = "core.scene"
    override val purpose: String = "ThumbnailPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
