...
/** Production expansion contract for Settings. */
class XSettingsCapability : ExpansionCapability {
    override val id = "core.navigation.settings"
    override val area = "core.navigation"
    override val purpose = "Settings capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
