...
/**
 * Runtime capability implementation for core.navigation.settings.
 *
 ...
 */
class XSettingsCapability : ExpansionCapability {
    override val id: String = "core.navigation.settings"
    override val area: String = "core.navigation"
    override val purpose: String = "Settings capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
