...
/** Production expansion contract for Diagnostics. */
class XDiagnosticsCapability : ExpansionCapability {
    override val id = "core.repository.diagnostics"
    override val area = "core.repository"
    override val purpose = "Diagnostics capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
