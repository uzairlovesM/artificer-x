...
/**
 * Runtime capability implementation for core.repository.diagnostics.
 *
...
class XDiagnosticsCapability : ExpansionCapability {
    override val id: String = "core.repository.diagnostics"
    override val area: String = "core.repository"
    override val purpose: String = "Diagnostics capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
