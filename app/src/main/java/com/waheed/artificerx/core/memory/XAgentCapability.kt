...
/**
 * Runtime capability implementation for core.memory.agent.
 *
...
class XAgentCapability : ExpansionCapability {
    override val id: String = "core.memory.agent"
    override val area: String = "core.memory"
    override val purpose: String = "Agent capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
