...
/** Production expansion contract for DeepLink. */
class XDeepLinkCapability : ExpansionCapability {
    override val id = "core.navigation.deeplink"
    override val area = "core.navigation"
    override val purpose = "DeepLink capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
