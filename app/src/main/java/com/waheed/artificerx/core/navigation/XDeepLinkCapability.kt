...
/**
 * Runtime capability implementation for core.navigation.deeplink.
 *
 ...
 */
class XDeepLinkCapability : ExpansionCapability {
    override val id: String = "core.navigation.deeplink"
    override val area: String = "core.navigation"
    override val purpose: String = "DeepLink capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
