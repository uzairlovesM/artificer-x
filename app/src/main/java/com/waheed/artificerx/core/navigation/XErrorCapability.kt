...
class XErrorCapability : ExpansionCapability {
    override val id = "core.navigation.error"
    override val area = "core.navigation"
    override val purpose = "Error capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
