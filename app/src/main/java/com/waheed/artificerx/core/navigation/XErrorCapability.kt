...
/**
 * Runtime capability implementation for core.navigation.error.
 *
 ...
 */
class XErrorCapability : ExpansionCapability {
    override val id: String = "core.navigation.error"
    override val area: String = "core.navigation"
    override val purpose: String = "Error capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
