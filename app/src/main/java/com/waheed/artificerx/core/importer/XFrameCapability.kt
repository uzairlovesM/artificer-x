...
/**
 * Runtime capability implementation for core.importer.frame.
 *
 ...
 */
class XFrameCapability : ExpansionCapability {
    override val id: String = "core.importer.frame"
    override val area: String = "core.importer"
    override val purpose: String = "Frame capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
