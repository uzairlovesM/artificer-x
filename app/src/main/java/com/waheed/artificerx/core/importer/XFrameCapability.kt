...
/** Production expansion contract for Frame. */
class XFrameCapability : ExpansionCapability {
    override val id = "core.importer.frame"
    override val area = "core.importer"
    override val purpose = "Frame capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
