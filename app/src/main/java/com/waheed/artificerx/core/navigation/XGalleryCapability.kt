...
/** Production expansion contract for Gallery. */
class XGalleryCapability : ExpansionCapability {
    override val id = "core.navigation.gallery"
    override val area = "core.navigation"
    override val purpose = "Gallery capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
