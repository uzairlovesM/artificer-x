...
/**
 * Runtime capability implementation for core.navigation.gallery.
 *
 ...
 */
class XGalleryCapability : ExpansionCapability {
    override val id: String = "core.navigation.gallery"
    override val area: String = "core.navigation"
    override val purpose: String = "Gallery capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
