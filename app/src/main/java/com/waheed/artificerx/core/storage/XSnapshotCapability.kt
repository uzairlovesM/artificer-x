...
/**
 * Runtime capability implementation for core.storage.snapshot.
 *
...
class XSnapshotCapability : ExpansionCapability {
    override val id: String = "core.storage.snapshot"
    override val area: String = "core.storage"
    override val purpose: String = "Snapshot capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
