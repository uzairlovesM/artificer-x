...
/** Production expansion contract for Snapshot. */
class XSnapshotCapability : ExpansionCapability {
    override val id = "core.storage.snapshot"
    override val area = "core.storage"
    override val purpose = "Snapshot capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
