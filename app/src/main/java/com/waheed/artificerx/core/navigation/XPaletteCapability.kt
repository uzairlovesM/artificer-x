...
/**
 * Runtime capability implementation for core.navigation.palette.
 *
 ...
 */
class XPaletteCapability : ExpansionCapability {
    override val id: String = "core.navigation.palette"
    override val area: String = "core.navigation"
    override val purpose: String = "Palette capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
