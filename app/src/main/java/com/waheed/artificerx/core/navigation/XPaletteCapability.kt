...
/** Production expansion contract for Palette. */
class XPaletteCapability : ExpansionCapability {
    override val id = "core.navigation.palette"
    override val area = "core.navigation"
    override val purpose = "Palette capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
