...
class XContextCapability : ExpansionCapability {
    override val id = "core.navigation.context"
    override val area = "core.navigation"
    override val purpose = "Context capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
