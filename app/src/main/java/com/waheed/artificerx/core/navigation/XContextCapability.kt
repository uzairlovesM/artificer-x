...
/**
 * Runtime capability implementation for core.navigation.context.
 *
...
class XContextCapability : ExpansionCapability {
    override val id: String = "core.navigation.context"
    override val area: String = "core.navigation"
    override val purpose: String = "Context capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
