...
/**
 * Runtime capability implementation for core.usecase2.preview.
 *
 ...
 */
class XPreviewCapability : ExpansionCapability {
    override val id: String = "core.usecase2.preview"
    override val area: String = "core.usecase2"
    override val purpose: String = "Preview capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
