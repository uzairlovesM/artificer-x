...
/** Production expansion contract for Preview. */
class XPreviewCapability : ExpansionCapability {
    override val id = "core.usecase2.preview"
    override val area = "core.usecase2"
    override val purpose = "Preview capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
