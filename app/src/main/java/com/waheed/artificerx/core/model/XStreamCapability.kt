...
/**
 * Runtime capability implementation for core.model.stream.
 *
...
class XStreamCapability : ExpansionCapability {
    override val id: String = "core.model.stream"
    override val area: String = "core.model"
    override val purpose: String = "Stream capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
