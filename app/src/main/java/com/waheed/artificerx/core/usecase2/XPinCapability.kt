...
/**
 * Runtime capability implementation for core.usecase2.pin.
 *
 ...
 */
class XPinCapability : ExpansionCapability {
    override val id: String = "core.usecase2.pin"
    override val area: String = "core.usecase2"
    override val purpose: String = "Pin capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
