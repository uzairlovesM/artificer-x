...
/**
 * Runtime capability implementation for core.remoteagent.batch.
 *
...
class XBatchCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.batch"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Batch capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
