...
/** Production expansion contract for Batch. */
class XBatchCapability : ExpansionCapability {
    override val id = "core.remoteagent.batch"
    override val area = "core.remoteagent"
    override val purpose = "Batch capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
