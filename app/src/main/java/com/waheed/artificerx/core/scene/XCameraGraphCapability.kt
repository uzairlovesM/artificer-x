...
/**
 * Runtime capability implementation for core.scene.cameragraph.
 *
 ...
 */
class XCameraGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.cameragraph"
    override val area: String = "core.scene"
    override val purpose: String = "CameraGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
