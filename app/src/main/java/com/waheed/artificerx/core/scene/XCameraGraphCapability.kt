...
/** Production expansion contract for CameraGraph. */
class XCameraGraphCapability : ExpansionCapability {
    override val id = "core.scene.cameragraph"
    override val area = "core.scene"
    override val purpose = "CameraGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
