...
/** Production expansion contract for Blame. */
class XBlameCapability : ExpansionCapability {
    override val id = "core.repository.blame"
    override val area = "core.repository"
    override val purpose = "Blame capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
