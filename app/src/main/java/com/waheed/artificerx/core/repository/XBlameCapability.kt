...
/**
 * Runtime capability implementation for core.repository.blame.
 *
 ...
 */
class XBlameCapability : ExpansionCapability {
    override val id: String = "core.repository.blame"
    override val area: String = "core.repository"
    override val purpose: String = "Blame capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
