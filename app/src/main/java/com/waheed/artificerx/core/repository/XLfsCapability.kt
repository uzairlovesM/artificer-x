...
/** Production expansion contract for Lfs. */
class XLfsCapability : ExpansionCapability {
    override val id = "core.repository.lfs"
    override val area = "core.repository"
    override val purpose = "Lfs capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
