...
/**
 * Runtime capability implementation for core.repository.lfs.
 *
 ...
 */
class XLfsCapability : ExpansionCapability {
    override val id: String = "core.repository.lfs"
    override val area: String = "core.repository"
    override val purpose: String = "Lfs capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
