...
/** Production expansion contract for SmartFolder. */
class XSmartFolderCapability : ExpansionCapability {
    override val id = "core.storage.smartfolder"
    override val area = "core.storage"
    override val purpose = "SmartFolder capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
