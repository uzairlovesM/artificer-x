...
/**
 * Runtime capability implementation for core.storage.smartfolder.
 *
 ...
 */
class XSmartFolderCapability : ExpansionCapability {
    override val id: String = "core.storage.smartfolder"
    override val area: String = "core.storage"
    override val purpose: String = "SmartFolder capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
