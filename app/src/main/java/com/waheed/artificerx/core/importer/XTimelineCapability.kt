...
class XTimelineCapability : ExpansionCapability {
    override val id = "core.importer.timeline"
    override val area = "core.importer"
    override val purpose = "Timeline capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
