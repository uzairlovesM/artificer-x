...
/**
 * Runtime capability implementation for core.importer.timeline.
 *
...
class XTimelineCapability : ExpansionCapability {
    override val id: String = "core.importer.timeline"
    override val area: String = "core.importer"
    override val purpose: String = "Timeline capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
