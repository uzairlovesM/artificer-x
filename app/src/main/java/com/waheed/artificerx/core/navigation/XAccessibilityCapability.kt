...
/** Production expansion contract for Accessibility. */
class XAccessibilityCapability : ExpansionCapability {
    override val id = "core.navigation.accessibility"
    override val area = "core.navigation"
    override val purpose = "Accessibility capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
