...
/**
 * Runtime capability implementation for core.creative.bubbleplan.
 *
 ...
 */
class XBubblePlanCapability : ExpansionCapability {
    override val id: String = "core.creative.bubbleplan"
    override val area: String = "core.creative"
    override val purpose: String = "BubblePlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
