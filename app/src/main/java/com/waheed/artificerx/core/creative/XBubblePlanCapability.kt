...
/** Production expansion contract for BubblePlan. */
class XBubblePlanCapability : ExpansionCapability {
    override val id = "core.creative.bubbleplan"
    override val area = "core.creative"
    override val purpose = "BubblePlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
