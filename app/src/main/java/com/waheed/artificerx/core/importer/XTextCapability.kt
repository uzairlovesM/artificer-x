...
/**
 * Runtime capability implementation for core.importer.text.
 *
 ...
 */
class XTextCapability : ExpansionCapability {
    override val id: String = "core.importer.text"
    override val area: String = "core.importer"
    override val purpose: String = "Text capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
