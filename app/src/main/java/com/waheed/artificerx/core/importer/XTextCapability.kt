...
/** Production expansion contract for Text. */
class XTextCapability : ExpansionCapability {
    override val id = "core.importer.text"
    override val area = "core.importer"
    override val purpose = "Text capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
