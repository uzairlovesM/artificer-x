...
/**
 * Runtime capability implementation for core.export.pdf.
 *
...
class XPdfCapability : ExpansionCapability {
    override val id: String = "core.export.pdf"
    override val area: String = "core.export"
    override val purpose: String = "Pdf capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
