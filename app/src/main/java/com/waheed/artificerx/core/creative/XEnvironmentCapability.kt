...
/**
 * Runtime capability implementation for core.creative.environment.
 *
 ...
 */
class XEnvironmentCapability : ExpansionCapability {
    override val id: String = "core.creative.environment"
    override val area: String = "core.creative"
    override val purpose: String = "Environment capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
