...
/** Production expansion contract for Environment. */
class XEnvironmentCapability : ExpansionCapability {
    override val id = "core.creative.environment"
    override val area = "core.creative"
    override val purpose = "Environment capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
