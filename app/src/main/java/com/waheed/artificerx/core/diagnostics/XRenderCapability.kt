...
/**
 * Runtime capability implementation for core.diagnostics.render.
 *
 ...
 */
class XRenderCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.render"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Render capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
