...
/** Production expansion contract for Render. */
class XRenderCapability : ExpansionCapability {
    override val id = "core.diagnostics.render"
    override val area = "core.diagnostics"
    override val purpose = "Render capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
