...
/**
 * Runtime capability implementation for core.scene.normalizer.
 *
 ...
 */
class XNormalizerCapability : ExpansionCapability {
    override val id: String = "core.scene.normalizer"
    override val area: String = "core.scene"
    override val purpose: String = "Normalizer capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
