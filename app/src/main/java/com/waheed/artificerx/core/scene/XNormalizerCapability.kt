...
/** Production expansion contract for Normalizer. */
class XNormalizerCapability : ExpansionCapability {
    override val id = "core.scene.normalizer"
    override val area = "core.scene"
    override val purpose = "Normalizer capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
