...
class XValidateCapability : ExpansionCapability {
    override val id = "core.export.validate"
    override val area = "core.export"
    override val purpose = "Validate capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
