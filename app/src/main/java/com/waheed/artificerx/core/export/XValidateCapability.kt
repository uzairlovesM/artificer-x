...
/**
 * Runtime capability implementation for core.export.validate.
 *
...
class XValidateCapability : ExpansionCapability {
    override val id: String = "core.export.validate"
    override val area: String = "core.export"
    override val purpose: String = "Validate capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
