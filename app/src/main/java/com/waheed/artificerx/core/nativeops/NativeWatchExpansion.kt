...
class NativeWatchExpansion : ExpansionCapability {
    override val id: String = "core.nativeops.nativewatch"
    override val area: String = "core.nativeops"
    override val purpose: String = "NativeWatch coordinates core.nativeops responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
