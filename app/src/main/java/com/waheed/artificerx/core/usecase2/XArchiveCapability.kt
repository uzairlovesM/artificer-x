...
class XArchiveCapability : ExpansionCapability {
    override val id = "core.usecase2.archive"
    override val area = "core.usecase2"
    override val purpose = "Archive capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
