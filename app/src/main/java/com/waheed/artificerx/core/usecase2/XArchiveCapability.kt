...
/**
 * Runtime capability implementation for core.usecase2.archive.
 *
...
class XArchiveCapability : ExpansionCapability {
    override val id: String = "core.usecase2.archive"
    override val area: String = "core.usecase2"
    override val purpose: String = "Archive capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
