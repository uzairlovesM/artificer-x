...
class XSearchCapability : ExpansionCapability {
    override val id = "core.storage.search"
    override val area = "core.storage"
    override val purpose = "Search capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
