...
/**
 * Runtime capability implementation for core.storage.search.
 *
...
class XSearchCapability : ExpansionCapability {
    override val id: String = "core.storage.search"
    override val area: String = "core.storage"
    override val purpose: String = "Search capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
