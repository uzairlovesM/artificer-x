...
/**
 * Runtime capability implementation for core.model.mmap.
 *
 ...
 */
class XMmapCapability : ExpansionCapability {
    override val id: String = "core.model.mmap"
    override val area: String = "core.model"
    override val purpose: String = "Mmap capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
