...
/** Production expansion contract for Mmap. */
class XMmapCapability : ExpansionCapability {
    override val id = "core.model.mmap"
    override val area = "core.model"
    override val purpose = "Mmap capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
