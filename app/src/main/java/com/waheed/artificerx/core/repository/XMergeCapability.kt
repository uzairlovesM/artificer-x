...
/**
 * Runtime capability implementation for core.repository.merge.
 *
 ...
 */
class XMergeCapability : ExpansionCapability {
    override val id: String = "core.repository.merge"
    override val area: String = "core.repository"
    override val purpose: String = "Merge capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
