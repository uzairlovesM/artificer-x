...
/** Production expansion contract for Merge. */
class XMergeCapability : ExpansionCapability {
    override val id = "core.repository.merge"
    override val area = "core.repository"
    override val purpose = "Merge capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
