...
/** Production expansion contract for Watcher. */
class XWatcherCapability : ExpansionCapability {
    override val id = "core.storage.watcher"
    override val area = "core.storage"
    override val purpose = "Watcher capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
