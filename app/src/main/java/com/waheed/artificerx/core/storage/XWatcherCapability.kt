...
/**
 * Runtime capability implementation for core.storage.watcher.
 *
 ...
 */
class XWatcherCapability : ExpansionCapability {
    override val id: String = "core.storage.watcher"
    override val area: String = "core.storage"
    override val purpose: String = "Watcher capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
