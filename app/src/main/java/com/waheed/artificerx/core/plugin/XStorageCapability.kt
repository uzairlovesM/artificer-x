...
class XStorageCapability : ExpansionCapability {
    override val id = "core.plugin.storage"
    override val area = "core.plugin"
    override val purpose = "Storage capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
