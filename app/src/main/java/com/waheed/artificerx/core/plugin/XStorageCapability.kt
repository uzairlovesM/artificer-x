...
/**
 * Runtime capability implementation for core.plugin.storage.
 *
...
class XStorageCapability : ExpansionCapability {
    override val id: String = "core.plugin.storage"
    override val area: String = "core.plugin"
    override val purpose: String = "Storage capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
