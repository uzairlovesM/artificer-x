...
/** Production expansion contract for Shortcut. */
class XShortcutCapability : ExpansionCapability {
    override val id = "core.navigation.shortcut"
    override val area = "core.navigation"
    override val purpose = "Shortcut capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
