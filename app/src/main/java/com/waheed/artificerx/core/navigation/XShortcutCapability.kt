...
/**
 * Runtime capability implementation for core.navigation.shortcut.
 *
 ...
 */
class XShortcutCapability : ExpansionCapability {
    override val id: String = "core.navigation.shortcut"
    override val area: String = "core.navigation"
    override val purpose: String = "Shortcut capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
