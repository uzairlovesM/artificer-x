...
/** Production expansion contract for Importer. */
class XImporterCapability : ExpansionCapability {
    override val id = "core.plugin.importer"
    override val area = "core.plugin"
    override val purpose = "Importer capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
