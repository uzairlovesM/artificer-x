...
/**
 * Runtime capability implementation for core.plugin.importer.
 *
 ...
 */
class XImporterCapability : ExpansionCapability {
    override val id: String = "core.plugin.importer"
    override val area: String = "core.plugin"
    override val purpose: String = "Importer capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
