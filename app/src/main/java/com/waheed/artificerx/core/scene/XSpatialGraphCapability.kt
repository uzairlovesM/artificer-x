...
/**
 * Runtime capability implementation for core.scene.spatialgraph.
 *
 ...
 */
class XSpatialGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.spatialgraph"
    override val area: String = "core.scene"
    override val purpose: String = "SpatialGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
