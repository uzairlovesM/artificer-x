...
/** Production expansion contract for SpatialGraph. */
class XSpatialGraphCapability : ExpansionCapability {
    override val id = "core.scene.spatialgraph"
    override val area = "core.scene"
    override val purpose = "SpatialGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
