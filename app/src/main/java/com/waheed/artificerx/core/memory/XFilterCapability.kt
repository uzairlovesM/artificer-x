...
class XFilterCapability : ExpansionCapability {
    override val id = "core.memory.filter"
    override val area = "core.memory"
    override val purpose = "Filter capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
