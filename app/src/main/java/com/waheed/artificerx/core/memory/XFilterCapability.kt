...
/**
 * Runtime capability implementation for core.memory.filter.
 *
...
class XFilterCapability : ExpansionCapability {
    override val id: String = "core.memory.filter"
    override val area: String = "core.memory"
    override val purpose: String = "Filter capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
