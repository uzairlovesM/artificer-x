...
/**
 * Runtime capability implementation for core.model.multimodal.
 *
 ...
 */
class XMultimodalCapability : ExpansionCapability {
    override val id: String = "core.model.multimodal"
    override val area: String = "core.model"
    override val purpose: String = "Multimodal capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
