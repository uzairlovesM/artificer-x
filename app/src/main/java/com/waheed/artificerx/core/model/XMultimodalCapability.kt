...
/** Production expansion contract for Multimodal. */
class XMultimodalCapability : ExpansionCapability {
    override val id = "core.model.multimodal"
    override val area = "core.model"
    override val purpose = "Multimodal capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
