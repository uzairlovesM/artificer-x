...
class XQualityCapability : ExpansionCapability {
    override val id = "core.research.quality"
    override val area = "core.research"
    override val purpose = "Quality capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
