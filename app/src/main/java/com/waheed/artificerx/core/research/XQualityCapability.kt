...
/**
 * Runtime capability implementation for core.research.quality.
 *
...
class XQualityCapability : ExpansionCapability {
    override val id: String = "core.research.quality"
    override val area: String = "core.research"
    override val purpose: String = "Quality capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
