...
/**
 * Runtime capability implementation for core.remoteagent.normalize.
 *
 ...
 */
class XNormalizeCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.normalize"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Normalize capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
