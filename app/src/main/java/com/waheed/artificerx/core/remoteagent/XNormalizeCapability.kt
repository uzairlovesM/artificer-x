...
/** Production expansion contract for Normalize. */
class XNormalizeCapability : ExpansionCapability {
    override val id = "core.remoteagent.normalize"
    override val area = "core.remoteagent"
    override val purpose = "Normalize capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
