...
/** Production expansion contract for Tool. */
class XToolCapability : ExpansionCapability {
    override val id = "core.diagnostics.tool"
    override val area = "core.diagnostics"
    override val purpose = "Tool capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
