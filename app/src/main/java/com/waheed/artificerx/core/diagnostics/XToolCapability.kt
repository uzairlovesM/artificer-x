...
/**
 * Runtime capability implementation for core.diagnostics.tool.
 *
...
class XToolCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.tool"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Tool capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
