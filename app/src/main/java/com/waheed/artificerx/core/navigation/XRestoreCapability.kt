...
/**
 * Runtime capability implementation for core.navigation.restore.
 *
...
class XRestoreCapability : ExpansionCapability {
    override val id: String = "core.navigation.restore"
    override val area: String = "core.navigation"
    override val purpose: String = "Restore capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
