...
class XRestoreCapability : ExpansionCapability {
    override val id = "core.navigation.restore"
    override val area = "core.navigation"
    override val purpose = "Restore capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
