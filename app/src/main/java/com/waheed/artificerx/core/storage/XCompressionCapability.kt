...
/**
 * Runtime capability implementation for core.storage.compression.
 *
 ...
 */
class XCompressionCapability : ExpansionCapability {
    override val id: String = "core.storage.compression"
    override val area: String = "core.storage"
    override val purpose: String = "Compression capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
