...
/** Production expansion contract for Compression. */
class XCompressionCapability : ExpansionCapability {
    override val id = "core.storage.compression"
    override val area = "core.storage"
    override val purpose = "Compression capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
