...
/**
 * Runtime capability implementation for core.model.context.
 *
...
class XContextCapability : ExpansionCapability {
    override val id: String = "core.model.context"
    override val area: String = "core.model"
    override val purpose: String = "Context capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
