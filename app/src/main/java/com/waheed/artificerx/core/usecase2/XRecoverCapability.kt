...
/** Production expansion contract for Recover. */
class XRecoverCapability : ExpansionCapability {
    override val id = "core.usecase2.recover"
    override val area = "core.usecase2"
    override val purpose = "Recover capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
