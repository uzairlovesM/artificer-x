...
/**
 * Runtime capability implementation for core.usecase2.recover.
 *
 ...
 */
class XRecoverCapability : ExpansionCapability {
    override val id: String = "core.usecase2.recover"
    override val area: String = "core.usecase2"
    override val purpose: String = "Recover capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
