...
class XProfileCapability : ExpansionCapability {
    override val id = "core.export.profile"
    override val area = "core.export"
    override val purpose = "Profile capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
