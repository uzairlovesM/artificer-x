...
/**
 * Runtime capability implementation for core.export.profile.
 *
...
class XProfileCapability : ExpansionCapability {
    override val id: String = "core.export.profile"
    override val area: String = "core.export"
    override val purpose: String = "Profile capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
