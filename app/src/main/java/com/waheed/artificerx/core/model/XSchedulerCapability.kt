...
class XSchedulerCapability : ExpansionCapability {
    override val id = "core.model.scheduler"
    override val area = "core.model"
    override val purpose = "Scheduler capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
