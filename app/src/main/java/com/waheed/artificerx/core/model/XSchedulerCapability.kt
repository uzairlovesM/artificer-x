...
/**
 * Runtime capability implementation for core.model.scheduler.
 *
...
class XSchedulerCapability : ExpansionCapability {
    override val id: String = "core.model.scheduler"
    override val area: String = "core.model"
    override val purpose: String = "Scheduler capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
