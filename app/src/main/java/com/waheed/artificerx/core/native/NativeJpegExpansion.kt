...
class NativeJpegExpansion : ExpansionCapability {
    override val id: String = "core.native.nativejpeg"
    override val area: String = "core.native"
    override val purpose: String = "NativeJpeg coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
