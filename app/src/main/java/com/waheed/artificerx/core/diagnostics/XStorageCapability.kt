...
/**
 * Runtime capability implementation for core.diagnostics.storage.
 *
 ...
 */
class XStorageCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.storage"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Storage capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
