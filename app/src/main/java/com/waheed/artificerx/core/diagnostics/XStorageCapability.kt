...
/** Production expansion contract for Storage. */
class XStorageCapability : ExpansionCapability {
    override val id = "core.diagnostics.storage"
    override val area = "core.diagnostics"
    override val purpose = "Storage capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
