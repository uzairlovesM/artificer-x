...
class XEncryptionCapability : ExpansionCapability {
    override val id = "core.memory.encryption"
    override val area = "core.memory"
    override val purpose = "Encryption capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
