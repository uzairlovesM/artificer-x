...
/**
 * Runtime capability implementation for core.memory.encryption.
 *
...
class XEncryptionCapability : ExpansionCapability {
    override val id: String = "core.memory.encryption"
    override val area: String = "core.memory"
    override val purpose: String = "Encryption capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
