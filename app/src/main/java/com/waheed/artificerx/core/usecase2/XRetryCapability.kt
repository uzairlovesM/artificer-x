...
/**
 * Runtime capability implementation for core.usecase2.retry.
 *
...
class XRetryCapability : ExpansionCapability {
    override val id: String = "core.usecase2.retry"
    override val area: String = "core.usecase2"
    override val purpose: String = "Retry capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
