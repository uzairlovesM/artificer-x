...
class XRetryCapability : ExpansionCapability {
    override val id = "core.usecase2.retry"
    override val area = "core.usecase2"
    override val purpose = "Retry capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
