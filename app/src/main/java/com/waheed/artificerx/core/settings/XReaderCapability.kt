...
/** Production expansion contract for Reader. */
class XReaderCapability : ExpansionCapability {
    override val id = "core.settings.reader"
    override val area = "core.settings"
    override val purpose = "Reader capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
