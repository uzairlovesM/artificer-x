...
/**
 * Runtime capability implementation for core.settings.reader.
 *
 ...
 */
class XReaderCapability : ExpansionCapability {
    override val id: String = "core.settings.reader"
    override val area: String = "core.settings"
    override val purpose: String = "Reader capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
