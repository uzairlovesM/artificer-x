...
/** Production expansion contract for AnimationPlan. */
class XAnimationPlanCapability : ExpansionCapability {
    override val id = "core.creative.animationplan"
    override val area = "core.creative"
    override val purpose = "AnimationPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
