...
/**
 * Runtime capability implementation for core.creative.animationplan.
 *
 ...
 */
class XAnimationPlanCapability : ExpansionCapability {
    override val id: String = "core.creative.animationplan"
    override val area: String = "core.creative"
    override val purpose: String = "AnimationPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
