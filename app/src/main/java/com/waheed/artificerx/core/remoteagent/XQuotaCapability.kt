...
/**
 * Runtime capability implementation for core.remoteagent.quota.
 *
...
class XQuotaCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.quota"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Quota capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
