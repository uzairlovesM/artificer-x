...
class XQuotaCapability : ExpansionCapability {
    override val id = "core.remoteagent.quota"
    override val area = "core.remoteagent"
    override val purpose = "Quota capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
