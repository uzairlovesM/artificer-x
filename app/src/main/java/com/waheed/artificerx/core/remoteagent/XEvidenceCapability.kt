...
/** Production expansion contract for Evidence. */
class XEvidenceCapability : ExpansionCapability {
    override val id = "core.remoteagent.evidence"
    override val area = "core.remoteagent"
    override val purpose = "Evidence capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
