...
/**
 * Runtime capability implementation for core.remoteagent.evidence.
 *
...
class XEvidenceCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.evidence"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Evidence capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
