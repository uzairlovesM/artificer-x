...
/** Production expansion contract for Signature. */
class XSignatureCapability : ExpansionCapability {
    override val id = "core.plugin.signature"
    override val area = "core.plugin"
    override val purpose = "Signature capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
