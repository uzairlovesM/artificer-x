...
/**
 * Runtime capability implementation for core.plugin.signature.
 *
 ...
 */
class XSignatureCapability : ExpansionCapability {
    override val id: String = "core.plugin.signature"
    override val area: String = "core.plugin"
    override val purpose: String = "Signature capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
