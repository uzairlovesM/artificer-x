...
/** Production expansion contract for State. */
class XStateCapability : ExpansionCapability {
    override val id = "core.navigation.state"
    override val area = "core.navigation"
    override val purpose = "State capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
