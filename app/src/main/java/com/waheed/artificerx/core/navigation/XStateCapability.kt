...
/**
 * Runtime capability implementation for core.navigation.state.
 *
 ...
 */
class XStateCapability : ExpansionCapability {
    override val id: String = "core.navigation.state"
    override val area: String = "core.navigation"
    override val purpose: String = "State capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
