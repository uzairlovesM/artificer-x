...
/**
 * Runtime capability implementation for core.storage.trash.
 *
 ...
 */
class XTrashCapability : ExpansionCapability {
    override val id: String = "core.storage.trash"
    override val area: String = "core.storage"
    override val purpose: String = "Trash capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
