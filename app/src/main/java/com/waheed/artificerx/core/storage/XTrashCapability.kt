...
/** Production expansion contract for Trash. */
class XTrashCapability : ExpansionCapability {
    override val id = "core.storage.trash"
    override val area = "core.storage"
    override val purpose = "Trash capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
