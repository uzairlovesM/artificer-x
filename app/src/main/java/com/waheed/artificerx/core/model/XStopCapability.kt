...
/**
 * Runtime capability implementation for core.model.stop.
 *
 ...
 */
class XStopCapability : ExpansionCapability {
    override val id: String = "core.model.stop"
    override val area: String = "core.model"
    override val purpose: String = "Stop capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
