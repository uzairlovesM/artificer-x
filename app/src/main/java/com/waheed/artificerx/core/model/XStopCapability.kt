...
/** Production expansion contract for Stop. */
class XStopCapability : ExpansionCapability {
    override val id = "core.model.stop"
    override val area = "core.model"
    override val purpose = "Stop capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
