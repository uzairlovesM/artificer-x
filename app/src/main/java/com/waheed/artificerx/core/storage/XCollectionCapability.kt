...
/** Production expansion contract for Collection. */
class XCollectionCapability : ExpansionCapability {
    override val id = "core.storage.collection"
    override val area = "core.storage"
    override val purpose = "Collection capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
