...
/**
 * Runtime capability implementation for core.storage.collection.
 *
 ...
 */
class XCollectionCapability : ExpansionCapability {
    override val id: String = "core.storage.collection"
    override val area: String = "core.storage"
    override val purpose: String = "Collection capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
