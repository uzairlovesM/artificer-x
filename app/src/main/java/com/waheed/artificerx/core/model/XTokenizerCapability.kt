...
/** Production expansion contract for Tokenizer. */
class XTokenizerCapability : ExpansionCapability {
    override val id = "core.model.tokenizer"
    override val area = "core.model"
    override val purpose = "Tokenizer capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
