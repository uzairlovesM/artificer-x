...
/**
 * Runtime capability implementation for core.model.tokenizer.
 *
 ...
 */
class XTokenizerCapability : ExpansionCapability {
    override val id: String = "core.model.tokenizer"
    override val area: String = "core.model"
    override val purpose: String = "Tokenizer capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
