...
/**
 * Runtime capability implementation for core.plugin.search.
 *
...
class XSearchCapability : ExpansionCapability {
    override val id: String = "core.plugin.search"
    override val area: String = "core.plugin"
    override val purpose: String = "Search capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
