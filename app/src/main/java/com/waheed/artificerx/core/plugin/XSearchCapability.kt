...
class XSearchCapability : ExpansionCapability {
    override val id = "core.plugin.search"
    override val area = "core.plugin"
    override val purpose = "Search capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
