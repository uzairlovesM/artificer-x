...
class XProjectCapability : ExpansionCapability {
    override val id = "core.settings.project"
    override val area = "core.settings"
    override val purpose = "Project capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
