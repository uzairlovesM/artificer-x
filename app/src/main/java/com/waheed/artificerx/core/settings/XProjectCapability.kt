...
/**
 * Runtime capability implementation for core.settings.project.
 *
...
class XProjectCapability : ExpansionCapability {
    override val id: String = "core.settings.project"
    override val area: String = "core.settings"
    override val purpose: String = "Project capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
