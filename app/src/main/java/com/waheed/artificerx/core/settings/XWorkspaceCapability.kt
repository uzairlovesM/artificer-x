...
/**
 * Runtime capability implementation for core.settings.workspace.
 *
...
class XWorkspaceCapability : ExpansionCapability {
    override val id: String = "core.settings.workspace"
    override val area: String = "core.settings"
    override val purpose: String = "Workspace capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
