...
class XWorkspaceCapability : ExpansionCapability {
    override val id = "core.settings.workspace"
    override val area = "core.settings"
    override val purpose = "Workspace capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
