...
/**
 * Runtime capability implementation for core.creative.prop.
 *
 ...
 */
class XPropCapability : ExpansionCapability {
    override val id: String = "core.creative.prop"
    override val area: String = "core.creative"
    override val purpose: String = "Prop capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
