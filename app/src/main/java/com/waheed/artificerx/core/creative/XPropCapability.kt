...
/** Production expansion contract for Prop. */
class XPropCapability : ExpansionCapability {
    override val id = "core.creative.prop"
    override val area = "core.creative"
    override val purpose = "Prop capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
