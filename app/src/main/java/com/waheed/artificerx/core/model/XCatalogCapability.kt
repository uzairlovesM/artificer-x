...
class XCatalogCapability : ExpansionCapability {
    override val id = "core.model.catalog"
    override val area = "core.model"
    override val purpose = "Catalog capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
