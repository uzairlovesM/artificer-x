...
/**
 * Runtime capability implementation for core.model.catalog.
 *
...
class XCatalogCapability : ExpansionCapability {
    override val id: String = "core.model.catalog"
    override val area: String = "core.model"
    override val purpose: String = "Catalog capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
