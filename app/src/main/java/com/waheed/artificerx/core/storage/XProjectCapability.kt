...
/** Production expansion contract for Project. */
class XProjectCapability : ExpansionCapability {
    override val id = "core.storage.project"
    override val area = "core.storage"
    override val purpose = "Project capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
