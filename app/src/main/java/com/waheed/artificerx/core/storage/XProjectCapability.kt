...
/**
 * Runtime capability implementation for core.storage.project.
 *
...
class XProjectCapability : ExpansionCapability {
    override val id: String = "core.storage.project"
    override val area: String = "core.storage"
    override val purpose: String = "Project capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
