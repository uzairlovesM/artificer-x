...
/** Production expansion contract for Encryption. */
class XEncryptionCapability : ExpansionCapability {
    override val id = "core.storage.encryption"
    override val area = "core.storage"
    override val purpose = "Encryption capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
