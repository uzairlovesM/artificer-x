...
/**
 * Runtime capability implementation for core.storage.encryption.
 *
 ...
 */
class XEncryptionCapability : ExpansionCapability {
    override val id: String = "core.storage.encryption"
    override val area: String = "core.storage"
    override val purpose: String = "Encryption capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
