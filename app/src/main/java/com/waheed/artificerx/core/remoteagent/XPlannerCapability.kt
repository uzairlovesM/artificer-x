...
/**
 * Runtime capability implementation for core.remoteagent.planner.
 *
...
class XPlannerCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.planner"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Planner capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
