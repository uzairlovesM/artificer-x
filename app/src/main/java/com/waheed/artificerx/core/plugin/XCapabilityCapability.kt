...
/** Production expansion contract for Capability. */
class XCapabilityCapability : ExpansionCapability {
    override val id = "core.plugin.capability"
    override val area = "core.plugin"
    override val purpose = "Capability capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
