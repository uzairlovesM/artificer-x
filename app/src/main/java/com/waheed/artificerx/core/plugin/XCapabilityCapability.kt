...
/**
 * Runtime capability implementation for core.plugin.capability.
 *
 ...
 */
class XCapabilityCapability : ExpansionCapability {
    override val id: String = "core.plugin.capability"
    override val area: String = "core.plugin"
    override val purpose: String = "Capability capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
