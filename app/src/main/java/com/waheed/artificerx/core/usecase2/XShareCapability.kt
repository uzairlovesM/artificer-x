...
/** Production expansion contract for Share. */
class XShareCapability : ExpansionCapability {
    override val id = "core.usecase2.share"
    override val area = "core.usecase2"
    override val purpose = "Share capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
