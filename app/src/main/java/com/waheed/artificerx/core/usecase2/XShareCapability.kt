...
/**
 * Runtime capability implementation for core.usecase2.share.
 *
 ...
 */
class XShareCapability : ExpansionCapability {
    override val id: String = "core.usecase2.share"
    override val area: String = "core.usecase2"
    override val purpose: String = "Share capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
