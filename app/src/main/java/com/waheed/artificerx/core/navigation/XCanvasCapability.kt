...
/**
 * Runtime capability implementation for core.navigation.canvas.
 *
...
class XCanvasCapability : ExpansionCapability {
    override val id: String = "core.navigation.canvas"
    override val area: String = "core.navigation"
    override val purpose: String = "Canvas capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
