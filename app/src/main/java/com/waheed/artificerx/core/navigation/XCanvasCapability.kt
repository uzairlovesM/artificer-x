...
class XCanvasCapability : ExpansionCapability {
    override val id = "core.navigation.canvas"
    override val area = "core.navigation"
    override val purpose = "Canvas capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
