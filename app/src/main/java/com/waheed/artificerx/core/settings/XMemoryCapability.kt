...
class XMemoryCapability : ExpansionCapability {
    override val id = "core.settings.memory"
    override val area = "core.settings"
    override val purpose = "Memory capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
