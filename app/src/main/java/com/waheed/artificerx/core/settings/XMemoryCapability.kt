...
/**
 * Runtime capability implementation for core.settings.memory.
 *
...
class XMemoryCapability : ExpansionCapability {
    override val id: String = "core.settings.memory"
    override val area: String = "core.settings"
    override val purpose: String = "Memory capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
