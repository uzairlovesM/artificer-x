...
/** Production expansion contract for Episode. */
class XEpisodeCapability : ExpansionCapability {
    override val id = "core.memory.episode"
    override val area = "core.memory"
    override val purpose = "Episode capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
