...
/**
 * Runtime capability implementation for core.memory.episode.
 *
 ...
 */
class XEpisodeCapability : ExpansionCapability {
    override val id: String = "core.memory.episode"
    override val area: String = "core.memory"
    override val purpose: String = "Episode capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
