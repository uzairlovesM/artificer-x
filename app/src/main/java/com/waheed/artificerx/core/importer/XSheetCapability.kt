...
/**
 * Runtime capability implementation for core.importer.sheet.
 *
...
class XSheetCapability : ExpansionCapability {
    override val id: String = "core.importer.sheet"
    override val area: String = "core.importer"
    override val purpose: String = "Sheet capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
