...
class XSheetCapability : ExpansionCapability {
    override val id = "core.importer.sheet"
    override val area = "core.importer"
    override val purpose = "Sheet capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
