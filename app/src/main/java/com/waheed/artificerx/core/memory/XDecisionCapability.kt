...
/** Production expansion contract for Decision. */
class XDecisionCapability : ExpansionCapability {
    override val id = "core.memory.decision"
    override val area = "core.memory"
    override val purpose = "Decision capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
