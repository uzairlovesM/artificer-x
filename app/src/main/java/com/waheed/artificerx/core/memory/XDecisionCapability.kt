...
/**
 * Runtime capability implementation for core.memory.decision.
 *
 ...
 */
class XDecisionCapability : ExpansionCapability {
    override val id: String = "core.memory.decision"
    override val area: String = "core.memory"
    override val purpose: String = "Decision capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
