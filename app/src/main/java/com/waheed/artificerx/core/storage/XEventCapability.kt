...
/**
 * Runtime capability implementation for core.storage.event.
 *
 ...
 */
class XEventCapability : ExpansionCapability {
    override val id: String = "core.storage.event"
    override val area: String = "core.storage"
    override val purpose: String = "Event capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
