...
/** Production expansion contract for Event. */
class XEventCapability : ExpansionCapability {
    override val id = "core.storage.event"
    override val area = "core.storage"
    override val purpose = "Event capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
