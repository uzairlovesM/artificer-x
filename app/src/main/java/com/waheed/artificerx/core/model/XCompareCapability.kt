...
/** Production expansion contract for Compare. */
class XCompareCapability : ExpansionCapability {
    override val id = "core.model.compare"
    override val area = "core.model"
    override val purpose = "Compare capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
