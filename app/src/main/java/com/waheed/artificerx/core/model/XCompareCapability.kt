...
/**
 * Runtime capability implementation for core.model.compare.
 *
 ...
 */
class XCompareCapability : ExpansionCapability {
    override val id: String = "core.model.compare"
    override val area: String = "core.model"
    override val purpose: String = "Compare capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
