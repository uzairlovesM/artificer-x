...
/**
 * Runtime capability implementation for core.scene.furnituregraph.
 *
 ...
 */
class XFurnitureGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.furnituregraph"
    override val area: String = "core.scene"
    override val purpose: String = "FurnitureGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
