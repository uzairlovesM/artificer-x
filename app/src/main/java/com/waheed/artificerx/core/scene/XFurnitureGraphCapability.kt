...
/** Production expansion contract for FurnitureGraph. */
class XFurnitureGraphCapability : ExpansionCapability {
    override val id = "core.scene.furnituregraph"
    override val area = "core.scene"
    override val purpose = "FurnitureGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
