...
class XFavoriteCapability : ExpansionCapability {
    override val id = "core.navigation.favorite"
    override val area = "core.navigation"
    override val purpose = "Favorite capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
