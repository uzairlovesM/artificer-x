...
/**
 * Runtime capability implementation for core.navigation.favorite.
 *
 ...
 */
class XFavoriteCapability : ExpansionCapability {
    override val id: String = "core.navigation.favorite"
    override val area: String = "core.navigation"
    override val purpose: String = "Favorite capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
