...
class TelemetryExpansion : ExpansionCapability {
    override val id: String = "core.automation.telemetry"
    override val area: String = "core.automation"
    override val purpose: String = "Telemetry coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
