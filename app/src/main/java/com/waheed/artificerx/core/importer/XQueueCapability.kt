...
/**
 * Runtime capability implementation for core.importer.queue.
 *
...
class XQueueCapability : ExpansionCapability {
    override val id: String = "core.importer.queue"
    override val area: String = "core.importer"
    override val purpose: String = "Queue capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
