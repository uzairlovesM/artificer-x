...
class XQueueCapability : ExpansionCapability {
    override val id = "core.importer.queue"
    override val area = "core.importer"
    override val purpose = "Queue capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
