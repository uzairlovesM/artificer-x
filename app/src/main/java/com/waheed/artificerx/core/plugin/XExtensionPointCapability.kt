...
/**
 * Runtime capability implementation for core.plugin.extensionpoint.
 *
 ...
 */
class XExtensionPointCapability : ExpansionCapability {
    override val id: String = "core.plugin.extensionpoint"
    override val area: String = "core.plugin"
    override val purpose: String = "ExtensionPoint capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
