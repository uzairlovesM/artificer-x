...
/** Production expansion contract for ExtensionPoint. */
class XExtensionPointCapability : ExpansionCapability {
    override val id = "core.plugin.extensionpoint"
    override val area = "core.plugin"
    override val purpose = "ExtensionPoint capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
