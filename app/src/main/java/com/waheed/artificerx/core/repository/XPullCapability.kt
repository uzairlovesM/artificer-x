...
/**
 * Runtime capability implementation for core.repository.pull.
 *
 ...
 */
class XPullCapability : ExpansionCapability {
    override val id: String = "core.repository.pull"
    override val area: String = "core.repository"
    override val purpose: String = "Pull capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
