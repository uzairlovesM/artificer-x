...
/** Production expansion contract for Pull. */
class XPullCapability : ExpansionCapability {
    override val id = "core.repository.pull"
    override val area = "core.repository"
    override val purpose = "Pull capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
