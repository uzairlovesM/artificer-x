...
/**
 * Runtime capability implementation for core.export.retry.
 *
...
class XRetryCapability : ExpansionCapability {
    override val id: String = "core.export.retry"
    override val area: String = "core.export"
    override val purpose: String = "Retry capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
