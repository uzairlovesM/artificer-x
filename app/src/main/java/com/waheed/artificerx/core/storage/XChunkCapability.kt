...
/** Production expansion contract for Chunk. */
class XChunkCapability : ExpansionCapability {
    override val id = "core.storage.chunk"
    override val area = "core.storage"
    override val purpose = "Chunk capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
