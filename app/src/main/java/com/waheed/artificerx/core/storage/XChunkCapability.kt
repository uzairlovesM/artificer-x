...
/**
 * Runtime capability implementation for core.storage.chunk.
 *
...
class XChunkCapability : ExpansionCapability {
    override val id: String = "core.storage.chunk"
    override val area: String = "core.storage"
    override val purpose: String = "Chunk capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
