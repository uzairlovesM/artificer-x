...
/** Production expansion contract for Repair. */
class XRepairCapability : ExpansionCapability {
    override val id = "core.storage.repair"
    override val area = "core.storage"
    override val purpose = "Repair capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
