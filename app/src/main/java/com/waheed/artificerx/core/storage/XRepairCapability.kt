...
/**
 * Runtime capability implementation for core.storage.repair.
 *
...
class XRepairCapability : ExpansionCapability {
    override val id: String = "core.storage.repair"
    override val area: String = "core.storage"
    override val purpose: String = "Repair capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
