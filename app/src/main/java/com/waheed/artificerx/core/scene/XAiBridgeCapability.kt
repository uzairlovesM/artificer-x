...
/**
 * Runtime capability implementation for core.scene.aibridge.
 *
 ...
 */
class XAiBridgeCapability : ExpansionCapability {
    override val id: String = "core.scene.aibridge"
    override val area: String = "core.scene"
    override val purpose: String = "AiBridge capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
