...
/** Production expansion contract for AiBridge. */
class XAiBridgeCapability : ExpansionCapability {
    override val id = "core.scene.aibridge"
    override val area = "core.scene"
    override val purpose = "AiBridge capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
