...
/** Production expansion contract for Memory. */
class XMemoryCapability : ExpansionCapability {
    override val id = "core.diagnostics.memory"
    override val area = "core.diagnostics"
    override val purpose = "Memory capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
