...
/**
 * Runtime capability implementation for core.diagnostics.memory.
 *
 ...
 */
class XMemoryCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.memory"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Memory capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
