...
/**
 * Runtime capability implementation for core.export.sheet.
 *
...
class XSheetCapability : ExpansionCapability {
    override val id: String = "core.export.sheet"
    override val area: String = "core.export"
    override val purpose: String = "Sheet capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
