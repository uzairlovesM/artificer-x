...
class XManifestCapability : ExpansionCapability {
    override val id = "core.export.manifest"
    override val area = "core.export"
    override val purpose = "Manifest capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
