...
/**
 * Runtime capability implementation for core.export.manifest.
 *
...
class XManifestCapability : ExpansionCapability {
    override val id: String = "core.export.manifest"
    override val area: String = "core.export"
    override val purpose: String = "Manifest capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
