...
class XHealthCapability : ExpansionCapability {
    override val id = "core.settings.health"
    override val area = "core.settings"
    override val purpose = "Health capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
