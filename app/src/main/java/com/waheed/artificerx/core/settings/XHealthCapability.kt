...
/**
 * Runtime capability implementation for core.settings.health.
 *
...
class XHealthCapability : ExpansionCapability {
    override val id: String = "core.settings.health"
    override val area: String = "core.settings"
    override val purpose: String = "Health capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
