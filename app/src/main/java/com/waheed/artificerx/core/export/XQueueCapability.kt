...
/**
 * Runtime capability implementation for core.export.queue.
 *
...
class XQueueCapability : ExpansionCapability {
    override val id: String = "core.export.queue"
    override val area: String = "core.export"
    override val purpose: String = "Queue capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
