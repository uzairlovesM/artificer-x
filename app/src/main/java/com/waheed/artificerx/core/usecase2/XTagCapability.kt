...
/**
 * Runtime capability implementation for core.usecase2.tag.
 *
...
class XTagCapability : ExpansionCapability {
    override val id: String = "core.usecase2.tag"
    override val area: String = "core.usecase2"
    override val purpose: String = "Tag capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
