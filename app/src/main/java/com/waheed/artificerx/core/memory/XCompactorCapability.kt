...
/** Production expansion contract for Compactor. */
class XCompactorCapability : ExpansionCapability {
    override val id = "core.memory.compactor"
    override val area = "core.memory"
    override val purpose = "Compactor capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
