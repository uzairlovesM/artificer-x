...
/**
 * Runtime capability implementation for core.memory.compactor.
 *
 ...
 */
class XCompactorCapability : ExpansionCapability {
    override val id: String = "core.memory.compactor"
    override val area: String = "core.memory"
    override val purpose: String = "Compactor capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
