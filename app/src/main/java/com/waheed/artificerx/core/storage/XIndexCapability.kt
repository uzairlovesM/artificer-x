...
/**
 * Runtime capability implementation for core.storage.index.
 *
...
class XIndexCapability : ExpansionCapability {
    override val id: String = "core.storage.index"
    override val area: String = "core.storage"
    override val purpose: String = "Index capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
