...
/** Production expansion contract for Index. */
class XIndexCapability : ExpansionCapability {
    override val id = "core.storage.index"
    override val area = "core.storage"
    override val purpose = "Index capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
