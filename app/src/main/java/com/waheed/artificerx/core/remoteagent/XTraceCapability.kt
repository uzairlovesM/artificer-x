...
class XTraceCapability : ExpansionCapability {
    override val id = "core.remoteagent.trace"
    override val area = "core.remoteagent"
    override val purpose = "Trace capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
