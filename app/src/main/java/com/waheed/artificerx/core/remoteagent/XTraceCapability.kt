...
/**
 * Runtime capability implementation for core.remoteagent.trace.
 *
...
class XTraceCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.trace"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Trace capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
