...
/**
 * Runtime capability implementation for core.plugin.cache.
 *
...
class XCacheCapability : ExpansionCapability {
    override val id: String = "core.plugin.cache"
    override val area: String = "core.plugin"
    override val purpose: String = "Cache capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
