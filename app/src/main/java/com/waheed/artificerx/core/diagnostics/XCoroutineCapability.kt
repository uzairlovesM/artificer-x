...
/**
 * Runtime capability implementation for core.diagnostics.coroutine.
 *
 ...
 */
class XCoroutineCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.coroutine"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Coroutine capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
