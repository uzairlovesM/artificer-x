...
/** Production expansion contract for Coroutine. */
class XCoroutineCapability : ExpansionCapability {
    override val id = "core.diagnostics.coroutine"
    override val area = "core.diagnostics"
    override val purpose = "Coroutine capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
