...
class XRecoveryCapability : ExpansionCapability {
    override val id = "core.research.recovery"
    override val area = "core.research"
    override val purpose = "Recovery capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
