...
/**
 * Runtime capability implementation for core.research.recovery.
 *
...
class XRecoveryCapability : ExpansionCapability {
    override val id: String = "core.research.recovery"
    override val area: String = "core.research"
    override val purpose: String = "Recovery capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
