...
/** Production expansion contract for Retention. */
class XRetentionCapability : ExpansionCapability {
    override val id = "core.memory.retention"
    override val area = "core.memory"
    override val purpose = "Retention capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
