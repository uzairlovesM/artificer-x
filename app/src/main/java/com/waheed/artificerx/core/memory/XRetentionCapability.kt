...
/**
 * Runtime capability implementation for core.memory.retention.
 *
 ...
 */
class XRetentionCapability : ExpansionCapability {
    override val id: String = "core.memory.retention"
    override val area: String = "core.memory"
    override val purpose: String = "Retention capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
