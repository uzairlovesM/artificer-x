...
/** Production expansion contract for History. */
class XHistoryCapability : ExpansionCapability {
    override val id = "core.repository.history"
    override val area = "core.repository"
    override val purpose = "History capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
