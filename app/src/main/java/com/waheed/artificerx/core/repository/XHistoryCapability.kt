...
/**
 * Runtime capability implementation for core.repository.history.
 *
 ...
 */
class XHistoryCapability : ExpansionCapability {
    override val id: String = "core.repository.history"
    override val area: String = "core.repository"
    override val purpose: String = "History capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
