...
/** Production expansion contract for Filter. */
class XFilterCapability : ExpansionCapability {
    override val id = "core.plugin.filter"
    override val area = "core.plugin"
    override val purpose = "Filter capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
