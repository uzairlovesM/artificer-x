...
/**
 * Runtime capability implementation for core.plugin.filter.
 *
...
class XFilterCapability : ExpansionCapability {
    override val id: String = "core.plugin.filter"
    override val area: String = "core.plugin"
    override val purpose: String = "Filter capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
