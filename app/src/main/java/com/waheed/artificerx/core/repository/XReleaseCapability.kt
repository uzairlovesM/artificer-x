...
/**
 * Runtime capability implementation for core.repository.release.
 *
 ...
 */
class XReleaseCapability : ExpansionCapability {
    override val id: String = "core.repository.release"
    override val area: String = "core.repository"
    override val purpose: String = "Release capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
