...
/** Production expansion contract for Release. */
class XReleaseCapability : ExpansionCapability {
    override val id = "core.repository.release"
    override val area = "core.repository"
    override val purpose = "Release capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
