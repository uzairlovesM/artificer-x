...
/** Production expansion contract for Cpu. */
class XCpuCapability : ExpansionCapability {
    override val id = "core.diagnostics.cpu"
    override val area = "core.diagnostics"
    override val purpose = "Cpu capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
