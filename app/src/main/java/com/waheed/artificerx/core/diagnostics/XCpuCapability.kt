...
/**
 * Runtime capability implementation for core.diagnostics.cpu.
 *
 ...
 */
class XCpuCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.cpu"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Cpu capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
