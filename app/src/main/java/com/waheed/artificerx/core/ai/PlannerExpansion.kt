...
class PlannerExpansion : ExpansionCapability {
    override val id: String = "core.ai.planner"
    override val area: String = "core.ai"
    override val purpose: String = "Planner coordinates core.ai responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
