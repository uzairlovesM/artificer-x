...
/** Production expansion contract for Metric. */
class XMetricCapability : ExpansionCapability {
    override val id = "core.diagnostics.metric"
    override val area = "core.diagnostics"
    override val purpose = "Metric capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
