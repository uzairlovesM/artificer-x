...
/**
 * Runtime capability implementation for core.diagnostics.metric.
 *
 ...
 */
class XMetricCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.metric"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Metric capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
