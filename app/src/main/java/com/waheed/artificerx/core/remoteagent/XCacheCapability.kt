...
class XCacheCapability : ExpansionCapability {
    override val id = "core.remoteagent.cache"
    override val area = "core.remoteagent"
    override val purpose = "Cache capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
