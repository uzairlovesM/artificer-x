...
/**
 * Runtime capability implementation for core.remoteagent.cache.
 *
...
class XCacheCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.cache"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Cache capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
