...
class XTelemetryCapability : ExpansionCapability {
    override val id = "core.remoteagent.telemetry"
    override val area = "core.remoteagent"
    override val purpose = "Telemetry capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
