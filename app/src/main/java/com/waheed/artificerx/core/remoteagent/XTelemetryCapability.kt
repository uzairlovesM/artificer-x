...
/**
 * Runtime capability implementation for core.remoteagent.telemetry.
 *
...
class XTelemetryCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.telemetry"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Telemetry capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
