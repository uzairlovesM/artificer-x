...
/** Production expansion contract for Code. */
class XCodeCapability : ExpansionCapability {
    override val id = "core.remoteagent.code"
    override val area = "core.remoteagent"
    override val purpose = "Code capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
