...
/**
 * Runtime capability implementation for core.remoteagent.code.
 *
 ...
 */
class XCodeCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.code"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Code capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
