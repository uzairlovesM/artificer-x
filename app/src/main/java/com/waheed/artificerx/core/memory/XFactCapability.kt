...
/** Production expansion contract for Fact. */
class XFactCapability : ExpansionCapability {
    override val id = "core.memory.fact"
    override val area = "core.memory"
    override val purpose = "Fact capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
