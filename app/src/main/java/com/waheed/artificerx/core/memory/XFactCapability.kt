...
/**
 * Runtime capability implementation for core.memory.fact.
 *
 ...
 */
class XFactCapability : ExpansionCapability {
    override val id: String = "core.memory.fact"
    override val area: String = "core.memory"
    override val purpose: String = "Fact capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
