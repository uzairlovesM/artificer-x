...
/**
 * Runtime capability implementation for core.storage.hash.
 *
 ...
 */
class XHashCapability : ExpansionCapability {
    override val id: String = "core.storage.hash"
    override val area: String = "core.storage"
    override val purpose: String = "Hash capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
