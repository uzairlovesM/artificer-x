...
/** Production expansion contract for Hash. */
class XHashCapability : ExpansionCapability {
    override val id = "core.storage.hash"
    override val area = "core.storage"
    override val purpose = "Hash capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
