...
/**
 * Runtime capability implementation for core.usecase2.validate.
 *
 ...
 */
class XValidateCapability : ExpansionCapability {
    override val id: String = "core.usecase2.validate"
    override val area: String = "core.usecase2"
    override val purpose: String = "Validate capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
