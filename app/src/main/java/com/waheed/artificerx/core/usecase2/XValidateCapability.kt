...
class XValidateCapability : ExpansionCapability {
    override val id = "core.usecase2.validate"
    override val area = "core.usecase2"
    override val purpose = "Validate capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
