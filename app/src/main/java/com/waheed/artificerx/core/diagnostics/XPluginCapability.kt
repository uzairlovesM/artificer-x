...
/**
 * Runtime capability implementation for core.diagnostics.plugin.
 *
...
class XPluginCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.plugin"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Plugin capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
