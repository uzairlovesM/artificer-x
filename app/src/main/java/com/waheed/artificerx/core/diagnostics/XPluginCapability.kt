...
class XPluginCapability : ExpansionCapability {
    override val id = "core.diagnostics.plugin"
    override val area = "core.diagnostics"
    override val purpose = "Plugin capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
