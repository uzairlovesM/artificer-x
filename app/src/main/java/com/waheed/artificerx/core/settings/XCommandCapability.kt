...
/**
 * Runtime capability implementation for core.settings.command.
 *
...
class XCommandCapability : ExpansionCapability {
    override val id: String = "core.settings.command"
    override val area: String = "core.settings"
    override val purpose: String = "Command capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
