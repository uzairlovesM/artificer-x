...
class XCommandCapability : ExpansionCapability {
    override val id = "core.settings.command"
    override val area = "core.settings"
    override val purpose = "Command capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
