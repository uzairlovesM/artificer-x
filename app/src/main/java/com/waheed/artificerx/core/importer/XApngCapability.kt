...
/**
 * Runtime capability implementation for core.importer.apng.
 *
 ...
 */
class XApngCapability : ExpansionCapability {
    override val id: String = "core.importer.apng"
    override val area: String = "core.importer"
    override val purpose: String = "Apng capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
