...
/** Production expansion contract for Apng. */
class XApngCapability : ExpansionCapability {
    override val id = "core.importer.apng"
    override val area = "core.importer"
    override val purpose = "Apng capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
