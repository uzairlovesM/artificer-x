...
class XCheckpointCapability : ExpansionCapability {
    override val id = "core.creative.checkpoint"
    override val area = "core.creative"
    override val purpose = "Checkpoint capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
