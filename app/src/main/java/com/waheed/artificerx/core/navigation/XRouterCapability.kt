...
class XRouterCapability : ExpansionCapability {
    override val id = "core.navigation.router"
    override val area = "core.navigation"
    override val purpose = "Router capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
