...
/**
 * Runtime capability implementation for core.navigation.router.
 *
 ...
 */
class XRouterCapability : ExpansionCapability {
    override val id: String = "core.navigation.router"
    override val area: String = "core.navigation"
    override val purpose: String = "Router capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
