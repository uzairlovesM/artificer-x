...
class XWorkspaceCapability : ExpansionCapability {
    override val id = "core.repository.workspace"
    override val area = "core.repository"
    override val purpose = "Workspace capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
