...
/**
 * Runtime capability implementation for core.repository.workspace.
 *
...
class XWorkspaceCapability : ExpansionCapability {
    override val id: String = "core.repository.workspace"
    override val area: String = "core.repository"
    override val purpose: String = "Workspace capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
