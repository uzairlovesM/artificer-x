...
/**
 * Runtime capability implementation for core.research.report.
 *
...
class XReportCapability : ExpansionCapability {
    override val id: String = "core.research.report"
    override val area: String = "core.research"
    override val purpose: String = "Report capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
