...
class XReportCapability : ExpansionCapability {
    override val id = "core.research.report"
    override val area = "core.research"
    override val purpose = "Report capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
