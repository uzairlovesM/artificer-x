...
/**
 * Runtime capability implementation for core.creative.brief.
 *
 ...
 */
class XBriefCapability : ExpansionCapability {
    override val id: String = "core.creative.brief"
    override val area: String = "core.creative"
    override val purpose: String = "Brief capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
