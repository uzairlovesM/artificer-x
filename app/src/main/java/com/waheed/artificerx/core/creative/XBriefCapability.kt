...
/** Production expansion contract for Brief. */
class XBriefCapability : ExpansionCapability {
    override val id = "core.creative.brief"
    override val area = "core.creative"
    override val purpose = "Brief capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
