...
/** Production expansion contract for StyleGuide. */
class XStyleGuideCapability : ExpansionCapability {
    override val id = "core.creative.styleguide"
    override val area = "core.creative"
    override val purpose = "StyleGuide capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
