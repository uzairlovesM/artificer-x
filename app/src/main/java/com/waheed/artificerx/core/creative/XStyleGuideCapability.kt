...
/**
 * Runtime capability implementation for core.creative.styleguide.
 *
 ...
 */
class XStyleGuideCapability : ExpansionCapability {
    override val id: String = "core.creative.styleguide"
    override val area: String = "core.creative"
    override val purpose: String = "StyleGuide capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
