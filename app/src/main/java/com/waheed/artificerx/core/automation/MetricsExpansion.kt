...
class MetricsExpansion : ExpansionCapability {
    override val id: String = "core.automation.metrics"
    override val area: String = "core.automation"
    override val purpose: String = "Metrics coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
