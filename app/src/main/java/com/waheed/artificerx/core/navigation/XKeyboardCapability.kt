...
/**
 * Runtime capability implementation for core.navigation.keyboard.
 *
 ...
 */
class XKeyboardCapability : ExpansionCapability {
    override val id: String = "core.navigation.keyboard"
    override val area: String = "core.navigation"
    override val purpose: String = "Keyboard capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
