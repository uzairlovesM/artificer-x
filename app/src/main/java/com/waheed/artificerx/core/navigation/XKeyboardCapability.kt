...
/** Production expansion contract for Keyboard. */
class XKeyboardCapability : ExpansionCapability {
    override val id = "core.navigation.keyboard"
    override val area = "core.navigation"
    override val purpose = "Keyboard capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
