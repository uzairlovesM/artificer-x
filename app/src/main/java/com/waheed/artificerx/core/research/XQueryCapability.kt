...
/** Production expansion contract for Query. */
class XQueryCapability : ExpansionCapability {
    override val id = "core.research.query"
    override val area = "core.research"
    override val purpose = "Query capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
