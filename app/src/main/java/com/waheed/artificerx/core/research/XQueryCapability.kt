...
/**
 * Runtime capability implementation for core.research.query.
 *
 ...
 */
class XQueryCapability : ExpansionCapability {
    override val id: String = "core.research.query"
    override val area: String = "core.research"
    override val purpose: String = "Query capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
