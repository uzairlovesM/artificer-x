...
/**
 * Runtime capability implementation for core.storage.migration.
 *
...
class XMigrationCapability : ExpansionCapability {
    override val id: String = "core.storage.migration"
    override val area: String = "core.storage"
    override val purpose: String = "Migration capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
