...
/** Production expansion contract for Migration. */
class XMigrationCapability : ExpansionCapability {
    override val id = "core.storage.migration"
    override val area = "core.storage"
    override val purpose = "Migration capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
