...
class XRetrieverCapability : ExpansionCapability {
    override val id = "core.memory.retriever"
    override val area = "core.memory"
    override val purpose = "Retriever capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
