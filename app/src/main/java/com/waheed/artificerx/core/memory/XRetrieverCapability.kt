...
/**
 * Runtime capability implementation for core.memory.retriever.
 *
...
class XRetrieverCapability : ExpansionCapability {
    override val id: String = "core.memory.retriever"
    override val area: String = "core.memory"
    override val purpose: String = "Retriever capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
