...
/**
 * Runtime capability implementation for core.export.layer.
 *
...
class XLayerCapability : ExpansionCapability {
    override val id: String = "core.export.layer"
    override val area: String = "core.export"
    override val purpose: String = "Layer capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
