...
class XProviderCapability : ExpansionCapability {
    override val id = "core.plugin.provider"
    override val area = "core.plugin"
    override val purpose = "Provider capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
