...
/**
 * Runtime capability implementation for core.plugin.provider.
 *
...
class XProviderCapability : ExpansionCapability {
    override val id: String = "core.plugin.provider"
    override val area: String = "core.plugin"
    override val purpose: String = "Provider capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
