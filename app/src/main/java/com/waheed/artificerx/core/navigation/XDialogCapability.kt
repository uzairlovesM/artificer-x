...
/** Production expansion contract for Dialog. */
class XDialogCapability : ExpansionCapability {
    override val id = "core.navigation.dialog"
    override val area = "core.navigation"
    override val purpose = "Dialog capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
