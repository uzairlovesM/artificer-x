...
/**
 * Runtime capability implementation for core.navigation.dialog.
 *
 ...
 */
class XDialogCapability : ExpansionCapability {
    override val id: String = "core.navigation.dialog"
    override val area: String = "core.navigation"
    override val purpose: String = "Dialog capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
