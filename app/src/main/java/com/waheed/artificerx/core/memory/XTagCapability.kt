...
/**
 * Runtime capability implementation for core.memory.tag.
 *
...
class XTagCapability : ExpansionCapability {
    override val id: String = "core.memory.tag"
    override val area: String = "core.memory"
    override val purpose: String = "Tag capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
