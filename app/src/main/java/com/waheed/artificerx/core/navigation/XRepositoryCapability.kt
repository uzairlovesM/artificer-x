...
/**
 * Runtime capability implementation for core.navigation.repository.
 *
 ...
 */
class XRepositoryCapability : ExpansionCapability {
    override val id: String = "core.navigation.repository"
    override val area: String = "core.navigation"
    override val purpose: String = "Repository capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
