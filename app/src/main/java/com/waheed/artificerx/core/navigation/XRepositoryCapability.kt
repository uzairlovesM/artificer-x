...
/** Production expansion contract for Repository. */
class XRepositoryCapability : ExpansionCapability {
    override val id = "core.navigation.repository"
    override val area = "core.navigation"
    override val purpose = "Repository capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
