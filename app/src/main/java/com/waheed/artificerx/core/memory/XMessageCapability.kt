...
/**
 * Runtime capability implementation for core.memory.message.
 *
 ...
 */
class XMessageCapability : ExpansionCapability {
    override val id: String = "core.memory.message"
    override val area: String = "core.memory"
    override val purpose: String = "Message capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
