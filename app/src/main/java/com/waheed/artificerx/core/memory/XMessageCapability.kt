...
/** Production expansion contract for Message. */
class XMessageCapability : ExpansionCapability {
    override val id = "core.memory.message"
    override val area = "core.memory"
    override val purpose = "Message capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
