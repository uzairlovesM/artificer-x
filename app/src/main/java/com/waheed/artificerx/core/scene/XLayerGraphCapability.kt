...
/**
 * Runtime capability implementation for core.scene.layergraph.
 *
 ...
 */
class XLayerGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.layergraph"
    override val area: String = "core.scene"
    override val purpose: String = "LayerGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
