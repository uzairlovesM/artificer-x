...
/** Production expansion contract for LayerGraph. */
class XLayerGraphCapability : ExpansionCapability {
    override val id = "core.scene.layergraph"
    override val area = "core.scene"
    override val purpose = "LayerGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
