...
/** Production expansion contract for Continuity. */
class XContinuityCapability : ExpansionCapability {
    override val id = "core.creative.continuity"
    override val area = "core.creative"
    override val purpose = "Continuity capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
