...
/** Production expansion contract for Entity. */
class XEntityCapability : ExpansionCapability {
    override val id = "core.research.entity"
    override val area = "core.research"
    override val purpose = "Entity capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
