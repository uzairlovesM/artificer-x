...
/**
 * Runtime capability implementation for core.research.entity.
 *
 ...
 */
class XEntityCapability : ExpansionCapability {
    override val id: String = "core.research.entity"
    override val area: String = "core.research"
    override val purpose: String = "Entity capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
