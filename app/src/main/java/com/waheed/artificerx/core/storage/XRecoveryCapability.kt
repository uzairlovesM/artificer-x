...
/**
 * Runtime capability implementation for core.storage.recovery.
 *
...
class XRecoveryCapability : ExpansionCapability {
    override val id: String = "core.storage.recovery"
    override val area: String = "core.storage"
    override val purpose: String = "Recovery capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
