...
class XRecoveryCapability : ExpansionCapability {
    override val id = "core.storage.recovery"
    override val area = "core.storage"
    override val purpose = "Recovery capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
