...
/** Production expansion contract for Git. */
class XGitCapability : ExpansionCapability {
    override val id = "core.repository.git"
    override val area = "core.repository"
    override val purpose = "Git capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
