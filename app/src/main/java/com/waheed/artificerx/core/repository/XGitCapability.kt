...
/**
 * Runtime capability implementation for core.repository.git.
 *
 ...
 */
class XGitCapability : ExpansionCapability {
    override val id: String = "core.repository.git"
    override val area: String = "core.repository"
    override val purpose: String = "Git capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
