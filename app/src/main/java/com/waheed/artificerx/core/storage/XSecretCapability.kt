...
/** Production expansion contract for Secret. */
class XSecretCapability : ExpansionCapability {
    override val id = "core.storage.secret"
    override val area = "core.storage"
    override val purpose = "Secret capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
