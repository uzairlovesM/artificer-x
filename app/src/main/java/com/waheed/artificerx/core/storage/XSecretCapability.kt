...
/**
 * Runtime capability implementation for core.storage.secret.
 *
 ...
 */
class XSecretCapability : ExpansionCapability {
    override val id: String = "core.storage.secret"
    override val area: String = "core.storage"
    override val purpose: String = "Secret capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
