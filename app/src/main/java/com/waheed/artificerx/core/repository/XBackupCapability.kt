...
/**
 * Runtime capability implementation for core.repository.backup.
 *
...
class XBackupCapability : ExpansionCapability {
    override val id: String = "core.repository.backup"
    override val area: String = "core.repository"
    override val purpose: String = "Backup capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
