...
class XBackupCapability : ExpansionCapability {
    override val id = "core.repository.backup"
    override val area = "core.repository"
    override val purpose = "Backup capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
