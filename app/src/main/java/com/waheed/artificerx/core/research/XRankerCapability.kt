...
/**
 * Runtime capability implementation for core.research.ranker.
 *
 ...
 */
class XRankerCapability : ExpansionCapability {
    override val id: String = "core.research.ranker"
    override val area: String = "core.research"
    override val purpose: String = "Ranker capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
