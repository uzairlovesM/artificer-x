...
/** Production expansion contract for Ranker. */
class XRankerCapability : ExpansionCapability {
    override val id = "core.research.ranker"
    override val area = "core.research"
    override val purpose = "Ranker capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
