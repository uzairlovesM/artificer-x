...
/**
 * Runtime capability implementation for core.repository.status.
 *
 ...
 */
class XStatusCapability : ExpansionCapability {
    override val id: String = "core.repository.status"
    override val area: String = "core.repository"
    override val purpose: String = "Status capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
