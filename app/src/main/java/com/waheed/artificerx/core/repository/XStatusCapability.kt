...
class XStatusCapability : ExpansionCapability {
    override val id = "core.repository.status"
    override val area = "core.repository"
    override val purpose = "Status capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
