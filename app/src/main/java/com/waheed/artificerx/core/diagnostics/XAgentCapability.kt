...
/**
 * Runtime capability implementation for core.diagnostics.agent.
 *
 ...
 */
class XAgentCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.agent"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Agent capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
