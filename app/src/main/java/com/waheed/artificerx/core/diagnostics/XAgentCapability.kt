...
/** Production expansion contract for Agent. */
class XAgentCapability : ExpansionCapability {
    override val id = "core.diagnostics.agent"
    override val area = "core.diagnostics"
    override val purpose = "Agent capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
