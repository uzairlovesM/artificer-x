...
/**
 * Runtime capability implementation for core.plugin.screen.
 *
 ...
 */
class XScreenCapability : ExpansionCapability {
    override val id: String = "core.plugin.screen"
    override val area: String = "core.plugin"
    override val purpose: String = "Screen capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
