...
/** Production expansion contract for Screen. */
class XScreenCapability : ExpansionCapability {
    override val id = "core.plugin.screen"
    override val area = "core.plugin"
    override val purpose = "Screen capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
