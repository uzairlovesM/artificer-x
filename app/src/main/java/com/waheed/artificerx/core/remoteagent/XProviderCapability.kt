...
/**
 * Runtime capability implementation for core.remoteagent.provider.
 *
...
class XProviderCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.provider"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Provider capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
