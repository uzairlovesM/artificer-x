...
class XProviderCapability : ExpansionCapability {
    override val id = "core.remoteagent.provider"
    override val area = "core.remoteagent"
    override val purpose = "Provider capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
