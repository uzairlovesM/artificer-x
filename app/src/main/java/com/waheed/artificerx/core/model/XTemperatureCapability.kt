...
/**
 * Runtime capability implementation for core.model.temperature.
 *
 ...
 */
class XTemperatureCapability : ExpansionCapability {
    override val id: String = "core.model.temperature"
    override val area: String = "core.model"
    override val purpose: String = "Temperature capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
