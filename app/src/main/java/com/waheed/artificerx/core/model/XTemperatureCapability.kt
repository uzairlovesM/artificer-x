...
/** Production expansion contract for Temperature. */
class XTemperatureCapability : ExpansionCapability {
    override val id = "core.model.temperature"
    override val area = "core.model"
    override val purpose = "Temperature capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
