...
/** Production expansion contract for ArchitectureGraph. */
class XArchitectureGraphCapability : ExpansionCapability {
    override val id = "core.scene.architecturegraph"
    override val area = "core.scene"
    override val purpose = "ArchitectureGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
