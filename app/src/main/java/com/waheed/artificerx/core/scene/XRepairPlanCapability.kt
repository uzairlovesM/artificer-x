...
/**
 * Runtime capability implementation for core.scene.repairplan.
 *
 ...
 */
class XRepairPlanCapability : ExpansionCapability {
    override val id: String = "core.scene.repairplan"
    override val area: String = "core.scene"
    override val purpose: String = "RepairPlan capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
