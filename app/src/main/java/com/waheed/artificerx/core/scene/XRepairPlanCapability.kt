...
/** Production expansion contract for RepairPlan. */
class XRepairPlanCapability : ExpansionCapability {
    override val id = "core.scene.repairplan"
    override val area = "core.scene"
    override val purpose = "RepairPlan capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
