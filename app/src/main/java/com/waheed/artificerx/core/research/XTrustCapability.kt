...
/**
 * Runtime capability implementation for core.research.trust.
 *
 ...
 */
class XTrustCapability : ExpansionCapability {
    override val id: String = "core.research.trust"
    override val area: String = "core.research"
    override val purpose: String = "Trust capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
