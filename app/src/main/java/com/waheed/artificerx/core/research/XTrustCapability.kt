...
class XTrustCapability : ExpansionCapability {
    override val id = "core.research.trust"
    override val area = "core.research"
    override val purpose = "Trust capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
