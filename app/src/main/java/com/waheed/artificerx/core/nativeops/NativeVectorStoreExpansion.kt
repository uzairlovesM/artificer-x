...
class NativeVectorStoreExpansion : ExpansionCapability {
    override val id: String = "core.nativeops.nativevectorstore"
    override val area: String = "core.nativeops"
    override val purpose: String = "NativeVectorStore coordinates core.nativeops responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
