...
/**
 * Runtime capability implementation for core.scene.sketchpass.
 *
 ...
 */
class XSketchPassCapability : ExpansionCapability {
    override val id: String = "core.scene.sketchpass"
    override val area: String = "core.scene"
    override val purpose: String = "SketchPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
