...
/** Production expansion contract for SketchPass. */
class XSketchPassCapability : ExpansionCapability {
    override val id = "core.scene.sketchpass"
    override val area = "core.scene"
    override val purpose = "SketchPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
