...
/**
 * Runtime capability implementation for core.scene.artifactbridge.
 *
 ...
 */
class XArtifactBridgeCapability : ExpansionCapability {
    override val id: String = "core.scene.artifactbridge"
    override val area: String = "core.scene"
    override val purpose: String = "ArtifactBridge capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
