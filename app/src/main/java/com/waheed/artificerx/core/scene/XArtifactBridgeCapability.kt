...
/** Production expansion contract for ArtifactBridge. */
class XArtifactBridgeCapability : ExpansionCapability {
    override val id = "core.scene.artifactbridge"
    override val area = "core.scene"
    override val purpose = "ArtifactBridge capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
