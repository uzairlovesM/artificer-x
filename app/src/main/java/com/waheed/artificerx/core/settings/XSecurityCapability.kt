...
/**
 * Runtime capability implementation for core.settings.security.
 *
...
class XSecurityCapability : ExpansionCapability {
    override val id: String = "core.settings.security"
    override val area: String = "core.settings"
    override val purpose: String = "Security capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
