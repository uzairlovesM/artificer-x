...
class XSecurityCapability : ExpansionCapability {
    override val id = "core.settings.security"
    override val area = "core.settings"
    override val purpose = "Security capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
