...
class XProjectCapability : ExpansionCapability {
    override val id = "core.memory.project"
    override val area = "core.memory"
    override val purpose = "Project capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
