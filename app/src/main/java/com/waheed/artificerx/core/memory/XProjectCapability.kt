...
/**
 * Runtime capability implementation for core.memory.project.
 *
...
class XProjectCapability : ExpansionCapability {
    override val id: String = "core.memory.project"
    override val area: String = "core.memory"
    override val purpose: String = "Project capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
