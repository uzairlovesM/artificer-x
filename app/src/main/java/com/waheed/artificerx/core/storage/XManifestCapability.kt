...
/**
 * Runtime capability implementation for core.storage.manifest.
 *
...
class XManifestCapability : ExpansionCapability {
    override val id: String = "core.storage.manifest"
    override val area: String = "core.storage"
    override val purpose: String = "Manifest capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
