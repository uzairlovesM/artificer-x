...
/** Production expansion contract for Manifest. */
class XManifestCapability : ExpansionCapability {
    override val id = "core.storage.manifest"
    override val area = "core.storage"
    override val purpose = "Manifest capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
