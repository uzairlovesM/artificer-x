...
class XDiagnosticsCapability : ExpansionCapability {
    override val id = "core.settings.diagnostics"
    override val area = "core.settings"
    override val purpose = "Diagnostics capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
