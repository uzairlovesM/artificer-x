...
/**
 * Runtime capability implementation for core.settings.diagnostics.
 *
...
class XDiagnosticsCapability : ExpansionCapability {
    override val id: String = "core.settings.diagnostics"
    override val area: String = "core.settings"
    override val purpose: String = "Diagnostics capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
