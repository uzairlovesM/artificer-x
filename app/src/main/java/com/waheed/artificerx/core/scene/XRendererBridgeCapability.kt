...
/**
 * Runtime capability implementation for core.scene.rendererbridge.
 *
 ...
 */
class XRendererBridgeCapability : ExpansionCapability {
    override val id: String = "core.scene.rendererbridge"
    override val area: String = "core.scene"
    override val purpose: String = "RendererBridge capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
