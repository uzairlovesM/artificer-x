...
/** Production expansion contract for RendererBridge. */
class XRendererBridgeCapability : ExpansionCapability {
    override val id = "core.scene.rendererbridge"
    override val area = "core.scene"
    override val purpose = "RendererBridge capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
