...
/**
 * Runtime capability implementation for core.export.toml.
 *
...
class XTomlCapability : ExpansionCapability {
    override val id: String = "core.export.toml"
    override val area: String = "core.export"
    override val purpose: String = "Toml capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
