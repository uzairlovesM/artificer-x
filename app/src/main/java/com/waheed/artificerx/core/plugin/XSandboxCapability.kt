...
/** Production expansion contract for Sandbox. */
class XSandboxCapability : ExpansionCapability {
    override val id = "core.plugin.sandbox"
    override val area = "core.plugin"
    override val purpose = "Sandbox capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
