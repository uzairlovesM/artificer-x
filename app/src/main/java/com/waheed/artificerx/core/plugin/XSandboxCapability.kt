...
/**
 * Runtime capability implementation for core.plugin.sandbox.
 *
 ...
 */
class XSandboxCapability : ExpansionCapability {
    override val id: String = "core.plugin.sandbox"
    override val area: String = "core.plugin"
    override val purpose: String = "Sandbox capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
