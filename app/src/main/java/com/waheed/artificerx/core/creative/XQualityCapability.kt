...
class XQualityCapability : ExpansionCapability {
    override val id = "core.creative.quality"
    override val area = "core.creative"
    override val purpose = "Quality capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
