...
/**
 * Runtime capability implementation for core.creative.quality.
 *
...
class XQualityCapability : ExpansionCapability {
    override val id: String = "core.creative.quality"
    override val area: String = "core.creative"
    override val purpose: String = "Quality capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
