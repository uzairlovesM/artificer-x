...
/** Production expansion contract for Anatomy. */
class XAnatomyCapability : ExpansionCapability {
    override val id = "core.creative.anatomy"
    override val area = "core.creative"
    override val purpose = "Anatomy capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
