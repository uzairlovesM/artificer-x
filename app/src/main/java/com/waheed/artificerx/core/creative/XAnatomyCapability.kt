...
/**
 * Runtime capability implementation for core.creative.anatomy.
 *
 ...
 */
class XAnatomyCapability : ExpansionCapability {
    override val id: String = "core.creative.anatomy"
    override val area: String = "core.creative"
    override val purpose: String = "Anatomy capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
