...
/** Production expansion contract for Schema. */
class XSchemaCapability : ExpansionCapability {
    override val id = "core.settings.schema"
    override val area = "core.settings"
    override val purpose = "Schema capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
