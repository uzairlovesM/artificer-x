...
/**
 * Runtime capability implementation for core.settings.schema.
 *
 ...
 */
class XSchemaCapability : ExpansionCapability {
    override val id: String = "core.settings.schema"
    override val area: String = "core.settings"
    override val purpose: String = "Schema capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
