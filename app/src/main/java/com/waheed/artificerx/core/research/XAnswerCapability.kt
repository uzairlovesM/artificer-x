...
/** Production expansion contract for Answer. */
class XAnswerCapability : ExpansionCapability {
    override val id = "core.research.answer"
    override val area = "core.research"
    override val purpose = "Answer capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
