...
/**
 * Runtime capability implementation for core.research.answer.
 *
 ...
 */
class XAnswerCapability : ExpansionCapability {
    override val id: String = "core.research.answer"
    override val area: String = "core.research"
    override val purpose: String = "Answer capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
