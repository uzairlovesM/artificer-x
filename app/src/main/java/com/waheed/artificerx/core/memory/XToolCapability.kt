...
/**
 * Runtime capability implementation for core.memory.tool.
 *
...
class XToolCapability : ExpansionCapability {
    override val id: String = "core.memory.tool"
    override val area: String = "core.memory"
    override val purpose: String = "Tool capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
