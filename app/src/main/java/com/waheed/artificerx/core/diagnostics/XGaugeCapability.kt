...
/** Production expansion contract for Gauge. */
class XGaugeCapability : ExpansionCapability {
    override val id = "core.diagnostics.gauge"
    override val area = "core.diagnostics"
    override val purpose = "Gauge capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
