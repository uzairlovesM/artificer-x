...
/**
 * Runtime capability implementation for core.diagnostics.gauge.
 *
 ...
 */
class XGaugeCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.gauge"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Gauge capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
