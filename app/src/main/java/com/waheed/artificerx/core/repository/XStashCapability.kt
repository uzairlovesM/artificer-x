...
/** Production expansion contract for Stash. */
class XStashCapability : ExpansionCapability {
    override val id = "core.repository.stash"
    override val area = "core.repository"
    override val purpose = "Stash capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
