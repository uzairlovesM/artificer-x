...
/**
 * Runtime capability implementation for core.repository.stash.
 *
 ...
 */
class XStashCapability : ExpansionCapability {
    override val id: String = "core.repository.stash"
    override val area: String = "core.repository"
    override val purpose: String = "Stash capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
