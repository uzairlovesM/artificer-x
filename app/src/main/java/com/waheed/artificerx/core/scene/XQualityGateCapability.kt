...
/** Production expansion contract for QualityGate. */
class XQualityGateCapability : ExpansionCapability {
    override val id = "core.scene.qualitygate"
    override val area = "core.scene"
    override val purpose = "QualityGate capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
