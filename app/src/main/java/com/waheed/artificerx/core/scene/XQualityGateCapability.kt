...
/**
 * Runtime capability implementation for core.scene.qualitygate.
 *
 ...
 */
class XQualityGateCapability : ExpansionCapability {
    override val id: String = "core.scene.qualitygate"
    override val area: String = "core.scene"
    override val purpose: String = "QualityGate capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
