...
/**
 * Runtime capability implementation for core.importer.batch.
 *
 ...
 */
class XBatchCapability : ExpansionCapability {
    override val id: String = "core.importer.batch"
    override val area: String = "core.importer"
    override val purpose: String = "Batch capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
