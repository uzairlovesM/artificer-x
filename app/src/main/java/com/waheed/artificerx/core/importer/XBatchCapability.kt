...
class XBatchCapability : ExpansionCapability {
    override val id = "core.importer.batch"
    override val area = "core.importer"
    override val purpose = "Batch capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
