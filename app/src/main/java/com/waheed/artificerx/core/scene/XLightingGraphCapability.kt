...
/** Production expansion contract for LightingGraph. */
class XLightingGraphCapability : ExpansionCapability {
    override val id = "core.scene.lightinggraph"
    override val area = "core.scene"
    override val purpose = "LightingGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
