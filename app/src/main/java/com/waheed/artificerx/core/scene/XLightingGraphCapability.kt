...
/**
 * Runtime capability implementation for core.scene.lightinggraph.
 *
 ...
 */
class XLightingGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.lightinggraph"
    override val area: String = "core.scene"
    override val purpose: String = "LightingGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
