...
/**
 * Runtime capability implementation for core.navigation.destination.
 *
 ...
 */
class XDestinationCapability : ExpansionCapability {
    override val id: String = "core.navigation.destination"
    override val area: String = "core.navigation"
    override val purpose: String = "Destination capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
