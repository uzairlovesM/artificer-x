...
/** Production expansion contract for Destination. */
class XDestinationCapability : ExpansionCapability {
    override val id = "core.navigation.destination"
    override val area = "core.navigation"
    override val purpose = "Destination capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
