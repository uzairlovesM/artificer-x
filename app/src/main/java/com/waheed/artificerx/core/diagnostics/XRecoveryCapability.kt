...
/** Production expansion contract for Recovery. */
class XRecoveryCapability : ExpansionCapability {
    override val id = "core.diagnostics.recovery"
    override val area = "core.diagnostics"
    override val purpose = "Recovery capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
