...
/**
 * Runtime capability implementation for core.diagnostics.recovery.
 *
 ...
 */
class XRecoveryCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.recovery"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Recovery capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
