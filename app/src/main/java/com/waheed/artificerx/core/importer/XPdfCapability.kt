...
/** Production expansion contract for Pdf. */
class XPdfCapability : ExpansionCapability {
    override val id = "core.importer.pdf"
    override val area = "core.importer"
    override val purpose = "Pdf capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
