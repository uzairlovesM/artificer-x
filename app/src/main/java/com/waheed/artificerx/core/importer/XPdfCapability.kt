...
/**
 * Runtime capability implementation for core.importer.pdf.
 *
 ...
 */
class XPdfCapability : ExpansionCapability {
    override val id: String = "core.importer.pdf"
    override val area: String = "core.importer"
    override val purpose: String = "Pdf capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
