...
class XBackupCapability : ExpansionCapability {
    override val id = "core.diagnostics.backup"
    override val area = "core.diagnostics"
    override val purpose = "Backup capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
