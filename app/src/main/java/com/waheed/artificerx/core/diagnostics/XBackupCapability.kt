...
/**
 * Runtime capability implementation for core.diagnostics.backup.
 *
...
class XBackupCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.backup"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Backup capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
