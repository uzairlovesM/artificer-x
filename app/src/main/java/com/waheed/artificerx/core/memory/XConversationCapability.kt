...
/** Production expansion contract for Conversation. */
class XConversationCapability : ExpansionCapability {
    override val id = "core.memory.conversation"
    override val area = "core.memory"
    override val purpose = "Conversation capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
