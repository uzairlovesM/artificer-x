...
/**
 * Runtime capability implementation for core.memory.conversation.
 *
 ...
 */
class XConversationCapability : ExpansionCapability {
    override val id: String = "core.memory.conversation"
    override val area: String = "core.memory"
    override val purpose: String = "Conversation capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
