...
/**
 * Runtime capability implementation for core.research.metrics.
 *
...
class XMetricsCapability : ExpansionCapability {
    override val id: String = "core.research.metrics"
    override val area: String = "core.research"
    override val purpose: String = "Metrics capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
