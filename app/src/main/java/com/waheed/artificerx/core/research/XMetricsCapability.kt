...
class XMetricsCapability : ExpansionCapability {
    override val id = "core.research.metrics"
    override val area = "core.research"
    override val purpose = "Metrics capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
