...
/**
 * Runtime capability implementation for core.settings.art.
 *
 ...
 */
class XArtCapability : ExpansionCapability {
    override val id: String = "core.settings.art"
    override val area: String = "core.settings"
    override val purpose: String = "Art capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
