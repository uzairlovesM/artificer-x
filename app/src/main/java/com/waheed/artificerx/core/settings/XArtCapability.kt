...
/** Production expansion contract for Art. */
class XArtCapability : ExpansionCapability {
    override val id = "core.settings.art"
    override val area = "core.settings"
    override val purpose = "Art capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
