...
/**
 * Runtime capability implementation for core.remoteagent.search.
 *
...
class XSearchCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.search"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Search capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
