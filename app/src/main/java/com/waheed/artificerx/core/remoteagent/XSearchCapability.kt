...
class XSearchCapability : ExpansionCapability {
    override val id = "core.remoteagent.search"
    override val area = "core.remoteagent"
    override val purpose = "Search capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
