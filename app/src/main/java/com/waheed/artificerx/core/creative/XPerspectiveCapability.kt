...
/** Production expansion contract for Perspective. */
class XPerspectiveCapability : ExpansionCapability {
    override val id = "core.creative.perspective"
    override val area = "core.creative"
    override val purpose = "Perspective capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
