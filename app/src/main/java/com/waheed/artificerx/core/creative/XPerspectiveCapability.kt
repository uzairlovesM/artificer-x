...
/**
 * Runtime capability implementation for core.creative.perspective.
 *
 ...
 */
class XPerspectiveCapability : ExpansionCapability {
    override val id: String = "core.creative.perspective"
    override val area: String = "core.creative"
    override val purpose: String = "Perspective capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
