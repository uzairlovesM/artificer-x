...
/**
 * Runtime capability implementation for core.remoteagent.status.
 *
...
class XStatusCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.status"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Status capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
