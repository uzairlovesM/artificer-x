...
/** Production expansion contract for Status. */
class XStatusCapability : ExpansionCapability {
    override val id = "core.remoteagent.status"
    override val area = "core.remoteagent"
    override val purpose = "Status capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
