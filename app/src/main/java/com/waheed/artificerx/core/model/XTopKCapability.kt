...
/**
 * Runtime capability implementation for core.model.topk.
 *
 ...
 */
class XTopKCapability : ExpansionCapability {
    override val id: String = "core.model.topk"
    override val area: String = "core.model"
    override val purpose: String = "TopK capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
