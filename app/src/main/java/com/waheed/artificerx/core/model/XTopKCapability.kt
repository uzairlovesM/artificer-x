...
/** Production expansion contract for TopK. */
class XTopKCapability : ExpansionCapability {
    override val id = "core.model.topk"
    override val area = "core.model"
    override val purpose = "TopK capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
