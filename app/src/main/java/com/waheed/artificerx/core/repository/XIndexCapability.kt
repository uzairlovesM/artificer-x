...
/**
 * Runtime capability implementation for core.repository.index.
 *
 ...
 */
class XIndexCapability : ExpansionCapability {
    override val id: String = "core.repository.index"
    override val area: String = "core.repository"
    override val purpose: String = "Index capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
