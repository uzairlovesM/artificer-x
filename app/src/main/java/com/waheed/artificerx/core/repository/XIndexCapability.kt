...
class XIndexCapability : ExpansionCapability {
    override val id = "core.repository.index"
    override val area = "core.repository"
    override val purpose = "Index capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
