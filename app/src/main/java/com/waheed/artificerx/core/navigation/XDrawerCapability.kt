...
/** Production expansion contract for Drawer. */
class XDrawerCapability : ExpansionCapability {
    override val id = "core.navigation.drawer"
    override val area = "core.navigation"
    override val purpose = "Drawer capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
