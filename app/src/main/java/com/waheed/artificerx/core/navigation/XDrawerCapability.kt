...
/**
 * Runtime capability implementation for core.navigation.drawer.
 *
 ...
 */
class XDrawerCapability : ExpansionCapability {
    override val id: String = "core.navigation.drawer"
    override val area: String = "core.navigation"
    override val purpose: String = "Drawer capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
