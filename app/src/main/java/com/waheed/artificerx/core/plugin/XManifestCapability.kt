...
/**
 * Runtime capability implementation for core.plugin.manifest.
 *
...
class XManifestCapability : ExpansionCapability {
    override val id: String = "core.plugin.manifest"
    override val area: String = "core.plugin"
    override val purpose: String = "Manifest capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
