...
class XManifestCapability : ExpansionCapability {
    override val id = "core.plugin.manifest"
    override val area = "core.plugin"
    override val purpose = "Manifest capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
