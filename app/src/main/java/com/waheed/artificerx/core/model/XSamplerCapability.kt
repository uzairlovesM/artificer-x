...
/**
 * Runtime capability implementation for core.model.sampler.
 *
 ...
 */
class XSamplerCapability : ExpansionCapability {
    override val id: String = "core.model.sampler"
    override val area: String = "core.model"
    override val purpose: String = "Sampler capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
