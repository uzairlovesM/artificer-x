...
/** Production expansion contract for Sampler. */
class XSamplerCapability : ExpansionCapability {
    override val id = "core.model.sampler"
    override val area = "core.model"
    override val purpose = "Sampler capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
