...
/** Production expansion contract for ShadowPass. */
class XShadowPassCapability : ExpansionCapability {
    override val id = "core.scene.shadowpass"
    override val area = "core.scene"
    override val purpose = "ShadowPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
