...
/**
 * Runtime capability implementation for core.scene.shadowpass.
 *
 ...
 */
class XShadowPassCapability : ExpansionCapability {
    override val id: String = "core.scene.shadowpass"
    override val area: String = "core.scene"
    override val purpose: String = "ShadowPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
