...
/** Production expansion contract for Score. */
class XScoreCapability : ExpansionCapability {
    override val id = "core.creative.score"
    override val area = "core.creative"
    override val purpose = "Score capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
