...
/**
 * Runtime capability implementation for core.creative.score.
 *
 ...
 */
class XScoreCapability : ExpansionCapability {
    override val id: String = "core.creative.score"
    override val area: String = "core.creative"
    override val purpose: String = "Score capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
