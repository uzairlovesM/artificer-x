...
class XArtifactCapability : ExpansionCapability {
    override val id = "core.creative.artifact"
    override val area = "core.creative"
    override val purpose = "Artifact capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
