...
/**
 * Runtime capability implementation for core.export.metadata.
 *
...
class XMetadataCapability : ExpansionCapability {
    override val id: String = "core.export.metadata"
    override val area: String = "core.export"
    override val purpose: String = "Metadata capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
