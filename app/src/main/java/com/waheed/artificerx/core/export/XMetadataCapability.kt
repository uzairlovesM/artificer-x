...
class XMetadataCapability : ExpansionCapability {
    override val id = "core.export.metadata"
    override val area = "core.export"
    override val purpose = "Metadata capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
