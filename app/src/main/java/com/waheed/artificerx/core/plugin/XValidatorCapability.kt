...
/**
 * Runtime capability implementation for core.plugin.validator.
 *
...
class XValidatorCapability : ExpansionCapability {
    override val id: String = "core.plugin.validator"
    override val area: String = "core.plugin"
    override val purpose: String = "Validator capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
