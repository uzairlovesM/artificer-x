...
class XValidatorCapability : ExpansionCapability {
    override val id = "core.plugin.validator"
    override val area = "core.plugin"
    override val purpose = "Validator capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
