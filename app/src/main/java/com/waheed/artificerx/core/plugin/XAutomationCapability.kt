...
class XAutomationCapability : ExpansionCapability {
    override val id = "core.plugin.automation"
    override val area = "core.plugin"
    override val purpose = "Automation capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
