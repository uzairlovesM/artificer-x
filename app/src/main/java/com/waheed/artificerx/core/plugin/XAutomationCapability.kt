...
/**
 * Runtime capability implementation for core.plugin.automation.
 *
...
class XAutomationCapability : ExpansionCapability {
    override val id: String = "core.plugin.automation"
    override val area: String = "core.plugin"
    override val purpose: String = "Automation capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
