...
/**
 * Runtime capability implementation for core.diagnostics.native.
 *
 ...
 */
class XNativeCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.native"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Native capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
