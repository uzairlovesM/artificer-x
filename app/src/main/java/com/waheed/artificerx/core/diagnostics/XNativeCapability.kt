...
/** Production expansion contract for Native. */
class XNativeCapability : ExpansionCapability {
    override val id = "core.diagnostics.native"
    override val area = "core.diagnostics"
    override val purpose = "Native capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
