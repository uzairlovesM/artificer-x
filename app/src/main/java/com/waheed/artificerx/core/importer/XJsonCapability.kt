...
/** Production expansion contract for Json. */
class XJsonCapability : ExpansionCapability {
    override val id = "core.importer.json"
    override val area = "core.importer"
    override val purpose = "Json capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
