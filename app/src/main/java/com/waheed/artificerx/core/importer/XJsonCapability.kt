...
/**
 * Runtime capability implementation for core.importer.json.
 *
 ...
 */
class XJsonCapability : ExpansionCapability {
    override val id: String = "core.importer.json"
    override val area: String = "core.importer"
    override val purpose: String = "Json capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
