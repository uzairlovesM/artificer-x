...
/**
 * Runtime capability implementation for core.diagnostics.gpu.
 *
 ...
 */
class XGpuCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.gpu"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Gpu capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
