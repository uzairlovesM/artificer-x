...
/** Production expansion contract for Gpu. */
class XGpuCapability : ExpansionCapability {
    override val id = "core.diagnostics.gpu"
    override val area = "core.diagnostics"
    override val purpose = "Gpu capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
