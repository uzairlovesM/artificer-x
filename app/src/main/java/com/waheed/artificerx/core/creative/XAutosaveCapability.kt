...
/** Production expansion contract for Autosave. */
class XAutosaveCapability : ExpansionCapability {
    override val id = "core.creative.autosave"
    override val area = "core.creative"
    override val purpose = "Autosave capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
