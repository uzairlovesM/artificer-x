...
/**
 * Runtime capability implementation for core.creative.autosave.
 *
 ...
 */
class XAutosaveCapability : ExpansionCapability {
    override val id: String = "core.creative.autosave"
    override val area: String = "core.creative"
    override val purpose: String = "Autosave capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
