...
/**
 * Runtime capability implementation for core.scene.revision.
 *
...
class XRevisionCapability : ExpansionCapability {
    override val id: String = "core.scene.revision"
    override val area: String = "core.scene"
    override val purpose: String = "Revision capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
