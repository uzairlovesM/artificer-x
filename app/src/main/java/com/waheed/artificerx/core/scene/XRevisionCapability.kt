...
class XRevisionCapability : ExpansionCapability {
    override val id = "core.scene.revision"
    override val area = "core.scene"
    override val purpose = "Revision capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
