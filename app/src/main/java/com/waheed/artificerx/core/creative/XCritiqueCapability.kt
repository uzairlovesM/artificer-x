...
/**
 * Runtime capability implementation for core.creative.critique.
 *
 ...
 */
class XCritiqueCapability : ExpansionCapability {
    override val id: String = "core.creative.critique"
    override val area: String = "core.creative"
    override val purpose: String = "Critique capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
