...
/** Production expansion contract for Critique. */
class XCritiqueCapability : ExpansionCapability {
    override val id = "core.creative.critique"
    override val area = "core.creative"
    override val purpose = "Critique capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
