...
/** Production expansion contract for Lifecycle. */
class XLifecycleCapability : ExpansionCapability {
    override val id = "core.plugin.lifecycle"
    override val area = "core.plugin"
    override val purpose = "Lifecycle capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
