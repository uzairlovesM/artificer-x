...
/**
 * Runtime capability implementation for core.plugin.lifecycle.
 *
 ...
 */
class XLifecycleCapability : ExpansionCapability {
    override val id: String = "core.plugin.lifecycle"
    override val area: String = "core.plugin"
    override val purpose: String = "Lifecycle capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
