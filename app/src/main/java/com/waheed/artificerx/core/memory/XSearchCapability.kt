...
/**
 * Runtime capability implementation for core.memory.search.
 *
...
class XSearchCapability : ExpansionCapability {
    override val id: String = "core.memory.search"
    override val area: String = "core.memory"
    override val purpose: String = "Search capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
