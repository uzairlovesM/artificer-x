...
class XSearchCapability : ExpansionCapability {
    override val id = "core.memory.search"
    override val area = "core.memory"
    override val purpose = "Search capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
