...
/**
 * Runtime capability implementation for core.creative.consistency.
 *
 ...
 */
class XConsistencyCapability : ExpansionCapability {
    override val id: String = "core.creative.consistency"
    override val area: String = "core.creative"
    override val purpose: String = "Consistency capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
