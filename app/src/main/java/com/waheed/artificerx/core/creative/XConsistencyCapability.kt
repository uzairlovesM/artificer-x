...
/** Production expansion contract for Consistency. */
class XConsistencyCapability : ExpansionCapability {
    override val id = "core.creative.consistency"
    override val area = "core.creative"
    override val purpose = "Consistency capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
