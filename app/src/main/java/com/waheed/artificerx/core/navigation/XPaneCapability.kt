...
/**
 * Runtime capability implementation for core.navigation.pane.
 *
 ...
 */
class XPaneCapability : ExpansionCapability {
    override val id: String = "core.navigation.pane"
    override val area: String = "core.navigation"
    override val purpose: String = "Pane capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
