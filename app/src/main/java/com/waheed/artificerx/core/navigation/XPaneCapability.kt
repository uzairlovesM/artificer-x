...
/** Production expansion contract for Pane. */
class XPaneCapability : ExpansionCapability {
    override val id = "core.navigation.pane"
    override val area = "core.navigation"
    override val purpose = "Pane capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
