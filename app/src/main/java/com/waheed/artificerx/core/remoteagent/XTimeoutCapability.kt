...
/**
 * Runtime capability implementation for core.remoteagent.timeout.
 *
...
class XTimeoutCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.timeout"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Timeout capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
