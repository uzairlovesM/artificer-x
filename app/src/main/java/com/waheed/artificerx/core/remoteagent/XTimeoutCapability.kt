...
/** Production expansion contract for Timeout. */
class XTimeoutCapability : ExpansionCapability {
    override val id = "core.remoteagent.timeout"
    override val area = "core.remoteagent"
    override val purpose = "Timeout capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
