...
/**
 * Runtime capability implementation for core.plugin.trust.
 *
...
class XTrustCapability : ExpansionCapability {
    override val id: String = "core.plugin.trust"
    override val area: String = "core.plugin"
    override val purpose: String = "Trust capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
