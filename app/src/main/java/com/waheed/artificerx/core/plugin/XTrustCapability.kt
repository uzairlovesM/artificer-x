...
/** Production expansion contract for Trust. */
class XTrustCapability : ExpansionCapability {
    override val id = "core.plugin.trust"
    override val area = "core.plugin"
    override val purpose = "Trust capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
