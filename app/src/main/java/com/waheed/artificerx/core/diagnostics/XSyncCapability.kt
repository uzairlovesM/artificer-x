...
/**
 * Runtime capability implementation for core.diagnostics.sync.
 *
 ...
 */
class XSyncCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.sync"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Sync capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
