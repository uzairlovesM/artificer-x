...
/** Production expansion contract for Sync. */
class XSyncCapability : ExpansionCapability {
    override val id = "core.diagnostics.sync"
    override val area = "core.diagnostics"
    override val purpose = "Sync capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
