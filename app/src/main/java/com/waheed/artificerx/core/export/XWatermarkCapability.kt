...
/** Production expansion contract for Watermark. */
class XWatermarkCapability : ExpansionCapability {
    override val id = "core.export.watermark"
    override val area = "core.export"
    override val purpose = "Watermark capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
