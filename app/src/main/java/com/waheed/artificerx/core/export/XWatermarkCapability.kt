...
/**
 * Runtime capability implementation for core.export.watermark.
 *
 ...
 */
class XWatermarkCapability : ExpansionCapability {
    override val id: String = "core.export.watermark"
    override val area: String = "core.export"
    override val purpose: String = "Watermark capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
