...
/**
 * Runtime capability implementation for core.diagnostics.counter.
 *
 ...
 */
class XCounterCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.counter"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Counter capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
