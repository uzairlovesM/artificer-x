...
/** Production expansion contract for Counter. */
class XCounterCapability : ExpansionCapability {
    override val id = "core.diagnostics.counter"
    override val area = "core.diagnostics"
    override val purpose = "Counter capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
