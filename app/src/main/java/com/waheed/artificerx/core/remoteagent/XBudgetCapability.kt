...
/** Production expansion contract for Budget. */
class XBudgetCapability : ExpansionCapability {
    override val id = "core.remoteagent.budget"
    override val area = "core.remoteagent"
    override val purpose = "Budget capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
