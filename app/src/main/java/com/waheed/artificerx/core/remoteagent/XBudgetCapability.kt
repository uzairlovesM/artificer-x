...
/**
 * Runtime capability implementation for core.remoteagent.budget.
 *
 ...
 */
class XBudgetCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.budget"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Budget capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
