...
/** Production expansion contract for Modal. */
class XModalCapability : ExpansionCapability {
    override val id = "core.navigation.modal"
    override val area = "core.navigation"
    override val purpose = "Modal capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
