...
/**
 * Runtime capability implementation for core.navigation.modal.
 *
 ...
 */
class XModalCapability : ExpansionCapability {
    override val id: String = "core.navigation.modal"
    override val area: String = "core.navigation"
    override val purpose: String = "Modal capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
