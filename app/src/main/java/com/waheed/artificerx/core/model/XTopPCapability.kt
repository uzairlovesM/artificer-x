...
/**
 * Runtime capability implementation for core.model.topp.
 *
 ...
 */
class XTopPCapability : ExpansionCapability {
    override val id: String = "core.model.topp"
    override val area: String = "core.model"
    override val purpose: String = "TopP capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
