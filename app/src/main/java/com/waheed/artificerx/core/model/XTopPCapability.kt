...
/** Production expansion contract for TopP. */
class XTopPCapability : ExpansionCapability {
    override val id = "core.model.topp"
    override val area = "core.model"
    override val purpose = "TopP capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
