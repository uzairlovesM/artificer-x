...
/** Production expansion contract for Sort. */
class XSortCapability : ExpansionCapability {
    override val id = "core.usecase2.sort"
    override val area = "core.usecase2"
    override val purpose = "Sort capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
