...
/**
 * Runtime capability implementation for core.usecase2.sort.
 *
 ...
 */
class XSortCapability : ExpansionCapability {
    override val id: String = "core.usecase2.sort"
    override val area: String = "core.usecase2"
    override val purpose: String = "Sort capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
