...
class XNetworkCapability : ExpansionCapability {
    override val id = "core.settings.network"
    override val area = "core.settings"
    override val purpose = "Network capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
