...
/**
 * Runtime capability implementation for core.settings.network.
 *
...
class XNetworkCapability : ExpansionCapability {
    override val id: String = "core.settings.network"
    override val area: String = "core.settings"
    override val purpose: String = "Network capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
