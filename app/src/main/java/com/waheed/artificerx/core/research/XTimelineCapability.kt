...
/**
 * Runtime capability implementation for core.research.timeline.
 *
 ...
 */
class XTimelineCapability : ExpansionCapability {
    override val id: String = "core.research.timeline"
    override val area: String = "core.research"
    override val purpose: String = "Timeline capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
