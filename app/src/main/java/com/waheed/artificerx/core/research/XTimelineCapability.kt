...
/** Production expansion contract for Timeline. */
class XTimelineCapability : ExpansionCapability {
    override val id = "core.research.timeline"
    override val area = "core.research"
    override val purpose = "Timeline capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
