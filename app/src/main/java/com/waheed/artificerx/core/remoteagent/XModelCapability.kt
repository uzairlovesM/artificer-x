...
/**
 * Runtime capability implementation for core.remoteagent.model.
 *
...
class XModelCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.model"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Model capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
