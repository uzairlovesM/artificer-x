...
class XModelCapability : ExpansionCapability {
    override val id = "core.remoteagent.model"
    override val area = "core.remoteagent"
    override val purpose = "Model capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
