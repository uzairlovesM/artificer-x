...
/**
 * Runtime capability implementation for core.plugin.theme.
 *
...
class XThemeCapability : ExpansionCapability {
    override val id: String = "core.plugin.theme"
    override val area: String = "core.plugin"
    override val purpose: String = "Theme capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
