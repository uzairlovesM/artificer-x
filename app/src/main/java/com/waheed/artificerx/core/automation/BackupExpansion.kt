...
class BackupExpansion : ExpansionCapability {
    override val id: String = "core.automation.backup"
    override val area: String = "core.automation"
    override val purpose: String = "Backup coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
