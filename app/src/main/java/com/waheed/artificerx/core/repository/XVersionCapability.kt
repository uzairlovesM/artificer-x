...
class XVersionCapability : ExpansionCapability {
    override val id = "core.repository.version"
    override val area = "core.repository"
    override val purpose = "Version capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
