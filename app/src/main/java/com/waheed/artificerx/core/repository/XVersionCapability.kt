...
/**
 * Runtime capability implementation for core.repository.version.
 *
 ...
 */
class XVersionCapability : ExpansionCapability {
    override val id: String = "core.repository.version"
    override val area: String = "core.repository"
    override val purpose: String = "Version capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
