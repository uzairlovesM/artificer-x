...
/** Production expansion contract for Brush. */
class XBrushCapability : ExpansionCapability {
    override val id = "core.plugin.brush"
    override val area = "core.plugin"
    override val purpose = "Brush capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
