...
/**
 * Runtime capability implementation for core.plugin.brush.
 *
...
class XBrushCapability : ExpansionCapability {
    override val id: String = "core.plugin.brush"
    override val area: String = "core.plugin"
    override val purpose: String = "Brush capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
