...
/**
 * Runtime capability implementation for core.model.recommend.
 *
 ...
 */
class XRecommendCapability : ExpansionCapability {
    override val id: String = "core.model.recommend"
    override val area: String = "core.model"
    override val purpose: String = "Recommend capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
