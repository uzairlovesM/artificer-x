...
/** Production expansion contract for Recommend. */
class XRecommendCapability : ExpansionCapability {
    override val id = "core.model.recommend"
    override val area = "core.model"
    override val purpose = "Recommend capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
