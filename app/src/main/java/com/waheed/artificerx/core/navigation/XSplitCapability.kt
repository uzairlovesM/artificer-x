...
/** Production expansion contract for Split. */
class XSplitCapability : ExpansionCapability {
    override val id = "core.navigation.split"
    override val area = "core.navigation"
    override val purpose = "Split capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
