...
/**
 * Runtime capability implementation for core.navigation.split.
 *
 ...
 */
class XSplitCapability : ExpansionCapability {
    override val id: String = "core.navigation.split"
    override val area: String = "core.navigation"
    override val purpose: String = "Split capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
