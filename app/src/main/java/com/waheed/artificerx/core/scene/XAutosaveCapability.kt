...
class XAutosaveCapability : ExpansionCapability {
    override val id = "core.scene.autosave"
    override val area = "core.scene"
    override val purpose = "Autosave capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
