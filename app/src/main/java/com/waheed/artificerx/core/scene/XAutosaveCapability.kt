...
/**
 * Runtime capability implementation for core.scene.autosave.
 *
...
class XAutosaveCapability : ExpansionCapability {
    override val id: String = "core.scene.autosave"
    override val area: String = "core.scene"
    override val purpose: String = "Autosave capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
