...
/** Production expansion contract for Directory. */
class XDirectoryCapability : ExpansionCapability {
    override val id = "core.storage.directory"
    override val area = "core.storage"
    override val purpose = "Directory capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
