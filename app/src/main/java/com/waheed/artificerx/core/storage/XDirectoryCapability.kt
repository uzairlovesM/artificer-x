...
/**
 * Runtime capability implementation for core.storage.directory.
 *
 ...
 */
class XDirectoryCapability : ExpansionCapability {
    override val id: String = "core.storage.directory"
    override val area: String = "core.storage"
    override val purpose: String = "Directory capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
