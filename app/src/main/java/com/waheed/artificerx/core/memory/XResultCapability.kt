...
/**
 * Runtime capability implementation for core.memory.result.
 *
 ...
 */
class XResultCapability : ExpansionCapability {
    override val id: String = "core.memory.result"
    override val area: String = "core.memory"
    override val purpose: String = "Result capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
