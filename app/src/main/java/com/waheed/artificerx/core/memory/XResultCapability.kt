...
class XResultCapability : ExpansionCapability {
    override val id = "core.memory.result"
    override val area = "core.memory"
    override val purpose = "Result capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
