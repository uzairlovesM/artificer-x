...
/**
 * Runtime capability implementation for core.scene.spec.
 *
 ...
 */
class XSpecCapability : ExpansionCapability {
    override val id: String = "core.scene.spec"
    override val area: String = "core.scene"
    override val purpose: String = "Spec capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
