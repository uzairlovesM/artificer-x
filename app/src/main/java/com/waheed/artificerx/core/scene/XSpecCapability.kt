...
/** Production expansion contract for Spec. */
class XSpecCapability : ExpansionCapability {
    override val id = "core.scene.spec"
    override val area = "core.scene"
    override val purpose = "Spec capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
