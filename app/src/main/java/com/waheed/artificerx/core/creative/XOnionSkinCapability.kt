...
/** Production expansion contract for OnionSkin. */
class XOnionSkinCapability : ExpansionCapability {
    override val id = "core.creative.onionskin"
    override val area = "core.creative"
    override val purpose = "OnionSkin capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
