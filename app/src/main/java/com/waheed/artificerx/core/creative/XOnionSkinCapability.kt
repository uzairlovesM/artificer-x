...
/**
 * Runtime capability implementation for core.creative.onionskin.
 *
 ...
 */
class XOnionSkinCapability : ExpansionCapability {
    override val id: String = "core.creative.onionskin"
    override val area: String = "core.creative"
    override val purpose: String = "OnionSkin capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
