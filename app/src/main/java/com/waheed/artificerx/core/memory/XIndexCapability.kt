...
/**
 * Runtime capability implementation for core.memory.index.
 *
...
class XIndexCapability : ExpansionCapability {
    override val id: String = "core.memory.index"
    override val area: String = "core.memory"
    override val purpose: String = "Index capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
