...
/**
 * Runtime capability implementation for core.repository.metrics.
 *
...
class XMetricsCapability : ExpansionCapability {
    override val id: String = "core.repository.metrics"
    override val area: String = "core.repository"
    override val purpose: String = "Metrics capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
