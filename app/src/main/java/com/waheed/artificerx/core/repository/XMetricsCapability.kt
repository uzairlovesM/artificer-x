...
class XMetricsCapability : ExpansionCapability {
    override val id = "core.repository.metrics"
    override val area = "core.repository"
    override val purpose = "Metrics capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
