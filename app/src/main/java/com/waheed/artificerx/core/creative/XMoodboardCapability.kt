...
/**
 * Runtime capability implementation for core.creative.moodboard.
 *
...
class XMoodboardCapability : ExpansionCapability {
    override val id: String = "core.creative.moodboard"
    override val area: String = "core.creative"
    override val purpose: String = "Moodboard capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
