...
class XConfidenceCapability : ExpansionCapability {
    override val id = "core.memory.confidence"
    override val area = "core.memory"
    override val purpose = "Confidence capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
