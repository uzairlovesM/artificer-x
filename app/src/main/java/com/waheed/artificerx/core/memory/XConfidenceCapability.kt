...
/**
 * Runtime capability implementation for core.memory.confidence.
 *
...
class XConfidenceCapability : ExpansionCapability {
    override val id: String = "core.memory.confidence"
    override val area: String = "core.memory"
    override val purpose: String = "Confidence capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
