...
/**
 * Runtime capability implementation for core.research.gap.
 *
 ...
 */
class XGapCapability : ExpansionCapability {
    override val id: String = "core.research.gap"
    override val area: String = "core.research"
    override val purpose: String = "Gap capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
