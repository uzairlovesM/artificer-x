...
/** Production expansion contract for Gap. */
class XGapCapability : ExpansionCapability {
    override val id = "core.research.gap"
    override val area = "core.research"
    override val purpose = "Gap capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
