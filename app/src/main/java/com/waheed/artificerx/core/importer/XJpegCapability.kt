...
/** Production expansion contract for Jpeg. */
class XJpegCapability : ExpansionCapability {
    override val id = "core.importer.jpeg"
    override val area = "core.importer"
    override val purpose = "Jpeg capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
