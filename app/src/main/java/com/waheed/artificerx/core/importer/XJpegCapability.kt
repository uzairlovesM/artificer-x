...
/**
 * Runtime capability implementation for core.importer.jpeg.
 *
 ...
 */
class XJpegCapability : ExpansionCapability {
    override val id: String = "core.importer.jpeg"
    override val area: String = "core.importer"
    override val purpose: String = "Jpeg capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
