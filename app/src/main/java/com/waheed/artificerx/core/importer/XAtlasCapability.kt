...
/**
 * Runtime capability implementation for core.importer.atlas.
 *
...
class XAtlasCapability : ExpansionCapability {
    override val id: String = "core.importer.atlas"
    override val area: String = "core.importer"
    override val purpose: String = "Atlas capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
