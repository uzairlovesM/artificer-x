...
class XAtlasCapability : ExpansionCapability {
    override val id = "core.importer.atlas"
    override val area = "core.importer"
    override val purpose = "Atlas capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
