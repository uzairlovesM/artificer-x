...
/** Production expansion contract for Scanner. */
class XScannerCapability : ExpansionCapability {
    override val id = "core.plugin.scanner"
    override val area = "core.plugin"
    override val purpose = "Scanner capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
