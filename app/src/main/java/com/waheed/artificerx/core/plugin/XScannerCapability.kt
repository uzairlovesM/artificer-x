...
/**
 * Runtime capability implementation for core.plugin.scanner.
 *
 ...
 */
class XScannerCapability : ExpansionCapability {
    override val id: String = "core.plugin.scanner"
    override val area: String = "core.plugin"
    override val purpose: String = "Scanner capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
