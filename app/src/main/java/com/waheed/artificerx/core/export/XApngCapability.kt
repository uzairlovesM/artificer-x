...
/**
 * Runtime capability implementation for core.export.apng.
 *
...
class XApngCapability : ExpansionCapability {
    override val id: String = "core.export.apng"
    override val area: String = "core.export"
    override val purpose: String = "Apng capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
