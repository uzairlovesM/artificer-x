...
/** Production expansion contract for Pin. */
class XPinCapability : ExpansionCapability {
    override val id = "core.storage.pin"
    override val area = "core.storage"
    override val purpose = "Pin capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
