...
/**
 * Runtime capability implementation for core.storage.pin.
 *
...
class XPinCapability : ExpansionCapability {
    override val id: String = "core.storage.pin"
    override val area: String = "core.storage"
    override val purpose: String = "Pin capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
