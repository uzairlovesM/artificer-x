...
/**
 * Runtime capability implementation for core.creative.catalog.
 *
 ...
 */
class XCatalogCapability : ExpansionCapability {
    override val id: String = "core.creative.catalog"
    override val area: String = "core.creative"
    override val purpose: String = "Catalog capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
