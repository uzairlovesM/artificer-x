...
class XCatalogCapability : ExpansionCapability {
    override val id = "core.creative.catalog"
    override val area = "core.creative"
    override val purpose = "Catalog capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
