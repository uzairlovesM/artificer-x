...
/** Production expansion contract for Rebase. */
class XRebaseCapability : ExpansionCapability {
    override val id = "core.repository.rebase"
    override val area = "core.repository"
    override val purpose = "Rebase capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
