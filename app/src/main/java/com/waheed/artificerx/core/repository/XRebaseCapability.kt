...
/**
 * Runtime capability implementation for core.repository.rebase.
 *
 ...
 */
class XRebaseCapability : ExpansionCapability {
    override val id: String = "core.repository.rebase"
    override val area: String = "core.repository"
    override val purpose: String = "Rebase capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
