...
class NativeSqlExpansion : ExpansionCapability {
    override val id: String = "core.native.nativesql"
    override val area: String = "core.native"
    override val purpose: String = "NativeSql coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
