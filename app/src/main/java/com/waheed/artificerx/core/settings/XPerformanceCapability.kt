...
/**
 * Runtime capability implementation for core.settings.performance.
 *
 ...
 */
class XPerformanceCapability : ExpansionCapability {
    override val id: String = "core.settings.performance"
    override val area: String = "core.settings"
    override val purpose: String = "Performance capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
