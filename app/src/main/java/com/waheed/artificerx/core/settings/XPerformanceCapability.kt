...
/** Production expansion contract for Performance. */
class XPerformanceCapability : ExpansionCapability {
    override val id = "core.settings.performance"
    override val area = "core.settings"
    override val purpose = "Performance capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
