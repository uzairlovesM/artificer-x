...
class XCredentialCapability : ExpansionCapability {
    override val id = "core.repository.credential"
    override val area = "core.repository"
    override val purpose = "Credential capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
