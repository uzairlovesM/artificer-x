...
/**
 * Runtime capability implementation for core.repository.credential.
 *
 ...
 */
class XCredentialCapability : ExpansionCapability {
    override val id: String = "core.repository.credential"
    override val area: String = "core.repository"
    override val purpose: String = "Credential capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
