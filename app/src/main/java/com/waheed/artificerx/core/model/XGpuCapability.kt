...
/**
 * Runtime capability implementation for core.model.gpu.
 *
...
class XGpuCapability : ExpansionCapability {
    override val id: String = "core.model.gpu"
    override val area: String = "core.model"
    override val purpose: String = "Gpu capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
