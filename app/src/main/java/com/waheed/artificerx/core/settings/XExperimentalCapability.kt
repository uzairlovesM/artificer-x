...
/** Production expansion contract for Experimental. */
class XExperimentalCapability : ExpansionCapability {
    override val id = "core.settings.experimental"
    override val area = "core.settings"
    override val purpose = "Experimental capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
