...
/**
 * Runtime capability implementation for core.settings.experimental.
 *
 ...
 */
class XExperimentalCapability : ExpansionCapability {
    override val id: String = "core.settings.experimental"
    override val area: String = "core.settings"
    override val purpose: String = "Experimental capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
