...
/**
 * Runtime capability implementation for core.model.cache.
 *
...
class XCacheCapability : ExpansionCapability {
    override val id: String = "core.model.cache"
    override val area: String = "core.model"
    override val purpose: String = "Cache capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
