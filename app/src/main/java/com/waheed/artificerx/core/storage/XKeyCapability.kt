...
/**
 * Runtime capability implementation for core.storage.key.
 *
 ...
 */
class XKeyCapability : ExpansionCapability {
    override val id: String = "core.storage.key"
    override val area: String = "core.storage"
    override val purpose: String = "Key capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
