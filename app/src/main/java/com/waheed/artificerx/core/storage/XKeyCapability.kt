...
/** Production expansion contract for Key. */
class XKeyCapability : ExpansionCapability {
    override val id = "core.storage.key"
    override val area = "core.storage"
    override val purpose = "Key capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
