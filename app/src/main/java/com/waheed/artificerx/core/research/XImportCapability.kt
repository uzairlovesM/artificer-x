...
class XImportCapability : ExpansionCapability {
    override val id = "core.research.import"
    override val area = "core.research"
    override val purpose = "Import capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
