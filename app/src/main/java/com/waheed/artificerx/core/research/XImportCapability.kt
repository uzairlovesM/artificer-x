...
/**
 * Runtime capability implementation for core.research.import.
 *
...
class XImportCapability : ExpansionCapability {
    override val id: String = "core.research.import"
    override val area: String = "core.research"
    override val purpose: String = "Import capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
