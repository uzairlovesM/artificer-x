...
/** Production expansion contract for DiffPass. */
class XDiffPassCapability : ExpansionCapability {
    override val id = "core.scene.diffpass"
    override val area = "core.scene"
    override val purpose = "DiffPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
