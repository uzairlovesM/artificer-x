...
/**
 * Runtime capability implementation for core.scene.diffpass.
 *
 ...
 */
class XDiffPassCapability : ExpansionCapability {
    override val id: String = "core.scene.diffpass"
    override val area: String = "core.scene"
    override val purpose: String = "DiffPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
