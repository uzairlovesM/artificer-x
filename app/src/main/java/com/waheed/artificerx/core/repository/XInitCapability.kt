...
/**
 * Runtime capability implementation for core.repository.init.
 *
 ...
 */
class XInitCapability : ExpansionCapability {
    override val id: String = "core.repository.init"
    override val area: String = "core.repository"
    override val purpose: String = "Init capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
