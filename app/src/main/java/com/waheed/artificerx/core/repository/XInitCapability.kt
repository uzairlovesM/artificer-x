...
/** Production expansion contract for Init. */
class XInitCapability : ExpansionCapability {
    override val id = "core.repository.init"
    override val area = "core.repository"
    override val purpose = "Init capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
