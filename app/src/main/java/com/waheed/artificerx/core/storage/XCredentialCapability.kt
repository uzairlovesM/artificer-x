...
/** Production expansion contract for Credential. */
class XCredentialCapability : ExpansionCapability {
    override val id = "core.storage.credential"
    override val area = "core.storage"
    override val purpose = "Credential capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
