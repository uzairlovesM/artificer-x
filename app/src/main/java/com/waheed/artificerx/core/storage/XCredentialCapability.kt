...
/**
 * Runtime capability implementation for core.storage.credential.
 *
...
class XCredentialCapability : ExpansionCapability {
    override val id: String = "core.storage.credential"
    override val area: String = "core.storage"
    override val purpose: String = "Credential capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
