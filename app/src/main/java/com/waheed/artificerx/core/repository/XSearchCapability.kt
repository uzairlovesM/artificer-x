...
/**
 * Runtime capability implementation for core.repository.search.
 *
...
class XSearchCapability : ExpansionCapability {
    override val id: String = "core.repository.search"
    override val area: String = "core.repository"
    override val purpose: String = "Search capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
