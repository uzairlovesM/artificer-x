...
class XSearchCapability : ExpansionCapability {
    override val id = "core.repository.search"
    override val area = "core.repository"
    override val purpose = "Search capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
