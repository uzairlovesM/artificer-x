...
/**
 * Runtime capability implementation for core.export.color.
 *
...
class XColorCapability : ExpansionCapability {
    override val id: String = "core.export.color"
    override val area: String = "core.export"
    override val purpose: String = "Color capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
