...
/**
 * Runtime capability implementation for core.model.policy.
 *
...
class XPolicyCapability : ExpansionCapability {
    override val id: String = "core.model.policy"
    override val area: String = "core.model"
    override val purpose: String = "Policy capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
