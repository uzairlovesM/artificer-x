...
class XCritiqueCapability : ExpansionCapability {
    override val id = "core.scene.critique"
    override val area = "core.scene"
    override val purpose = "Critique capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
