...
/**
 * Runtime capability implementation for core.scene.critique.
 *
...
class XCritiqueCapability : ExpansionCapability {
    override val id: String = "core.scene.critique"
    override val area: String = "core.scene"
    override val purpose: String = "Critique capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
