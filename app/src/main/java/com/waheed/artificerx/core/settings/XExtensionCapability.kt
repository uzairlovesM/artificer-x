...
/**
 * Runtime capability implementation for core.settings.extension.
 *
 ...
 */
class XExtensionCapability : ExpansionCapability {
    override val id: String = "core.settings.extension"
    override val area: String = "core.settings"
    override val purpose: String = "Extension capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
