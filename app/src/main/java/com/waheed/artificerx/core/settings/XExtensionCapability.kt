...
/** Production expansion contract for Extension. */
class XExtensionCapability : ExpansionCapability {
    override val id = "core.settings.extension"
    override val area = "core.settings"
    override val purpose = "Extension capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
