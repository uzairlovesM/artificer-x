...
/**
 * Runtime capability implementation for core.usecase2.filter.
 *
 ...
 */
class XFilterCapability : ExpansionCapability {
    override val id: String = "core.usecase2.filter"
    override val area: String = "core.usecase2"
    override val purpose: String = "Filter capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
