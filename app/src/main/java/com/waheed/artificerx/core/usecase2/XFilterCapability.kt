...
class XFilterCapability : ExpansionCapability {
    override val id = "core.usecase2.filter"
    override val area = "core.usecase2"
    override val purpose = "Filter capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
