...
/**
 * Runtime capability implementation for core.research.confidence.
 *
 ...
 */
class XConfidenceCapability : ExpansionCapability {
    override val id: String = "core.research.confidence"
    override val area: String = "core.research"
    override val purpose: String = "Confidence capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
