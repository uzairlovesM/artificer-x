...
/** Production expansion contract for Confidence. */
class XConfidenceCapability : ExpansionCapability {
    override val id = "core.research.confidence"
    override val area = "core.research"
    override val purpose = "Confidence capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
