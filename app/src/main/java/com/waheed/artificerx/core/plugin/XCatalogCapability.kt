...
/**
 * Runtime capability implementation for core.plugin.catalog.
 *
...
class XCatalogCapability : ExpansionCapability {
    override val id: String = "core.plugin.catalog"
    override val area: String = "core.plugin"
    override val purpose: String = "Catalog capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
