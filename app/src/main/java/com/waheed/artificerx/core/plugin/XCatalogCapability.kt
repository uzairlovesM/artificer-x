...
class XCatalogCapability : ExpansionCapability {
    override val id = "core.plugin.catalog"
    override val area = "core.plugin"
    override val purpose = "Catalog capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
