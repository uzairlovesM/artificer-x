...
/** Production expansion contract for Writer. */
class XWriterCapability : ExpansionCapability {
    override val id = "core.settings.writer"
    override val area = "core.settings"
    override val purpose = "Writer capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
