...
/**
 * Runtime capability implementation for core.settings.writer.
 *
 ...
 */
class XWriterCapability : ExpansionCapability {
    override val id: String = "core.settings.writer"
    override val area: String = "core.settings"
    override val purpose: String = "Writer capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
