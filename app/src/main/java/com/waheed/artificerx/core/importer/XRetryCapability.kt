...
/**
 * Runtime capability implementation for core.importer.retry.
 *
...
class XRetryCapability : ExpansionCapability {
    override val id: String = "core.importer.retry"
    override val area: String = "core.importer"
    override val purpose: String = "Retry capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
