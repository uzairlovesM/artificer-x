...
class XRetryCapability : ExpansionCapability {
    override val id = "core.importer.retry"
    override val area = "core.importer"
    override val purpose = "Retry capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
