...
/**
 * Runtime capability implementation for core.research.retry.
 *
...
class XRetryCapability : ExpansionCapability {
    override val id: String = "core.research.retry"
    override val area: String = "core.research"
    override val purpose: String = "Retry capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
