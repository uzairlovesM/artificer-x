...
/** Production expansion contract for Profiler. */
class XProfilerCapability : ExpansionCapability {
    override val id = "core.diagnostics.profiler"
    override val area = "core.diagnostics"
    override val purpose = "Profiler capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
