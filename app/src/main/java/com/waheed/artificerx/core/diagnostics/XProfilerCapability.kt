...
/**
 * Runtime capability implementation for core.diagnostics.profiler.
 *
 ...
 */
class XProfilerCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.profiler"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Profiler capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
