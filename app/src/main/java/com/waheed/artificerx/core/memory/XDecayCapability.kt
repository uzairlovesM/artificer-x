...
/** Production expansion contract for Decay. */
class XDecayCapability : ExpansionCapability {
    override val id = "core.memory.decay"
    override val area = "core.memory"
    override val purpose = "Decay capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
