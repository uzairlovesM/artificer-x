...
/**
 * Runtime capability implementation for core.memory.decay.
 *
 ...
 */
class XDecayCapability : ExpansionCapability {
    override val id: String = "core.memory.decay"
    override val area: String = "core.memory"
    override val purpose: String = "Decay capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
