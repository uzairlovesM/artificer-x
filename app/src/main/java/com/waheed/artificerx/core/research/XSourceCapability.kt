...
/**
 * Runtime capability implementation for core.research.source.
 *
 ...
 */
class XSourceCapability : ExpansionCapability {
    override val id: String = "core.research.source"
    override val area: String = "core.research"
    override val purpose: String = "Source capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
