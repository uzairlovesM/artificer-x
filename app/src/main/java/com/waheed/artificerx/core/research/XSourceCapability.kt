...
class XSourceCapability : ExpansionCapability {
    override val id = "core.research.source"
    override val area = "core.research"
    override val purpose = "Source capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
