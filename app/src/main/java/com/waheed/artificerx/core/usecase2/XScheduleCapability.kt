...
/**
 * Runtime capability implementation for core.usecase2.schedule.
 *
 ...
 */
class XScheduleCapability : ExpansionCapability {
    override val id: String = "core.usecase2.schedule"
    override val area: String = "core.usecase2"
    override val purpose: String = "Schedule capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
