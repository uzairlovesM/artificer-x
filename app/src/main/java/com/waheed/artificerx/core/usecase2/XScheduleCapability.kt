...
/** Production expansion contract for Schedule. */
class XScheduleCapability : ExpansionCapability {
    override val id = "core.usecase2.schedule"
    override val area = "core.usecase2"
    override val purpose = "Schedule capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
