...
/**
 * Runtime capability implementation for core.settings.backup.
 *
...
class XBackupCapability : ExpansionCapability {
    override val id: String = "core.settings.backup"
    override val area: String = "core.settings"
    override val purpose: String = "Backup capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
