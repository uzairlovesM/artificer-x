...
/**
 * Runtime capability implementation for core.export.manga.
 *
...
class XMangaCapability : ExpansionCapability {
    override val id: String = "core.export.manga"
    override val area: String = "core.export"
    override val purpose: String = "Manga capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
