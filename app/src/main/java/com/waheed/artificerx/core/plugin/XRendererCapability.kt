...
/** Production expansion contract for Renderer. */
class XRendererCapability : ExpansionCapability {
    override val id = "core.plugin.renderer"
    override val area = "core.plugin"
    override val purpose = "Renderer capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
