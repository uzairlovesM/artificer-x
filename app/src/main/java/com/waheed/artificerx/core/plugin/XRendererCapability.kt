...
/**
 * Runtime capability implementation for core.plugin.renderer.
 *
 ...
 */
class XRendererCapability : ExpansionCapability {
    override val id: String = "core.plugin.renderer"
    override val area: String = "core.plugin"
    override val purpose: String = "Renderer capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
