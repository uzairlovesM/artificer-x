...
class XPermissionCapability : ExpansionCapability {
    override val id = "core.remoteagent.permission"
    override val area = "core.remoteagent"
    override val purpose = "Permission capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
