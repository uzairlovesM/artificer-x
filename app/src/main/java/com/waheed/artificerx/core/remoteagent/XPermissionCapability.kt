...
/**
 * Runtime capability implementation for core.remoteagent.permission.
 *
...
class XPermissionCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.permission"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Permission capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
