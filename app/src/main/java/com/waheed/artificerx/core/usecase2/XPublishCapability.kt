...
/**
 * Runtime capability implementation for core.usecase2.publish.
 *
 ...
 */
class XPublishCapability : ExpansionCapability {
    override val id: String = "core.usecase2.publish"
    override val area: String = "core.usecase2"
    override val purpose: String = "Publish capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
