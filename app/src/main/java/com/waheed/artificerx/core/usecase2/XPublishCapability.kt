...
/** Production expansion contract for Publish. */
class XPublishCapability : ExpansionCapability {
    override val id = "core.usecase2.publish"
    override val area = "core.usecase2"
    override val purpose = "Publish capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
