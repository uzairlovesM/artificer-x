...
/**
 * Runtime capability implementation for core.memory.semantic.
 *
 ...
 */
class XSemanticCapability : ExpansionCapability {
    override val id: String = "core.memory.semantic"
    override val area: String = "core.memory"
    override val purpose: String = "Semantic capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
