...
/** Production expansion contract for Semantic. */
class XSemanticCapability : ExpansionCapability {
    override val id = "core.memory.semantic"
    override val area = "core.memory"
    override val purpose = "Semantic capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
