...
class XRecoveryCapability : ExpansionCapability {
    override val id = "core.plugin.recovery"
    override val area = "core.plugin"
    override val purpose = "Recovery capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
