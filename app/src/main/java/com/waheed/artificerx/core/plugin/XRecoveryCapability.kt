...
/**
 * Runtime capability implementation for core.plugin.recovery.
 *
...
class XRecoveryCapability : ExpansionCapability {
    override val id: String = "core.plugin.recovery"
    override val area: String = "core.plugin"
    override val purpose: String = "Recovery capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
