...
class ExportExpansion : ExpansionCapability {
    override val id: String = "core.automation.export"
    override val area: String = "core.automation"
    override val purpose: String = "Export coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
