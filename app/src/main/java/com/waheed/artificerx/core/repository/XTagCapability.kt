...
/**
 * Runtime capability implementation for core.repository.tag.
 *
 ...
 */
class XTagCapability : ExpansionCapability {
    override val id: String = "core.repository.tag"
    override val area: String = "core.repository"
    override val purpose: String = "Tag capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
