...
class XTagCapability : ExpansionCapability {
    override val id = "core.repository.tag"
    override val area = "core.repository"
    override val purpose = "Tag capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
