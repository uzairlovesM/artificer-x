...
/** Production expansion contract for Profile. */
class XProfileCapability : ExpansionCapability {
    override val id = "core.navigation.profile"
    override val area = "core.navigation"
    override val purpose = "Profile capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
