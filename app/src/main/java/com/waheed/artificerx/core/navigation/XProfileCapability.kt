...
/**
 * Runtime capability implementation for core.navigation.profile.
 *
 ...
 */
class XProfileCapability : ExpansionCapability {
    override val id: String = "core.navigation.profile"
    override val area: String = "core.navigation"
    override val purpose: String = "Profile capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
