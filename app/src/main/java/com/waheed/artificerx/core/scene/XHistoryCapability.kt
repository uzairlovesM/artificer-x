...
/**
 * Runtime capability implementation for core.scene.history.
 *
...
class XHistoryCapability : ExpansionCapability {
    override val id: String = "core.scene.history"
    override val area: String = "core.scene"
    override val purpose: String = "History capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
