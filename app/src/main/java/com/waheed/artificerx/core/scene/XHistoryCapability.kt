...
class XHistoryCapability : ExpansionCapability {
    override val id = "core.scene.history"
    override val area = "core.scene"
    override val purpose = "History capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
