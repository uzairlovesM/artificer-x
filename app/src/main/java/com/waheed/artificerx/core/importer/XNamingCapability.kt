...
/**
 * Runtime capability implementation for core.importer.naming.
 *
 ...
 */
class XNamingCapability : ExpansionCapability {
    override val id: String = "core.importer.naming"
    override val area: String = "core.importer"
    override val purpose: String = "Naming capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
