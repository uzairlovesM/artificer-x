...
/** Production expansion contract for Naming. */
class XNamingCapability : ExpansionCapability {
    override val id = "core.importer.naming"
    override val area = "core.importer"
    override val purpose = "Naming capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
