...
class XSummaryCapability : ExpansionCapability {
    override val id = "core.memory.summary"
    override val area = "core.memory"
    override val purpose = "Summary capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
