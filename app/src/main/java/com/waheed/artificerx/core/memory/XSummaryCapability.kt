...
/**
 * Runtime capability implementation for core.memory.summary.
 *
...
class XSummaryCapability : ExpansionCapability {
    override val id: String = "core.memory.summary"
    override val area: String = "core.memory"
    override val purpose: String = "Summary capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
