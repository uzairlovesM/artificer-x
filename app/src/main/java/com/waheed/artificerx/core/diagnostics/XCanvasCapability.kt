...
/**
 * Runtime capability implementation for core.diagnostics.canvas.
 *
 ...
 */
class XCanvasCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.canvas"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Canvas capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
