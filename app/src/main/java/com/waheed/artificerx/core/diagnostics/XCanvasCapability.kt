...
/** Production expansion contract for Canvas. */
class XCanvasCapability : ExpansionCapability {
    override val id = "core.diagnostics.canvas"
    override val area = "core.diagnostics"
    override val purpose = "Canvas capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
