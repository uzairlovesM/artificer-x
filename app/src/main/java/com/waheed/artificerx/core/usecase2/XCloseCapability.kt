...
/** Production expansion contract for Close. */
class XCloseCapability : ExpansionCapability {
    override val id = "core.usecase2.close"
    override val area = "core.usecase2"
    override val purpose = "Close capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
