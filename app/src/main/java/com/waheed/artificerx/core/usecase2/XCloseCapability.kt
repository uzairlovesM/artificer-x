...
/**
 * Runtime capability implementation for core.usecase2.close.
 *
 ...
 */
class XCloseCapability : ExpansionCapability {
    override val id: String = "core.usecase2.close"
    override val area: String = "core.usecase2"
    override val purpose: String = "Close capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
