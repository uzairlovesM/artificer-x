...
/**
 * Runtime capability implementation for core.repository.conflict.
 *
 ...
 */
class XConflictCapability : ExpansionCapability {
    override val id: String = "core.repository.conflict"
    override val area: String = "core.repository"
    override val purpose: String = "Conflict capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
