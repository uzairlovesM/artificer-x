...
/** Production expansion contract for Conflict. */
class XConflictCapability : ExpansionCapability {
    override val id = "core.repository.conflict"
    override val area = "core.repository"
    override val purpose = "Conflict capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
