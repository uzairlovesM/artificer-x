...
class XMigrationCapability : ExpansionCapability {
    override val id = "core.settings.migration"
    override val area = "core.settings"
    override val purpose = "Migration capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
