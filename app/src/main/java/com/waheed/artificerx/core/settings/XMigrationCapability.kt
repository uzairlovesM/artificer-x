...
/**
 * Runtime capability implementation for core.settings.migration.
 *
 ...
 */
class XMigrationCapability : ExpansionCapability {
    override val id: String = "core.settings.migration"
    override val area: String = "core.settings"
    override val purpose: String = "Migration capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
