...
/** Production expansion contract for Diagnose. */
class XDiagnoseCapability : ExpansionCapability {
    override val id = "core.usecase2.diagnose"
    override val area = "core.usecase2"
    override val purpose = "Diagnose capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
