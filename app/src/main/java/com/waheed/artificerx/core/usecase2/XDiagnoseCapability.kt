...
/**
 * Runtime capability implementation for core.usecase2.diagnose.
 *
 ...
 */
class XDiagnoseCapability : ExpansionCapability {
    override val id: String = "core.usecase2.diagnose"
    override val area: String = "core.usecase2"
    override val purpose: String = "Diagnose capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
