...
/** Production expansion contract for Plugins. */
class XPluginsCapability : ExpansionCapability {
    override val id = "core.navigation.plugins"
    override val area = "core.navigation"
    override val purpose = "Plugins capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
