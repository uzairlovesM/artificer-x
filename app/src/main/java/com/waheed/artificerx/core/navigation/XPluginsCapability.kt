...
/**
 * Runtime capability implementation for core.navigation.plugins.
 *
 ...
 */
class XPluginsCapability : ExpansionCapability {
    override val id: String = "core.navigation.plugins"
    override val area: String = "core.navigation"
    override val purpose: String = "Plugins capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
