...
/** Production expansion contract for Overlay. */
class XOverlayCapability : ExpansionCapability {
    override val id = "core.navigation.overlay"
    override val area = "core.navigation"
    override val purpose = "Overlay capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
