...
/**
 * Runtime capability implementation for core.navigation.overlay.
 *
 ...
 */
class XOverlayCapability : ExpansionCapability {
    override val id: String = "core.navigation.overlay"
    override val area: String = "core.navigation"
    override val purpose: String = "Overlay capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
