...
class XModelCapability : ExpansionCapability {
    override val id = "core.settings.model"
    override val area = "core.settings"
    override val purpose = "Model capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
