...
/**
 * Runtime capability implementation for core.settings.model.
 *
...
class XModelCapability : ExpansionCapability {
    override val id: String = "core.settings.model"
    override val area: String = "core.settings"
    override val purpose: String = "Model capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
