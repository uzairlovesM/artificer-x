...
/** Production expansion contract for Seed. */
class XSeedCapability : ExpansionCapability {
    override val id = "core.model.seed"
    override val area = "core.model"
    override val purpose = "Seed capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
