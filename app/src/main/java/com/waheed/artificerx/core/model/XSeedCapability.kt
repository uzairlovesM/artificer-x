...
/**
 * Runtime capability implementation for core.model.seed.
 *
 ...
 */
class XSeedCapability : ExpansionCapability {
    override val id: String = "core.model.seed"
    override val area: String = "core.model"
    override val purpose: String = "Seed capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
