...
/** Production expansion contract for Patch. */
class XPatchCapability : ExpansionCapability {
    override val id = "core.repository.patch"
    override val area = "core.repository"
    override val purpose = "Patch capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
