...
/**
 * Runtime capability implementation for core.repository.patch.
 *
 ...
 */
class XPatchCapability : ExpansionCapability {
    override val id: String = "core.repository.patch"
    override val area: String = "core.repository"
    override val purpose: String = "Patch capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
