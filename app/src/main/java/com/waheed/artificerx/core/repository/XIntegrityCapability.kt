...
/**
 * Runtime capability implementation for core.repository.integrity.
 *
...
class XIntegrityCapability : ExpansionCapability {
    override val id: String = "core.repository.integrity"
    override val area: String = "core.repository"
    override val purpose: String = "Integrity capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
