...
class XIntegrityCapability : ExpansionCapability {
    override val id = "core.repository.integrity"
    override val area = "core.repository"
    override val purpose = "Integrity capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
