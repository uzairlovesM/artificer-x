...
/** Production expansion contract for Navigation. */
class XNavigationCapability : ExpansionCapability {
    override val id = "core.diagnostics.navigation"
    override val area = "core.diagnostics"
    override val purpose = "Navigation capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
