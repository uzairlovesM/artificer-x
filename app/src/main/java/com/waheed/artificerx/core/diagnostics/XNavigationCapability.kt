...
/**
 * Runtime capability implementation for core.diagnostics.navigation.
 *
 ...
 */
class XNavigationCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.navigation"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Navigation capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
