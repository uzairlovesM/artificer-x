...
/** Production expansion contract for Error. */
class XErrorCapability : ExpansionCapability {
    override val id = "core.remoteagent.error"
    override val area = "core.remoteagent"
    override val purpose = "Error capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
