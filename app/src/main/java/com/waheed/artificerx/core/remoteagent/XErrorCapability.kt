...
/**
 * Runtime capability implementation for core.remoteagent.error.
 *
...
class XErrorCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.error"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Error capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
