...
/**
 * Runtime capability implementation for core.model.search.
 *
...
class XSearchCapability : ExpansionCapability {
    override val id: String = "core.model.search"
    override val area: String = "core.model"
    override val purpose: String = "Search capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
