...
class NativeWavExpansion : ExpansionCapability {
    override val id: String = "core.native.nativewav"
    override val area: String = "core.native"
    override val purpose: String = "NativeWav coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
