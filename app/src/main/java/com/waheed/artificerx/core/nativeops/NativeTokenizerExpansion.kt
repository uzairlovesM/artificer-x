...
class NativeTokenizerExpansion : ExpansionCapability {
    override val id: String = "core.nativeops.nativetokenizer"
    override val area: String = "core.nativeops"
    override val purpose: String = "NativeTokenizer coordinates core.nativeops responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
