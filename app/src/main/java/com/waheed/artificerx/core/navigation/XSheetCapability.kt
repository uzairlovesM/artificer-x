...
/** Production expansion contract for Sheet. */
class XSheetCapability : ExpansionCapability {
    override val id = "core.navigation.sheet"
    override val area = "core.navigation"
    override val purpose = "Sheet capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
