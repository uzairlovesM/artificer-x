...
/**
 * Runtime capability implementation for core.navigation.sheet.
 *
 ...
 */
class XSheetCapability : ExpansionCapability {
    override val id: String = "core.navigation.sheet"
    override val area: String = "core.navigation"
    override val purpose: String = "Sheet capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
