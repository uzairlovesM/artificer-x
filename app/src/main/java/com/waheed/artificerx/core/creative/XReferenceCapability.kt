...
/** Production expansion contract for Reference. */
class XReferenceCapability : ExpansionCapability {
    override val id = "core.creative.reference"
    override val area = "core.creative"
    override val purpose = "Reference capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
