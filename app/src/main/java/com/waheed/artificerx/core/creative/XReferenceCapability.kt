...
/**
 * Runtime capability implementation for core.creative.reference.
 *
 ...
 */
class XReferenceCapability : ExpansionCapability {
    override val id: String = "core.creative.reference"
    override val area: String = "core.creative"
    override val purpose: String = "Reference capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
