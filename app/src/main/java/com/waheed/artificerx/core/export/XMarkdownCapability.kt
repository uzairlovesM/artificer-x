...
/**
 * Runtime capability implementation for core.export.markdown.
 *
...
class XMarkdownCapability : ExpansionCapability {
    override val id: String = "core.export.markdown"
    override val area: String = "core.export"
    override val purpose: String = "Markdown capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
