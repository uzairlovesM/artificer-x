...
class XMarkdownCapability : ExpansionCapability {
    override val id = "core.export.markdown"
    override val area = "core.export"
    override val purpose = "Markdown capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
