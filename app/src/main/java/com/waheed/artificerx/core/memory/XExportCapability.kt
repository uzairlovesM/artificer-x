...
/**
 * Runtime capability implementation for core.memory.export.
 *
...
class XExportCapability : ExpansionCapability {
    override val id: String = "core.memory.export"
    override val area: String = "core.memory"
    override val purpose: String = "Export capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
