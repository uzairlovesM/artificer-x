...
class XExportCapability : ExpansionCapability {
    override val id = "core.memory.export"
    override val area = "core.memory"
    override val purpose = "Export capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
