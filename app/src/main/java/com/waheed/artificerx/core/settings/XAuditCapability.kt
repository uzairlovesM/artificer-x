...
/**
 * Runtime capability implementation for core.settings.audit.
 *
...
class XAuditCapability : ExpansionCapability {
    override val id: String = "core.settings.audit"
    override val area: String = "core.settings"
    override val purpose: String = "Audit capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
