...
class XAuditCapability : ExpansionCapability {
    override val id = "core.settings.audit"
    override val area = "core.settings"
    override val purpose = "Audit capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
