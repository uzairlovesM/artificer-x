...
/**
 * Runtime capability implementation for core.usecase2.update.
 *
 ...
 */
class XUpdateCapability : ExpansionCapability {
    override val id: String = "core.usecase2.update"
    override val area: String = "core.usecase2"
    override val purpose: String = "Update capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
