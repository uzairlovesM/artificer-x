...
/** Production expansion contract for Update. */
class XUpdateCapability : ExpansionCapability {
    override val id = "core.usecase2.update"
    override val area = "core.usecase2"
    override val purpose = "Update capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
