...
class XSpriteCapability : ExpansionCapability {
    override val id = "core.export.sprite"
    override val area = "core.export"
    override val purpose = "Sprite capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
