...
/**
 * Runtime capability implementation for core.export.sprite.
 *
...
class XSpriteCapability : ExpansionCapability {
    override val id: String = "core.export.sprite"
    override val area: String = "core.export"
    override val purpose: String = "Sprite capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
