...
class XMigrationCapability : ExpansionCapability {
    override val id = "core.plugin.migration"
    override val area = "core.plugin"
    override val purpose = "Migration capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
