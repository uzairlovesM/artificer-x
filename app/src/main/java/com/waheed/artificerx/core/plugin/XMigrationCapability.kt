...
/**
 * Runtime capability implementation for core.plugin.migration.
 *
...
class XMigrationCapability : ExpansionCapability {
    override val id: String = "core.plugin.migration"
    override val area: String = "core.plugin"
    override val purpose: String = "Migration capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
