...
class XQueueCapability : ExpansionCapability {
    override val id = "core.research.queue"
    override val area = "core.research"
    override val purpose = "Queue capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
