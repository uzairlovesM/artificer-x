...
/**
 * Runtime capability implementation for core.research.queue.
 *
 ...
 */
class XQueueCapability : ExpansionCapability {
    override val id: String = "core.research.queue"
    override val area: String = "core.research"
    override val purpose: String = "Queue capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
