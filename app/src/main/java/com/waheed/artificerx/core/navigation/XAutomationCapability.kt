...
class XAutomationCapability : ExpansionCapability {
    override val id = "core.navigation.automation"
    override val area = "core.navigation"
    override val purpose = "Automation capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
