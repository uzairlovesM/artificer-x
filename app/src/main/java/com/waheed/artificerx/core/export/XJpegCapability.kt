...
/**
 * Runtime capability implementation for core.export.jpeg.
 *
...
class XJpegCapability : ExpansionCapability {
    override val id: String = "core.export.jpeg"
    override val area: String = "core.export"
    override val purpose: String = "Jpeg capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
