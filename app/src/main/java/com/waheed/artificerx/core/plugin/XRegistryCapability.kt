...
/**
 * Runtime capability implementation for core.plugin.registry.
 *
 ...
 */
class XRegistryCapability : ExpansionCapability {
    override val id: String = "core.plugin.registry"
    override val area: String = "core.plugin"
    override val purpose: String = "Registry capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
