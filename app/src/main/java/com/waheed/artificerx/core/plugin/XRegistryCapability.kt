...
/** Production expansion contract for Registry. */
class XRegistryCapability : ExpansionCapability {
    override val id = "core.plugin.registry"
    override val area = "core.plugin"
    override val purpose = "Registry capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
