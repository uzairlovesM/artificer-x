...
/** Production expansion contract for DragDrop. */
class XDragDropCapability : ExpansionCapability {
    override val id = "core.importer.dragdrop"
    override val area = "core.importer"
    override val purpose = "DragDrop capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
