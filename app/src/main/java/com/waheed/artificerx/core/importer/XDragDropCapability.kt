...
/**
 * Runtime capability implementation for core.importer.dragdrop.
 *
 ...
 */
class XDragDropCapability : ExpansionCapability {
    override val id: String = "core.importer.dragdrop"
    override val area: String = "core.importer"
    override val purpose: String = "DragDrop capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
