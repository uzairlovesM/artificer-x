...
/**
 * Runtime capability implementation for core.settings.manga.
 *
...
class XMangaCapability : ExpansionCapability {
    override val id: String = "core.settings.manga"
    override val area: String = "core.settings"
    override val purpose: String = "Manga capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
