...
class XMangaCapability : ExpansionCapability {
    override val id = "core.settings.manga"
    override val area = "core.settings"
    override val purpose = "Manga capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
