...
/**
 * Runtime capability implementation for core.storage.transaction.
 *
 ...
 */
class XTransactionCapability : ExpansionCapability {
    override val id: String = "core.storage.transaction"
    override val area: String = "core.storage"
    override val purpose: String = "Transaction capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
