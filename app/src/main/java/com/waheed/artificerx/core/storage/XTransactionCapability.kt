...
/** Production expansion contract for Transaction. */
class XTransactionCapability : ExpansionCapability {
    override val id = "core.storage.transaction"
    override val area = "core.storage"
    override val purpose = "Transaction capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
