...
/**
 * Runtime capability implementation for core.remoteagent.scheduler.
 *
...
class XSchedulerCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.scheduler"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Scheduler capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
