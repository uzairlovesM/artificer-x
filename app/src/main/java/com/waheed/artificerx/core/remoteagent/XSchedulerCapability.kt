...
/** Production expansion contract for Scheduler. */
class XSchedulerCapability : ExpansionCapability {
    override val id = "core.remoteagent.scheduler"
    override val area = "core.remoteagent"
    override val purpose = "Scheduler capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
