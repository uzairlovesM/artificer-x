...
/**
 * Runtime capability implementation for core.usecase2.approve.
 *
 ...
 */
class XApproveCapability : ExpansionCapability {
    override val id: String = "core.usecase2.approve"
    override val area: String = "core.usecase2"
    override val purpose: String = "Approve capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
