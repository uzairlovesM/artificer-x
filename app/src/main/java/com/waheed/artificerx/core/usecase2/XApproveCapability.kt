...
/** Production expansion contract for Approve. */
class XApproveCapability : ExpansionCapability {
    override val id = "core.usecase2.approve"
    override val area = "core.usecase2"
    override val purpose = "Approve capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
