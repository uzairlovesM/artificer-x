...
/**
 * Runtime capability implementation for core.repository.grep.
 *
 ...
 */
class XGrepCapability : ExpansionCapability {
    override val id: String = "core.repository.grep"
    override val area: String = "core.repository"
    override val purpose: String = "Grep capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
