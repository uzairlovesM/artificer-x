...
/** Production expansion contract for Grep. */
class XGrepCapability : ExpansionCapability {
    override val id = "core.repository.grep"
    override val area = "core.repository"
    override val purpose = "Grep capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
