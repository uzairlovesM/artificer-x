...
/** Production expansion contract for Delete. */
class XDeleteCapability : ExpansionCapability {
    override val id = "core.usecase2.delete"
    override val area = "core.usecase2"
    override val purpose = "Delete capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
