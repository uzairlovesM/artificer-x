...
/**
 * Runtime capability implementation for core.usecase2.delete.
 *
 ...
 */
class XDeleteCapability : ExpansionCapability {
    override val id: String = "core.usecase2.delete"
    override val area: String = "core.usecase2"
    override val purpose: String = "Delete capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
