...
/**
 * Runtime capability implementation for core.creative.timing.
 *
 ...
 */
class XTimingCapability : ExpansionCapability {
    override val id: String = "core.creative.timing"
    override val area: String = "core.creative"
    override val purpose: String = "Timing capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
