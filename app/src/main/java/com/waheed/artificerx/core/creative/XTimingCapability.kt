...
/** Production expansion contract for Timing. */
class XTimingCapability : ExpansionCapability {
    override val id = "core.creative.timing"
    override val area = "core.creative"
    override val purpose = "Timing capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
