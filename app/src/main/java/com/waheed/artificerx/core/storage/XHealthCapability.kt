...
class XHealthCapability : ExpansionCapability {
    override val id = "core.storage.health"
    override val area = "core.storage"
    override val purpose = "Health capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
