...
/**
 * Runtime capability implementation for core.storage.health.
 *
...
class XHealthCapability : ExpansionCapability {
    override val id: String = "core.storage.health"
    override val area: String = "core.storage"
    override val purpose: String = "Health capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
