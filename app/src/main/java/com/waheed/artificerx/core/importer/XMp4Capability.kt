...
/** Production expansion contract for Mp4. */
class XMp4Capability : ExpansionCapability {
    override val id = "core.importer.mp4"
    override val area = "core.importer"
    override val purpose = "Mp4 capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
