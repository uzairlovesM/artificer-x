...
/**
 * Runtime capability implementation for core.importer.mp4.
 *
 ...
 */
class XMp4Capability : ExpansionCapability {
    override val id: String = "core.importer.mp4"
    override val area: String = "core.importer"
    override val purpose: String = "Mp4 capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
