...
/** Production expansion contract for Compatibility. */
class XCompatibilityCapability : ExpansionCapability {
    override val id = "core.plugin.compatibility"
    override val area = "core.plugin"
    override val purpose = "Compatibility capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
