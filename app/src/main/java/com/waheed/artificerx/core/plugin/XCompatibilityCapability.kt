...
/**
 * Runtime capability implementation for core.plugin.compatibility.
 *
 ...
 */
class XCompatibilityCapability : ExpansionCapability {
    override val id: String = "core.plugin.compatibility"
    override val area: String = "core.plugin"
    override val purpose: String = "Compatibility capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
