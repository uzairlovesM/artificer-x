...
/** Production expansion contract for Task. */
class XTaskCapability : ExpansionCapability {
    override val id = "core.memory.task"
    override val area = "core.memory"
    override val purpose = "Task capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
