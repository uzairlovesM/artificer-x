...
/**
 * Runtime capability implementation for core.memory.task.
 *
 ...
 */
class XTaskCapability : ExpansionCapability {
    override val id: String = "core.memory.task"
    override val area: String = "core.memory"
    override val purpose: String = "Task capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
