...
/**
 * Runtime capability implementation for core.repository.network.
 *
...
class XNetworkCapability : ExpansionCapability {
    override val id: String = "core.repository.network"
    override val area: String = "core.repository"
    override val purpose: String = "Network capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
