...
class XNetworkCapability : ExpansionCapability {
    override val id = "core.repository.network"
    override val area = "core.repository"
    override val purpose = "Network capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
