...
/**
 * Runtime capability implementation for core.navigation.workspace.
 *
 ...
 */
class XWorkspaceCapability : ExpansionCapability {
    override val id: String = "core.navigation.workspace"
    override val area: String = "core.navigation"
    override val purpose: String = "Workspace capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
