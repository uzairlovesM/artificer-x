...
class XWorkspaceCapability : ExpansionCapability {
    override val id = "core.navigation.workspace"
    override val area = "core.navigation"
    override val purpose = "Workspace capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
