...
/** Production expansion contract for Research. */
class XResearchCapability : ExpansionCapability {
    override val id = "core.remoteagent.research"
    override val area = "core.remoteagent"
    override val purpose = "Research capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
