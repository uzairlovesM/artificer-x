...
/**
 * Runtime capability implementation for core.remoteagent.research.
 *
...
class XResearchCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.research"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Research capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
