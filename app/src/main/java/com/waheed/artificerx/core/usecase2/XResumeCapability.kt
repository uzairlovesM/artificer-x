...
/**
 * Runtime capability implementation for core.usecase2.resume.
 *
 ...
 */
class XResumeCapability : ExpansionCapability {
    override val id: String = "core.usecase2.resume"
    override val area: String = "core.usecase2"
    override val purpose: String = "Resume capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
