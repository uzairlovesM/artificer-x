...
/** Production expansion contract for Resume. */
class XResumeCapability : ExpansionCapability {
    override val id = "core.usecase2.resume"
    override val area = "core.usecase2"
    override val purpose = "Resume capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
