...
/**
 * Runtime capability implementation for core.remoteagent.fallback.
 *
...
class XFallbackCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.fallback"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Fallback capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
