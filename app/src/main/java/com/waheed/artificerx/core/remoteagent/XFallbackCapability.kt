...
/** Production expansion contract for Fallback. */
class XFallbackCapability : ExpansionCapability {
    override val id = "core.remoteagent.fallback"
    override val area = "core.remoteagent"
    override val purpose = "Fallback capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
