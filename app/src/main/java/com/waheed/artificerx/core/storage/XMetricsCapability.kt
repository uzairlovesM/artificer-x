...
/**
 * Runtime capability implementation for core.storage.metrics.
 *
...
class XMetricsCapability : ExpansionCapability {
    override val id: String = "core.storage.metrics"
    override val area: String = "core.storage"
    override val purpose: String = "Metrics capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
