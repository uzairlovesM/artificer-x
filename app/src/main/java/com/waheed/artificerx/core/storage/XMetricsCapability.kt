...
/** Production expansion contract for Metrics. */
class XMetricsCapability : ExpansionCapability {
    override val id = "core.storage.metrics"
    override val area = "core.storage"
    override val purpose = "Metrics capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
