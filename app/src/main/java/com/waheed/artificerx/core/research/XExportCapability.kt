...
/**
 * Runtime capability implementation for core.research.export.
 *
...
class XExportCapability : ExpansionCapability {
    override val id: String = "core.research.export"
    override val area: String = "core.research"
    override val purpose: String = "Export capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
