...
class XExportCapability : ExpansionCapability {
    override val id = "core.research.export"
    override val area = "core.research"
    override val purpose = "Export capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
