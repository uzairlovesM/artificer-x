...
/**
 * Runtime capability implementation for core.model.telemetry.
 *
...
class XTelemetryCapability : ExpansionCapability {
    override val id: String = "core.model.telemetry"
    override val area: String = "core.model"
    override val purpose: String = "Telemetry capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
