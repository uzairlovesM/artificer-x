...
class XTelemetryCapability : ExpansionCapability {
    override val id = "core.model.telemetry"
    override val area = "core.model"
    override val purpose = "Telemetry capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
