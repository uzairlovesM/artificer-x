...
/** Production expansion contract for Character. */
class XCharacterCapability : ExpansionCapability {
    override val id = "core.creative.character"
    override val area = "core.creative"
    override val purpose = "Character capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
