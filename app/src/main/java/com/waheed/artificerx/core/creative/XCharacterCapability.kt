...
/**
 * Runtime capability implementation for core.creative.character.
 *
 ...
 */
class XCharacterCapability : ExpansionCapability {
    override val id: String = "core.creative.character"
    override val area: String = "core.creative"
    override val purpose: String = "Character capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
