...
/** Production expansion contract for ColorScript. */
class XColorScriptCapability : ExpansionCapability {
    override val id = "core.creative.colorscript"
    override val area = "core.creative"
    override val purpose = "ColorScript capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
