...
/**
 * Runtime capability implementation for core.creative.colorscript.
 *
 ...
 */
class XColorScriptCapability : ExpansionCapability {
    override val id: String = "core.creative.colorscript"
    override val area: String = "core.creative"
    override val purpose: String = "ColorScript capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
