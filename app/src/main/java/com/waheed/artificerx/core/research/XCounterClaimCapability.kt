...
/**
 * Runtime capability implementation for core.research.counterclaim.
 *
 ...
 */
class XCounterClaimCapability : ExpansionCapability {
    override val id: String = "core.research.counterclaim"
    override val area: String = "core.research"
    override val purpose: String = "CounterClaim capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
