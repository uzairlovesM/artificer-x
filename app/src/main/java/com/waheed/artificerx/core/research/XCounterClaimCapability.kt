...
/** Production expansion contract for CounterClaim. */
class XCounterClaimCapability : ExpansionCapability {
    override val id = "core.research.counterclaim"
    override val area = "core.research"
    override val purpose = "CounterClaim capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
