...
/**
 * Runtime capability implementation for core.research.embedding.
 *
 ...
 */
class XEmbeddingCapability : ExpansionCapability {
    override val id: String = "core.research.embedding"
    override val area: String = "core.research"
    override val purpose: String = "Embedding capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
