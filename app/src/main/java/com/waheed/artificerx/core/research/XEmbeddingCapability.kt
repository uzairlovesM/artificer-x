...
/** Production expansion contract for Embedding. */
class XEmbeddingCapability : ExpansionCapability {
    override val id = "core.research.embedding"
    override val area = "core.research"
    override val purpose = "Embedding capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
