...
/** Production expansion contract for Checkpoint. */
class XCheckpointCapability : ExpansionCapability {
    override val id = "core.remoteagent.checkpoint"
    override val area = "core.remoteagent"
    override val purpose = "Checkpoint capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
