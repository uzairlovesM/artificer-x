...
/**
 * Runtime capability implementation for core.remoteagent.checkpoint.
 *
...
class XCheckpointCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.checkpoint"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Checkpoint capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
