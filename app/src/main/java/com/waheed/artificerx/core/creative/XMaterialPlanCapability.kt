...
/**
 * Runtime capability implementation for core.creative.materialplan.
 *
 ...
 */
class XMaterialPlanCapability : ExpansionCapability {
    override val id: String = "core.creative.materialplan"
    override val area: String = "core.creative"
    override val purpose: String = "MaterialPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
