...
/** Production expansion contract for MaterialPlan. */
class XMaterialPlanCapability : ExpansionCapability {
    override val id = "core.creative.materialplan"
    override val area = "core.creative"
    override val purpose = "MaterialPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
