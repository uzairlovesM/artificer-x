...
/**
 * Runtime capability implementation for core.remoteagent.artifact.
 *
...
class XArtifactCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.artifact"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Artifact capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
