...
class XArtifactCapability : ExpansionCapability {
    override val id = "core.remoteagent.artifact"
    override val area = "core.remoteagent"
    override val purpose = "Artifact capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
