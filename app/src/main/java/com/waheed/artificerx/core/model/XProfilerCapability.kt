...
/**
 * Runtime capability implementation for core.model.profiler.
 *
...
class XProfilerCapability : ExpansionCapability {
    override val id: String = "core.model.profiler"
    override val area: String = "core.model"
    override val purpose: String = "Profiler capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
