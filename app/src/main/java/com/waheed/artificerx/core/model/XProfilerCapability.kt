...
class XProfilerCapability : ExpansionCapability {
    override val id = "core.model.profiler"
    override val area = "core.model"
    override val purpose = "Profiler capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
