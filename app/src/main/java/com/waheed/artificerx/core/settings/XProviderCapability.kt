...
/**
 * Runtime capability implementation for core.settings.provider.
 *
...
class XProviderCapability : ExpansionCapability {
    override val id: String = "core.settings.provider"
    override val area: String = "core.settings"
    override val purpose: String = "Provider capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
