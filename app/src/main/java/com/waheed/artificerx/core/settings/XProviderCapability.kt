...
class XProviderCapability : ExpansionCapability {
    override val id = "core.settings.provider"
    override val area = "core.settings"
    override val purpose = "Provider capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
