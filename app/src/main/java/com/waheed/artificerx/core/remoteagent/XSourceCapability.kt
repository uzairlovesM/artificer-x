...
/**
 * Runtime capability implementation for core.remoteagent.source.
 *
...
class XSourceCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.source"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Source capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
