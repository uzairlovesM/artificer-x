...
/** Production expansion contract for Source. */
class XSourceCapability : ExpansionCapability {
    override val id = "core.remoteagent.source"
    override val area = "core.remoteagent"
    override val purpose = "Source capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
