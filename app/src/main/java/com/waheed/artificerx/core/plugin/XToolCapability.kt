...
/**
 * Runtime capability implementation for core.plugin.tool.
 *
...
class XToolCapability : ExpansionCapability {
    override val id: String = "core.plugin.tool"
    override val area: String = "core.plugin"
    override val purpose: String = "Tool capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
