...
class XChecksumCapability : ExpansionCapability {
    override val id = "core.export.checksum"
    override val area = "core.export"
    override val purpose = "Checksum capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
