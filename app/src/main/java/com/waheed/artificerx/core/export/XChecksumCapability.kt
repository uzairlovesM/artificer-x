...
/**
 * Runtime capability implementation for core.export.checksum.
 *
...
class XChecksumCapability : ExpansionCapability {
    override val id: String = "core.export.checksum"
    override val area: String = "core.export"
    override val purpose: String = "Checksum capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
