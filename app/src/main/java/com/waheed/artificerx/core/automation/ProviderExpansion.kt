...
class ProviderExpansion : ExpansionCapability {
    override val id: String = "core.automation.provider"
    override val area: String = "core.automation"
    override val purpose: String = "Provider coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
