...
/**
 * Runtime capability implementation for core.diagnostics.automation.
 *
 ...
 */
class XAutomationCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.automation"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Automation capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
