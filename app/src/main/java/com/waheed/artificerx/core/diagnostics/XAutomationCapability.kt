...
/** Production expansion contract for Automation. */
class XAutomationCapability : ExpansionCapability {
    override val id = "core.diagnostics.automation"
    override val area = "core.diagnostics"
    override val purpose = "Automation capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
