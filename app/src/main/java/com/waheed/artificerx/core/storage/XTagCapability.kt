...
/** Production expansion contract for Tag. */
class XTagCapability : ExpansionCapability {
    override val id = "core.storage.tag"
    override val area = "core.storage"
    override val purpose = "Tag capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
