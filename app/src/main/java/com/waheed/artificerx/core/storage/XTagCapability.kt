...
/**
 * Runtime capability implementation for core.storage.tag.
 *
...
class XTagCapability : ExpansionCapability {
    override val id: String = "core.storage.tag"
    override val area: String = "core.storage"
    override val purpose: String = "Tag capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
