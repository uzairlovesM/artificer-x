...
/**
 * Runtime capability implementation for core.plugin.loader.
 *
 ...
 */
class XLoaderCapability : ExpansionCapability {
    override val id: String = "core.plugin.loader"
    override val area: String = "core.plugin"
    override val purpose: String = "Loader capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
