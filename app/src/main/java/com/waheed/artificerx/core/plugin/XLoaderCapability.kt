...
/** Production expansion contract for Loader. */
class XLoaderCapability : ExpansionCapability {
    override val id = "core.plugin.loader"
    override val area = "core.plugin"
    override val purpose = "Loader capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
