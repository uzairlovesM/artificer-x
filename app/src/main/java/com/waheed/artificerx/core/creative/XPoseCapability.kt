...
/** Production expansion contract for Pose. */
class XPoseCapability : ExpansionCapability {
    override val id = "core.creative.pose"
    override val area = "core.creative"
    override val purpose = "Pose capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
