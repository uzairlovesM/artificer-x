...
/**
 * Runtime capability implementation for core.creative.pose.
 *
 ...
 */
class XPoseCapability : ExpansionCapability {
    override val id: String = "core.creative.pose"
    override val area: String = "core.creative"
    override val purpose: String = "Pose capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
