...
/** Production expansion contract for WorkingTree. */
class XWorkingTreeCapability : ExpansionCapability {
    override val id = "core.repository.workingtree"
    override val area = "core.repository"
    override val purpose = "WorkingTree capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
