...
/**
 * Runtime capability implementation for core.repository.workingtree.
 *
 ...
 */
class XWorkingTreeCapability : ExpansionCapability {
    override val id: String = "core.repository.workingtree"
    override val area: String = "core.repository"
    override val purpose: String = "WorkingTree capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
