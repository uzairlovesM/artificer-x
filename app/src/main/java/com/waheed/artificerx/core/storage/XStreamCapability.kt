...
/** Production expansion contract for Stream. */
class XStreamCapability : ExpansionCapability {
    override val id = "core.storage.stream"
    override val area = "core.storage"
    override val purpose = "Stream capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
