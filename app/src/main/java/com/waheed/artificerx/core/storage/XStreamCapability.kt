...
/**
 * Runtime capability implementation for core.storage.stream.
 *
 ...
 */
class XStreamCapability : ExpansionCapability {
    override val id: String = "core.storage.stream"
    override val area: String = "core.storage"
    override val purpose: String = "Stream capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
