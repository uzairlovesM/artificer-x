...
/**
 * Runtime capability implementation for core.importer.gif.
 *
 ...
 */
class XGifCapability : ExpansionCapability {
    override val id: String = "core.importer.gif"
    override val area: String = "core.importer"
    override val purpose: String = "Gif capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
