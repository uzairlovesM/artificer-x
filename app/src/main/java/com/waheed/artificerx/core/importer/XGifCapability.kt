...
/** Production expansion contract for Gif. */
class XGifCapability : ExpansionCapability {
    override val id = "core.importer.gif"
    override val area = "core.importer"
    override val purpose = "Gif capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
