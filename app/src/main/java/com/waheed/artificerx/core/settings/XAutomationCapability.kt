...
class XAutomationCapability : ExpansionCapability {
    override val id = "core.settings.automation"
    override val area = "core.settings"
    override val purpose = "Automation capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
