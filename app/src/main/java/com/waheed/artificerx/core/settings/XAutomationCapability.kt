...
/**
 * Runtime capability implementation for core.settings.automation.
 *
...
class XAutomationCapability : ExpansionCapability {
    override val id: String = "core.settings.automation"
    override val area: String = "core.settings"
    override val purpose: String = "Automation capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
