...
/**
 * Runtime capability implementation for core.usecase2.configure.
 *
 ...
 */
class XConfigureCapability : ExpansionCapability {
    override val id: String = "core.usecase2.configure"
    override val area: String = "core.usecase2"
    override val purpose: String = "Configure capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
