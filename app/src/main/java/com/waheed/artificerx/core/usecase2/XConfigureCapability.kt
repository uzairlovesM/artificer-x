...
/** Production expansion contract for Configure. */
class XConfigureCapability : ExpansionCapability {
    override val id = "core.usecase2.configure"
    override val area = "core.usecase2"
    override val purpose = "Configure capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
