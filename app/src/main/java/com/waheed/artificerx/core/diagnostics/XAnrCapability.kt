...
/**
 * Runtime capability implementation for core.diagnostics.anr.
 *
 ...
 */
class XAnrCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.anr"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Anr capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
