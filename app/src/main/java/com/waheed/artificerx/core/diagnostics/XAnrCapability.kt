...
/** Production expansion contract for Anr. */
class XAnrCapability : ExpansionCapability {
    override val id = "core.diagnostics.anr"
    override val area = "core.diagnostics"
    override val purpose = "Anr capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
