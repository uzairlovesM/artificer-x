...
/**
 * Runtime capability implementation for core.research.extractor.
 *
 ...
 */
class XExtractorCapability : ExpansionCapability {
    override val id: String = "core.research.extractor"
    override val area: String = "core.research"
    override val purpose: String = "Extractor capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
