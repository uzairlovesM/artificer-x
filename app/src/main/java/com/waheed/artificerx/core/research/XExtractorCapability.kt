...
/** Production expansion contract for Extractor. */
class XExtractorCapability : ExpansionCapability {
    override val id = "core.research.extractor"
    override val area = "core.research"
    override val purpose = "Extractor capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
