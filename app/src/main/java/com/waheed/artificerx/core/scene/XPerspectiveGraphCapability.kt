...
/** Production expansion contract for PerspectiveGraph. */
class XPerspectiveGraphCapability : ExpansionCapability {
    override val id = "core.scene.perspectivegraph"
    override val area = "core.scene"
    override val purpose = "PerspectiveGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
