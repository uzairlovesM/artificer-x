...
/**
 * Runtime capability implementation for core.scene.perspectivegraph.
 *
 ...
 */
class XPerspectiveGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.perspectivegraph"
    override val area: String = "core.scene"
    override val purpose: String = "PerspectiveGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
