...
/**
 * Runtime capability implementation for core.research.cache.
 *
...
class XCacheCapability : ExpansionCapability {
    override val id: String = "core.research.cache"
    override val area: String = "core.research"
    override val purpose: String = "Cache capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
