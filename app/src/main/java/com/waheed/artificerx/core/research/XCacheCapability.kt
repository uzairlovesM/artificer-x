...
class XCacheCapability : ExpansionCapability {
    override val id = "core.research.cache"
    override val area = "core.research"
    override val purpose = "Cache capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
