...
/**
 * Runtime capability implementation for core.model.audio.
 *
 ...
 */
class XAudioCapability : ExpansionCapability {
    override val id: String = "core.model.audio"
    override val area: String = "core.model"
    override val purpose: String = "Audio capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
