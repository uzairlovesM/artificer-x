...
/** Production expansion contract for Audio. */
class XAudioCapability : ExpansionCapability {
    override val id = "core.model.audio"
    override val area = "core.model"
    override val purpose = "Audio capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
