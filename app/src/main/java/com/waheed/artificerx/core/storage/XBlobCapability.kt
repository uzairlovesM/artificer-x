...
/**
 * Runtime capability implementation for core.storage.blob.
 *
 ...
 */
class XBlobCapability : ExpansionCapability {
    override val id: String = "core.storage.blob"
    override val area: String = "core.storage"
    override val purpose: String = "Blob capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
