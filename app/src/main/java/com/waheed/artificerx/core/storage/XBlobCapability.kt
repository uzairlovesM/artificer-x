...
/** Production expansion contract for Blob. */
class XBlobCapability : ExpansionCapability {
    override val id = "core.storage.blob"
    override val area = "core.storage"
    override val purpose = "Blob capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
