...
/**
 * Runtime capability implementation for core.settings.chat.
 *
...
class XChatCapability : ExpansionCapability {
    override val id: String = "core.settings.chat"
    override val area: String = "core.settings"
    override val purpose: String = "Chat capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
