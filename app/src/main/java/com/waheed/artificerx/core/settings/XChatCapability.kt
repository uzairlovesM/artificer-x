...
class XChatCapability : ExpansionCapability {
    override val id = "core.settings.chat"
    override val area = "core.settings"
    override val purpose = "Chat capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
