...
/**
 * Runtime capability implementation for core.diagnostics.cache.
 *
...
class XCacheCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.cache"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Cache capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
