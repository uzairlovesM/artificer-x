...
class XCacheCapability : ExpansionCapability {
    override val id = "core.diagnostics.cache"
    override val area = "core.diagnostics"
    override val purpose = "Cache capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
