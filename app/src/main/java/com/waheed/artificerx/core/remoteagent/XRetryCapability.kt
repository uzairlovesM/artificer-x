...
/**
 * Runtime capability implementation for core.remoteagent.retry.
 *
...
class XRetryCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.retry"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Retry capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
