...
class XRetryCapability : ExpansionCapability {
    override val id = "core.remoteagent.retry"
    override val area = "core.remoteagent"
    override val purpose = "Retry capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
