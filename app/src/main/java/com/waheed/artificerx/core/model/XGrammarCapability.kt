...
/** Production expansion contract for Grammar. */
class XGrammarCapability : ExpansionCapability {
    override val id = "core.model.grammar"
    override val area = "core.model"
    override val purpose = "Grammar capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
