...
/**
 * Runtime capability implementation for core.model.grammar.
 *
 ...
 */
class XGrammarCapability : ExpansionCapability {
    override val id: String = "core.model.grammar"
    override val area: String = "core.model"
    override val purpose: String = "Grammar capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
