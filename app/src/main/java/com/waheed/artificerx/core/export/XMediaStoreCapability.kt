...
class XMediaStoreCapability : ExpansionCapability {
    override val id = "core.export.mediastore"
    override val area = "core.export"
    override val purpose = "MediaStore capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
