...
/**
 * Runtime capability implementation for core.export.mediastore.
 *
...
class XMediaStoreCapability : ExpansionCapability {
    override val id: String = "core.export.mediastore"
    override val area: String = "core.export"
    override val purpose: String = "MediaStore capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
