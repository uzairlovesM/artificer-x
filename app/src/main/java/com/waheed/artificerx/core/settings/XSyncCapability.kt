...
class XSyncCapability : ExpansionCapability {
    override val id = "core.settings.sync"
    override val area = "core.settings"
    override val purpose = "Sync capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
