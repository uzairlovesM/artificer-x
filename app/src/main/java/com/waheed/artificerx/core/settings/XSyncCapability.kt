...
/**
 * Runtime capability implementation for core.settings.sync.
 *
...
class XSyncCapability : ExpansionCapability {
    override val id: String = "core.settings.sync"
    override val area: String = "core.settings"
    override val purpose: String = "Sync capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
