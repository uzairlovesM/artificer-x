...
/**
 * Runtime capability implementation for core.scene.recovery.
 *
...
class XRecoveryCapability : ExpansionCapability {
    override val id: String = "core.scene.recovery"
    override val area: String = "core.scene"
    override val purpose: String = "Recovery capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
