...
class XRecoveryCapability : ExpansionCapability {
    override val id = "core.scene.recovery"
    override val area = "core.scene"
    override val purpose = "Recovery capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
