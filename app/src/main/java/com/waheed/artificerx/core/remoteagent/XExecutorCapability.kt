...
/**
 * Runtime capability implementation for core.remoteagent.executor.
 *
...
class XExecutorCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.executor"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Executor capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
