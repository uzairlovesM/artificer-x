...
/** Production expansion contract for Executor. */
class XExecutorCapability : ExpansionCapability {
    override val id = "core.remoteagent.executor"
    override val area = "core.remoteagent"
    override val purpose = "Executor capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
