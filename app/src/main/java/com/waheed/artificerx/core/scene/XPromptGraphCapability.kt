...
/**
 * Runtime capability implementation for core.scene.promptgraph.
 *
 ...
 */
class XPromptGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.promptgraph"
    override val area: String = "core.scene"
    override val purpose: String = "PromptGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
