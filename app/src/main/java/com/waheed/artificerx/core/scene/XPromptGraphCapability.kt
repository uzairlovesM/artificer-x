...
/** Production expansion contract for PromptGraph. */
class XPromptGraphCapability : ExpansionCapability {
    override val id = "core.scene.promptgraph"
    override val area = "core.scene"
    override val purpose = "PromptGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
