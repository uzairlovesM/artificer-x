...
/** Production expansion contract for Crawler. */
class XCrawlerCapability : ExpansionCapability {
    override val id = "core.research.crawler"
    override val area = "core.research"
    override val purpose = "Crawler capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
