...
/**
 * Runtime capability implementation for core.research.crawler.
 *
 ...
 */
class XCrawlerCapability : ExpansionCapability {
    override val id: String = "core.research.crawler"
    override val area: String = "core.research"
    override val purpose: String = "Crawler capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
