...
/**
 * Runtime capability implementation for core.repository.clone.
 *
...
class XCloneCapability : ExpansionCapability {
    override val id: String = "core.repository.clone"
    override val area: String = "core.repository"
    override val purpose: String = "Clone capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
