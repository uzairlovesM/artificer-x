...
/** Production expansion contract for DetailPass. */
class XDetailPassCapability : ExpansionCapability {
    override val id = "core.scene.detailpass"
    override val area = "core.scene"
    override val purpose = "DetailPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
