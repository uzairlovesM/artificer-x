...
/**
 * Runtime capability implementation for core.scene.detailpass.
 *
 ...
 */
class XDetailPassCapability : ExpansionCapability {
    override val id: String = "core.scene.detailpass"
    override val area: String = "core.scene"
    override val purpose: String = "DetailPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
