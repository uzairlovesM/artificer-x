...
/**
 * Runtime capability implementation for core.usecase2.optimize.
 *
 ...
 */
class XOptimizeCapability : ExpansionCapability {
    override val id: String = "core.usecase2.optimize"
    override val area: String = "core.usecase2"
    override val purpose: String = "Optimize capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
