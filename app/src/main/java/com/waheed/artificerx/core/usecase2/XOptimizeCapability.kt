...
/** Production expansion contract for Optimize. */
class XOptimizeCapability : ExpansionCapability {
    override val id = "core.usecase2.optimize"
    override val area = "core.usecase2"
    override val purpose = "Optimize capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
