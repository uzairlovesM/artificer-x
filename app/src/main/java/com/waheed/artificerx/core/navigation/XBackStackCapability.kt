...
/** Production expansion contract for BackStack. */
class XBackStackCapability : ExpansionCapability {
    override val id = "core.navigation.backstack"
    override val area = "core.navigation"
    override val purpose = "BackStack capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
