...
/**
 * Runtime capability implementation for core.navigation.backstack.
 *
 ...
 */
class XBackStackCapability : ExpansionCapability {
    override val id: String = "core.navigation.backstack"
    override val area: String = "core.navigation"
    override val purpose: String = "BackStack capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
