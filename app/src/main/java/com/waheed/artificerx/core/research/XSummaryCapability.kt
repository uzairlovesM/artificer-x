...
/** Production expansion contract for Summary. */
class XSummaryCapability : ExpansionCapability {
    override val id = "core.research.summary"
    override val area = "core.research"
    override val purpose = "Summary capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
