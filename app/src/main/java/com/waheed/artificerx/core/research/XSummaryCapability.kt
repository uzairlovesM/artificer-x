...
/**
 * Runtime capability implementation for core.research.summary.
 *
 ...
 */
class XSummaryCapability : ExpansionCapability {
    override val id: String = "core.research.summary"
    override val area: String = "core.research"
    override val purpose: String = "Summary capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
