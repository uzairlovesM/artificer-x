...
class XManifestCapability : ExpansionCapability {
    override val id = "core.importer.manifest"
    override val area = "core.importer"
    override val purpose = "Manifest capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
