...
/**
 * Runtime capability implementation for core.importer.manifest.
 *
...
class XManifestCapability : ExpansionCapability {
    override val id: String = "core.importer.manifest"
    override val area: String = "core.importer"
    override val purpose: String = "Manifest capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
