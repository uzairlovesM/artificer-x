...
/**
 * Runtime capability implementation for core.scene.materialgraph.
 *
 ...
 */
class XMaterialGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.materialgraph"
    override val area: String = "core.scene"
    override val purpose: String = "MaterialGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
