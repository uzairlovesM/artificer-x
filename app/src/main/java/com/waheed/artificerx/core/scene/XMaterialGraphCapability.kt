...
/** Production expansion contract for MaterialGraph. */
class XMaterialGraphCapability : ExpansionCapability {
    override val id = "core.scene.materialgraph"
    override val area = "core.scene"
    override val purpose = "MaterialGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
