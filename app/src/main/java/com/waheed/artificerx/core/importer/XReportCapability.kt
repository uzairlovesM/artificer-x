...
/**
 * Runtime capability implementation for core.importer.report.
 *
...
class XReportCapability : ExpansionCapability {
    override val id: String = "core.importer.report"
    override val area: String = "core.importer"
    override val purpose: String = "Report capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
