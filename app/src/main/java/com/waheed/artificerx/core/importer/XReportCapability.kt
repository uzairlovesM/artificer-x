...
class XReportCapability : ExpansionCapability {
    override val id = "core.importer.report"
    override val area = "core.importer"
    override val purpose = "Report capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
