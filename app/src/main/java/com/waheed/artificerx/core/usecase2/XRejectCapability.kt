...
/**
 * Runtime capability implementation for core.usecase2.reject.
 *
 ...
 */
class XRejectCapability : ExpansionCapability {
    override val id: String = "core.usecase2.reject"
    override val area: String = "core.usecase2"
    override val purpose: String = "Reject capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
