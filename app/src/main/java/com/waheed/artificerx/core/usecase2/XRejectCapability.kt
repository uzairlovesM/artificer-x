...
/** Production expansion contract for Reject. */
class XRejectCapability : ExpansionCapability {
    override val id = "core.usecase2.reject"
    override val area = "core.usecase2"
    override val purpose = "Reject capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
