...
/** Production expansion contract for Validate. */
class XValidateCapability : ExpansionCapability {
    override val id = "core.importer.validate"
    override val area = "core.importer"
    override val purpose = "Validate capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
