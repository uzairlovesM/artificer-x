...
/**
 * Runtime capability implementation for core.importer.validate.
 *
...
class XValidateCapability : ExpansionCapability {
    override val id: String = "core.importer.validate"
    override val area: String = "core.importer"
    override val purpose: String = "Validate capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
