...
/**
 * Runtime capability implementation for core.navigation.checkpoint.
 *
 ...
 */
class XCheckpointCapability : ExpansionCapability {
    override val id: String = "core.navigation.checkpoint"
    override val area: String = "core.navigation"
    override val purpose: String = "Checkpoint capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
