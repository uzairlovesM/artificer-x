...
class XCheckpointCapability : ExpansionCapability {
    override val id = "core.navigation.checkpoint"
    override val area = "core.navigation"
    override val purpose = "Checkpoint capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
