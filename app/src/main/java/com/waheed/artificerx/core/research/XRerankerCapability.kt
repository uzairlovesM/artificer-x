...
/** Production expansion contract for Reranker. */
class XRerankerCapability : ExpansionCapability {
    override val id = "core.research.reranker"
    override val area = "core.research"
    override val purpose = "Reranker capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
