...
/**
 * Runtime capability implementation for core.research.reranker.
 *
 ...
 */
class XRerankerCapability : ExpansionCapability {
    override val id: String = "core.research.reranker"
    override val area: String = "core.research"
    override val purpose: String = "Reranker capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
