...
/** Production expansion contract for Claim. */
class XClaimCapability : ExpansionCapability {
    override val id = "core.research.claim"
    override val area = "core.research"
    override val purpose = "Claim capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
