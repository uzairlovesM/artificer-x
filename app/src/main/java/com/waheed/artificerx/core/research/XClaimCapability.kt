...
/**
 * Runtime capability implementation for core.research.claim.
 *
 ...
 */
class XClaimCapability : ExpansionCapability {
    override val id: String = "core.research.claim"
    override val area: String = "core.research"
    override val purpose: String = "Claim capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
