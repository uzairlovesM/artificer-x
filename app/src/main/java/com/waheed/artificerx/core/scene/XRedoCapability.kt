...
/** Production expansion contract for Redo. */
class XRedoCapability : ExpansionCapability {
    override val id = "core.scene.redo"
    override val area = "core.scene"
    override val purpose = "Redo capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
