...
/**
 * Runtime capability implementation for core.scene.redo.
 *
 ...
 */
class XRedoCapability : ExpansionCapability {
    override val id: String = "core.scene.redo"
    override val area: String = "core.scene"
    override val purpose: String = "Redo capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
