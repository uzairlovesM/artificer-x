...
/**
 * Runtime capability implementation for core.remoteagent.output.
 *
 ...
 */
class XOutputCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.output"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Output capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
