...
/** Production expansion contract for Output. */
class XOutputCapability : ExpansionCapability {
    override val id = "core.remoteagent.output"
    override val area = "core.remoteagent"
    override val purpose = "Output capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
