...
/**
 * Runtime capability implementation for core.settings.font.
 *
 ...
 */
class XFontCapability : ExpansionCapability {
    override val id: String = "core.settings.font"
    override val area: String = "core.settings"
    override val purpose: String = "Font capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
