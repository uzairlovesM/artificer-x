...
class XFontCapability : ExpansionCapability {
    override val id = "core.settings.font"
    override val area = "core.settings"
    override val purpose = "Font capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
