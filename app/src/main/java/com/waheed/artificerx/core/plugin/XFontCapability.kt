...
/**
 * Runtime capability implementation for core.plugin.font.
 *
...
class XFontCapability : ExpansionCapability {
    override val id: String = "core.plugin.font"
    override val area: String = "core.plugin"
    override val purpose: String = "Font capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
