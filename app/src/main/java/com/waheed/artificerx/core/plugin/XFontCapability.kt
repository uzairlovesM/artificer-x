...
/** Production expansion contract for Font. */
class XFontCapability : ExpansionCapability {
    override val id = "core.plugin.font"
    override val area = "core.plugin"
    override val purpose = "Font capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
