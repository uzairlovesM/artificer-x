...
/**
 * Runtime capability implementation for core.repository.auth.
 *
 ...
 */
class XAuthCapability : ExpansionCapability {
    override val id: String = "core.repository.auth"
    override val area: String = "core.repository"
    override val purpose: String = "Auth capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
