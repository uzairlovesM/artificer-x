...
/** Production expansion contract for Auth. */
class XAuthCapability : ExpansionCapability {
    override val id = "core.repository.auth"
    override val area = "core.repository"
    override val purpose = "Auth capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
