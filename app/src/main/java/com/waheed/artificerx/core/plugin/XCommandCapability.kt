...
/**
 * Runtime capability implementation for core.plugin.command.
 *
...
class XCommandCapability : ExpansionCapability {
    override val id: String = "core.plugin.command"
    override val area: String = "core.plugin"
    override val purpose: String = "Command capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
