...
/** Production expansion contract for Command. */
class XCommandCapability : ExpansionCapability {
    override val id = "core.plugin.command"
    override val area = "core.plugin"
    override val purpose = "Command capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
