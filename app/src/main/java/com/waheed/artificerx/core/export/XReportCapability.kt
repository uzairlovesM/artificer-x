...
class XReportCapability : ExpansionCapability {
    override val id = "core.export.report"
    override val area = "core.export"
    override val purpose = "Report capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
