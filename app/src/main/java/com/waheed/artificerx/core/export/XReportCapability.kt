...
/**
 * Runtime capability implementation for core.export.report.
 *
...
class XReportCapability : ExpansionCapability {
    override val id: String = "core.export.report"
    override val area: String = "core.export"
    override val purpose: String = "Report capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
