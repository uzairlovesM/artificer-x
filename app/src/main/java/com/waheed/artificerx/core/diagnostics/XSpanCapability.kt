...
/**
 * Runtime capability implementation for core.diagnostics.span.
 *
 ...
 */
class XSpanCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.span"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Span capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
