...
/** Production expansion contract for Span. */
class XSpanCapability : ExpansionCapability {
    override val id = "core.diagnostics.span"
    override val area = "core.diagnostics"
    override val purpose = "Span capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
