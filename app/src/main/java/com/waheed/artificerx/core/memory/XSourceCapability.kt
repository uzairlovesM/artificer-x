...
class XSourceCapability : ExpansionCapability {
    override val id = "core.memory.source"
    override val area = "core.memory"
    override val purpose = "Source capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
