...
/**
 * Runtime capability implementation for core.memory.source.
 *
...
class XSourceCapability : ExpansionCapability {
    override val id: String = "core.memory.source"
    override val area: String = "core.memory"
    override val purpose: String = "Source capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
