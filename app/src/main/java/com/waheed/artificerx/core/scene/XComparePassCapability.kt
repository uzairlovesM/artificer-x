...
/**
 * Runtime capability implementation for core.scene.comparepass.
 *
 ...
 */
class XComparePassCapability : ExpansionCapability {
    override val id: String = "core.scene.comparepass"
    override val area: String = "core.scene"
    override val purpose: String = "ComparePass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
