...
/** Production expansion contract for ComparePass. */
class XComparePassCapability : ExpansionCapability {
    override val id = "core.scene.comparepass"
    override val area = "core.scene"
    override val purpose = "ComparePass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
