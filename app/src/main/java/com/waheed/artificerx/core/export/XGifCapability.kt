...
/**
 * Runtime capability implementation for core.export.gif.
 *
...
class XGifCapability : ExpansionCapability {
    override val id: String = "core.export.gif"
    override val area: String = "core.export"
    override val purpose: String = "Gif capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
