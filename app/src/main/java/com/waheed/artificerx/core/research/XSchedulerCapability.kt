...
/**
 * Runtime capability implementation for core.research.scheduler.
 *
 ...
 */
class XSchedulerCapability : ExpansionCapability {
    override val id: String = "core.research.scheduler"
    override val area: String = "core.research"
    override val purpose: String = "Scheduler capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
