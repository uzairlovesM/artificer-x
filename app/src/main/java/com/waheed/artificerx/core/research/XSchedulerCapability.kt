...
class XSchedulerCapability : ExpansionCapability {
    override val id = "core.research.scheduler"
    override val area = "core.research"
    override val purpose = "Scheduler capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
