...
/** Production expansion contract for Precision. */
class XPrecisionCapability : ExpansionCapability {
    override val id = "core.model.precision"
    override val area = "core.model"
    override val purpose = "Precision capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
