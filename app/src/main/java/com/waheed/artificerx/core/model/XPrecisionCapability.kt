...
/**
 * Runtime capability implementation for core.model.precision.
 *
 ...
 */
class XPrecisionCapability : ExpansionCapability {
    override val id: String = "core.model.precision"
    override val area: String = "core.model"
    override val purpose: String = "Precision capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
