...
/** Production expansion contract for Network. */
class XNetworkCapability : ExpansionCapability {
    override val id = "core.diagnostics.network"
    override val area = "core.diagnostics"
    override val purpose = "Network capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
