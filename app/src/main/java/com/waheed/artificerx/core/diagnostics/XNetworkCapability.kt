...
/**
 * Runtime capability implementation for core.diagnostics.network.
 *
 ...
 */
class XNetworkCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.network"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Network capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
