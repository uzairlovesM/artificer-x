...
/**
 * Runtime capability implementation for core.plugin.deactivation.
 *
 ...
 */
class XDeactivationCapability : ExpansionCapability {
    override val id: String = "core.plugin.deactivation"
    override val area: String = "core.plugin"
    override val purpose: String = "Deactivation capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
