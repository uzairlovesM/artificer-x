...
/** Production expansion contract for Deactivation. */
class XDeactivationCapability : ExpansionCapability {
    override val id = "core.plugin.deactivation"
    override val area = "core.plugin"
    override val purpose = "Deactivation capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
