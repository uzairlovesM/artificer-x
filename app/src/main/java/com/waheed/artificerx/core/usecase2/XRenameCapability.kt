...
/** Production expansion contract for Rename. */
class XRenameCapability : ExpansionCapability {
    override val id = "core.usecase2.rename"
    override val area = "core.usecase2"
    override val purpose = "Rename capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
