...
/**
 * Runtime capability implementation for core.usecase2.rename.
 *
 ...
 */
class XRenameCapability : ExpansionCapability {
    override val id: String = "core.usecase2.rename"
    override val area: String = "core.usecase2"
    override val purpose: String = "Rename capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
