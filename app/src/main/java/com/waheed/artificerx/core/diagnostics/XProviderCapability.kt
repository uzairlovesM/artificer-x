...
/**
 * Runtime capability implementation for core.diagnostics.provider.
 *
 ...
 */
class XProviderCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.provider"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Provider capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
