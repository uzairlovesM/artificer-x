...
/** Production expansion contract for Provider. */
class XProviderCapability : ExpansionCapability {
    override val id = "core.diagnostics.provider"
    override val area = "core.diagnostics"
    override val purpose = "Provider capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
