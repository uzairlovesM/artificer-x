...
/** Production expansion contract for Test. */
class XTestCapability : ExpansionCapability {
    override val id = "core.usecase2.test"
    override val area = "core.usecase2"
    override val purpose = "Test capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
