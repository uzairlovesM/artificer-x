...
/**
 * Runtime capability implementation for core.usecase2.test.
 *
 ...
 */
class XTestCapability : ExpansionCapability {
    override val id: String = "core.usecase2.test"
    override val area: String = "core.usecase2"
    override val purpose: String = "Test capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
