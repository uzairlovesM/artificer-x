...
/**
 * Runtime capability implementation for core.repository.archive.
 *
 ...
 */
class XArchiveCapability : ExpansionCapability {
    override val id: String = "core.repository.archive"
    override val area: String = "core.repository"
    override val purpose: String = "Archive capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
