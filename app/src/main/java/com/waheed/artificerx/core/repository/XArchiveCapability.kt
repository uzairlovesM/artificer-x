...
class XArchiveCapability : ExpansionCapability {
    override val id = "core.repository.archive"
    override val area = "core.repository"
    override val purpose = "Archive capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
