...
/**
 * Runtime capability implementation for core.importer.resolution.
 *
 ...
 */
class XResolutionCapability : ExpansionCapability {
    override val id: String = "core.importer.resolution"
    override val area: String = "core.importer"
    override val purpose: String = "Resolution capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
