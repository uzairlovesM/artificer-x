...
/** Production expansion contract for Resolution. */
class XResolutionCapability : ExpansionCapability {
    override val id = "core.importer.resolution"
    override val area = "core.importer"
    override val purpose = "Resolution capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
