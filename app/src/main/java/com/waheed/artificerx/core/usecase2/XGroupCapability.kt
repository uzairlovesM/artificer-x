...
/**
 * Runtime capability implementation for core.usecase2.group.
 *
 ...
 */
class XGroupCapability : ExpansionCapability {
    override val id: String = "core.usecase2.group"
    override val area: String = "core.usecase2"
    override val purpose: String = "Group capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
