...
/** Production expansion contract for Group. */
class XGroupCapability : ExpansionCapability {
    override val id = "core.usecase2.group"
    override val area = "core.usecase2"
    override val purpose = "Group capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
