...
/** Production expansion contract for Deduplicator. */
class XDeduplicatorCapability : ExpansionCapability {
    override val id = "core.research.deduplicator"
    override val area = "core.research"
    override val purpose = "Deduplicator capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
