...
/**
 * Runtime capability implementation for core.research.deduplicator.
 *
 ...
 */
class XDeduplicatorCapability : ExpansionCapability {
    override val id: String = "core.research.deduplicator"
    override val area: String = "core.research"
    override val purpose: String = "Deduplicator capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
