...
/**
 * Runtime capability implementation for core.navigation.intent.
 *
 ...
 */
class XIntentCapability : ExpansionCapability {
    override val id: String = "core.navigation.intent"
    override val area: String = "core.navigation"
    override val purpose: String = "Intent capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
