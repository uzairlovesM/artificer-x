...
/** Production expansion contract for Intent. */
class XIntentCapability : ExpansionCapability {
    override val id = "core.navigation.intent"
    override val area = "core.navigation"
    override val purpose = "Intent capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
