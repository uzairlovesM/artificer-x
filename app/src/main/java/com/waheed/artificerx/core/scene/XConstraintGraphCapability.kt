...
/**
 * Runtime capability implementation for core.scene.constraintgraph.
 *
 ...
 */
class XConstraintGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.constraintgraph"
    override val area: String = "core.scene"
    override val purpose: String = "ConstraintGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
