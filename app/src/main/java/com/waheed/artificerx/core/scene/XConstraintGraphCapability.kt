...
/** Production expansion contract for ConstraintGraph. */
class XConstraintGraphCapability : ExpansionCapability {
    override val id = "core.scene.constraintgraph"
    override val area = "core.scene"
    override val purpose = "ConstraintGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
