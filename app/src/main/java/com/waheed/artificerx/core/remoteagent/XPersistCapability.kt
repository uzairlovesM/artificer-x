...
/** Production expansion contract for Persist. */
class XPersistCapability : ExpansionCapability {
    override val id = "core.remoteagent.persist"
    override val area = "core.remoteagent"
    override val purpose = "Persist capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
