...
/**
 * Runtime capability implementation for core.remoteagent.persist.
 *
 ...
 */
class XPersistCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.persist"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Persist capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
