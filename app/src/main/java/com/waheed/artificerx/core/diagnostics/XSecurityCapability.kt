...
/**
 * Runtime capability implementation for core.diagnostics.security.
 *
 ...
 */
class XSecurityCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.security"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Security capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
