...
/** Production expansion contract for Security. */
class XSecurityCapability : ExpansionCapability {
    override val id = "core.diagnostics.security"
    override val area = "core.diagnostics"
    override val purpose = "Security capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
