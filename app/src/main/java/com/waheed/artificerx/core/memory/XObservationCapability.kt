...
/** Production expansion contract for Observation. */
class XObservationCapability : ExpansionCapability {
    override val id = "core.memory.observation"
    override val area = "core.memory"
    override val purpose = "Observation capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
