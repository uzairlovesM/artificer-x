...
/**
 * Runtime capability implementation for core.memory.observation.
 *
 ...
 */
class XObservationCapability : ExpansionCapability {
    override val id: String = "core.memory.observation"
    override val area: String = "core.memory"
    override val purpose: String = "Observation capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
