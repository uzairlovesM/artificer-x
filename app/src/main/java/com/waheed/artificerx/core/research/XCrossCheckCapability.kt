...
/** Production expansion contract for CrossCheck. */
class XCrossCheckCapability : ExpansionCapability {
    override val id = "core.research.crosscheck"
    override val area = "core.research"
    override val purpose = "CrossCheck capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
