...
/**
 * Runtime capability implementation for core.research.crosscheck.
 *
 ...
 */
class XCrossCheckCapability : ExpansionCapability {
    override val id: String = "core.research.crosscheck"
    override val area: String = "core.research"
    override val purpose: String = "CrossCheck capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
