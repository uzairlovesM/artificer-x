...
/** Production expansion contract for Retriever. */
class XRetrieverCapability : ExpansionCapability {
    override val id = "core.research.retriever"
    override val area = "core.research"
    override val purpose = "Retriever capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
