...
/**
 * Runtime capability implementation for core.research.retriever.
 *
 ...
 */
class XRetrieverCapability : ExpansionCapability {
    override val id: String = "core.research.retriever"
    override val area: String = "core.research"
    override val purpose: String = "Retriever capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
