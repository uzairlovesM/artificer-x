...
/** Production expansion contract for Workspace. */
class XWorkspaceCapability : ExpansionCapability {
    override val id = "core.storage.workspace"
    override val area = "core.storage"
    override val purpose = "Workspace capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
