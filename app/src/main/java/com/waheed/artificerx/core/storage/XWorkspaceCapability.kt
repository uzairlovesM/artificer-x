...
/**
 * Runtime capability implementation for core.storage.workspace.
 *
...
class XWorkspaceCapability : ExpansionCapability {
    override val id: String = "core.storage.workspace"
    override val area: String = "core.storage"
    override val purpose: String = "Workspace capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
