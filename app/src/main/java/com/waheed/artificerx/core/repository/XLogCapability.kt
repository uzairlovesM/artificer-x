...
class XLogCapability : ExpansionCapability {
    override val id = "core.repository.log"
    override val area = "core.repository"
    override val purpose = "Log capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
