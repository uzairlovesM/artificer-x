...
/**
 * Runtime capability implementation for core.repository.log.
 *
...
class XLogCapability : ExpansionCapability {
    override val id: String = "core.repository.log"
    override val area: String = "core.repository"
    override val purpose: String = "Log capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
