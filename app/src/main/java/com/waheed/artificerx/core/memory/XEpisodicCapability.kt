...
/**
 * Runtime capability implementation for core.memory.episodic.
 *
 ...
 */
class XEpisodicCapability : ExpansionCapability {
    override val id: String = "core.memory.episodic"
    override val area: String = "core.memory"
    override val purpose: String = "Episodic capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
