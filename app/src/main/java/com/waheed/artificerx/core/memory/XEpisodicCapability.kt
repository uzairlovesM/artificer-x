...
/** Production expansion contract for Episodic. */
class XEpisodicCapability : ExpansionCapability {
    override val id = "core.memory.episodic"
    override val area = "core.memory"
    override val purpose = "Episodic capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
