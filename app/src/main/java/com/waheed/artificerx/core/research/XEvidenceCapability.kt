...
/**
 * Runtime capability implementation for core.research.evidence.
 *
 ...
 */
class XEvidenceCapability : ExpansionCapability {
    override val id: String = "core.research.evidence"
    override val area: String = "core.research"
    override val purpose: String = "Evidence capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
