...
class XEvidenceCapability : ExpansionCapability {
    override val id = "core.research.evidence"
    override val area = "core.research"
    override val purpose = "Evidence capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
