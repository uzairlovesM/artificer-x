...
/**
 * Runtime capability implementation for core.plugin.event.
 *
...
class XEventCapability : ExpansionCapability {
    override val id: String = "core.plugin.event"
    override val area: String = "core.plugin"
    override val purpose: String = "Event capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
