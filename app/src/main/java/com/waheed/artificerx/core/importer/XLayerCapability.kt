...
/**
 * Runtime capability implementation for core.importer.layer.
 *
 ...
 */
class XLayerCapability : ExpansionCapability {
    override val id: String = "core.importer.layer"
    override val area: String = "core.importer"
    override val purpose: String = "Layer capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
