...
/** Production expansion contract for Layer. */
class XLayerCapability : ExpansionCapability {
    override val id = "core.importer.layer"
    override val area = "core.importer"
    override val purpose = "Layer capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
