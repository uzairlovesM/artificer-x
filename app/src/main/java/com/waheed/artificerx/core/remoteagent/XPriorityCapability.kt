...
/** Production expansion contract for Priority. */
class XPriorityCapability : ExpansionCapability {
    override val id = "core.remoteagent.priority"
    override val area = "core.remoteagent"
    override val purpose = "Priority capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
