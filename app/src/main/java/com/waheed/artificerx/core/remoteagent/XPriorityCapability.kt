...
/**
 * Runtime capability implementation for core.remoteagent.priority.
 *
 ...
 */
class XPriorityCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.priority"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Priority capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
