...
/** Production expansion contract for PassPlanner. */
class XPassPlannerCapability : ExpansionCapability {
    override val id = "core.scene.passplanner"
    override val area = "core.scene"
    override val purpose = "PassPlanner capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
