...
/**
 * Runtime capability implementation for core.scene.passplanner.
 *
 ...
 */
class XPassPlannerCapability : ExpansionCapability {
    override val id: String = "core.scene.passplanner"
    override val area: String = "core.scene"
    override val purpose: String = "PassPlanner capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
