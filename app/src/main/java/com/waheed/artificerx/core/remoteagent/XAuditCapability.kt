...
class XAuditCapability : ExpansionCapability {
    override val id = "core.remoteagent.audit"
    override val area = "core.remoteagent"
    override val purpose = "Audit capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
