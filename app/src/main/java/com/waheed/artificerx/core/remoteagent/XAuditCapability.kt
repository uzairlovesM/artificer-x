...
/**
 * Runtime capability implementation for core.remoteagent.audit.
 *
...
class XAuditCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.audit"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Audit capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
