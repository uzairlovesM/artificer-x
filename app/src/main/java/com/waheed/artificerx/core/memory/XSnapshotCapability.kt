...
/**
 * Runtime capability implementation for core.memory.snapshot.
 *
...
class XSnapshotCapability : ExpansionCapability {
    override val id: String = "core.memory.snapshot"
    override val area: String = "core.memory"
    override val purpose: String = "Snapshot capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
