...
class XSnapshotCapability : ExpansionCapability {
    override val id = "core.memory.snapshot"
    override val area = "core.memory"
    override val purpose = "Snapshot capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
