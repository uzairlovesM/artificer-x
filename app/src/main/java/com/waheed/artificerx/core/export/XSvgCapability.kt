...
/**
 * Runtime capability implementation for core.export.svg.
 *
...
class XSvgCapability : ExpansionCapability {
    override val id: String = "core.export.svg"
    override val area: String = "core.export"
    override val purpose: String = "Svg capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
