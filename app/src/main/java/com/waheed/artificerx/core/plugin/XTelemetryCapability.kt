...
/**
 * Runtime capability implementation for core.plugin.telemetry.
 *
...
class XTelemetryCapability : ExpansionCapability {
    override val id: String = "core.plugin.telemetry"
    override val area: String = "core.plugin"
    override val purpose: String = "Telemetry capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
