...
class XTelemetryCapability : ExpansionCapability {
    override val id = "core.plugin.telemetry"
    override val area = "core.plugin"
    override val purpose = "Telemetry capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
