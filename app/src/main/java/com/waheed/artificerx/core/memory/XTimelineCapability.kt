...
class XTimelineCapability : ExpansionCapability {
    override val id = "core.memory.timeline"
    override val area = "core.memory"
    override val purpose = "Timeline capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
