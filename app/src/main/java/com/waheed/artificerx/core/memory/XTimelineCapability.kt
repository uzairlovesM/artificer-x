...
/**
 * Runtime capability implementation for core.memory.timeline.
 *
...
class XTimelineCapability : ExpansionCapability {
    override val id: String = "core.memory.timeline"
    override val area: String = "core.memory"
    override val purpose: String = "Timeline capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
