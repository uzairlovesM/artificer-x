...
class XFallbackCapability : ExpansionCapability {
    override val id = "core.model.fallback"
    override val area = "core.model"
    override val purpose = "Fallback capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
