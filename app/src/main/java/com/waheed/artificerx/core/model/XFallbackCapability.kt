...
/**
 * Runtime capability implementation for core.model.fallback.
 *
 ...
 */
class XFallbackCapability : ExpansionCapability {
    override val id: String = "core.model.fallback"
    override val area: String = "core.model"
    override val purpose: String = "Fallback capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
