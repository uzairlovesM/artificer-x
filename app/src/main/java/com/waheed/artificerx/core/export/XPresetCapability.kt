...
/**
 * Runtime capability implementation for core.export.preset.
 *
...
class XPresetCapability : ExpansionCapability {
    override val id: String = "core.export.preset"
    override val area: String = "core.export"
    override val purpose: String = "Preset capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
