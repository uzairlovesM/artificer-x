...
class XPresetCapability : ExpansionCapability {
    override val id = "core.export.preset"
    override val area = "core.export"
    override val purpose = "Preset capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
