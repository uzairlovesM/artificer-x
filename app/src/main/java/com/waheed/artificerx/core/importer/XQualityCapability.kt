...
/**
 * Runtime capability implementation for core.importer.quality.
 *
 ...
 */
class XQualityCapability : ExpansionCapability {
    override val id: String = "core.importer.quality"
    override val area: String = "core.importer"
    override val purpose: String = "Quality capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
