...
/** Production expansion contract for Quality. */
class XQualityCapability : ExpansionCapability {
    override val id = "core.importer.quality"
    override val area = "core.importer"
    override val purpose = "Quality capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
