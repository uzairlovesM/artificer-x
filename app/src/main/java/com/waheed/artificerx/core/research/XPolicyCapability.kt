...
class XPolicyCapability : ExpansionCapability {
    override val id = "core.research.policy"
    override val area = "core.research"
    override val purpose = "Policy capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
