...
/**
 * Runtime capability implementation for core.research.policy.
 *
 ...
 */
class XPolicyCapability : ExpansionCapability {
    override val id: String = "core.research.policy"
    override val area: String = "core.research"
    override val purpose: String = "Policy capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
