...
/**
 * Runtime capability implementation for core.diagnostics.leak.
 *
 ...
 */
class XLeakCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.leak"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Leak capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
