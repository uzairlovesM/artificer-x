...
/** Production expansion contract for Leak. */
class XLeakCapability : ExpansionCapability {
    override val id = "core.diagnostics.leak"
    override val area = "core.diagnostics"
    override val purpose = "Leak capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
