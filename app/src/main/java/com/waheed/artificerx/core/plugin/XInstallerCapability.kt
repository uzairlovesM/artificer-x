...
/**
 * Runtime capability implementation for core.plugin.installer.
 *
 ...
 */
class XInstallerCapability : ExpansionCapability {
    override val id: String = "core.plugin.installer"
    override val area: String = "core.plugin"
    override val purpose: String = "Installer capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
