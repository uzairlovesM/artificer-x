...
/** Production expansion contract for Installer. */
class XInstallerCapability : ExpansionCapability {
    override val id = "core.plugin.installer"
    override val area = "core.plugin"
    override val purpose = "Installer capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
