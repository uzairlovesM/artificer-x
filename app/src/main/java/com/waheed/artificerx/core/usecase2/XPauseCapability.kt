...
/**
 * Runtime capability implementation for core.usecase2.pause.
 *
 ...
 */
class XPauseCapability : ExpansionCapability {
    override val id: String = "core.usecase2.pause"
    override val area: String = "core.usecase2"
    override val purpose: String = "Pause capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
