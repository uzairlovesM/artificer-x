...
/** Production expansion contract for Pause. */
class XPauseCapability : ExpansionCapability {
    override val id = "core.usecase2.pause"
    override val area = "core.usecase2"
    override val purpose = "Pause capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
