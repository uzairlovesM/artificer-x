...
class XPlannerCapability : ExpansionCapability {
    override val id = "core.research.planner"
    override val area = "core.research"
    override val purpose = "Planner capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
