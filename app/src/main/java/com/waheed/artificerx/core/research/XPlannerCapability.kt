...
/**
 * Runtime capability implementation for core.research.planner.
 *
...
class XPlannerCapability : ExpansionCapability {
    override val id: String = "core.research.planner"
    override val area: String = "core.research"
    override val purpose: String = "Planner capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
