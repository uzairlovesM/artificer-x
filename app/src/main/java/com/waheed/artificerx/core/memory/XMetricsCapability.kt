...
/**
 * Runtime capability implementation for core.memory.metrics.
 *
...
class XMetricsCapability : ExpansionCapability {
    override val id: String = "core.memory.metrics"
    override val area: String = "core.memory"
    override val purpose: String = "Metrics capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
