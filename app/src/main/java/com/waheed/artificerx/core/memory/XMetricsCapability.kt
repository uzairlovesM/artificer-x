...
class XMetricsCapability : ExpansionCapability {
    override val id = "core.memory.metrics"
    override val area = "core.memory"
    override val purpose = "Metrics capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
