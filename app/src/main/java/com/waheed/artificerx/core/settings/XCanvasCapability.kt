...
class XCanvasCapability : ExpansionCapability {
    override val id = "core.settings.canvas"
    override val area = "core.settings"
    override val purpose = "Canvas capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
