...
/**
 * Runtime capability implementation for core.settings.canvas.
 *
...
class XCanvasCapability : ExpansionCapability {
    override val id: String = "core.settings.canvas"
    override val area: String = "core.settings"
    override val purpose: String = "Canvas capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
