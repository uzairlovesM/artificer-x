...
class XRankerCapability : ExpansionCapability {
    override val id = "core.memory.ranker"
    override val area = "core.memory"
    override val purpose = "Ranker capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
