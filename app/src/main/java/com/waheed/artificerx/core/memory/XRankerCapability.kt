...
/**
 * Runtime capability implementation for core.memory.ranker.
 *
...
class XRankerCapability : ExpansionCapability {
    override val id: String = "core.memory.ranker"
    override val area: String = "core.memory"
    override val purpose: String = "Ranker capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
