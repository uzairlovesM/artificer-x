...
/** Production expansion contract for Usage. */
class XUsageCapability : ExpansionCapability {
    override val id = "core.storage.usage"
    override val area = "core.storage"
    override val purpose = "Usage capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
