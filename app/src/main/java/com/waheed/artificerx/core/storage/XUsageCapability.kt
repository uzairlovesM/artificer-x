...
/**
 * Runtime capability implementation for core.storage.usage.
 *
 ...
 */
class XUsageCapability : ExpansionCapability {
    override val id: String = "core.storage.usage"
    override val area: String = "core.storage"
    override val purpose: String = "Usage capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
