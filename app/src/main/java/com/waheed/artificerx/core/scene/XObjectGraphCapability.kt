...
/** Production expansion contract for ObjectGraph. */
class XObjectGraphCapability : ExpansionCapability {
    override val id = "core.scene.objectgraph"
    override val area = "core.scene"
    override val purpose = "ObjectGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
