...
/**
 * Runtime capability implementation for core.scene.objectgraph.
 *
 ...
 */
class XObjectGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.objectgraph"
    override val area: String = "core.scene"
    override val purpose: String = "ObjectGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
