...
class XMetricsCapability : ExpansionCapability {
    override val id = "core.navigation.metrics"
    override val area = "core.navigation"
    override val purpose = "Metrics capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
