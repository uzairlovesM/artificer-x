...
/**
 * Runtime capability implementation for core.navigation.metrics.
 *
 ...
 */
class XMetricsCapability : ExpansionCapability {
    override val id: String = "core.navigation.metrics"
    override val area: String = "core.navigation"
    override val purpose: String = "Metrics capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
