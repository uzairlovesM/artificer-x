...
/**
 * Runtime capability implementation for core.settings.shortcut.
 *
...
class XShortcutCapability : ExpansionCapability {
    override val id: String = "core.settings.shortcut"
    override val area: String = "core.settings"
    override val purpose: String = "Shortcut capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
