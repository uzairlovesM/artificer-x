...
class XShortcutCapability : ExpansionCapability {
    override val id = "core.settings.shortcut"
    override val area = "core.settings"
    override val purpose = "Shortcut capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
