...
/**
 * Runtime capability implementation for core.export.batch.
 *
...
class XBatchCapability : ExpansionCapability {
    override val id: String = "core.export.batch"
    override val area: String = "core.export"
    override val purpose: String = "Batch capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
