...
/**
 * Runtime capability implementation for core.model.eviction.
 *
...
class XEvictionCapability : ExpansionCapability {
    override val id: String = "core.model.eviction"
    override val area: String = "core.model"
    override val purpose: String = "Eviction capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
