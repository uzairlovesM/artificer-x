...
class XEvictionCapability : ExpansionCapability {
    override val id = "core.model.eviction"
    override val area = "core.model"
    override val purpose = "Eviction capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
