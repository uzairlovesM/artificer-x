...
/**
 * Runtime capability implementation for core.model.importer.
 *
...
class XImporterCapability : ExpansionCapability {
    override val id: String = "core.model.importer"
    override val area: String = "core.model"
    override val purpose: String = "Importer capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
