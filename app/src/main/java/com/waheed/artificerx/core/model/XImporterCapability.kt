...
class XImporterCapability : ExpansionCapability {
    override val id = "core.model.importer"
    override val area = "core.model"
    override val purpose = "Importer capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
