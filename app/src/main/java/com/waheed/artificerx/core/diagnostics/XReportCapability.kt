...
/**
 * Runtime capability implementation for core.diagnostics.report.
 *
 ...
 */
class XReportCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.report"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Report capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
