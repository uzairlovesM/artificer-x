...
/** Production expansion contract for Report. */
class XReportCapability : ExpansionCapability {
    override val id = "core.diagnostics.report"
    override val area = "core.diagnostics"
    override val purpose = "Report capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
