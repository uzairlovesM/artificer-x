...
/** Production expansion contract for File. */
class XFileCapability : ExpansionCapability {
    override val id = "core.storage.file"
    override val area = "core.storage"
    override val purpose = "File capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
