...
/**
 * Runtime capability implementation for core.storage.file.
 *
...
class XFileCapability : ExpansionCapability {
    override val id: String = "core.storage.file"
    override val area: String = "core.storage"
    override val purpose: String = "File capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
