...
/**
 * Runtime capability implementation for core.creative.panelplan.
 *
 ...
 */
class XPanelPlanCapability : ExpansionCapability {
    override val id: String = "core.creative.panelplan"
    override val area: String = "core.creative"
    override val purpose: String = "PanelPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
