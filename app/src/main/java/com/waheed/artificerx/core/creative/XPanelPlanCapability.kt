...
/** Production expansion contract for PanelPlan. */
class XPanelPlanCapability : ExpansionCapability {
    override val id = "core.creative.panelplan"
    override val area = "core.creative"
    override val purpose = "PanelPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
