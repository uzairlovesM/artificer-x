...
/**
 * Runtime capability implementation for core.repository.file.
 *
 ...
 */
class XFileCapability : ExpansionCapability {
    override val id: String = "core.repository.file"
    override val area: String = "core.repository"
    override val purpose: String = "File capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
