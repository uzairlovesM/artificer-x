...
class XFileCapability : ExpansionCapability {
    override val id = "core.repository.file"
    override val area = "core.repository"
    override val purpose = "File capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
