...
/** Production expansion contract for Workflow. */
class XWorkflowCapability : ExpansionCapability {
    override val id = "core.plugin.workflow"
    override val area = "core.plugin"
    override val purpose = "Workflow capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
