...
/**
 * Runtime capability implementation for core.plugin.workflow.
 *
 ...
 */
class XWorkflowCapability : ExpansionCapability {
    override val id: String = "core.plugin.workflow"
    override val area: String = "core.plugin"
    override val purpose: String = "Workflow capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
