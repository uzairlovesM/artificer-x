...
/** Production expansion contract for Parse. */
class XParseCapability : ExpansionCapability {
    override val id = "core.remoteagent.parse"
    override val area = "core.remoteagent"
    override val purpose = "Parse capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
