...
/**
 * Runtime capability implementation for core.remoteagent.parse.
 *
 ...
 */
class XParseCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.parse"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Parse capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
