...
/**
 * Runtime capability implementation for core.remoteagent.metric.
 *
...
class XMetricCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.metric"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Metric capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
