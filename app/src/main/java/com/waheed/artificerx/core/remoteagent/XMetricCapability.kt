...
class XMetricCapability : ExpansionCapability {
    override val id = "core.remoteagent.metric"
    override val area = "core.remoteagent"
    override val purpose = "Metric capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
