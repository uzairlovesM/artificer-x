...
class XStreamCapability : ExpansionCapability {
    override val id = "core.remoteagent.stream"
    override val area = "core.remoteagent"
    override val purpose = "Stream capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
