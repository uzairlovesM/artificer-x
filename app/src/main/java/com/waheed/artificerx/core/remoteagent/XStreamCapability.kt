...
/**
 * Runtime capability implementation for core.remoteagent.stream.
 *
...
class XStreamCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.stream"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Stream capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
