...
/** Production expansion contract for Storyboard. */
class XStoryboardCapability : ExpansionCapability {
    override val id = "core.importer.storyboard"
    override val area = "core.importer"
    override val purpose = "Storyboard capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
