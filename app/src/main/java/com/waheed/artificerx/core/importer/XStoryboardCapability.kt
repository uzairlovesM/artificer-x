...
/**
 * Runtime capability implementation for core.importer.storyboard.
 *
 ...
 */
class XStoryboardCapability : ExpansionCapability {
    override val id: String = "core.importer.storyboard"
    override val area: String = "core.importer"
    override val purpose: String = "Storyboard capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
