...
/** Production expansion contract for Fetcher. */
class XFetcherCapability : ExpansionCapability {
    override val id = "core.research.fetcher"
    override val area = "core.research"
    override val purpose = "Fetcher capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
