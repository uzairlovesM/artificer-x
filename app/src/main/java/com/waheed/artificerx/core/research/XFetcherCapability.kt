...
/**
 * Runtime capability implementation for core.research.fetcher.
 *
 ...
 */
class XFetcherCapability : ExpansionCapability {
    override val id: String = "core.research.fetcher"
    override val area: String = "core.research"
    override val purpose: String = "Fetcher capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
