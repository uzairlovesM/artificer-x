...
/** Production expansion contract for HighlightPass. */
class XHighlightPassCapability : ExpansionCapability {
    override val id = "core.scene.highlightpass"
    override val area = "core.scene"
    override val purpose = "HighlightPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
