...
/**
 * Runtime capability implementation for core.scene.highlightpass.
 *
 ...
 */
class XHighlightPassCapability : ExpansionCapability {
    override val id: String = "core.scene.highlightpass"
    override val area: String = "core.scene"
    override val purpose: String = "HighlightPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
