...
/**
 * Runtime capability implementation for core.diagnostics.export.
 *
 ...
 */
class XExportCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.export"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Export capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
