...
/** Production expansion contract for Export. */
class XExportCapability : ExpansionCapability {
    override val id = "core.diagnostics.export"
    override val area = "core.diagnostics"
    override val purpose = "Export capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
