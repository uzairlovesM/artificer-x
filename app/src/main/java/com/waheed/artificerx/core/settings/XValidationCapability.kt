...
/** Production expansion contract for Validation. */
class XValidationCapability : ExpansionCapability {
    override val id = "core.settings.validation"
    override val area = "core.settings"
    override val purpose = "Validation capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
