...
/**
 * Runtime capability implementation for core.settings.validation.
 *
 ...
 */
class XValidationCapability : ExpansionCapability {
    override val id: String = "core.settings.validation"
    override val area: String = "core.settings"
    override val purpose: String = "Validation capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
