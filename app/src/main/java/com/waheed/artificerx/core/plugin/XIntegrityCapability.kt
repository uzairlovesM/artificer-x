...
class XIntegrityCapability : ExpansionCapability {
    override val id = "core.plugin.integrity"
    override val area = "core.plugin"
    override val purpose = "Integrity capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
