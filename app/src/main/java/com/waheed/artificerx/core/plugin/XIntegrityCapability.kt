...
/**
 * Runtime capability implementation for core.plugin.integrity.
 *
...
class XIntegrityCapability : ExpansionCapability {
    override val id: String = "core.plugin.integrity"
    override val area: String = "core.plugin"
    override val purpose: String = "Integrity capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
