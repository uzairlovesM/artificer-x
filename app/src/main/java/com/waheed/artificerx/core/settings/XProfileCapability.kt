...
/**
 * Runtime capability implementation for core.settings.profile.
 *
...
class XProfileCapability : ExpansionCapability {
    override val id: String = "core.settings.profile"
    override val area: String = "core.settings"
    override val purpose: String = "Profile capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
