...
class XProfileCapability : ExpansionCapability {
    override val id = "core.settings.profile"
    override val area = "core.settings"
    override val purpose = "Profile capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
