...
class XDiagnosticsCapability : ExpansionCapability {
    override val id = "core.navigation.diagnostics"
    override val area = "core.navigation"
    override val purpose = "Diagnostics capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
