...
/**
 * Runtime capability implementation for core.navigation.diagnostics.
 *
 ...
 */
class XDiagnosticsCapability : ExpansionCapability {
    override val id: String = "core.navigation.diagnostics"
    override val area: String = "core.navigation"
    override val purpose: String = "Diagnostics capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
