...
/** Production expansion contract for Activation. */
class XActivationCapability : ExpansionCapability {
    override val id = "core.plugin.activation"
    override val area = "core.plugin"
    override val purpose = "Activation capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
