...
/**
 * Runtime capability implementation for core.plugin.activation.
 *
 ...
 */
class XActivationCapability : ExpansionCapability {
    override val id: String = "core.plugin.activation"
    override val area: String = "core.plugin"
    override val purpose: String = "Activation capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
