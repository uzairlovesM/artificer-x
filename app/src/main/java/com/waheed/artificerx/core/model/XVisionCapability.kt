...
/**
 * Runtime capability implementation for core.model.vision.
 *
 ...
 */
class XVisionCapability : ExpansionCapability {
    override val id: String = "core.model.vision"
    override val area: String = "core.model"
    override val purpose: String = "Vision capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
