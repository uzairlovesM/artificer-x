...
/** Production expansion contract for Vision. */
class XVisionCapability : ExpansionCapability {
    override val id = "core.model.vision"
    override val area = "core.model"
    override val purpose = "Vision capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
