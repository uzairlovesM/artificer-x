...
/**
 * Runtime capability implementation for core.scene.validator.
 *
...
class XValidatorCapability : ExpansionCapability {
    override val id: String = "core.scene.validator"
    override val area: String = "core.scene"
    override val purpose: String = "Validator capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
