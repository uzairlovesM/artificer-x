...
/**
 * Runtime capability implementation for core.memory.workspace.
 *
...
class XWorkspaceCapability : ExpansionCapability {
    override val id: String = "core.memory.workspace"
    override val area: String = "core.memory"
    override val purpose: String = "Workspace capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
