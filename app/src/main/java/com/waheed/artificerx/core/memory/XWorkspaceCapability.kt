...
class XWorkspaceCapability : ExpansionCapability {
    override val id = "core.memory.workspace"
    override val area = "core.memory"
    override val purpose = "Workspace capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
