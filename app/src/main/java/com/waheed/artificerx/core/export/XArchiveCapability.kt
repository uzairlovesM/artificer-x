...
class XArchiveCapability : ExpansionCapability {
    override val id = "core.export.archive"
    override val area = "core.export"
    override val purpose = "Archive capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
