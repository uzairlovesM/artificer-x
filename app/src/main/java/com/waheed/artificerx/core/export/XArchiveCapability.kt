...
/**
 * Runtime capability implementation for core.export.archive.
 *
...
class XArchiveCapability : ExpansionCapability {
    override val id: String = "core.export.archive"
    override val area: String = "core.export"
    override val purpose: String = "Archive capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
