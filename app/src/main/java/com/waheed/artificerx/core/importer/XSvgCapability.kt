...
/**
 * Runtime capability implementation for core.importer.svg.
 *
 ...
 */
class XSvgCapability : ExpansionCapability {
    override val id: String = "core.importer.svg"
    override val area: String = "core.importer"
    override val purpose: String = "Svg capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
