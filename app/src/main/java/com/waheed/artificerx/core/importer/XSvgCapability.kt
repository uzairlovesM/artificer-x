...
/** Production expansion contract for Svg. */
class XSvgCapability : ExpansionCapability {
    override val id = "core.importer.svg"
    override val area = "core.importer"
    override val purpose = "Svg capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
