...
/**
 * Runtime capability implementation for core.plugin.audit.
 *
...
class XAuditCapability : ExpansionCapability {
    override val id: String = "core.plugin.audit"
    override val area: String = "core.plugin"
    override val purpose: String = "Audit capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
