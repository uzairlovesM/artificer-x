...
/**
 * Runtime capability implementation for core.export.atlas.
 *
...
class XAtlasCapability : ExpansionCapability {
    override val id: String = "core.export.atlas"
    override val area: String = "core.export"
    override val purpose: String = "Atlas capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
