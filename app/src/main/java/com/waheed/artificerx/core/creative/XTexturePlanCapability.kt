...
/**
 * Runtime capability implementation for core.creative.textureplan.
 *
 ...
 */
class XTexturePlanCapability : ExpansionCapability {
    override val id: String = "core.creative.textureplan"
    override val area: String = "core.creative"
    override val purpose: String = "TexturePlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
