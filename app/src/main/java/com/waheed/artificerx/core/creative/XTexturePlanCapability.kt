...
/** Production expansion contract for TexturePlan. */
class XTexturePlanCapability : ExpansionCapability {
    override val id = "core.creative.textureplan"
    override val area = "core.creative"
    override val purpose = "TexturePlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
