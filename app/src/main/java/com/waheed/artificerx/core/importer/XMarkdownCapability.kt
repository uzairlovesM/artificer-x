...
/**
 * Runtime capability implementation for core.importer.markdown.
 *
 ...
 */
class XMarkdownCapability : ExpansionCapability {
    override val id: String = "core.importer.markdown"
    override val area: String = "core.importer"
    override val purpose: String = "Markdown capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
