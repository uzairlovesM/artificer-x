...
/** Production expansion contract for Markdown. */
class XMarkdownCapability : ExpansionCapability {
    override val id = "core.importer.markdown"
    override val area = "core.importer"
    override val purpose = "Markdown capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
