...
/** Production expansion contract for SemanticGraph. */
class XSemanticGraphCapability : ExpansionCapability {
    override val id = "core.scene.semanticgraph"
    override val area = "core.scene"
    override val purpose = "SemanticGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
