...
/**
 * Runtime capability implementation for core.scene.semanticgraph.
 *
 ...
 */
class XSemanticGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.semanticgraph"
    override val area: String = "core.scene"
    override val purpose: String = "SemanticGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
