...
/**
 * Runtime capability implementation for core.storage.journal.
 *
 ...
 */
class XJournalCapability : ExpansionCapability {
    override val id: String = "core.storage.journal"
    override val area: String = "core.storage"
    override val purpose: String = "Journal capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
