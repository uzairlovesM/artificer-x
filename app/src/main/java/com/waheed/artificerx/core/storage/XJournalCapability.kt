...
/** Production expansion contract for Journal. */
class XJournalCapability : ExpansionCapability {
    override val id = "core.storage.journal"
    override val area = "core.storage"
    override val purpose = "Journal capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
