...
/**
 * Runtime capability implementation for core.export.resolution.
 *
...
class XResolutionCapability : ExpansionCapability {
    override val id: String = "core.export.resolution"
    override val area: String = "core.export"
    override val purpose: String = "Resolution capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
