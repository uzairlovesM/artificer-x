...
class XResolutionCapability : ExpansionCapability {
    override val id = "core.export.resolution"
    override val area = "core.export"
    override val purpose = "Resolution capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
