...
/**
 * Runtime capability implementation for core.scene.compositiongraph.
 *
 ...
 */
class XCompositionGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.compositiongraph"
    override val area: String = "core.scene"
    override val purpose: String = "CompositionGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
