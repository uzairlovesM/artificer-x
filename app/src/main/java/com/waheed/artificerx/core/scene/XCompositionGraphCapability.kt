...
/** Production expansion contract for CompositionGraph. */
class XCompositionGraphCapability : ExpansionCapability {
    override val id = "core.scene.compositiongraph"
    override val area = "core.scene"
    override val purpose = "CompositionGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
