...
/** Production expansion contract for Diff. */
class XDiffCapability : ExpansionCapability {
    override val id = "core.repository.diff"
    override val area = "core.repository"
    override val purpose = "Diff capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
