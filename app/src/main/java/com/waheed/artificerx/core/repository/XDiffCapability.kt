...
/**
 * Runtime capability implementation for core.repository.diff.
 *
 ...
 */
class XDiffCapability : ExpansionCapability {
    override val id: String = "core.repository.diff"
    override val area: String = "core.repository"
    override val purpose: String = "Diff capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
