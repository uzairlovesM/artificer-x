...
class XDeduplicatorCapability : ExpansionCapability {
    override val id = "core.memory.deduplicator"
    override val area = "core.memory"
    override val purpose = "Deduplicator capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
