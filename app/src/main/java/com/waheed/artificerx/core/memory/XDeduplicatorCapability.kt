...
/**
 * Runtime capability implementation for core.memory.deduplicator.
 *
...
class XDeduplicatorCapability : ExpansionCapability {
    override val id: String = "core.memory.deduplicator"
    override val area: String = "core.memory"
    override val purpose: String = "Deduplicator capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
