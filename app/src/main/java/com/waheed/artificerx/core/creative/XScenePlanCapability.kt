...
/**
 * Runtime capability implementation for core.creative.sceneplan.
 *
 ...
 */
class XScenePlanCapability : ExpansionCapability {
    override val id: String = "core.creative.sceneplan"
    override val area: String = "core.creative"
    override val purpose: String = "ScenePlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
