...
/** Production expansion contract for ScenePlan. */
class XScenePlanCapability : ExpansionCapability {
    override val id = "core.creative.sceneplan"
    override val area = "core.creative"
    override val purpose = "ScenePlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
