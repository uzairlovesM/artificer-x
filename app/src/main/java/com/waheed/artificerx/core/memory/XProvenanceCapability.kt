...
/**
 * Runtime capability implementation for core.memory.provenance.
 *
...
class XProvenanceCapability : ExpansionCapability {
    override val id: String = "core.memory.provenance"
    override val area: String = "core.memory"
    override val purpose: String = "Provenance capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
