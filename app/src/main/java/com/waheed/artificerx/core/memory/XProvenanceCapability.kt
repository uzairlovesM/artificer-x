...
class XProvenanceCapability : ExpansionCapability {
    override val id = "core.memory.provenance"
    override val area = "core.memory"
    override val purpose = "Provenance capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
