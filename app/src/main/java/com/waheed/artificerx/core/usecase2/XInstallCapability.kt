...
/** Production expansion contract for Install. */
class XInstallCapability : ExpansionCapability {
    override val id = "core.usecase2.install"
    override val area = "core.usecase2"
    override val purpose = "Install capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
