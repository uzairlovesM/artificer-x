...
/**
 * Runtime capability implementation for core.usecase2.install.
 *
 ...
 */
class XInstallCapability : ExpansionCapability {
    override val id: String = "core.usecase2.install"
    override val area: String = "core.usecase2"
    override val purpose: String = "Install capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
