...
/**
 * Runtime capability implementation for core.navigation.search.
 *
...
class XSearchCapability : ExpansionCapability {
    override val id: String = "core.navigation.search"
    override val area: String = "core.navigation"
    override val purpose: String = "Search capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
