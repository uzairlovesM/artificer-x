...
class XSearchCapability : ExpansionCapability {
    override val id = "core.navigation.search"
    override val area = "core.navigation"
    override val purpose = "Search capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
