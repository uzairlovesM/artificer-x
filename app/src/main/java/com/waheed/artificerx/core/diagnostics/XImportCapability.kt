...
/** Production expansion contract for Import. */
class XImportCapability : ExpansionCapability {
    override val id = "core.diagnostics.import"
    override val area = "core.diagnostics"
    override val purpose = "Import capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
