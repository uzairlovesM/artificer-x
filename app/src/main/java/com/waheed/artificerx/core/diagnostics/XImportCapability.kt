...
/**
 * Runtime capability implementation for core.diagnostics.import.
 *
 ...
 */
class XImportCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.import"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Import capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
