...
class XMetadataCapability : ExpansionCapability {
    override val id = "core.model.metadata"
    override val area = "core.model"
    override val purpose = "Metadata capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
