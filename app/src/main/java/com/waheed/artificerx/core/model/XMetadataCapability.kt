...
/**
 * Runtime capability implementation for core.model.metadata.
 *
...
class XMetadataCapability : ExpansionCapability {
    override val id: String = "core.model.metadata"
    override val area: String = "core.model"
    override val purpose: String = "Metadata capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
