...
/**
 * Runtime capability implementation for core.usecase2.open.
 *
 ...
 */
class XOpenCapability : ExpansionCapability {
    override val id: String = "core.usecase2.open"
    override val area: String = "core.usecase2"
    override val purpose: String = "Open capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
