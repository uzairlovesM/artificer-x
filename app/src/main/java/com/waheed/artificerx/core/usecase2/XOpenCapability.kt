...
/** Production expansion contract for Open. */
class XOpenCapability : ExpansionCapability {
    override val id = "core.usecase2.open"
    override val area = "core.usecase2"
    override val purpose = "Open capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
