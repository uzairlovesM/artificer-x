...
/**
 * Runtime capability implementation for core.usecase2.duplicate.
 *
 ...
 */
class XDuplicateCapability : ExpansionCapability {
    override val id: String = "core.usecase2.duplicate"
    override val area: String = "core.usecase2"
    override val purpose: String = "Duplicate capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
