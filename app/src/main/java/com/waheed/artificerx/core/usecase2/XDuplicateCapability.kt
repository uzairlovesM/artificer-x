...
/** Production expansion contract for Duplicate. */
class XDuplicateCapability : ExpansionCapability {
    override val id = "core.usecase2.duplicate"
    override val area = "core.usecase2"
    override val purpose = "Duplicate capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
