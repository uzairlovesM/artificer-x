...
/**
 * Runtime capability implementation for core.importer.picker.
 *
 ...
 */
class XPickerCapability : ExpansionCapability {
    override val id: String = "core.importer.picker"
    override val area: String = "core.importer"
    override val purpose: String = "Picker capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
