...
/** Production expansion contract for Picker. */
class XPickerCapability : ExpansionCapability {
    override val id = "core.importer.picker"
    override val area = "core.importer"
    override val purpose = "Picker capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
