...
/** Production expansion contract for Battery. */
class XBatteryCapability : ExpansionCapability {
    override val id = "core.diagnostics.battery"
    override val area = "core.diagnostics"
    override val purpose = "Battery capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
