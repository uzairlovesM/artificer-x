...
/**
 * Runtime capability implementation for core.diagnostics.battery.
 *
 ...
 */
class XBatteryCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.battery"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Battery capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
