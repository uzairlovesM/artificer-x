...
/** Production expansion contract for Route. */
class XRouteCapability : ExpansionCapability {
    override val id = "core.diagnostics.route"
    override val area = "core.diagnostics"
    override val purpose = "Route capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
