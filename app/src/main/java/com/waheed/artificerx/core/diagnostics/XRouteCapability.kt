...
/**
 * Runtime capability implementation for core.diagnostics.route.
 *
 ...
 */
class XRouteCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.route"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Route capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
