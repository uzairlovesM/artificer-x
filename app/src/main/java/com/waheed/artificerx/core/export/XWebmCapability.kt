...
/**
 * Runtime capability implementation for core.export.webm.
 *
...
class XWebmCapability : ExpansionCapability {
    override val id: String = "core.export.webm"
    override val area: String = "core.export"
    override val purpose: String = "Webm capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
