...
class NativeInferenceExpansion : ExpansionCapability {
    override val id: String = "core.native.nativeinference"
    override val area: String = "core.native"
    override val purpose: String = "NativeInference coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
