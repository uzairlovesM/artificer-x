...
/** Production expansion contract for Png. */
class XPngCapability : ExpansionCapability {
    override val id = "core.importer.png"
    override val area = "core.importer"
    override val purpose = "Png capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
