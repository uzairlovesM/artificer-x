...
/**
 * Runtime capability implementation for core.importer.png.
 *
 ...
 */
class XPngCapability : ExpansionCapability {
    override val id: String = "core.importer.png"
    override val area: String = "core.importer"
    override val purpose: String = "Png capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
