...
/**
 * Runtime capability implementation for core.diagnostics.trace.
 *
 ...
 */
class XTraceCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.trace"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Trace capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
