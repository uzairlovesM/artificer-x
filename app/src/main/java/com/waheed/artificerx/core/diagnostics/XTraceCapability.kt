...
/** Production expansion contract for Trace. */
class XTraceCapability : ExpansionCapability {
    override val id = "core.diagnostics.trace"
    override val area = "core.diagnostics"
    override val purpose = "Trace capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
