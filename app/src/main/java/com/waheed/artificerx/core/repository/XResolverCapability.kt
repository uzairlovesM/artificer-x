...
/**
 * Runtime capability implementation for core.repository.resolver.
 *
 ...
 */
class XResolverCapability : ExpansionCapability {
    override val id: String = "core.repository.resolver"
    override val area: String = "core.repository"
    override val purpose: String = "Resolver capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
