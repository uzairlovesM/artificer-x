...
class XResolverCapability : ExpansionCapability {
    override val id = "core.repository.resolver"
    override val area = "core.repository"
    override val purpose = "Resolver capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
