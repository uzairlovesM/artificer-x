...
class NativeShellExpansion : ExpansionCapability {
    override val id: String = "core.native.nativeshell"
    override val area: String = "core.native"
    override val purpose: String = "NativeShell coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
