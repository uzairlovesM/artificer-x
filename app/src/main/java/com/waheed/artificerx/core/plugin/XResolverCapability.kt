...
/** Production expansion contract for Resolver. */
class XResolverCapability : ExpansionCapability {
    override val id = "core.plugin.resolver"
    override val area = "core.plugin"
    override val purpose = "Resolver capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
