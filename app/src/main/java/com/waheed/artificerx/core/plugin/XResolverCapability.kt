...
/**
 * Runtime capability implementation for core.plugin.resolver.
 *
...
class XResolverCapability : ExpansionCapability {
    override val id: String = "core.plugin.resolver"
    override val area: String = "core.plugin"
    override val purpose: String = "Resolver capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
