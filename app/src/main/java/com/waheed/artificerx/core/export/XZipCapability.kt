...
/**
 * Runtime capability implementation for core.export.zip.
 *
...
class XZipCapability : ExpansionCapability {
    override val id: String = "core.export.zip"
    override val area: String = "core.export"
    override val purpose: String = "Zip capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
