...
/**
 * Runtime capability implementation for core.importer.template.
 *
 ...
 */
class XTemplateCapability : ExpansionCapability {
    override val id: String = "core.importer.template"
    override val area: String = "core.importer"
    override val purpose: String = "Template capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
