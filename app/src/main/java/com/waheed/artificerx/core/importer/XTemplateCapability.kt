...
/** Production expansion contract for Template. */
class XTemplateCapability : ExpansionCapability {
    override val id = "core.importer.template"
    override val area = "core.importer"
    override val purpose = "Template capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
