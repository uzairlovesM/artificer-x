...
/** Production expansion contract for Fetch. */
class XFetchCapability : ExpansionCapability {
    override val id = "core.remoteagent.fetch"
    override val area = "core.remoteagent"
    override val purpose = "Fetch capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
