...
/**
 * Runtime capability implementation for core.remoteagent.fetch.
 *
...
class XFetchCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.fetch"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Fetch capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
