...
/** Production expansion contract for Sprite. */
class XSpriteCapability : ExpansionCapability {
    override val id = "core.importer.sprite"
    override val area = "core.importer"
    override val purpose = "Sprite capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
