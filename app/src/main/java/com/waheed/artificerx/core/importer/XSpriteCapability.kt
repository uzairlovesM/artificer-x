...
/**
 * Runtime capability implementation for core.importer.sprite.
 *
 ...
 */
class XSpriteCapability : ExpansionCapability {
    override val id: String = "core.importer.sprite"
    override val area: String = "core.importer"
    override val purpose: String = "Sprite capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
