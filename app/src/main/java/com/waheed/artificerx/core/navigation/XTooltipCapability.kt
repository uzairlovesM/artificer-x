...
/** Production expansion contract for Tooltip. */
class XTooltipCapability : ExpansionCapability {
    override val id = "core.navigation.tooltip"
    override val area = "core.navigation"
    override val purpose = "Tooltip capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
