...
/**
 * Runtime capability implementation for core.navigation.tooltip.
 *
 ...
 */
class XTooltipCapability : ExpansionCapability {
    override val id: String = "core.navigation.tooltip"
    override val area: String = "core.navigation"
    override val purpose: String = "Tooltip capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
