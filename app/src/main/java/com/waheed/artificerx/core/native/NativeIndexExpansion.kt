...
class NativeIndexExpansion : ExpansionCapability {
    override val id: String = "core.native.nativeindex"
    override val area: String = "core.native"
    override val purpose: String = "NativeIndex coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
