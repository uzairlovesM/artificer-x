...
/**
 * Runtime capability implementation for core.storage.artifact.
 *
...
class XArtifactCapability : ExpansionCapability {
    override val id: String = "core.storage.artifact"
    override val area: String = "core.storage"
    override val purpose: String = "Artifact capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
