...
/** Production expansion contract for Artifact. */
class XArtifactCapability : ExpansionCapability {
    override val id = "core.storage.artifact"
    override val area = "core.storage"
    override val purpose = "Artifact capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
