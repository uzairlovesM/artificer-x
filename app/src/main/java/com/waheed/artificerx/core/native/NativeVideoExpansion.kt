...
class NativeVideoExpansion : ExpansionCapability {
    override val id: String = "core.native.nativevideo"
    override val area: String = "core.native"
    override val purpose: String = "NativeVideo coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
