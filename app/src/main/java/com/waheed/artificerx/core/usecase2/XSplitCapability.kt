...
class XSplitCapability : ExpansionCapability {
    override val id = "core.usecase2.split"
    override val area = "core.usecase2"
    override val purpose = "Split capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
