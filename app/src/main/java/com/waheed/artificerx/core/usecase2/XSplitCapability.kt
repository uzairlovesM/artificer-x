...
/**
 * Runtime capability implementation for core.usecase2.split.
 *
...
class XSplitCapability : ExpansionCapability {
    override val id: String = "core.usecase2.split"
    override val area: String = "core.usecase2"
    override val purpose: String = "Split capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
