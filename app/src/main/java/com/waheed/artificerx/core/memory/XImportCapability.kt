...
/**
 * Runtime capability implementation for core.memory.import.
 *
...
class XImportCapability : ExpansionCapability {
    override val id: String = "core.memory.import"
    override val area: String = "core.memory"
    override val purpose: String = "Import capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
