...
class XImportCapability : ExpansionCapability {
    override val id = "core.memory.import"
    override val area = "core.memory"
    override val purpose = "Import capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
