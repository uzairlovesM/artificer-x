...
/**
 * Runtime capability implementation for core.usecase2.create.
 *
 ...
 */
class XCreateCapability : ExpansionCapability {
    override val id: String = "core.usecase2.create"
    override val area: String = "core.usecase2"
    override val purpose: String = "Create capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
