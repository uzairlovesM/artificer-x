...
/** Production expansion contract for Create. */
class XCreateCapability : ExpansionCapability {
    override val id = "core.usecase2.create"
    override val area = "core.usecase2"
    override val purpose = "Create capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
