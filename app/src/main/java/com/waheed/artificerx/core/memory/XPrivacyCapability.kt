...
class XPrivacyCapability : ExpansionCapability {
    override val id = "core.memory.privacy"
    override val area = "core.memory"
    override val purpose = "Privacy capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
