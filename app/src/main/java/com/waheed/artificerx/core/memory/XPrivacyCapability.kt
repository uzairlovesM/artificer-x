...
/**
 * Runtime capability implementation for core.memory.privacy.
 *
...
class XPrivacyCapability : ExpansionCapability {
    override val id: String = "core.memory.privacy"
    override val area: String = "core.memory"
    override val purpose: String = "Privacy capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
