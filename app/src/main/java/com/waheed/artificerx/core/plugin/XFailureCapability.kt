...
class XFailureCapability : ExpansionCapability {
    override val id = "core.plugin.failure"
    override val area = "core.plugin"
    override val purpose = "Failure capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
