...
/**
 * Runtime capability implementation for core.plugin.failure.
 *
...
class XFailureCapability : ExpansionCapability {
    override val id: String = "core.plugin.failure"
    override val area: String = "core.plugin"
    override val purpose: String = "Failure capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
