...
/**
 * Runtime capability implementation for core.diagnostics.audit.
 *
 ...
 */
class XAuditCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.audit"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Audit capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
