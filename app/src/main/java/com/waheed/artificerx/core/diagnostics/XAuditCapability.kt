...
/** Production expansion contract for Audit. */
class XAuditCapability : ExpansionCapability {
    override val id = "core.diagnostics.audit"
    override val area = "core.diagnostics"
    override val purpose = "Audit capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
