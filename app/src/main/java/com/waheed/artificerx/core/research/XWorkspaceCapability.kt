...
class XWorkspaceCapability : ExpansionCapability {
    override val id = "core.research.workspace"
    override val area = "core.research"
    override val purpose = "Workspace capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
