...
/**
 * Runtime capability implementation for core.creative.mangaplan.
 *
 ...
 */
class XMangaPlanCapability : ExpansionCapability {
    override val id: String = "core.creative.mangaplan"
    override val area: String = "core.creative"
    override val purpose: String = "MangaPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
