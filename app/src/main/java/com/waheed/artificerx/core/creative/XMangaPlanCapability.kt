...
/** Production expansion contract for MangaPlan. */
class XMangaPlanCapability : ExpansionCapability {
    override val id = "core.creative.mangaplan"
    override val area = "core.creative"
    override val purpose = "MangaPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
