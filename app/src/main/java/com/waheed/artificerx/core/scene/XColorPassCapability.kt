...
/** Production expansion contract for ColorPass. */
class XColorPassCapability : ExpansionCapability {
    override val id = "core.scene.colorpass"
    override val area = "core.scene"
    override val purpose = "ColorPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
