...
/**
 * Runtime capability implementation for core.scene.colorpass.
 *
 ...
 */
class XColorPassCapability : ExpansionCapability {
    override val id: String = "core.scene.colorpass"
    override val area: String = "core.scene"
    override val purpose: String = "ColorPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
