...
/**
 * Runtime capability implementation for core.importer.zip.
 *
 ...
 */
class XZipCapability : ExpansionCapability {
    override val id: String = "core.importer.zip"
    override val area: String = "core.importer"
    override val purpose: String = "Zip capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
