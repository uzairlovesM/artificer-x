...
/** Production expansion contract for Zip. */
class XZipCapability : ExpansionCapability {
    override val id = "core.importer.zip"
    override val area = "core.importer"
    override val purpose = "Zip capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
