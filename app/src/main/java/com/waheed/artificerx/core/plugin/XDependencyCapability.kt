...
class XDependencyCapability : ExpansionCapability {
    override val id = "core.plugin.dependency"
    override val area = "core.plugin"
    override val purpose = "Dependency capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
