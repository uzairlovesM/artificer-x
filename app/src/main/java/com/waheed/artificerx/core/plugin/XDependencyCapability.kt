...
/**
 * Runtime capability implementation for core.plugin.dependency.
 *
...
class XDependencyCapability : ExpansionCapability {
    override val id: String = "core.plugin.dependency"
    override val area: String = "core.plugin"
    override val purpose: String = "Dependency capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
