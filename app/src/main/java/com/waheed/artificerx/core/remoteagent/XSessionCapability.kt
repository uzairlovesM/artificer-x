...
/**
 * Runtime capability implementation for core.remoteagent.session.
 *
...
class XSessionCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.session"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Session capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
