...
/** Production expansion contract for Session. */
class XSessionCapability : ExpansionCapability {
    override val id = "core.remoteagent.session"
    override val area = "core.remoteagent"
    override val purpose = "Session capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
