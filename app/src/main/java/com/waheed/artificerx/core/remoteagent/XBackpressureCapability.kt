...
/**
 * Runtime capability implementation for core.remoteagent.backpressure.
 *
 ...
 */
class XBackpressureCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.backpressure"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Backpressure capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
