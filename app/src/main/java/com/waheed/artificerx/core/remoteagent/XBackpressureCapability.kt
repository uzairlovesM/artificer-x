...
/** Production expansion contract for Backpressure. */
class XBackpressureCapability : ExpansionCapability {
    override val id = "core.remoteagent.backpressure"
    override val area = "core.remoteagent"
    override val purpose = "Backpressure capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
