...
class NativeHashExpansion : ExpansionCapability {
    override val id: String = "core.native.nativehash"
    override val area: String = "core.native"
    override val purpose: String = "NativeHash coordinates core.native responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
