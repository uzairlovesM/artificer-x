...
/**
 * Runtime capability implementation for core.creative.thumbnail.
 *
 ...
 */
class XThumbnailCapability : ExpansionCapability {
    override val id: String = "core.creative.thumbnail"
    override val area: String = "core.creative"
    override val purpose: String = "Thumbnail capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
