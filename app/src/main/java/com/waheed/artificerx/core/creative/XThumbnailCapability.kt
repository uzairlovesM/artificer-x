...
/** Production expansion contract for Thumbnail. */
class XThumbnailCapability : ExpansionCapability {
    override val id = "core.creative.thumbnail"
    override val area = "core.creative"
    override val purpose = "Thumbnail capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
