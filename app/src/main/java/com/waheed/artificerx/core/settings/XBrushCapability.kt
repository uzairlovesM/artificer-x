...
/**
 * Runtime capability implementation for core.settings.brush.
 *
 ...
 */
class XBrushCapability : ExpansionCapability {
    override val id: String = "core.settings.brush"
    override val area: String = "core.settings"
    override val purpose: String = "Brush capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
