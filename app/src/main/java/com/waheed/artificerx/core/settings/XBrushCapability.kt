...
class XBrushCapability : ExpansionCapability {
    override val id = "core.settings.brush"
    override val area = "core.settings"
    override val purpose = "Brush capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
