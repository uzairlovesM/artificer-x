...
/**
 * Runtime capability implementation for core.settings.permission.
 *
 ...
 */
class XPermissionCapability : ExpansionCapability {
    override val id: String = "core.settings.permission"
    override val area: String = "core.settings"
    override val purpose: String = "Permission capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
