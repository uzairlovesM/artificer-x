...
class XPermissionCapability : ExpansionCapability {
    override val id = "core.settings.permission"
    override val area = "core.settings"
    override val purpose = "Permission capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
