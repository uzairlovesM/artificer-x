...
/**
 * Runtime capability implementation for core.model.validator.
 *
...
class XValidatorCapability : ExpansionCapability {
    override val id: String = "core.model.validator"
    override val area: String = "core.model"
    override val purpose: String = "Validator capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
