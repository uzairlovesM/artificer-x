...
class XValidatorCapability : ExpansionCapability {
    override val id = "core.model.validator"
    override val area = "core.model"
    override val purpose = "Validator capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
