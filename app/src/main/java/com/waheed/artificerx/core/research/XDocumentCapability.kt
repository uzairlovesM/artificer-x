...
/** Production expansion contract for Document. */
class XDocumentCapability : ExpansionCapability {
    override val id = "core.research.document"
    override val area = "core.research"
    override val purpose = "Document capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
