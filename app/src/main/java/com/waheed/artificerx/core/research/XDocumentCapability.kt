...
/**
 * Runtime capability implementation for core.research.document.
 *
 ...
 */
class XDocumentCapability : ExpansionCapability {
    override val id: String = "core.research.document"
    override val area: String = "core.research"
    override val purpose: String = "Document capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
