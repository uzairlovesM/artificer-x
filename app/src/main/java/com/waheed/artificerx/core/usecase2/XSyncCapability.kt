...
class XSyncCapability : ExpansionCapability {
    override val id = "core.usecase2.sync"
    override val area = "core.usecase2"
    override val purpose = "Sync capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
