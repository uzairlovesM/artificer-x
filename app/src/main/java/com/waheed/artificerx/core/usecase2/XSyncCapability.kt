...
/**
 * Runtime capability implementation for core.usecase2.sync.
 *
...
class XSyncCapability : ExpansionCapability {
    override val id: String = "core.usecase2.sync"
    override val area: String = "core.usecase2"
    override val purpose: String = "Sync capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
