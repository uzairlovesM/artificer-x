...
/** Production expansion contract for Object. */
class XObjectCapability : ExpansionCapability {
    override val id = "core.storage.object"
    override val area = "core.storage"
    override val purpose = "Object capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
