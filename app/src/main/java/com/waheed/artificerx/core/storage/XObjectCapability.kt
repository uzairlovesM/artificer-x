...
/**
 * Runtime capability implementation for core.storage.object.
 *
...
class XObjectCapability : ExpansionCapability {
    override val id: String = "core.storage.object"
    override val area: String = "core.storage"
    override val purpose: String = "Object capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
