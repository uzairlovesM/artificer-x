...
/** Production expansion contract for Copy. */
class XCopyCapability : ExpansionCapability {
    override val id = "core.usecase2.copy"
    override val area = "core.usecase2"
    override val purpose = "Copy capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
