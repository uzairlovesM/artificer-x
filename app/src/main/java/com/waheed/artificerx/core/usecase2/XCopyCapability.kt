...
/**
 * Runtime capability implementation for core.usecase2.copy.
 *
 ...
 */
class XCopyCapability : ExpansionCapability {
    override val id: String = "core.usecase2.copy"
    override val area: String = "core.usecase2"
    override val purpose: String = "Copy capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
