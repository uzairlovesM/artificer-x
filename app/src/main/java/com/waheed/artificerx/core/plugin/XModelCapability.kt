...
/**
 * Runtime capability implementation for core.plugin.model.
 *
...
class XModelCapability : ExpansionCapability {
    override val id: String = "core.plugin.model"
    override val area: String = "core.plugin"
    override val purpose: String = "Model capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
