...
/**
 * Runtime capability implementation for core.remoteagent.policy.
 *
...
class XPolicyCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.policy"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Policy capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
