...
/** Production expansion contract for Policy. */
class XPolicyCapability : ExpansionCapability {
    override val id = "core.remoteagent.policy"
    override val area = "core.remoteagent"
    override val purpose = "Policy capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
