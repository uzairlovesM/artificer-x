...
class XHealthCapability : ExpansionCapability {
    override val id = "core.plugin.health"
    override val area = "core.plugin"
    override val purpose = "Health capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
