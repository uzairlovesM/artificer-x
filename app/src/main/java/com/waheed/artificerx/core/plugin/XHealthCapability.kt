...
/**
 * Runtime capability implementation for core.plugin.health.
 *
...
class XHealthCapability : ExpansionCapability {
    override val id: String = "core.plugin.health"
    override val area: String = "core.plugin"
    override val purpose: String = "Health capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
