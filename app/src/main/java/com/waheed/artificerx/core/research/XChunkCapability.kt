...
class XChunkCapability : ExpansionCapability {
    override val id = "core.research.chunk"
    override val area = "core.research"
    override val purpose = "Chunk capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
