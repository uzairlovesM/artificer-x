...
/**
 * Runtime capability implementation for core.research.chunk.
 *
 ...
 */
class XChunkCapability : ExpansionCapability {
    override val id: String = "core.research.chunk"
    override val area: String = "core.research"
    override val purpose: String = "Chunk capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
