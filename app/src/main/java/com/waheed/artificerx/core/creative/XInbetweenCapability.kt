...
/**
 * Runtime capability implementation for core.creative.inbetween.
 *
 ...
 */
class XInbetweenCapability : ExpansionCapability {
    override val id: String = "core.creative.inbetween"
    override val area: String = "core.creative"
    override val purpose: String = "Inbetween capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
