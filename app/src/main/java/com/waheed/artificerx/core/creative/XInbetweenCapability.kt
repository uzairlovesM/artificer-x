...
/** Production expansion contract for Inbetween. */
class XInbetweenCapability : ExpansionCapability {
    override val id = "core.creative.inbetween"
    override val area = "core.creative"
    override val purpose = "Inbetween capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
