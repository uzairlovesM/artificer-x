...
/**
 * Runtime capability implementation for core.settings.store.
 *
 ...
 */
class XStoreCapability : ExpansionCapability {
    override val id: String = "core.settings.store"
    override val area: String = "core.settings"
    override val purpose: String = "Store capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
