...
/** Production expansion contract for Store. */
class XStoreCapability : ExpansionCapability {
    override val id = "core.settings.store"
    override val area = "core.settings"
    override val purpose = "Store capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
