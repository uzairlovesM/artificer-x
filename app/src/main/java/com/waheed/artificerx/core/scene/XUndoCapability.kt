...
/** Production expansion contract for Undo. */
class XUndoCapability : ExpansionCapability {
    override val id = "core.scene.undo"
    override val area = "core.scene"
    override val purpose = "Undo capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
