...
/**
 * Runtime capability implementation for core.scene.undo.
 *
 ...
 */
class XUndoCapability : ExpansionCapability {
    override val id: String = "core.scene.undo"
    override val area: String = "core.scene"
    override val purpose: String = "Undo capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
