...
/**
 * Runtime capability implementation for core.diagnostics.room.
 *
 ...
 */
class XRoomCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.room"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Room capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
