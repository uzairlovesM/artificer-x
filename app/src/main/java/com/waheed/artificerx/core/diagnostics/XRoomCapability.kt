...
/** Production expansion contract for Room. */
class XRoomCapability : ExpansionCapability {
    override val id = "core.diagnostics.room"
    override val area = "core.diagnostics"
    override val purpose = "Room capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
