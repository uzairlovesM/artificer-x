...
class XDestinationCapability : ExpansionCapability {
    override val id = "core.export.destination"
    override val area = "core.export"
    override val purpose = "Destination capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
