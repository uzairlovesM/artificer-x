...
/**
 * Runtime capability implementation for core.export.destination.
 *
...
class XDestinationCapability : ExpansionCapability {
    override val id: String = "core.export.destination"
    override val area: String = "core.export"
    override val purpose: String = "Destination capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
