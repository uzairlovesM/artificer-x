...
/**
 * Runtime capability implementation for core.model.embedding.
 *
...
class XEmbeddingCapability : ExpansionCapability {
    override val id: String = "core.model.embedding"
    override val area: String = "core.model"
    override val purpose: String = "Embedding capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
