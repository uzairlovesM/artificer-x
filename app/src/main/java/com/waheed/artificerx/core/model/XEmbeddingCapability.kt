...
class XEmbeddingCapability : ExpansionCapability {
    override val id = "core.model.embedding"
    override val area = "core.model"
    override val purpose = "Embedding capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
