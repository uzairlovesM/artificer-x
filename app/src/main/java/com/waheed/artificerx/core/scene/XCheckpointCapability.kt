...
class XCheckpointCapability : ExpansionCapability {
    override val id = "core.scene.checkpoint"
    override val area = "core.scene"
    override val purpose = "Checkpoint capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
