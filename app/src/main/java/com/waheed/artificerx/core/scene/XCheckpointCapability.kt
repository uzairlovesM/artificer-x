...
/**
 * Runtime capability implementation for core.scene.checkpoint.
 *
...
class XCheckpointCapability : ExpansionCapability {
    override val id: String = "core.scene.checkpoint"
    override val area: String = "core.scene"
    override val purpose: String = "Checkpoint capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
