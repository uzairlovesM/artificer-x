...
class XPolicyCapability : ExpansionCapability {
    override val id = "core.settings.policy"
    override val area = "core.settings"
    override val purpose = "Policy capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
