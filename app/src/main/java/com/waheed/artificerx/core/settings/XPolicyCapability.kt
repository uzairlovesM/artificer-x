...
/**
 * Runtime capability implementation for core.settings.policy.
 *
...
class XPolicyCapability : ExpansionCapability {
    override val id: String = "core.settings.policy"
    override val area: String = "core.settings"
    override val purpose: String = "Policy capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
