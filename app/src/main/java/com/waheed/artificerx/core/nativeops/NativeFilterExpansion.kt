...
class NativeFilterExpansion : ExpansionCapability {
    override val id: String = "core.nativeops.nativefilter"
    override val area: String = "core.nativeops"
    override val purpose: String = "NativeFilter coordinates core.nativeops responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
