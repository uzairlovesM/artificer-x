...
class XCheckpointCapability : ExpansionCapability {
    override val id = "core.memory.checkpoint"
    override val area = "core.memory"
    override val purpose = "Checkpoint capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
