...
/**
 * Runtime capability implementation for core.memory.checkpoint.
 *
...
class XCheckpointCapability : ExpansionCapability {
    override val id: String = "core.memory.checkpoint"
    override val area: String = "core.memory"
    override val purpose: String = "Checkpoint capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
