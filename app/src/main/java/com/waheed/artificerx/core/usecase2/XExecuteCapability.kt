...
/** Production expansion contract for Execute. */
class XExecuteCapability : ExpansionCapability {
    override val id = "core.usecase2.execute"
    override val area = "core.usecase2"
    override val purpose = "Execute capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
