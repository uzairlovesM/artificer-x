...
/**
 * Runtime capability implementation for core.usecase2.execute.
 *
 ...
 */
class XExecuteCapability : ExpansionCapability {
    override val id: String = "core.usecase2.execute"
    override val area: String = "core.usecase2"
    override val purpose: String = "Execute capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
