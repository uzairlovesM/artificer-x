...
class XRecentCapability : ExpansionCapability {
    override val id = "core.navigation.recent"
    override val area = "core.navigation"
    override val purpose = "Recent capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
