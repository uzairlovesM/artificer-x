...
/**
 * Runtime capability implementation for core.navigation.recent.
 *
 ...
 */
class XRecentCapability : ExpansionCapability {
    override val id: String = "core.navigation.recent"
    override val area: String = "core.navigation"
    override val purpose: String = "Recent capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
