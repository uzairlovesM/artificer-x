...
class XNamingCapability : ExpansionCapability {
    override val id = "core.export.naming"
    override val area = "core.export"
    override val purpose = "Naming capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
