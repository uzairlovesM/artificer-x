...
/**
 * Runtime capability implementation for core.export.naming.
 *
...
class XNamingCapability : ExpansionCapability {
    override val id: String = "core.export.naming"
    override val area: String = "core.export"
    override val purpose: String = "Naming capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
