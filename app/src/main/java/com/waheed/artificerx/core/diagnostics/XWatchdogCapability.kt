...
/**
 * Runtime capability implementation for core.diagnostics.watchdog.
 *
 ...
 */
class XWatchdogCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.watchdog"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Watchdog capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
