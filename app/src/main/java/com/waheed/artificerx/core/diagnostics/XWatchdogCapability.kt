...
/** Production expansion contract for Watchdog. */
class XWatchdogCapability : ExpansionCapability {
    override val id = "core.diagnostics.watchdog"
    override val area = "core.diagnostics"
    override val purpose = "Watchdog capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
