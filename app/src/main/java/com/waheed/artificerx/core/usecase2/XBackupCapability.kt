...
/**
 * Runtime capability implementation for core.usecase2.backup.
 *
...
class XBackupCapability : ExpansionCapability {
    override val id: String = "core.usecase2.backup"
    override val area: String = "core.usecase2"
    override val purpose: String = "Backup capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
