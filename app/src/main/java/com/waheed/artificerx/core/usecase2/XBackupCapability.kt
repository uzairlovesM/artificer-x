...
class XBackupCapability : ExpansionCapability {
    override val id = "core.usecase2.backup"
    override val area = "core.usecase2"
    override val purpose = "Backup capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
