...
/**
 * Runtime capability implementation for core.storage.favorite.
 *
...
class XFavoriteCapability : ExpansionCapability {
    override val id: String = "core.storage.favorite"
    override val area: String = "core.storage"
    override val purpose: String = "Favorite capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
