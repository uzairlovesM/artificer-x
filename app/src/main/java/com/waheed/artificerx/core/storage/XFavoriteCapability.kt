...
/** Production expansion contract for Favorite. */
class XFavoriteCapability : ExpansionCapability {
    override val id = "core.storage.favorite"
    override val area = "core.storage"
    override val purpose = "Favorite capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
