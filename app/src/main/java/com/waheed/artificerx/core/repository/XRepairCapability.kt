...
class XRepairCapability : ExpansionCapability {
    override val id = "core.repository.repair"
    override val area = "core.repository"
    override val purpose = "Repair capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
