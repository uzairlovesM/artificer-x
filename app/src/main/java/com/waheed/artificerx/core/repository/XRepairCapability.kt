...
/**
 * Runtime capability implementation for core.repository.repair.
 *
 ...
 */
class XRepairCapability : ExpansionCapability {
    override val id: String = "core.repository.repair"
    override val area: String = "core.repository"
    override val purpose: String = "Repair capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
