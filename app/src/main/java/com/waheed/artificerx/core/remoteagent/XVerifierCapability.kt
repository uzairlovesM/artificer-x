...
/** Production expansion contract for Verifier. */
class XVerifierCapability : ExpansionCapability {
    override val id = "core.remoteagent.verifier"
    override val area = "core.remoteagent"
    override val purpose = "Verifier capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
