...
/**
 * Runtime capability implementation for core.remoteagent.verifier.
 *
...
class XVerifierCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.verifier"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Verifier capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
