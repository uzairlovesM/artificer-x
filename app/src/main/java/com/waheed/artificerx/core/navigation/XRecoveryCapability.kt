...
class XRecoveryCapability : ExpansionCapability {
    override val id = "core.navigation.recovery"
    override val area = "core.navigation"
    override val purpose = "Recovery capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
