...
/**
 * Runtime capability implementation for core.navigation.recovery.
 *
...
class XRecoveryCapability : ExpansionCapability {
    override val id: String = "core.navigation.recovery"
    override val area: String = "core.navigation"
    override val purpose: String = "Recovery capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
