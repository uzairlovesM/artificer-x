...
/**
 * Runtime capability implementation for core.memory.working.
 *
 ...
 */
class XWorkingCapability : ExpansionCapability {
    override val id: String = "core.memory.working"
    override val area: String = "core.memory"
    override val purpose: String = "Working capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
