...
/** Production expansion contract for Working. */
class XWorkingCapability : ExpansionCapability {
    override val id = "core.memory.working"
    override val area = "core.memory"
    override val purpose = "Working capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
