...
/**
 * Runtime capability implementation for core.memory.action.
 *
 ...
 */
class XActionCapability : ExpansionCapability {
    override val id: String = "core.memory.action"
    override val area: String = "core.memory"
    override val purpose: String = "Action capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
