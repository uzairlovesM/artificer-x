...
/** Production expansion contract for Action. */
class XActionCapability : ExpansionCapability {
    override val id = "core.memory.action"
    override val area = "core.memory"
    override val purpose = "Action capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
