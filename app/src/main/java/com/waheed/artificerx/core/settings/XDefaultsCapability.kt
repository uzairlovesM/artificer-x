...
/** Production expansion contract for Defaults. */
class XDefaultsCapability : ExpansionCapability {
    override val id = "core.settings.defaults"
    override val area = "core.settings"
    override val purpose = "Defaults capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
