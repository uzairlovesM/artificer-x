...
/**
 * Runtime capability implementation for core.settings.defaults.
 *
 ...
 */
class XDefaultsCapability : ExpansionCapability {
    override val id: String = "core.settings.defaults"
    override val area: String = "core.settings"
    override val purpose: String = "Defaults capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
