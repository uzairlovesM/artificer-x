...
/**
 * Runtime capability implementation for core.creative.assetplan.
 *
 ...
 */
class XAssetPlanCapability : ExpansionCapability {
    override val id: String = "core.creative.assetplan"
    override val area: String = "core.creative"
    override val purpose: String = "AssetPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
