...
/** Production expansion contract for AssetPlan. */
class XAssetPlanCapability : ExpansionCapability {
    override val id = "core.creative.assetplan"
    override val area = "core.creative"
    override val purpose = "AssetPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
