...
/** Production expansion contract for Critic. */
class XCriticCapability : ExpansionCapability {
    override val id = "core.remoteagent.critic"
    override val area = "core.remoteagent"
    override val purpose = "Critic capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
