...
/**
 * Runtime capability implementation for core.remoteagent.critic.
 *
 ...
 */
class XCriticCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.critic"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Critic capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
