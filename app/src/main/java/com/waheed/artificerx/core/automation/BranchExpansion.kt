...
class BranchExpansion : ExpansionCapability {
    override val id: String = "core.automation.branch"
    override val area: String = "core.automation"
    override val purpose: String = "Branch coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
