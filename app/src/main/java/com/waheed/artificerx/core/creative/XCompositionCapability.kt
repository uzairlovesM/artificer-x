...
/** Production expansion contract for Composition. */
class XCompositionCapability : ExpansionCapability {
    override val id = "core.creative.composition"
    override val area = "core.creative"
    override val purpose = "Composition capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
