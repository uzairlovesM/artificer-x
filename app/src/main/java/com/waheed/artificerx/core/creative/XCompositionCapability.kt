...
/**
 * Runtime capability implementation for core.creative.composition.
 *
 ...
 */
class XCompositionCapability : ExpansionCapability {
    override val id: String = "core.creative.composition"
    override val area: String = "core.creative"
    override val purpose: String = "Composition capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
