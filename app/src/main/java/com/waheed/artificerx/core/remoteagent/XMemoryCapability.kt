...
class XMemoryCapability : ExpansionCapability {
    override val id = "core.remoteagent.memory"
    override val area = "core.remoteagent"
    override val purpose = "Memory capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
