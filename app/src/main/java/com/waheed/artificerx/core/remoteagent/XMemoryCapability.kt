...
/**
 * Runtime capability implementation for core.remoteagent.memory.
 *
...
class XMemoryCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.memory"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Memory capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
