...
/** Production expansion contract for ExportPass. */
class XExportPassCapability : ExpansionCapability {
    override val id = "core.scene.exportpass"
    override val area = "core.scene"
    override val purpose = "ExportPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
