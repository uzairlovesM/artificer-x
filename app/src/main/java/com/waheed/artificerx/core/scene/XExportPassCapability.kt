...
/**
 * Runtime capability implementation for core.scene.exportpass.
 *
 ...
 */
class XExportPassCapability : ExpansionCapability {
    override val id: String = "core.scene.exportpass"
    override val area: String = "core.scene"
    override val purpose: String = "ExportPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
