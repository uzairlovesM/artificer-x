...
/**
 * Runtime capability implementation for core.model.unload.
 *
 ...
 */
class XUnloadCapability : ExpansionCapability {
    override val id: String = "core.model.unload"
    override val area: String = "core.model"
    override val purpose: String = "Unload capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
