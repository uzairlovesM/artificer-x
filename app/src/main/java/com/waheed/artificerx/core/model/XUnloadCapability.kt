...
/** Production expansion contract for Unload. */
class XUnloadCapability : ExpansionCapability {
    override val id = "core.model.unload"
    override val area = "core.model"
    override val purpose = "Unload capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
