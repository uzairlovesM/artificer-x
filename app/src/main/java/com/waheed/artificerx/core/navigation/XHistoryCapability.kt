...
class XHistoryCapability : ExpansionCapability {
    override val id = "core.navigation.history"
    override val area = "core.navigation"
    override val purpose = "History capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
