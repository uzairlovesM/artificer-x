...
/**
 * Runtime capability implementation for core.creative.brushplan.
 *
 ...
 */
class XBrushPlanCapability : ExpansionCapability {
    override val id: String = "core.creative.brushplan"
    override val area: String = "core.creative"
    override val purpose: String = "BrushPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
