...
/** Production expansion contract for BrushPlan. */
class XBrushPlanCapability : ExpansionCapability {
    override val id = "core.creative.brushplan"
    override val area = "core.creative"
    override val purpose = "BrushPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
