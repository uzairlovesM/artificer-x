...
class CanvasExpansion : ExpansionCapability {
    override val id: String = "core.automation.canvas"
    override val area: String = "core.automation"
    override val purpose: String = "Canvas coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
