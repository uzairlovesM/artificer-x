...
/**
 * Runtime capability implementation for core.navigation.session.
 *
 ...
 */
class XSessionCapability : ExpansionCapability {
    override val id: String = "core.navigation.session"
    override val area: String = "core.navigation"
    override val purpose: String = "Session capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
