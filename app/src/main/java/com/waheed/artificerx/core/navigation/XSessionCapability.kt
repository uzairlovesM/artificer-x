...
class XSessionCapability : ExpansionCapability {
    override val id = "core.navigation.session"
    override val area = "core.navigation"
    override val purpose = "Session capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
