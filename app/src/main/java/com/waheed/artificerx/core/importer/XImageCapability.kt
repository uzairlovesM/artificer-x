...
/**
 * Runtime capability implementation for core.importer.image.
 *
...
class XImageCapability : ExpansionCapability {
    override val id: String = "core.importer.image"
    override val area: String = "core.importer"
    override val purpose: String = "Image capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
