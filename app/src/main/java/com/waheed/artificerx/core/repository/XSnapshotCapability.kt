...
/**
 * Runtime capability implementation for core.repository.snapshot.
 *
 ...
 */
class XSnapshotCapability : ExpansionCapability {
    override val id: String = "core.repository.snapshot"
    override val area: String = "core.repository"
    override val purpose: String = "Snapshot capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
