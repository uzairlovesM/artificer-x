...
class XSnapshotCapability : ExpansionCapability {
    override val id = "core.repository.snapshot"
    override val area = "core.repository"
    override val purpose = "Snapshot capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
