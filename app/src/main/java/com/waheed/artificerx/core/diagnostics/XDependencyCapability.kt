...
/** Production expansion contract for Dependency. */
class XDependencyCapability : ExpansionCapability {
    override val id = "core.diagnostics.dependency"
    override val area = "core.diagnostics"
    override val purpose = "Dependency capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
