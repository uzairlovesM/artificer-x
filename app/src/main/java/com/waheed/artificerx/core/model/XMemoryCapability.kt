...
/**
 * Runtime capability implementation for core.model.memory.
 *
...
class XMemoryCapability : ExpansionCapability {
    override val id: String = "core.model.memory"
    override val area: String = "core.model"
    override val purpose: String = "Memory capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
