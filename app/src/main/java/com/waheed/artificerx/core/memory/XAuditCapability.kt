...
/**
 * Runtime capability implementation for core.memory.audit.
 *
...
class XAuditCapability : ExpansionCapability {
    override val id: String = "core.memory.audit"
    override val area: String = "core.memory"
    override val purpose: String = "Audit capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
