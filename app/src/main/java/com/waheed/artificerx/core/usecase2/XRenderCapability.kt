...
/**
 * Runtime capability implementation for core.usecase2.render.
 *
...
class XRenderCapability : ExpansionCapability {
    override val id: String = "core.usecase2.render"
    override val area: String = "core.usecase2"
    override val purpose: String = "Render capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
