...
class XRenderCapability : ExpansionCapability {
    override val id = "core.usecase2.render"
    override val area = "core.usecase2"
    override val purpose = "Render capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
