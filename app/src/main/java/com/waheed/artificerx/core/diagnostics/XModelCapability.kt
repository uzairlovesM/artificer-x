...
/**
 * Runtime capability implementation for core.diagnostics.model.
 *
 ...
 */
class XModelCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.model"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Model capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
