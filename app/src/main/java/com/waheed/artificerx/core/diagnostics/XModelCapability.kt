...
/** Production expansion contract for Model. */
class XModelCapability : ExpansionCapability {
    override val id = "core.diagnostics.model"
    override val area = "core.diagnostics"
    override val purpose = "Model capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
