...
/** Production expansion contract for Inspect. */
class XInspectCapability : ExpansionCapability {
    override val id = "core.usecase2.inspect"
    override val area = "core.usecase2"
    override val purpose = "Inspect capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
