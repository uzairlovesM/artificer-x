...
/**
 * Runtime capability implementation for core.usecase2.inspect.
 *
 ...
 */
class XInspectCapability : ExpansionCapability {
    override val id: String = "core.usecase2.inspect"
    override val area: String = "core.usecase2"
    override val purpose: String = "Inspect capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
