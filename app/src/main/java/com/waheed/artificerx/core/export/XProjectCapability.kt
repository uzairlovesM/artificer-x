...
/**
 * Runtime capability implementation for core.export.project.
 *
...
class XProjectCapability : ExpansionCapability {
    override val id: String = "core.export.project"
    override val area: String = "core.export"
    override val purpose: String = "Project capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
