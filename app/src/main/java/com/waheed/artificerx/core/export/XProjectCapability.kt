...
class XProjectCapability : ExpansionCapability {
    override val id = "core.export.project"
    override val area = "core.export"
    override val purpose = "Project capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
