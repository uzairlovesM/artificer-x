...
/** Production expansion contract for Animation. */
class XAnimationCapability : ExpansionCapability {
    override val id = "core.settings.animation"
    override val area = "core.settings"
    override val purpose = "Animation capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
