...
/**
 * Runtime capability implementation for core.settings.animation.
 *
 ...
 */
class XAnimationCapability : ExpansionCapability {
    override val id: String = "core.settings.animation"
    override val area: String = "core.settings"
    override val purpose: String = "Animation capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
