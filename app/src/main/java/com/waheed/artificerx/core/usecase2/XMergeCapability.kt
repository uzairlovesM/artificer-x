...
class XMergeCapability : ExpansionCapability {
    override val id = "core.usecase2.merge"
    override val area = "core.usecase2"
    override val purpose = "Merge capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
