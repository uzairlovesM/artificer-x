...
/**
 * Runtime capability implementation for core.usecase2.merge.
 *
...
class XMergeCapability : ExpansionCapability {
    override val id: String = "core.usecase2.merge"
    override val area: String = "core.usecase2"
    override val purpose: String = "Merge capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
