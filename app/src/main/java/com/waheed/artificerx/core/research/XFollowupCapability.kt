...
/** Production expansion contract for Followup. */
class XFollowupCapability : ExpansionCapability {
    override val id = "core.research.followup"
    override val area = "core.research"
    override val purpose = "Followup capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
