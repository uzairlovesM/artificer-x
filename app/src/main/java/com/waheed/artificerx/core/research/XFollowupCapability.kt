...
/**
 * Runtime capability implementation for core.research.followup.
 *
 ...
 */
class XFollowupCapability : ExpansionCapability {
    override val id: String = "core.research.followup"
    override val area: String = "core.research"
    override val purpose: String = "Followup capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
