...
/**
 * Runtime capability implementation for core.research.verifier.
 *
 ...
 */
class XVerifierCapability : ExpansionCapability {
    override val id: String = "core.research.verifier"
    override val area: String = "core.research"
    override val purpose: String = "Verifier capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
