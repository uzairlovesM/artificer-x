...
class XVerifierCapability : ExpansionCapability {
    override val id = "core.research.verifier"
    override val area = "core.research"
    override val purpose = "Verifier capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
