...
/**
 * Runtime capability implementation for core.importer.project.
 *
...
class XProjectCapability : ExpansionCapability {
    override val id: String = "core.importer.project"
    override val area: String = "core.importer"
    override val purpose: String = "Project capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
