...
class XProjectCapability : ExpansionCapability {
    override val id = "core.importer.project"
    override val area = "core.importer"
    override val purpose = "Project capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
