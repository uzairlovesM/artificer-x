...
/**
 * Runtime capability implementation for core.navigation.telemetry.
 *
 ...
 */
class XTelemetryCapability : ExpansionCapability {
    override val id: String = "core.navigation.telemetry"
    override val area: String = "core.navigation"
    override val purpose: String = "Telemetry capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
