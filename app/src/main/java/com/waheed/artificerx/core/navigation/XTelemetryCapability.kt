...
class XTelemetryCapability : ExpansionCapability {
    override val id = "core.navigation.telemetry"
    override val area = "core.navigation"
    override val purpose = "Telemetry capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
