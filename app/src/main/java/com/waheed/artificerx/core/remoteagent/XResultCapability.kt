...
/**
 * Runtime capability implementation for core.remoteagent.result.
 *
...
class XResultCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.result"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Result capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
