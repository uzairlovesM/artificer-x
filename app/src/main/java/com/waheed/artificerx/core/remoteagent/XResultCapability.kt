...
/** Production expansion contract for Result. */
class XResultCapability : ExpansionCapability {
    override val id = "core.remoteagent.result"
    override val area = "core.remoteagent"
    override val purpose = "Result capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
