...
/**
 * Runtime capability implementation for core.export.text.
 *
...
class XTextCapability : ExpansionCapability {
    override val id: String = "core.export.text"
    override val area: String = "core.export"
    override val purpose: String = "Text capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
