...
/** Production expansion contract for Integrity. */
class XIntegrityCapability : ExpansionCapability {
    override val id = "core.diagnostics.integrity"
    override val area = "core.diagnostics"
    override val purpose = "Integrity capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
