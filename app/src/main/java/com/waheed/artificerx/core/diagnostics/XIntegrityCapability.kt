...
/**
 * Runtime capability implementation for core.diagnostics.integrity.
 *
 ...
 */
class XIntegrityCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.integrity"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Integrity capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
