...
/**
 * Runtime capability implementation for core.repository.cherrypick.
 *
 ...
 */
class XCherryPickCapability : ExpansionCapability {
    override val id: String = "core.repository.cherrypick"
    override val area: String = "core.repository"
    override val purpose: String = "CherryPick capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
