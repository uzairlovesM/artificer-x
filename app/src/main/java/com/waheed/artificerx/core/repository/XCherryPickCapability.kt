...
/** Production expansion contract for CherryPick. */
class XCherryPickCapability : ExpansionCapability {
    override val id = "core.repository.cherrypick"
    override val area = "core.repository"
    override val purpose = "CherryPick capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
