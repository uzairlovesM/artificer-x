...
/** Production expansion contract for Preference. */
class XPreferenceCapability : ExpansionCapability {
    override val id = "core.memory.preference"
    override val area = "core.memory"
    override val purpose = "Preference capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
