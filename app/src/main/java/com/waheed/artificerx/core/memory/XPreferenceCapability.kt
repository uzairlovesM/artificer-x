...
/**
 * Runtime capability implementation for core.memory.preference.
 *
 ...
 */
class XPreferenceCapability : ExpansionCapability {
    override val id: String = "core.memory.preference"
    override val area: String = "core.memory"
    override val purpose: String = "Preference capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
