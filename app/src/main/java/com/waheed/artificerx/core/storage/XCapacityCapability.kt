...
/** Production expansion contract for Capacity. */
class XCapacityCapability : ExpansionCapability {
    override val id = "core.storage.capacity"
    override val area = "core.storage"
    override val purpose = "Capacity capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
