...
/**
 * Runtime capability implementation for core.storage.capacity.
 *
 ...
 */
class XCapacityCapability : ExpansionCapability {
    override val id: String = "core.storage.capacity"
    override val area: String = "core.storage"
    override val purpose: String = "Capacity capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
