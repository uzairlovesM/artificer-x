...
/** Production expansion contract for Provenance. */
class XProvenanceCapability : ExpansionCapability {
    override val id = "core.research.provenance"
    override val area = "core.research"
    override val purpose = "Provenance capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
