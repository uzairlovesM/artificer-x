...
class XStorageCapability : ExpansionCapability {
    override val id = "core.settings.storage"
    override val area = "core.settings"
    override val purpose = "Storage capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
