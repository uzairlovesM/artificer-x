...
/**
 * Runtime capability implementation for core.settings.storage.
 *
...
class XStorageCapability : ExpansionCapability {
    override val id: String = "core.settings.storage"
    override val area: String = "core.settings"
    override val purpose: String = "Storage capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
