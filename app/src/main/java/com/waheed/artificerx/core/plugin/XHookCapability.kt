...
/** Production expansion contract for Hook. */
class XHookCapability : ExpansionCapability {
    override val id = "core.plugin.hook"
    override val area = "core.plugin"
    override val purpose = "Hook capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
