...
/**
 * Runtime capability implementation for core.plugin.hook.
 *
...
class XHookCapability : ExpansionCapability {
    override val id: String = "core.plugin.hook"
    override val area: String = "core.plugin"
    override val purpose: String = "Hook capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
