...
/**
 * Runtime capability implementation for core.remoteagent.health.
 *
...
class XHealthCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.health"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Health capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
