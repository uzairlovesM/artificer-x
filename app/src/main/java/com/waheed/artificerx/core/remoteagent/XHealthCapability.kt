...
class XHealthCapability : ExpansionCapability {
    override val id = "core.remoteagent.health"
    override val area = "core.remoteagent"
    override val purpose = "Health capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
