...
/**
 * Runtime capability implementation for core.memory.compressor.
 *
...
class XCompressorCapability : ExpansionCapability {
    override val id: String = "core.memory.compressor"
    override val area: String = "core.memory"
    override val purpose: String = "Compressor capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
