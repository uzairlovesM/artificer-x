...
class XExportCapability : ExpansionCapability {
    override val id = "core.creative.export"
    override val area = "core.creative"
    override val purpose = "Export capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
