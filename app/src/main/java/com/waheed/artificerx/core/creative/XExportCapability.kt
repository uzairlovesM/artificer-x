...
/**
 * Runtime capability implementation for core.creative.export.
 *
...
class XExportCapability : ExpansionCapability {
    override val id: String = "core.creative.export"
    override val area: String = "core.creative"
    override val purpose: String = "Export capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
