...
/** Production expansion contract for Benchmark. */
class XBenchmarkCapability : ExpansionCapability {
    override val id = "core.usecase2.benchmark"
    override val area = "core.usecase2"
    override val purpose = "Benchmark capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
