...
/**
 * Runtime capability implementation for core.usecase2.benchmark.
 *
 ...
 */
class XBenchmarkCapability : ExpansionCapability {
    override val id: String = "core.usecase2.benchmark"
    override val area: String = "core.usecase2"
    override val purpose: String = "Benchmark capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
