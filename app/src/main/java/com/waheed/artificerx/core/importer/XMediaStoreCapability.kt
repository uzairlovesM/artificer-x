...
/**
 * Runtime capability implementation for core.importer.mediastore.
 *
 ...
 */
class XMediaStoreCapability : ExpansionCapability {
    override val id: String = "core.importer.mediastore"
    override val area: String = "core.importer"
    override val purpose: String = "MediaStore capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
