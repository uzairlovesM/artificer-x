...
/** Production expansion contract for MediaStore. */
class XMediaStoreCapability : ExpansionCapability {
    override val id = "core.importer.mediastore"
    override val area = "core.importer"
    override val purpose = "MediaStore capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
