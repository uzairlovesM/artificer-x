...
/**
 * Runtime capability implementation for core.scene.texturepass.
 *
 ...
 */
class XTexturePassCapability : ExpansionCapability {
    override val id: String = "core.scene.texturepass"
    override val area: String = "core.scene"
    override val purpose: String = "TexturePass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
