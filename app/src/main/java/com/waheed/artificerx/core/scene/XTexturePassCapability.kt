...
/** Production expansion contract for TexturePass. */
class XTexturePassCapability : ExpansionCapability {
    override val id = "core.scene.texturepass"
    override val area = "core.scene"
    override val purpose = "TexturePass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
