...
class XContextCapability : ExpansionCapability {
    override val id = "core.remoteagent.context"
    override val area = "core.remoteagent"
    override val purpose = "Context capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
