...
/**
 * Runtime capability implementation for core.remoteagent.context.
 *
...
class XContextCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.context"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Context capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
