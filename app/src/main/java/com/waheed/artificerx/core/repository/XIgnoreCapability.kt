...
/**
 * Runtime capability implementation for core.repository.ignore.
 *
 ...
 */
class XIgnoreCapability : ExpansionCapability {
    override val id: String = "core.repository.ignore"
    override val area: String = "core.repository"
    override val purpose: String = "Ignore capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
