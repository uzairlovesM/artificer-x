...
/** Production expansion contract for Ignore. */
class XIgnoreCapability : ExpansionCapability {
    override val id = "core.repository.ignore"
    override val area = "core.repository"
    override val purpose = "Ignore capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
