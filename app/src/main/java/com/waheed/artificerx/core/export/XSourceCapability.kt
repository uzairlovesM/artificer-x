...
/**
 * Runtime capability implementation for core.export.source.
 *
...
class XSourceCapability : ExpansionCapability {
    override val id: String = "core.export.source"
    override val area: String = "core.export"
    override val purpose: String = "Source capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
