...
class XSourceCapability : ExpansionCapability {
    override val id = "core.export.source"
    override val area = "core.export"
    override val purpose = "Source capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
