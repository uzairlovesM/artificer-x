...
/**
 * Runtime capability implementation for core.remoteagent.queue.
 *
...
class XQueueCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.queue"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Queue capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
