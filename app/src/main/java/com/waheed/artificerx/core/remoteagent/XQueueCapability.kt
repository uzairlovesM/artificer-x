...
/** Production expansion contract for Queue. */
class XQueueCapability : ExpansionCapability {
    override val id = "core.remoteagent.queue"
    override val area = "core.remoteagent"
    override val purpose = "Queue capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
