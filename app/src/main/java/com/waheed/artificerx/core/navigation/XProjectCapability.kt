...
class XProjectCapability : ExpansionCapability {
    override val id = "core.navigation.project"
    override val area = "core.navigation"
    override val purpose = "Project capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
