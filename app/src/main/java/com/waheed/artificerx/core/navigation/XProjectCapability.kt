...
/**
 * Runtime capability implementation for core.navigation.project.
 *
...
class XProjectCapability : ExpansionCapability {
    override val id: String = "core.navigation.project"
    override val area: String = "core.navigation"
    override val purpose: String = "Project capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
