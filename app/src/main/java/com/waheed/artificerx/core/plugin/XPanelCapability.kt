...
/**
 * Runtime capability implementation for core.plugin.panel.
 *
 ...
 */
class XPanelCapability : ExpansionCapability {
    override val id: String = "core.plugin.panel"
    override val area: String = "core.plugin"
    override val purpose: String = "Panel capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
