...
/** Production expansion contract for Panel. */
class XPanelCapability : ExpansionCapability {
    override val id = "core.plugin.panel"
    override val area = "core.plugin"
    override val purpose = "Panel capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
