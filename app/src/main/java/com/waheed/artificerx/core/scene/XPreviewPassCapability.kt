...
/** Production expansion contract for PreviewPass. */
class XPreviewPassCapability : ExpansionCapability {
    override val id = "core.scene.previewpass"
    override val area = "core.scene"
    override val purpose = "PreviewPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
