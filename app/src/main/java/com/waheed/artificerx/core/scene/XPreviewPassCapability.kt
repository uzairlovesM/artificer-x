...
/**
 * Runtime capability implementation for core.scene.previewpass.
 *
 ...
 */
class XPreviewPassCapability : ExpansionCapability {
    override val id: String = "core.scene.previewpass"
    override val area: String = "core.scene"
    override val purpose: String = "PreviewPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
