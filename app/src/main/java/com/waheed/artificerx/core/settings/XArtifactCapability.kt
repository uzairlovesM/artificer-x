...
/**
 * Runtime capability implementation for core.settings.artifact.
 *
 ...
 */
class XArtifactCapability : ExpansionCapability {
    override val id: String = "core.settings.artifact"
    override val area: String = "core.settings"
    override val purpose: String = "Artifact capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
