...
class XArtifactCapability : ExpansionCapability {
    override val id = "core.settings.artifact"
    override val area = "core.settings"
    override val purpose = "Artifact capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
