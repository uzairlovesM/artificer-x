...
/**
 * Runtime capability implementation for core.model.json.
 *
...
class XJsonCapability : ExpansionCapability {
    override val id: String = "core.model.json"
    override val area: String = "core.model"
    override val purpose: String = "Json capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
