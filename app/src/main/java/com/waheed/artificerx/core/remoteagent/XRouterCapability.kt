...
/** Production expansion contract for Router. */
class XRouterCapability : ExpansionCapability {
    override val id = "core.remoteagent.router"
    override val area = "core.remoteagent"
    override val purpose = "Router capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
