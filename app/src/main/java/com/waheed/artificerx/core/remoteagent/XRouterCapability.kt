...
/**
 * Runtime capability implementation for core.remoteagent.router.
 *
...
class XRouterCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.router"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Router capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
