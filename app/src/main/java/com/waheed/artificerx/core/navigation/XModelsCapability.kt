...
/**
 * Runtime capability implementation for core.navigation.models.
 *
 ...
 */
class XModelsCapability : ExpansionCapability {
    override val id: String = "core.navigation.models"
    override val area: String = "core.navigation"
    override val purpose: String = "Models capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
