...
/** Production expansion contract for Models. */
class XModelsCapability : ExpansionCapability {
    override val id = "core.navigation.models"
    override val area = "core.navigation"
    override val purpose = "Models capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
