...
/**
 * Runtime capability implementation for core.model.batch.
 *
...
class XBatchCapability : ExpansionCapability {
    override val id: String = "core.model.batch"
    override val area: String = "core.model"
    override val purpose: String = "Batch capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
