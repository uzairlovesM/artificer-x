...
/**
 * Runtime capability implementation for core.repository.commit.
 *
 ...
 */
class XCommitCapability : ExpansionCapability {
    override val id: String = "core.repository.commit"
    override val area: String = "core.repository"
    override val purpose: String = "Commit capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
