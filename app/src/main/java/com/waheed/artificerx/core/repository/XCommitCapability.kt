...
/** Production expansion contract for Commit. */
class XCommitCapability : ExpansionCapability {
    override val id = "core.repository.commit"
    override val area = "core.repository"
    override val purpose = "Commit capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
