...
/**
 * Runtime capability implementation for core.export.timeline.
 *
...
class XTimelineCapability : ExpansionCapability {
    override val id: String = "core.export.timeline"
    override val area: String = "core.export"
    override val purpose: String = "Timeline capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
