...
class XTimelineCapability : ExpansionCapability {
    override val id = "core.export.timeline"
    override val area = "core.export"
    override val purpose = "Timeline capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
