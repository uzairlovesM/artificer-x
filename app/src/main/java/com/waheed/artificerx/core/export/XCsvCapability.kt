...
/**
 * Runtime capability implementation for core.export.csv.
 *
...
class XCsvCapability : ExpansionCapability {
    override val id: String = "core.export.csv"
    override val area: String = "core.export"
    override val purpose: String = "Csv capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
