...
/** Production expansion contract for Health. */
class XHealthCapability : ExpansionCapability {
    override val id = "core.diagnostics.health"
    override val area = "core.diagnostics"
    override val purpose = "Health capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
