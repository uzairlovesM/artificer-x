...
/**
 * Runtime capability implementation for core.diagnostics.health.
 *
 ...
 */
class XHealthCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.health"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Health capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
