...
/**
 * Runtime capability implementation for core.storage.eviction.
 *
 ...
 */
class XEvictionCapability : ExpansionCapability {
    override val id: String = "core.storage.eviction"
    override val area: String = "core.storage"
    override val purpose: String = "Eviction capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
