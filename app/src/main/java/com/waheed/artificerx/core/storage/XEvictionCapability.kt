...
/** Production expansion contract for Eviction. */
class XEvictionCapability : ExpansionCapability {
    override val id = "core.storage.eviction"
    override val area = "core.storage"
    override val purpose = "Eviction capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
