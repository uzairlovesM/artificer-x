...
/**
 * Runtime capability implementation for core.usecase2.cancel.
 *
...
class XCancelCapability : ExpansionCapability {
    override val id: String = "core.usecase2.cancel"
    override val area: String = "core.usecase2"
    override val purpose: String = "Cancel capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
