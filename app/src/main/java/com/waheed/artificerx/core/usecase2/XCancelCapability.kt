...
class XCancelCapability : ExpansionCapability {
    override val id = "core.usecase2.cancel"
    override val area = "core.usecase2"
    override val purpose = "Cancel capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
