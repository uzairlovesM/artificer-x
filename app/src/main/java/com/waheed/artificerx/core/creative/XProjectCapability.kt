...
class XProjectCapability : ExpansionCapability {
    override val id = "core.creative.project"
    override val area = "core.creative"
    override val purpose = "Project capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
