...
/**
 * Runtime capability implementation for core.creative.project.
 *
...
class XProjectCapability : ExpansionCapability {
    override val id: String = "core.creative.project"
    override val area: String = "core.creative"
    override val purpose: String = "Project capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
