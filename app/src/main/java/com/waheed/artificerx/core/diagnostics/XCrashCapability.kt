...
/**
 * Runtime capability implementation for core.diagnostics.crash.
 *
 ...
 */
class XCrashCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.crash"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Crash capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
