...
/** Production expansion contract for Crash. */
class XCrashCapability : ExpansionCapability {
    override val id = "core.diagnostics.crash"
    override val area = "core.diagnostics"
    override val purpose = "Crash capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
