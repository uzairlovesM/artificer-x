...
/**
 * Runtime capability implementation for core.scene.linepass.
 *
 ...
 */
class XLinePassCapability : ExpansionCapability {
    override val id: String = "core.scene.linepass"
    override val area: String = "core.scene"
    override val purpose: String = "LinePass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
