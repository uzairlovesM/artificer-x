...
/** Production expansion contract for LinePass. */
class XLinePassCapability : ExpansionCapability {
    override val id = "core.scene.linepass"
    override val area = "core.scene"
    override val purpose = "LinePass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
