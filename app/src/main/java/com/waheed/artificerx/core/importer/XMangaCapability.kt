...
/** Production expansion contract for Manga. */
class XMangaCapability : ExpansionCapability {
    override val id = "core.importer.manga"
    override val area = "core.importer"
    override val purpose = "Manga capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
