...
/**
 * Runtime capability implementation for core.importer.manga.
 *
 ...
 */
class XMangaCapability : ExpansionCapability {
    override val id: String = "core.importer.manga"
    override val area: String = "core.importer"
    override val purpose: String = "Manga capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
