...
class XRecoveryCapability : ExpansionCapability {
    override val id = "core.memory.recovery"
    override val area = "core.memory"
    override val purpose = "Recovery capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
