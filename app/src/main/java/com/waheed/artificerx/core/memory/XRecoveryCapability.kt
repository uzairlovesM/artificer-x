...
/**
 * Runtime capability implementation for core.memory.recovery.
 *
...
class XRecoveryCapability : ExpansionCapability {
    override val id: String = "core.memory.recovery"
    override val area: String = "core.memory"
    override val purpose: String = "Recovery capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
