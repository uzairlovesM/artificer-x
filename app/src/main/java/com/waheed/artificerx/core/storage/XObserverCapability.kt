...
/** Production expansion contract for Observer. */
class XObserverCapability : ExpansionCapability {
    override val id = "core.storage.observer"
    override val area = "core.storage"
    override val purpose = "Observer capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
