...
/**
 * Runtime capability implementation for core.storage.observer.
 *
...
class XObserverCapability : ExpansionCapability {
    override val id: String = "core.storage.observer"
    override val area: String = "core.storage"
    override val purpose: String = "Observer capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
