...
class XPaletteCapability : ExpansionCapability {
    override val id = "core.creative.palette"
    override val area = "core.creative"
    override val purpose = "Palette capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
