...
/**
 * Runtime capability implementation for core.creative.palette.
 *
...
class XPaletteCapability : ExpansionCapability {
    override val id: String = "core.creative.palette"
    override val area: String = "core.creative"
    override val purpose: String = "Palette capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
