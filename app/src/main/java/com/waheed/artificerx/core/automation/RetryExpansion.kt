...
class RetryExpansion : ExpansionCapability {
    override val id: String = "core.automation.retry"
    override val area: String = "core.automation"
    override val purpose: String = "Retry coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
