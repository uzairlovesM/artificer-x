...
class XProvenanceCapability : ExpansionCapability {
    override val id = "core.creative.provenance"
    override val area = "core.creative"
    override val purpose = "Provenance capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
