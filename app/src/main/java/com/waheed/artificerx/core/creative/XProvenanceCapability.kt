...
/**
 * Runtime capability implementation for core.creative.provenance.
 *
 ...
 */
class XProvenanceCapability : ExpansionCapability {
    override val id: String = "core.creative.provenance"
    override val area: String = "core.creative"
    override val purpose: String = "Provenance capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
