...
/** Production expansion contract for LayerPlan. */
class XLayerPlanCapability : ExpansionCapability {
    override val id = "core.creative.layerplan"
    override val area = "core.creative"
    override val purpose = "LayerPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
