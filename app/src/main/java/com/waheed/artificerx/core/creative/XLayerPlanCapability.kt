...
/**
 * Runtime capability implementation for core.creative.layerplan.
 *
 ...
 */
class XLayerPlanCapability : ExpansionCapability {
    override val id: String = "core.creative.layerplan"
    override val area: String = "core.creative"
    override val purpose: String = "LayerPlan capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
