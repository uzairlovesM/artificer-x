...
/** Production expansion contract for Timer. */
class XTimerCapability : ExpansionCapability {
    override val id = "core.diagnostics.timer"
    override val area = "core.diagnostics"
    override val purpose = "Timer capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
