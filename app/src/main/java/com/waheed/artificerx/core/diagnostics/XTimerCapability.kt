...
/**
 * Runtime capability implementation for core.diagnostics.timer.
 *
 ...
 */
class XTimerCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.timer"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Timer capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
