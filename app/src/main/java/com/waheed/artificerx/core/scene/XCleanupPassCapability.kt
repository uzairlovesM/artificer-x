...
/**
 * Runtime capability implementation for core.scene.cleanuppass.
 *
 ...
 */
class XCleanupPassCapability : ExpansionCapability {
    override val id: String = "core.scene.cleanuppass"
    override val area: String = "core.scene"
    override val purpose: String = "CleanupPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
