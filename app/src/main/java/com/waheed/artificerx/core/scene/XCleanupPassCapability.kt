...
/** Production expansion contract for CleanupPass. */
class XCleanupPassCapability : ExpansionCapability {
    override val id = "core.scene.cleanuppass"
    override val area = "core.scene"
    override val purpose = "CleanupPass capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
