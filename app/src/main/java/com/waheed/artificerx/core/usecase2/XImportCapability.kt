...
class XImportCapability : ExpansionCapability {
    override val id = "core.usecase2.import"
    override val area = "core.usecase2"
    override val purpose = "Import capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
