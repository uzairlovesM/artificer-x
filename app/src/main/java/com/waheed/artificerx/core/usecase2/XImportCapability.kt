...
/**
 * Runtime capability implementation for core.usecase2.import.
 *
...
class XImportCapability : ExpansionCapability {
    override val id: String = "core.usecase2.import"
    override val area: String = "core.usecase2"
    override val purpose: String = "Import capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
