...
class XProfileCapability : ExpansionCapability {
    override val id = "core.importer.profile"
    override val area = "core.importer"
    override val purpose = "Profile capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
