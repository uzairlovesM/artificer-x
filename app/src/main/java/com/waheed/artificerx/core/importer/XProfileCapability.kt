...
/**
 * Runtime capability implementation for core.importer.profile.
 *
...
class XProfileCapability : ExpansionCapability {
    override val id: String = "core.importer.profile"
    override val area: String = "core.importer"
    override val purpose: String = "Profile capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
