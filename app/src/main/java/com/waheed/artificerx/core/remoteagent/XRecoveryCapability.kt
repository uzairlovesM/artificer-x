...
/**
 * Runtime capability implementation for core.remoteagent.recovery.
 *
...
class XRecoveryCapability : ExpansionCapability {
    override val id: String = "core.remoteagent.recovery"
    override val area: String = "core.remoteagent"
    override val purpose: String = "Recovery capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
