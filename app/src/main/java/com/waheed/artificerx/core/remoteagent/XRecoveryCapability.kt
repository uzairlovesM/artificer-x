...
class XRecoveryCapability : ExpansionCapability {
    override val id = "core.remoteagent.recovery"
    override val area = "core.remoteagent"
    override val purpose = "Recovery capability in core.remoteagent; explicit state, output, failure, telemetry, and provenance boundary."
