...
/** Production expansion contract for PaletteGraph. */
class XPaletteGraphCapability : ExpansionCapability {
    override val id = "core.scene.palettegraph"
    override val area = "core.scene"
    override val purpose = "PaletteGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
