...
/**
 * Runtime capability implementation for core.scene.palettegraph.
 *
 ...
 */
class XPaletteGraphCapability : ExpansionCapability {
    override val id: String = "core.scene.palettegraph"
    override val area: String = "core.scene"
    override val purpose: String = "PaletteGraph capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
