...
/**
 * Runtime capability implementation for core.plugin.version.
 *
...
class XVersionCapability : ExpansionCapability {
    override val id: String = "core.plugin.version"
    override val area: String = "core.plugin"
    override val purpose: String = "Version capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
