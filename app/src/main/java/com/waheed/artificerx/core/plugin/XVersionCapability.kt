...
/** Production expansion contract for Version. */
class XVersionCapability : ExpansionCapability {
    override val id = "core.plugin.version"
    override val area = "core.plugin"
    override val purpose = "Version capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
