...
/**
 * Runtime capability implementation for core.model.health.
 *
...
class XHealthCapability : ExpansionCapability {
    override val id: String = "core.model.health"
    override val area: String = "core.model"
    override val purpose: String = "Health capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
