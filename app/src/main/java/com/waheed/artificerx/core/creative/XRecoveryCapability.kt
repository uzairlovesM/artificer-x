...
class XRecoveryCapability : ExpansionCapability {
    override val id = "core.creative.recovery"
    override val area = "core.creative"
    override val purpose = "Recovery capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
