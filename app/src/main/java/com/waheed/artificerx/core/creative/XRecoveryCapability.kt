...
/**
 * Runtime capability implementation for core.creative.recovery.
 *
...
class XRecoveryCapability : ExpansionCapability {
    override val id: String = "core.creative.recovery"
    override val area: String = "core.creative"
    override val purpose: String = "Recovery capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
