...
/** Production expansion contract for Branch. */
class XBranchCapability : ExpansionCapability {
    override val id = "core.repository.branch"
    override val area = "core.repository"
    override val purpose = "Branch capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
