...
/**
 * Runtime capability implementation for core.repository.branch.
 *
 ...
 */
class XBranchCapability : ExpansionCapability {
    override val id: String = "core.repository.branch"
    override val area: String = "core.repository"
    override val purpose: String = "Branch capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
