...
/**
 * Runtime capability implementation for core.importer.avif.
 *
 ...
 */
class XAvifCapability : ExpansionCapability {
    override val id: String = "core.importer.avif"
    override val area: String = "core.importer"
    override val purpose: String = "Avif capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
