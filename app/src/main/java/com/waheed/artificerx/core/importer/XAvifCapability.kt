...
/** Production expansion contract for Avif. */
class XAvifCapability : ExpansionCapability {
    override val id = "core.importer.avif"
    override val area = "core.importer"
    override val purpose = "Avif capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
