...
/**
 * Runtime capability implementation for core.creative.refine.
 *
 ...
 */
class XRefineCapability : ExpansionCapability {
    override val id: String = "core.creative.refine"
    override val area: String = "core.creative"
    override val purpose: String = "Refine capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
