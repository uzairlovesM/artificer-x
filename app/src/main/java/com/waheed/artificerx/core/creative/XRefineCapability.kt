...
/** Production expansion contract for Refine. */
class XRefineCapability : ExpansionCapability {
    override val id = "core.creative.refine"
    override val area = "core.creative"
    override val purpose = "Refine capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
