...
/**
 * Runtime capability implementation for core.creative.review.
 *
 ...
 */
class XReviewCapability : ExpansionCapability {
    override val id: String = "core.creative.review"
    override val area: String = "core.creative"
    override val purpose: String = "Review capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
