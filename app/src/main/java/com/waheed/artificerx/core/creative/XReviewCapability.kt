...
/** Production expansion contract for Review. */
class XReviewCapability : ExpansionCapability {
    override val id = "core.creative.review"
    override val area = "core.creative"
    override val purpose = "Review capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
