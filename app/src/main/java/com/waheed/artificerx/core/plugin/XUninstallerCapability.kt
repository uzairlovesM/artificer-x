...
/** Production expansion contract for Uninstaller. */
class XUninstallerCapability : ExpansionCapability {
    override val id = "core.plugin.uninstaller"
    override val area = "core.plugin"
    override val purpose = "Uninstaller capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
