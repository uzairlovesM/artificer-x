...
/**
 * Runtime capability implementation for core.plugin.uninstaller.
 *
 ...
 */
class XUninstallerCapability : ExpansionCapability {
    override val id: String = "core.plugin.uninstaller"
    override val area: String = "core.plugin"
    override val purpose: String = "Uninstaller capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
