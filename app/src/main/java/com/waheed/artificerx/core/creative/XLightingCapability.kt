...
/** Production expansion contract for Lighting. */
class XLightingCapability : ExpansionCapability {
    override val id = "core.creative.lighting"
    override val area = "core.creative"
    override val purpose = "Lighting capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
