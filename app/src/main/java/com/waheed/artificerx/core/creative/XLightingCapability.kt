...
/**
 * Runtime capability implementation for core.creative.lighting.
 *
 ...
 */
class XLightingCapability : ExpansionCapability {
    override val id: String = "core.creative.lighting"
    override val area: String = "core.creative"
    override val purpose: String = "Lighting capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
