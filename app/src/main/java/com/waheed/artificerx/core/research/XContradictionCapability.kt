...
/** Production expansion contract for Contradiction. */
class XContradictionCapability : ExpansionCapability {
    override val id = "core.research.contradiction"
    override val area = "core.research"
    override val purpose = "Contradiction capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
