...
/** Production expansion contract for Uninstall. */
class XUninstallCapability : ExpansionCapability {
    override val id = "core.usecase2.uninstall"
    override val area = "core.usecase2"
    override val purpose = "Uninstall capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
