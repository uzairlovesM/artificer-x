...
/**
 * Runtime capability implementation for core.usecase2.uninstall.
 *
 ...
 */
class XUninstallCapability : ExpansionCapability {
    override val id: String = "core.usecase2.uninstall"
    override val area: String = "core.usecase2"
    override val purpose: String = "Uninstall capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
