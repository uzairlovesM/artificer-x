...
class XTemplateCapability : ExpansionCapability {
    override val id = "core.export.template"
    override val area = "core.export"
    override val purpose = "Template capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
