...
/**
 * Runtime capability implementation for core.export.template.
 *
...
class XTemplateCapability : ExpansionCapability {
    override val id: String = "core.export.template"
    override val area: String = "core.export"
    override val purpose: String = "Template capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
