...
/**
 * Runtime capability implementation for core.memory.health.
 *
...
class XHealthCapability : ExpansionCapability {
    override val id: String = "core.memory.health"
    override val area: String = "core.memory"
    override val purpose: String = "Health capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
