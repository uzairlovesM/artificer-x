...
class XHealthCapability : ExpansionCapability {
    override val id = "core.memory.health"
    override val area = "core.memory"
    override val purpose = "Health capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
