...
/** Production expansion contract for Ai. */
class XAiCapability : ExpansionCapability {
    override val id = "core.settings.ai"
    override val area = "core.settings"
    override val purpose = "Ai capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
