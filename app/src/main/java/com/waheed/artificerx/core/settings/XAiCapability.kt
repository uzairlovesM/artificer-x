...
/**
 * Runtime capability implementation for core.settings.ai.
 *
 ...
 */
class XAiCapability : ExpansionCapability {
    override val id: String = "core.settings.ai"
    override val area: String = "core.settings"
    override val purpose: String = "Ai capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
