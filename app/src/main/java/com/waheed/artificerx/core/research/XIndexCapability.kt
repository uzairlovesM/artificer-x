...
class XIndexCapability : ExpansionCapability {
    override val id = "core.research.index"
    override val area = "core.research"
    override val purpose = "Index capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
