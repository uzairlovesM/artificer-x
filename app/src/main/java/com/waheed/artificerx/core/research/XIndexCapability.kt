...
/**
 * Runtime capability implementation for core.research.index.
 *
...
class XIndexCapability : ExpansionCapability {
    override val id: String = "core.research.index"
    override val area: String = "core.research"
    override val purpose: String = "Index capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
