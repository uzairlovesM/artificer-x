...
/** Production expansion contract for Exporter. */
class XExporterCapability : ExpansionCapability {
    override val id = "core.plugin.exporter"
    override val area = "core.plugin"
    override val purpose = "Exporter capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
