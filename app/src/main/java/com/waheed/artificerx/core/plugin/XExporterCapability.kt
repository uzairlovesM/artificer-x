...
/**
 * Runtime capability implementation for core.plugin.exporter.
 *
 ...
 */
class XExporterCapability : ExpansionCapability {
    override val id: String = "core.plugin.exporter"
    override val area: String = "core.plugin"
    override val purpose: String = "Exporter capability in core.plugin; explicit state, output, failure, telemetry, and provenance boundary."
