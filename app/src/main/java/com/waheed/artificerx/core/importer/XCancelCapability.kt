...
class XCancelCapability : ExpansionCapability {
    override val id = "core.importer.cancel"
    override val area = "core.importer"
    override val purpose = "Cancel capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
