...
/**
 * Runtime capability implementation for core.importer.cancel.
 *
...
class XCancelCapability : ExpansionCapability {
    override val id: String = "core.importer.cancel"
    override val area: String = "core.importer"
    override val purpose: String = "Cancel capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
