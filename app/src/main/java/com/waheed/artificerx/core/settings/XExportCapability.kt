...
/**
 * Runtime capability implementation for core.settings.export.
 *
...
class XExportCapability : ExpansionCapability {
    override val id: String = "core.settings.export"
    override val area: String = "core.settings"
    override val purpose: String = "Export capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
