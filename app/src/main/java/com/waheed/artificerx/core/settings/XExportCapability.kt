...
class XExportCapability : ExpansionCapability {
    override val id = "core.settings.export"
    override val area = "core.settings"
    override val purpose = "Export capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
