...
class XBenchmarkCapability : ExpansionCapability {
    override val id = "core.model.benchmark"
    override val area = "core.model"
    override val purpose = "Benchmark capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
