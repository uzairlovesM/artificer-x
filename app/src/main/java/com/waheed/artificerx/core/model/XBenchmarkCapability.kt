...
/**
 * Runtime capability implementation for core.model.benchmark.
 *
...
class XBenchmarkCapability : ExpansionCapability {
    override val id: String = "core.model.benchmark"
    override val area: String = "core.model"
    override val purpose: String = "Benchmark capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
