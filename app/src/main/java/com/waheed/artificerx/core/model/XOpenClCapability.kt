...
/**
 * Runtime capability implementation for core.model.opencl.
 *
 ...
 */
class XOpenClCapability : ExpansionCapability {
    override val id: String = "core.model.opencl"
    override val area: String = "core.model"
    override val purpose: String = "OpenCl capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
