...
/** Production expansion contract for OpenCl. */
class XOpenClCapability : ExpansionCapability {
    override val id = "core.model.opencl"
    override val area = "core.model"
    override val purpose = "OpenCl capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
