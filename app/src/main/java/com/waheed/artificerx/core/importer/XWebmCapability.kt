...
/** Production expansion contract for Webm. */
class XWebmCapability : ExpansionCapability {
    override val id = "core.importer.webm"
    override val area = "core.importer"
    override val purpose = "Webm capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
