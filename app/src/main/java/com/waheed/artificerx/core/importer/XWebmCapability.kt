...
/**
 * Runtime capability implementation for core.importer.webm.
 *
 ...
 */
class XWebmCapability : ExpansionCapability {
    override val id: String = "core.importer.webm"
    override val area: String = "core.importer"
    override val purpose: String = "Webm capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
