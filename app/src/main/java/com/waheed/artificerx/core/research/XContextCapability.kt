...
/**
 * Runtime capability implementation for core.research.context.
 *
...
class XContextCapability : ExpansionCapability {
    override val id: String = "core.research.context"
    override val area: String = "core.research"
    override val purpose: String = "Context capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
