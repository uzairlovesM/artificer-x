...
class XContextCapability : ExpansionCapability {
    override val id = "core.research.context"
    override val area = "core.research"
    override val purpose = "Context capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
