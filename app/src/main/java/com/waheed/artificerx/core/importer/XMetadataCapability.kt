...
/**
 * Runtime capability implementation for core.importer.metadata.
 *
 ...
 */
class XMetadataCapability : ExpansionCapability {
    override val id: String = "core.importer.metadata"
    override val area: String = "core.importer"
    override val purpose: String = "Metadata capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
