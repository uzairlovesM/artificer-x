...
/** Production expansion contract for Metadata. */
class XMetadataCapability : ExpansionCapability {
    override val id = "core.importer.metadata"
    override val area = "core.importer"
    override val purpose = "Metadata capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
