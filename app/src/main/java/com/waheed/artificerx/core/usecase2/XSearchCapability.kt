...
/**
 * Runtime capability implementation for core.usecase2.search.
 *
...
class XSearchCapability : ExpansionCapability {
    override val id: String = "core.usecase2.search"
    override val area: String = "core.usecase2"
    override val purpose: String = "Search capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
