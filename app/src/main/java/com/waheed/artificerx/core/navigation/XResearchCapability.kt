...
/**
 * Runtime capability implementation for core.navigation.research.
 *
 ...
 */
class XResearchCapability : ExpansionCapability {
    override val id: String = "core.navigation.research"
    override val area: String = "core.navigation"
    override val purpose: String = "Research capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
