...
class XResearchCapability : ExpansionCapability {
    override val id = "core.navigation.research"
    override val area = "core.navigation"
    override val purpose = "Research capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
