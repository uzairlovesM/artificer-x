...
/**
 * Runtime capability implementation for core.scene.benchmark.
 *
...
class XBenchmarkCapability : ExpansionCapability {
    override val id: String = "core.scene.benchmark"
    override val area: String = "core.scene"
    override val purpose: String = "Benchmark capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
