...
class XBenchmarkCapability : ExpansionCapability {
    override val id = "core.scene.benchmark"
    override val area = "core.scene"
    override val purpose = "Benchmark capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
