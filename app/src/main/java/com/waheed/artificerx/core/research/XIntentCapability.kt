...
class XIntentCapability : ExpansionCapability {
    override val id = "core.research.intent"
    override val area = "core.research"
    override val purpose = "Intent capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
