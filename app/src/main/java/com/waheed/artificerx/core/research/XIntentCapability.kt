...
/**
 * Runtime capability implementation for core.research.intent.
 *
...
class XIntentCapability : ExpansionCapability {
    override val id: String = "core.research.intent"
    override val area: String = "core.research"
    override val purpose: String = "Intent capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
