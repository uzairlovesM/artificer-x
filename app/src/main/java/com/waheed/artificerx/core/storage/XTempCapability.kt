...
/** Production expansion contract for Temp. */
class XTempCapability : ExpansionCapability {
    override val id = "core.storage.temp"
    override val area = "core.storage"
    override val purpose = "Temp capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
