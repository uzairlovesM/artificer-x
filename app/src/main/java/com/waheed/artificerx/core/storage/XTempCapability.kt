...
/**
 * Runtime capability implementation for core.storage.temp.
 *
 ...
 */
class XTempCapability : ExpansionCapability {
    override val id: String = "core.storage.temp"
    override val area: String = "core.storage"
    override val purpose: String = "Temp capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
