...
/**
 * Runtime capability implementation for core.research.relation.
 *
 ...
 */
class XRelationCapability : ExpansionCapability {
    override val id: String = "core.research.relation"
    override val area: String = "core.research"
    override val purpose: String = "Relation capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
