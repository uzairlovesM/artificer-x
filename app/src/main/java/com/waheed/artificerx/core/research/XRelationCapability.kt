...
/** Production expansion contract for Relation. */
class XRelationCapability : ExpansionCapability {
    override val id = "core.research.relation"
    override val area = "core.research"
    override val purpose = "Relation capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
