...
/**
 * Runtime capability implementation for core.repository.hook.
 *
 ...
 */
class XHookCapability : ExpansionCapability {
    override val id: String = "core.repository.hook"
    override val area: String = "core.repository"
    override val purpose: String = "Hook capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
