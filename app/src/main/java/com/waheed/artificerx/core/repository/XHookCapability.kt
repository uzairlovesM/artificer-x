...
class XHookCapability : ExpansionCapability {
    override val id = "core.repository.hook"
    override val area = "core.repository"
    override val purpose = "Hook capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
