...
class XHistoryCapability : ExpansionCapability {
    override val id = "core.creative.history"
    override val area = "core.creative"
    override val purpose = "History capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
