...
/**
 * Runtime capability implementation for core.creative.history.
 *
...
class XHistoryCapability : ExpansionCapability {
    override val id: String = "core.creative.history"
    override val area: String = "core.creative"
    override val purpose: String = "History capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
