...
/**
 * Runtime capability implementation for core.settings.token.
 *
 ...
 */
class XTokenCapability : ExpansionCapability {
    override val id: String = "core.settings.token"
    override val area: String = "core.settings"
    override val purpose: String = "Token capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
