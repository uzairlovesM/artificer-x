...
/** Production expansion contract for Token. */
class XTokenCapability : ExpansionCapability {
    override val id = "core.settings.token"
    override val area = "core.settings"
    override val purpose = "Token capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
