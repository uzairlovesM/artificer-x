...
/**
 * Runtime capability implementation for core.export.mp4.
 *
...
class XMp4Capability : ExpansionCapability {
    override val id: String = "core.export.mp4"
    override val area: String = "core.export"
    override val purpose: String = "Mp4 capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
