...
/**
 * Runtime capability implementation for core.memory.longterm.
 *
 ...
 */
class XLongTermCapability : ExpansionCapability {
    override val id: String = "core.memory.longterm"
    override val area: String = "core.memory"
    override val purpose: String = "LongTerm capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
