...
/** Production expansion contract for LongTerm. */
class XLongTermCapability : ExpansionCapability {
    override val id = "core.memory.longterm"
    override val area = "core.memory"
    override val purpose = "LongTerm capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
