...
class XCommandCapability : ExpansionCapability {
    override val id = "core.navigation.command"
    override val area = "core.navigation"
    override val purpose = "Command capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
