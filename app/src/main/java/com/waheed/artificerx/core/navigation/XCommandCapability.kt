...
/**
 * Runtime capability implementation for core.navigation.command.
 *
 ...
 */
class XCommandCapability : ExpansionCapability {
    override val id: String = "core.navigation.command"
    override val area: String = "core.navigation"
    override val purpose: String = "Command capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
