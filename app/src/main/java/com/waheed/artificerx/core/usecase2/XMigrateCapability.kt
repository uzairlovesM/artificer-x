...
/** Production expansion contract for Migrate. */
class XMigrateCapability : ExpansionCapability {
    override val id = "core.usecase2.migrate"
    override val area = "core.usecase2"
    override val purpose = "Migrate capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
