...
/**
 * Runtime capability implementation for core.usecase2.migrate.
 *
 ...
 */
class XMigrateCapability : ExpansionCapability {
    override val id: String = "core.usecase2.migrate"
    override val area: String = "core.usecase2"
    override val purpose: String = "Migrate capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
