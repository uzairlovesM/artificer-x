...
/**
 * Runtime capability implementation for core.diagnostics.jni.
 *
 ...
 */
class XJniCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.jni"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Jni capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
