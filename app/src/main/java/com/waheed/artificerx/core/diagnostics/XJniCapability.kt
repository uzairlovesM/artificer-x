...
/** Production expansion contract for Jni. */
class XJniCapability : ExpansionCapability {
    override val id = "core.diagnostics.jni"
    override val area = "core.diagnostics"
    override val purpose = "Jni capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
