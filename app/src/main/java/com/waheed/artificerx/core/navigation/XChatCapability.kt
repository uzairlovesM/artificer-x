...
/**
 * Runtime capability implementation for core.navigation.chat.
 *
...
class XChatCapability : ExpansionCapability {
    override val id: String = "core.navigation.chat"
    override val area: String = "core.navigation"
    override val purpose: String = "Chat capability in core.navigation; explicit state, output, failure, telemetry, and provenance boundary."
