...
/**
 * Runtime capability implementation for core.importer.csv.
 *
 ...
 */
class XCsvCapability : ExpansionCapability {
    override val id: String = "core.importer.csv"
    override val area: String = "core.importer"
    override val purpose: String = "Csv capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
