...
/** Production expansion contract for Csv. */
class XCsvCapability : ExpansionCapability {
    override val id = "core.importer.csv"
    override val area = "core.importer"
    override val purpose = "Csv capability in core.importer; explicit state, output, failure, telemetry, and provenance boundary."
