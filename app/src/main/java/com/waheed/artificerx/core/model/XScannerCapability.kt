...
/**
 * Runtime capability implementation for core.model.scanner.
 *
...
class XScannerCapability : ExpansionCapability {
    override val id: String = "core.model.scanner"
    override val area: String = "core.model"
    override val purpose: String = "Scanner capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
