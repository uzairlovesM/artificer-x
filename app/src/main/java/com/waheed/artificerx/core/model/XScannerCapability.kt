...
class XScannerCapability : ExpansionCapability {
    override val id = "core.model.scanner"
    override val area = "core.model"
    override val purpose = "Scanner capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
