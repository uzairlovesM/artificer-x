...
class XRepairCapability : ExpansionCapability {
    override val id = "core.usecase2.repair"
    override val area = "core.usecase2"
    override val purpose = "Repair capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
