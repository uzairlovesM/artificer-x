...
/**
 * Runtime capability implementation for core.usecase2.repair.
 *
...
class XRepairCapability : ExpansionCapability {
    override val id: String = "core.usecase2.repair"
    override val area: String = "core.usecase2"
    override val purpose: String = "Repair capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
