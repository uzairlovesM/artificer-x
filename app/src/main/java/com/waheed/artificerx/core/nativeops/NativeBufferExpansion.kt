...
class NativeBufferExpansion : ExpansionCapability {
    override val id: String = "core.nativeops.nativebuffer"
    override val area: String = "core.nativeops"
    override val purpose: String = "NativeBuffer coordinates core.nativeops responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
