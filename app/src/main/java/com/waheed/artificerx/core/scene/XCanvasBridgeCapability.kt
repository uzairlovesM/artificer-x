...
/**
 * Runtime capability implementation for core.scene.canvasbridge.
 *
 ...
 */
class XCanvasBridgeCapability : ExpansionCapability {
    override val id: String = "core.scene.canvasbridge"
    override val area: String = "core.scene"
    override val purpose: String = "CanvasBridge capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
