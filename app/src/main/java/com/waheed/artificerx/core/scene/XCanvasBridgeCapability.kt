...
/** Production expansion contract for CanvasBridge. */
class XCanvasBridgeCapability : ExpansionCapability {
    override val id = "core.scene.canvasbridge"
    override val area = "core.scene"
    override val purpose = "CanvasBridge capability in core.scene; explicit state, output, failure, telemetry, and provenance boundary."
