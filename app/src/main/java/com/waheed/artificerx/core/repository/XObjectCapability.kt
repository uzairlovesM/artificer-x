...
class XObjectCapability : ExpansionCapability {
    override val id = "core.repository.object"
    override val area = "core.repository"
    override val purpose = "Object capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
