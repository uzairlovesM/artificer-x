...
/**
 * Runtime capability implementation for core.repository.object.
 *
 ...
 */
class XObjectCapability : ExpansionCapability {
    override val id: String = "core.repository.object"
    override val area: String = "core.repository"
    override val purpose: String = "Object capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
