...
/**
 * Runtime capability implementation for core.memory.importance.
 *
...
class XImportanceCapability : ExpansionCapability {
    override val id: String = "core.memory.importance"
    override val area: String = "core.memory"
    override val purpose: String = "Importance capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
