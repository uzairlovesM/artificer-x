...
/**
 * Runtime capability implementation for core.export.webp.
 *
...
class XWebpCapability : ExpansionCapability {
    override val id: String = "core.export.webp"
    override val area: String = "core.export"
    override val purpose: String = "Webp capability in core.export; explicit state, output, failure, telemetry, and provenance boundary."
