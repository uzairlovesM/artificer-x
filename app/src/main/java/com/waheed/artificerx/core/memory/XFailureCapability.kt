...
/**
 * Runtime capability implementation for core.memory.failure.
 *
...
class XFailureCapability : ExpansionCapability {
    override val id: String = "core.memory.failure"
    override val area: String = "core.memory"
    override val purpose: String = "Failure capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
