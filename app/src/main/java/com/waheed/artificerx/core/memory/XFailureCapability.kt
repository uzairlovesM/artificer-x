...
class XFailureCapability : ExpansionCapability {
    override val id = "core.memory.failure"
    override val area = "core.memory"
    override val purpose = "Failure capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
