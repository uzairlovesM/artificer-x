...
/**
 * Runtime capability implementation for core.usecase2.enable.
 *
 ...
 */
class XEnableCapability : ExpansionCapability {
    override val id: String = "core.usecase2.enable"
    override val area: String = "core.usecase2"
    override val purpose: String = "Enable capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
