...
/** Production expansion contract for Enable. */
class XEnableCapability : ExpansionCapability {
    override val id = "core.usecase2.enable"
    override val area = "core.usecase2"
    override val purpose = "Enable capability in core.usecase2; explicit state, output, failure, telemetry, and provenance boundary."
