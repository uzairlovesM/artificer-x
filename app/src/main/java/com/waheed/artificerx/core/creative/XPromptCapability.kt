...
/**
 * Runtime capability implementation for core.creative.prompt.
 *
 ...
 */
class XPromptCapability : ExpansionCapability {
    override val id: String = "core.creative.prompt"
    override val area: String = "core.creative"
    override val purpose: String = "Prompt capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
