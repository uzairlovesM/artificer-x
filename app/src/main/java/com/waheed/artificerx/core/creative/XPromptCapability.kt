...
/** Production expansion contract for Prompt. */
class XPromptCapability : ExpansionCapability {
    override val id = "core.creative.prompt"
    override val area = "core.creative"
    override val purpose = "Prompt capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
