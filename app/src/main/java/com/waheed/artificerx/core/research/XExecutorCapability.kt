...
/**
 * Runtime capability implementation for core.research.executor.
 *
 ...
 */
class XExecutorCapability : ExpansionCapability {
    override val id: String = "core.research.executor"
    override val area: String = "core.research"
    override val purpose: String = "Executor capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
