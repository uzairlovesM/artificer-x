...
class XExecutorCapability : ExpansionCapability {
    override val id = "core.research.executor"
    override val area = "core.research"
    override val purpose = "Executor capability in core.research; explicit state, output, failure, telemetry, and provenance boundary."
