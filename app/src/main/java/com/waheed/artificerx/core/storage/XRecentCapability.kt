...
/**
 * Runtime capability implementation for core.storage.recent.
 *
...
class XRecentCapability : ExpansionCapability {
    override val id: String = "core.storage.recent"
    override val area: String = "core.storage"
    override val purpose: String = "Recent capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
