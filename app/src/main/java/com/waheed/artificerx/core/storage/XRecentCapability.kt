...
/** Production expansion contract for Recent. */
class XRecentCapability : ExpansionCapability {
    override val id = "core.storage.recent"
    override val area = "core.storage"
    override val purpose = "Recent capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
