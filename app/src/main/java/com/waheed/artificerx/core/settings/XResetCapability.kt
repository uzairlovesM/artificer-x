...
/** Production expansion contract for Reset. */
class XResetCapability : ExpansionCapability {
    override val id = "core.settings.reset"
    override val area = "core.settings"
    override val purpose = "Reset capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
