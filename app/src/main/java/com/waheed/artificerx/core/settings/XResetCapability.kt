...
/**
 * Runtime capability implementation for core.settings.reset.
 *
 ...
 */
class XResetCapability : ExpansionCapability {
    override val id: String = "core.settings.reset"
    override val area: String = "core.settings"
    override val purpose: String = "Reset capability in core.settings; explicit state, output, failure, telemetry, and provenance boundary."
