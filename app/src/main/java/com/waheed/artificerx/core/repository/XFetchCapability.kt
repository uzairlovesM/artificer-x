...
class XFetchCapability : ExpansionCapability {
    override val id = "core.repository.fetch"
    override val area = "core.repository"
    override val purpose = "Fetch capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
