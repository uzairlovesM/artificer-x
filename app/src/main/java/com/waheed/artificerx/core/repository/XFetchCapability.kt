...
/**
 * Runtime capability implementation for core.repository.fetch.
 *
 ...
 */
class XFetchCapability : ExpansionCapability {
    override val id: String = "core.repository.fetch"
    override val area: String = "core.repository"
    override val purpose: String = "Fetch capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
