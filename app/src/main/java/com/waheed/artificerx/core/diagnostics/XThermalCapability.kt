...
/**
 * Runtime capability implementation for core.diagnostics.thermal.
 *
 ...
 */
class XThermalCapability : ExpansionCapability {
    override val id: String = "core.diagnostics.thermal"
    override val area: String = "core.diagnostics"
    override val purpose: String = "Thermal capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
