...
/** Production expansion contract for Thermal. */
class XThermalCapability : ExpansionCapability {
    override val id = "core.diagnostics.thermal"
    override val area = "core.diagnostics"
    override val purpose = "Thermal capability in core.diagnostics; explicit state, output, failure, telemetry, and provenance boundary."
