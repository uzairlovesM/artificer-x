...
/**
 * Runtime capability implementation for core.memory.artifact.
 *
...
class XArtifactCapability : ExpansionCapability {
    override val id: String = "core.memory.artifact"
    override val area: String = "core.memory"
    override val purpose: String = "Artifact capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
