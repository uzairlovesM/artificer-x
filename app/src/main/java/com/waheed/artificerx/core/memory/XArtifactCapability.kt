...
class XArtifactCapability : ExpansionCapability {
    override val id = "core.memory.artifact"
    override val area = "core.memory"
    override val purpose = "Artifact capability in core.memory; explicit state, output, failure, telemetry, and provenance boundary."
