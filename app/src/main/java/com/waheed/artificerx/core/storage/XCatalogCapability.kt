...
/**
 * Runtime capability implementation for core.storage.catalog.
 *
...
class XCatalogCapability : ExpansionCapability {
    override val id: String = "core.storage.catalog"
    override val area: String = "core.storage"
    override val purpose: String = "Catalog capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
