...
/** Production expansion contract for Catalog. */
class XCatalogCapability : ExpansionCapability {
    override val id = "core.storage.catalog"
    override val area = "core.storage"
    override val purpose = "Catalog capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
