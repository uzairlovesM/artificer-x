...
class XManifestCapability : ExpansionCapability {
    override val id = "core.model.manifest"
    override val area = "core.model"
    override val purpose = "Manifest capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
