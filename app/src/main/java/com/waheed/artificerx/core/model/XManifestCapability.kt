...
/**
 * Runtime capability implementation for core.model.manifest.
 *
...
class XManifestCapability : ExpansionCapability {
    override val id: String = "core.model.manifest"
    override val area: String = "core.model"
    override val purpose: String = "Manifest capability in core.model; explicit state, output, failure, telemetry, and provenance boundary."
