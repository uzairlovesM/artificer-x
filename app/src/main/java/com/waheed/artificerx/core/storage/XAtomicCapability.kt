...
/**
 * Runtime capability implementation for core.storage.atomic.
 *
 ...
 */
class XAtomicCapability : ExpansionCapability {
    override val id: String = "core.storage.atomic"
    override val area: String = "core.storage"
    override val purpose: String = "Atomic capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
