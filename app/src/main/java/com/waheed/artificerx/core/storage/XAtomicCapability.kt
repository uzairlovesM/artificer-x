...
/** Production expansion contract for Atomic. */
class XAtomicCapability : ExpansionCapability {
    override val id = "core.storage.atomic"
    override val area = "core.storage"
    override val purpose = "Atomic capability in core.storage; explicit state, output, failure, telemetry, and provenance boundary."
