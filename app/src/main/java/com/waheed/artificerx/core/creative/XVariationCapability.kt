...
/** Production expansion contract for Variation. */
class XVariationCapability : ExpansionCapability {
    override val id = "core.creative.variation"
    override val area = "core.creative"
    override val purpose = "Variation capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
