...
/**
 * Runtime capability implementation for core.creative.variation.
 *
 ...
 */
class XVariationCapability : ExpansionCapability {
    override val id: String = "core.creative.variation"
    override val area: String = "core.creative"
    override val purpose: String = "Variation capability in core.creative; explicit state, output, failure, telemetry, and provenance boundary."
