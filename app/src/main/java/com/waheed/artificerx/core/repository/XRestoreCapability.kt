...
/** Production expansion contract for Restore. */
class XRestoreCapability : ExpansionCapability {
    override val id = "core.repository.restore"
    override val area = "core.repository"
    override val purpose = "Restore capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
