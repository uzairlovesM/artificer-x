...
/**
 * Runtime capability implementation for core.repository.restore.
 *
 ...
 */
class XRestoreCapability : ExpansionCapability {
    override val id: String = "core.repository.restore"
    override val area: String = "core.repository"
    override val purpose: String = "Restore capability in core.repository; explicit state, output, failure, telemetry, and provenance boundary."
