...
class PriorityExpansion : ExpansionCapability {
    override val id: String = "core.automation.priority"
    override val area: String = "core.automation"
    override val purpose: String = "Priority coordinates core.automation responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
