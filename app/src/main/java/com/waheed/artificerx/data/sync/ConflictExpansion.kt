...
class ConflictExpansion : ExpansionCapability {
    override val id: String = "data.sync.conflict"
    override val area: String = "data.sync"
    override val purpose: String = "Conflict coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
