...
class ArtifactExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.artifact"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Artifact coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
