...
class ToolExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.tool"
    override val area: String = "data.remote.api"
    override val purpose: String = "Tool coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
