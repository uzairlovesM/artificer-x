...
class PriorityExpansion : ExpansionCapability {
    override val id: String = "data.network.priority"
    override val area: String = "data.network"
    override val purpose: String = "Priority coordinates data.network responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
