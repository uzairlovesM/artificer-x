...
class HistoryExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.history"
    override val area: String = "data.local.dao"
    override val purpose: String = "History coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
