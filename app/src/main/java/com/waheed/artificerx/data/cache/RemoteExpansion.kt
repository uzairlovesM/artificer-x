...
class RemoteExpansion : ExpansionCapability {
    override val id: String = "data.cache.remote"
    override val area: String = "data.cache"
    override val purpose: String = "Remote coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
