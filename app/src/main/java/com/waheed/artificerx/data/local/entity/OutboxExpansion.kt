...
class OutboxExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.outbox"
    override val area: String = "data.local.entity"
    override val purpose: String = "Outbox coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
