...
class AutomationExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.automation"
    override val area: String = "data.remote.api"
    override val purpose: String = "Automation coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
