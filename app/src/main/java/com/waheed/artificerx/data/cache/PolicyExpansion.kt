...
class PolicyExpansion : ExpansionCapability {
    override val id: String = "data.cache.policy"
    override val area: String = "data.cache"
    override val purpose: String = "Policy coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
