...
class PolicyExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.policy"
    override val area: String = "data.remote.api"
    override val purpose: String = "Policy coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
