...
class CanvasExpansion : ExpansionCapability {
    override val id: String = "data.cache.canvas"
    override val area: String = "data.cache"
    override val purpose: String = "Canvas coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
