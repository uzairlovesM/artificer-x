...
class TelemetryExpansion : ExpansionCapability {
    override val id: String = "data.network.telemetry"
    override val area: String = "data.network"
    override val purpose: String = "Telemetry coordinates data.network responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
