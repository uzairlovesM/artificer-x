...
class BackupExpansion : ExpansionCapability {
    override val id: String = "data.repository.backup"
    override val area: String = "data.repository"
    override val purpose: String = "Backup coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
