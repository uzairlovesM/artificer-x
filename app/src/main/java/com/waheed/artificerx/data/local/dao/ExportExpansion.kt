...
class ExportExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.export"
    override val area: String = "data.local.dao"
    override val purpose: String = "Export coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
