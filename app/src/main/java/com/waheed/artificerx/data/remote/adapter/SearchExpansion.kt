...
class SearchExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.search"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Search coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
