...
class TokenExpansion : ExpansionCapability {
    override val id: String = "data.sync.token"
    override val area: String = "data.sync"
    override val purpose: String = "Token coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
