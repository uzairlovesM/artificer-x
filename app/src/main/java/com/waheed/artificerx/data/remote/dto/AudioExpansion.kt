...
class AudioExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.audio"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Audio coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
