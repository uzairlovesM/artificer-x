...
class ArtifactExpansion : ExpansionCapability {
    override val id: String = "data.repository.artifact"
    override val area: String = "data.repository"
    override val purpose: String = "Artifact coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
