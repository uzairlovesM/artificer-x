...
class CheckpointExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.checkpoint"
    override val area: String = "data.local.dao"
    override val purpose: String = "Checkpoint coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
