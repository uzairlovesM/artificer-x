...
class ConflictExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.conflict"
    override val area: String = "data.local.dao"
    override val purpose: String = "Conflict coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
