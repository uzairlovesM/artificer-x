...
class ModelExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.model"
    override val area: String = "data.local.entity"
    override val purpose: String = "Model coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
