...
class CheckpointExpansion : ExpansionCapability {
    override val id: String = "data.cache.checkpoint"
    override val area: String = "data.cache"
    override val purpose: String = "Checkpoint coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
