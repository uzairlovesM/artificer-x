...
class CanvasExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.canvas"
    override val area: String = "data.remote.api"
    override val purpose: String = "Canvas coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
