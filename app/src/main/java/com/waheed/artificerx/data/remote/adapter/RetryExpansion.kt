...
class RetryExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.retry"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Retry coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
