...
class TimelineExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.timeline"
    override val area: String = "data.local.entity"
    override val purpose: String = "Timeline coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
