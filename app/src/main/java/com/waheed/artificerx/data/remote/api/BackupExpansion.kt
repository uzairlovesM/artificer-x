...
class BackupExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.backup"
    override val area: String = "data.remote.api"
    override val purpose: String = "Backup coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
