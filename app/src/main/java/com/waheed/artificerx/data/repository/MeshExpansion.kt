...
class MeshExpansion : ExpansionCapability {
    override val id: String = "data.repository.mesh"
    override val area: String = "data.repository"
    override val purpose: String = "Mesh coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
