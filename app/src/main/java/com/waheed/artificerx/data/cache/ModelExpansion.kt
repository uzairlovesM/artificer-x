...
class ModelExpansion : ExpansionCapability {
    override val id: String = "data.cache.model"
    override val area: String = "data.cache"
    override val purpose: String = "Model coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
