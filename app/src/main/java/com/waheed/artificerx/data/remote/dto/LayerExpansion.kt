...
class LayerExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.layer"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Layer coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
