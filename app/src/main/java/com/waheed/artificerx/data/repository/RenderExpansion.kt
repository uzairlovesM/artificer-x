...
class RenderExpansion : ExpansionCapability {
    override val id: String = "data.repository.render"
    override val area: String = "data.repository"
    override val purpose: String = "Render coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
