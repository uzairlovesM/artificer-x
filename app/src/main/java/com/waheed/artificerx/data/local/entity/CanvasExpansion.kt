...
class CanvasExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.canvas"
    override val area: String = "data.local.entity"
    override val purpose: String = "Canvas coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
