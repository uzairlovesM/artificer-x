...
class ModelExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.model"
    override val area: String = "data.remote.api"
    override val purpose: String = "Model coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
