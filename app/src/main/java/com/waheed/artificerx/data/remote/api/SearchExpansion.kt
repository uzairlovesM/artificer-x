...
class SearchExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.search"
    override val area: String = "data.remote.api"
    override val purpose: String = "Search coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
