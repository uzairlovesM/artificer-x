...
class LayerExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.layer"
    override val area: String = "data.local.entity"
    override val purpose: String = "Layer coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
