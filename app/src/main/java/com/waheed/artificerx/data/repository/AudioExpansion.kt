...
class AudioExpansion : ExpansionCapability {
    override val id: String = "data.repository.audio"
    override val area: String = "data.repository"
    override val purpose: String = "Audio coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
