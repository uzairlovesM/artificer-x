...
class ArtifactExpansion : ExpansionCapability {
    override val id: String = "data.cache.artifact"
    override val area: String = "data.cache"
    override val purpose: String = "Artifact coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
