...
class BatchExpansion : ExpansionCapability {
    override val id: String = "data.sync.batch"
    override val area: String = "data.sync"
    override val purpose: String = "Batch coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
