...
class PackageExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.package"
    override val area: String = "data.remote.api"
    override val purpose: String = "Package coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
