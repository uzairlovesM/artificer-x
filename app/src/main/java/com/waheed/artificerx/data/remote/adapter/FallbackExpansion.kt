...
class FallbackExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.fallback"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Fallback coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
