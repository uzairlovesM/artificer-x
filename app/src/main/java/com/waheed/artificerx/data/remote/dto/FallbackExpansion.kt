...
class FallbackExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.fallback"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Fallback coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
