...
class ExportExpansion : ExpansionCapability {
    override val id: String = "data.cache.export"
    override val area: String = "data.cache"
    override val purpose: String = "Export coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
