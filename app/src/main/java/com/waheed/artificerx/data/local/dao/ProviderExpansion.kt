...
class ProviderExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.provider"
    override val area: String = "data.local.dao"
    override val purpose: String = "Provider coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
