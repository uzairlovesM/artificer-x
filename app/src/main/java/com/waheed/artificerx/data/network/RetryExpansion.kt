...
class RetryExpansion : ExpansionCapability {
    override val id: String = "data.network.retry"
    override val area: String = "data.network"
    override val purpose: String = "Retry coordinates data.network responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
