...
class ModelExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.model"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Model coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
