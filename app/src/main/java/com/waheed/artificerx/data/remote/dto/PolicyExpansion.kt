...
class PolicyExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.policy"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Policy coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
