...
class EventExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.event"
    override val area: String = "data.local.entity"
    override val purpose: String = "Event coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
