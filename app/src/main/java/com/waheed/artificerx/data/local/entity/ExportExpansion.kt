...
class ExportExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.export"
    override val area: String = "data.local.entity"
    override val purpose: String = "Export coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
