...
class ArtifactExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.artifact"
    override val area: String = "data.local.dao"
    override val purpose: String = "Artifact coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
