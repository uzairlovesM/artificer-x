...
class ToolExecutionExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.toolexecution"
    override val area: String = "data.local.dao"
    override val purpose: String = "ToolExecution coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
