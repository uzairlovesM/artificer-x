...
class ImageExpansion : ExpansionCapability {
    override val id: String = "data.cache.image"
    override val area: String = "data.cache"
    override val purpose: String = "Image coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
