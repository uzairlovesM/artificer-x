...
class ProviderExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.provider"
    override val area: String = "data.local.entity"
    override val purpose: String = "Provider coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
