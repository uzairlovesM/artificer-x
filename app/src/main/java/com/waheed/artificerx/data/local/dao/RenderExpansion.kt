...
class RenderExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.render"
    override val area: String = "data.local.dao"
    override val purpose: String = "Render coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
