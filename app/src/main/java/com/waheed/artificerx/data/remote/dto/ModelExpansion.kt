...
class ModelExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.model"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Model coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
