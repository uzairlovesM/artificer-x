...
class ScheduleExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.schedule"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Schedule coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
