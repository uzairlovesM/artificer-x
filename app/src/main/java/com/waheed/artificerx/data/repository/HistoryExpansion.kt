...
class HistoryExpansion : ExpansionCapability {
    override val id: String = "data.repository.history"
    override val area: String = "data.repository"
    override val purpose: String = "History coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
