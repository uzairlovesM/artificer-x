...
class ProviderExpansion : ExpansionCapability {
    override val id: String = "data.repository.provider"
    override val area: String = "data.repository"
    override val purpose: String = "Provider coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
