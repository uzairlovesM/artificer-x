...
class MultipartExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.multipart"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Multipart coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
