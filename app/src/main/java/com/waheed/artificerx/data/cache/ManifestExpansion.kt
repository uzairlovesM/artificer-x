...
class ManifestExpansion : ExpansionCapability {
    override val id: String = "data.cache.manifest"
    override val area: String = "data.cache"
    override val purpose: String = "Manifest coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
