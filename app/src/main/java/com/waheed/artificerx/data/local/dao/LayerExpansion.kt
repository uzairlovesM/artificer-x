...
class LayerExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.layer"
    override val area: String = "data.local.dao"
    override val purpose: String = "Layer coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
