...
class SourceExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.source"
    override val area: String = "data.local.entity"
    override val purpose: String = "Source coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
