...
class ArtifactExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.artifact"
    override val area: String = "data.remote.api"
    override val purpose: String = "Artifact coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
