...
class BackupExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.backup"
    override val area: String = "data.local.dao"
    override val purpose: String = "Backup coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
