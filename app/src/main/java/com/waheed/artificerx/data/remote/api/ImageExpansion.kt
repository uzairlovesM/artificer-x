...
class ImageExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.image"
    override val area: String = "data.remote.api"
    override val purpose: String = "Image coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
