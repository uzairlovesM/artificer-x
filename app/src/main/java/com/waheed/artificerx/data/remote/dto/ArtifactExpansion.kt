...
class ArtifactExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.artifact"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Artifact coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
