...
class TimelineExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.timeline"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Timeline coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
