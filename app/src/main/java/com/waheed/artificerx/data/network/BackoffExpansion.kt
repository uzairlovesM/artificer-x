...
class BackoffExpansion : ExpansionCapability {
    override val id: String = "data.network.backoff"
    override val area: String = "data.network"
    override val purpose: String = "Backoff coordinates data.network responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
