...
class AutomationExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.automation"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Automation coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
