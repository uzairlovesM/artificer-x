...
class SearchExpansion : ExpansionCapability {
    override val id: String = "data.repository.search"
    override val area: String = "data.repository"
    override val purpose: String = "Search coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
