...
class ImageExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.image"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Image coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
