...
class AudioExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.audio"
    override val area: String = "data.remote.api"
    override val purpose: String = "Audio coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
