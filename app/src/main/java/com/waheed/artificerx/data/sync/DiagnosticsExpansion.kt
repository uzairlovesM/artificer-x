...
class DiagnosticsExpansion : ExpansionCapability {
    override val id: String = "data.sync.diagnostics"
    override val area: String = "data.sync"
    override val purpose: String = "Diagnostics coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
