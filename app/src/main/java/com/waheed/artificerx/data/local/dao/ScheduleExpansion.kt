...
class ScheduleExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.schedule"
    override val area: String = "data.local.dao"
    override val purpose: String = "Schedule coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
