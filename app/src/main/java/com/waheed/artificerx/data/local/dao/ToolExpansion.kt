...
class ToolExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.tool"
    override val area: String = "data.local.dao"
    override val purpose: String = "Tool coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
