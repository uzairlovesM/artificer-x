...
class BatchExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.batch"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Batch coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
