...
class QuotaExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.quota"
    override val area: String = "data.remote.api"
    override val purpose: String = "Quota coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
