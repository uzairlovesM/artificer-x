...
class BrushExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.brush"
    override val area: String = "data.local.dao"
    override val purpose: String = "Brush coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
