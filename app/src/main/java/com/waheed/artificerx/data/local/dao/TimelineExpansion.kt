...
class TimelineExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.timeline"
    override val area: String = "data.local.dao"
    override val purpose: String = "Timeline coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
