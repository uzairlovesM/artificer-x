...
class QuotaExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.quota"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Quota coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
