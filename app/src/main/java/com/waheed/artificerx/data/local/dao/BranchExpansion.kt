...
class BranchExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.branch"
    override val area: String = "data.local.dao"
    override val purpose: String = "Branch coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
