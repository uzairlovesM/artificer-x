...
class IntegrityExpansion : ExpansionCapability {
    override val id: String = "data.sync.integrity"
    override val area: String = "data.sync"
    override val purpose: String = "Integrity coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
