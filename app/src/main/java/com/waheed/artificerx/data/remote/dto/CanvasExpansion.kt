...
class CanvasExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.canvas"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Canvas coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
