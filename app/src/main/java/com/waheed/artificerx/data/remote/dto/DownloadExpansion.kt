...
class DownloadExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.download"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Download coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
