...
class CanvasExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.canvas"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Canvas coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
