...
class InboxExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.inbox"
    override val area: String = "data.local.dao"
    override val purpose: String = "Inbox coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
