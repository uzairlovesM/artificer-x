...
class CheckpointExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.checkpoint"
    override val area: String = "data.local.entity"
    override val purpose: String = "Checkpoint coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
