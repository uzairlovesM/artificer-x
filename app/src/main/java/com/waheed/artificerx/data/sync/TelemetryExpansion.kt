...
class TelemetryExpansion : ExpansionCapability {
    override val id: String = "data.sync.telemetry"
    override val area: String = "data.sync"
    override val purpose: String = "Telemetry coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
