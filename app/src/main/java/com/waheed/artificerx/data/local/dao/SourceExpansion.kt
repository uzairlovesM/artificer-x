...
class SourceExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.source"
    override val area: String = "data.local.dao"
    override val purpose: String = "Source coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
