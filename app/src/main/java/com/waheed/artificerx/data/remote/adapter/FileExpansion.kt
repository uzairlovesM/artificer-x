...
class FileExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.file"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "File coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
