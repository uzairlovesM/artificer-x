...
class PolicyExpansion : ExpansionCapability {
    override val id: String = "data.sync.policy"
    override val area: String = "data.sync"
    override val purpose: String = "Policy coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
