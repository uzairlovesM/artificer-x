...
class CacheExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.cache"
    override val area: String = "data.remote.api"
    override val purpose: String = "Cache coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
