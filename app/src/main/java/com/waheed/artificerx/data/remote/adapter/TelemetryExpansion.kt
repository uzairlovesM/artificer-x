...
class TelemetryExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.telemetry"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Telemetry coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
