...
class FileExpansion : ExpansionCapability {
    override val id: String = "data.repository.file"
    override val area: String = "data.repository"
    override val purpose: String = "File coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
