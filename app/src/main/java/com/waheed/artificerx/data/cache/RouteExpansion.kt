...
class RouteExpansion : ExpansionCapability {
    override val id: String = "data.cache.route"
    override val area: String = "data.cache"
    override val purpose: String = "Route coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
