...
class AutomationExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.automation"
    override val area: String = "data.local.entity"
    override val purpose: String = "Automation coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
