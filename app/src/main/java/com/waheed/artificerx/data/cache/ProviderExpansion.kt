...
class ProviderExpansion : ExpansionCapability {
    override val id: String = "data.cache.provider"
    override val area: String = "data.cache"
    override val purpose: String = "Provider coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
