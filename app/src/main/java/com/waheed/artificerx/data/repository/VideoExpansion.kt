...
class VideoExpansion : ExpansionCapability {
    override val id: String = "data.repository.video"
    override val area: String = "data.repository"
    override val purpose: String = "Video coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
