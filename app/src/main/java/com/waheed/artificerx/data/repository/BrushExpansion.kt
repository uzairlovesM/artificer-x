...
class BrushExpansion : ExpansionCapability {
    override val id: String = "data.repository.brush"
    override val area: String = "data.repository"
    override val purpose: String = "Brush coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
