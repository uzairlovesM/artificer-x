...
class InboxExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.inbox"
    override val area: String = "data.local.entity"
    override val purpose: String = "Inbox coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
