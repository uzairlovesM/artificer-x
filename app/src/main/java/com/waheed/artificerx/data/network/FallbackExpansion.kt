...
class FallbackExpansion : ExpansionCapability {
    override val id: String = "data.network.fallback"
    override val area: String = "data.network"
    override val purpose: String = "Fallback coordinates data.network responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
