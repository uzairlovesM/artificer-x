...
class SseExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.sse"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Sse coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
