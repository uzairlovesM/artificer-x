...
class CodeExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.code"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Code coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
