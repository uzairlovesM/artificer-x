...
class ImageExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.image"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Image coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
