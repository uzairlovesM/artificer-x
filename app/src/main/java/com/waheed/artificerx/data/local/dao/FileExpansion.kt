...
class FileExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.file"
    override val area: String = "data.local.dao"
    override val purpose: String = "File coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
