...
class HistoryExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.history"
    override val area: String = "data.local.entity"
    override val purpose: String = "History coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
