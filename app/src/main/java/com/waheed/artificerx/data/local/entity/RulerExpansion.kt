...
class RulerExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.ruler"
    override val area: String = "data.local.entity"
    override val purpose: String = "Ruler coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
