...
class StreamExpansion : ExpansionCapability {
    override val id: String = "data.remote.adapter.stream"
    override val area: String = "data.remote.adapter"
    override val purpose: String = "Stream coordinates data.remote.adapter responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
