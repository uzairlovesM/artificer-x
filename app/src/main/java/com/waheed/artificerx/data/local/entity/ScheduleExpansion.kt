...
class ScheduleExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.schedule"
    override val area: String = "data.local.entity"
    override val purpose: String = "Schedule coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
