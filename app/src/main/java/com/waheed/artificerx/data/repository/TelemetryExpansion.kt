...
class TelemetryExpansion : ExpansionCapability {
    override val id: String = "data.repository.telemetry"
    override val area: String = "data.repository"
    override val purpose: String = "Telemetry coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
