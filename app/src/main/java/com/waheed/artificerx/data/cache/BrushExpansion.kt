...
class BrushExpansion : ExpansionCapability {
    override val id: String = "data.cache.brush"
    override val area: String = "data.cache"
    override val purpose: String = "Brush coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
