...
class CacheExpansion : ExpansionCapability {
    override val id: String = "data.repository.cache"
    override val area: String = "data.repository"
    override val purpose: String = "Cache coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
