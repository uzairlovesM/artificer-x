...
class BrushExpansion : ExpansionCapability {
    override val id: String = "data.remote.dto.brush"
    override val area: String = "data.remote.dto"
    override val purpose: String = "Brush coordinates data.remote.dto responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
