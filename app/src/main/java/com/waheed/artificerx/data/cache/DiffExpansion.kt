...
class DiffExpansion : ExpansionCapability {
    override val id: String = "data.cache.diff"
    override val area: String = "data.cache"
    override val purpose: String = "Diff coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
