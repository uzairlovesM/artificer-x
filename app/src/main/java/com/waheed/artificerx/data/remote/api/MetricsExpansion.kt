...
class MetricsExpansion : ExpansionCapability {
    override val id: String = "data.remote.api.metrics"
    override val area: String = "data.remote.api"
    override val purpose: String = "Metrics coordinates data.remote.api responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
