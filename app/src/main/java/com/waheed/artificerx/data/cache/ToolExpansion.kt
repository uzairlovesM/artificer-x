...
class ToolExpansion : ExpansionCapability {
    override val id: String = "data.cache.tool"
    override val area: String = "data.cache"
    override val purpose: String = "Tool coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
