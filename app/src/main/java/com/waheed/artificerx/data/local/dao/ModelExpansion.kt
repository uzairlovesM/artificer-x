...
class ModelExpansion : ExpansionCapability {
    override val id: String = "data.local.dao.model"
    override val area: String = "data.local.dao"
    override val purpose: String = "Model coordinates data.local.dao responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
