...
class LockExpansion : ExpansionCapability {
    override val id: String = "data.sync.lock"
    override val area: String = "data.sync"
    override val purpose: String = "Lock coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
