...
class DownloadExpansion : ExpansionCapability {
    override val id: String = "data.network.download"
    override val area: String = "data.network"
    override val purpose: String = "Download coordinates data.network responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
