...
class CanvasExpansion : ExpansionCapability {
    override val id: String = "data.repository.canvas"
    override val area: String = "data.repository"
    override val purpose: String = "Canvas coordinates data.repository responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
