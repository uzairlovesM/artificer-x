...
class RepairExpansion : ExpansionCapability {
    override val id: String = "data.cache.repair"
    override val area: String = "data.cache"
    override val purpose: String = "Repair coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
