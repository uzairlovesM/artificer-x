...
class LeaseExpansion : ExpansionCapability {
    override val id: String = "data.cache.lease"
    override val area: String = "data.cache"
    override val purpose: String = "Lease coordinates data.cache responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
