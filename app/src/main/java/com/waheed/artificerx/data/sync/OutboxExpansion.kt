...
class OutboxExpansion : ExpansionCapability {
    override val id: String = "data.sync.outbox"
    override val area: String = "data.sync"
    override val purpose: String = "Outbox coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
