...
class EventExpansion : ExpansionCapability {
    override val id: String = "data.sync.event"
    override val area: String = "data.sync"
    override val purpose: String = "Event coordinates data.sync responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
