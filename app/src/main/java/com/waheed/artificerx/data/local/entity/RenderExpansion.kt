...
class RenderExpansion : ExpansionCapability {
    override val id: String = "data.local.entity.render"
    override val area: String = "data.local.entity"
    override val purpose: String = "Render coordinates data.local.entity responsibilities through explicit contracts, observable state, validation signals, and deterministic hand-off boundaries."
