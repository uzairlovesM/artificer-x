...
/** Concrete capability contract for style gate.
...
data class StyleGateCapability(val id:String="style_gate", val version:Int=1, val requires:Set<String>=emptySet(), val produces:Set<String>=emptySet(), val reversible:Boolean=true)
