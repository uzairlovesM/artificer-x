...
/** Concrete capability contract for line ruler.
...
data class LineRulerCapability(val id:String="line_ruler", val version:Int=1, val requires:Set<String>=emptySet(), val produces:Set<String>=emptySet(), val reversible:Boolean=true)
